...
type AssignmentVirtualMachineSpec struct {
	AssignmentVirtualMachineSpec2 `json:",inline"`
	// +optional
	KubeformOutput AssignmentVirtualMachineSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type AssignmentVirtualMachineSpec2 struct {
