...
type LearningInferenceClusterSpec struct {
	LearningInferenceClusterSpec2 `json:",inline"`
	// +optional
	KubeformOutput LearningInferenceClusterSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type LearningInferenceClusterSpec2 struct {
