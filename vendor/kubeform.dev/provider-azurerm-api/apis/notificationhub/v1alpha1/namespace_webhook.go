...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-notificationhub-azurerm-kubeform-com-v1alpha1-namespace_,mutating=false,failurePolicy=fail,groups=notificationhub.azurerm.kubeform.com,resources=namespace_s,versions=v1alpha1,name=namespace_.notificationhub.azurerm.kubeform.io,sideEffects=None,admissionReviewVersions=v1
