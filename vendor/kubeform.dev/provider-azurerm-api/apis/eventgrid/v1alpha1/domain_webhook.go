...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-eventgrid-azurerm-kubeform-com-v1alpha1-domain,mutating=false,failurePolicy=fail,groups=eventgrid.azurerm.kubeform.com,resources=domains,versions=v1alpha1,name=domain.eventgrid.azurerm.kubeform.io,sideEffects=None,admissionReviewVersions=v1
