...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-azurerm-api/apis/iotcentral/v1alpha1.Application":       schema_provider_azurerm_api_apis_iotcentral_v1alpha1_Application(ref),
		"kubeform.dev/provider-azurerm-api/apis/iotcentral/v1alpha1.ApplicationList":   schema_provider_azurerm_api_apis_iotcentral_v1alpha1_ApplicationList(ref),
		"kubeform.dev/provider-azurerm-api/apis/iotcentral/v1alpha1.ApplicationSpec":   schema_provider_azurerm_api_apis_iotcentral_v1alpha1_ApplicationSpec(ref),
		"kubeform.dev/provider-azurerm-api/apis/iotcentral/v1alpha1.ApplicationSpec2":  schema_provider_azurerm_api_apis_iotcentral_v1alpha1_ApplicationSpec2(ref),
		"kubeform.dev/provider-azurerm-api/apis/iotcentral/v1alpha1.ApplicationStatus": schema_provider_azurerm_api_apis_iotcentral_v1alpha1_ApplicationStatus(ref),
	}
}
...
func schema_provider_azurerm_api_apis_iotcentral_v1alpha1_Application(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/iotcentral/v1alpha1.ApplicationSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/iotcentral/v1alpha1.ApplicationStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-azurerm-api/apis/iotcentral/v1alpha1.ApplicationSpec", "kubeform.dev/provider-azurerm-api/apis/iotcentral/v1alpha1.ApplicationStatus"},
	}
}

func schema_provider_azurerm_api_apis_iotcentral_v1alpha1_ApplicationList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-azurerm-api/apis/iotcentral/v1alpha1.Application"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-azurerm-api/apis/iotcentral/v1alpha1.Application"},
	}
}

func schema_provider_azurerm_api_apis_iotcentral_v1alpha1_ApplicationSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/iotcentral/v1alpha1.ApplicationSpec2"),
						},
					},
				},
				Required: []string{"providerRef", "location", "name", "resourceGroupName", "subDomain"},
			},
		},
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/apimachinery/api/v1alpha1.ResourceTimeout", "kubeform.dev/provider-azurerm-api/apis/iotcentral/v1alpha1.ApplicationSpec2"},
	}
}

func schema_provider_azurerm_api_apis_iotcentral_v1alpha1_ApplicationSpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_azurerm_api_apis_iotcentral_v1alpha1_ApplicationStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
