...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-azurerm-api/apis/user/v1alpha1.AssignedIdentity":       schema_provider_azurerm_api_apis_user_v1alpha1_AssignedIdentity(ref),
		"kubeform.dev/provider-azurerm-api/apis/user/v1alpha1.AssignedIdentityList":   schema_provider_azurerm_api_apis_user_v1alpha1_AssignedIdentityList(ref),
		"kubeform.dev/provider-azurerm-api/apis/user/v1alpha1.AssignedIdentitySpec":   schema_provider_azurerm_api_apis_user_v1alpha1_AssignedIdentitySpec(ref),
		"kubeform.dev/provider-azurerm-api/apis/user/v1alpha1.AssignedIdentitySpec2":  schema_provider_azurerm_api_apis_user_v1alpha1_AssignedIdentitySpec2(ref),
		"kubeform.dev/provider-azurerm-api/apis/user/v1alpha1.AssignedIdentityStatus": schema_provider_azurerm_api_apis_user_v1alpha1_AssignedIdentityStatus(ref),
	}
}
...
func schema_provider_azurerm_api_apis_user_v1alpha1_AssignedIdentity(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/user/v1alpha1.AssignedIdentitySpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/user/v1alpha1.AssignedIdentityStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-azurerm-api/apis/user/v1alpha1.AssignedIdentitySpec", "kubeform.dev/provider-azurerm-api/apis/user/v1alpha1.AssignedIdentityStatus"},
	}
}

func schema_provider_azurerm_api_apis_user_v1alpha1_AssignedIdentityList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "AssignedIdentityList is a list of AssignedIdentitys",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							Description: "Items is a list of AssignedIdentity CRD objects",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-azurerm-api/apis/user/v1alpha1.AssignedIdentity"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-azurerm-api/apis/user/v1alpha1.AssignedIdentity"},
	}
}

func schema_provider_azurerm_api_apis_user_v1alpha1_AssignedIdentitySpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/user/v1alpha1.AssignedIdentitySpec2"),
						},
					},
				},
		...
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/apimachinery/api/v1alpha1.ResourceTimeout", "kubeform.dev/provider-azurerm-api/apis/user/v1alpha1.AssignedIdentitySpec2"},
	}
}

func schema_provider_azurerm_api_apis_user_v1alpha1_AssignedIdentitySpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_azurerm_api_apis_user_v1alpha1_AssignedIdentityStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
