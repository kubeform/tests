...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-azurerm-api/apis/cost/v1alpha1.ManagementExportResourceGroup":                 schema_provider_azurerm_api_apis_cost_v1alpha1_ManagementExportResourceGroup(ref),
		"kubeform.dev/provider-azurerm-api/apis/cost/v1alpha1.ManagementExportResourceGroupList":             schema_provider_azurerm_api_apis_cost_v1alpha1_ManagementExportResourceGroupList(ref),
		"kubeform.dev/provider-azurerm-api/apis/cost/v1alpha1.ManagementExportResourceGroupSpec":             schema_provider_azurerm_api_apis_cost_v1alpha1_ManagementExportResourceGroupSpec(ref),
		"kubeform.dev/provider-azurerm-api/apis/cost/v1alpha1.ManagementExportResourceGroupSpec2":            schema_provider_azurerm_api_apis_cost_v1alpha1_ManagementExportResourceGroupSpec2(ref),
		"kubeform.dev/provider-azurerm-api/apis/cost/v1alpha1.ManagementExportResourceGroupSpecDeliveryInfo": schema_provider_azurerm_api_apis_cost_v1alpha1_ManagementExportResourceGroupSpecDeliveryInfo(ref),
		"kubeform.dev/provider-azurerm-api/apis/cost/v1alpha1.ManagementExportResourceGroupSpecDeliveryInfoCodec": schema_provider_azurerm_api_apis_cost_v1alpha1_ManagementExportResourceGroupSpecDeliveryInfoCodec(ref),
		"kubeform.dev/provider-azurerm-api/apis/cost/v1alpha1.ManagementExportResourceGroupSpecQuery":             schema_provider_azurerm_api_apis_cost_v1alpha1_ManagementExportResourceGroupSpecQuery(ref),
		"kubeform.dev/provider-azurerm-api/apis/cost/v1alpha1.ManagementExportResourceGroupSpecQueryCodec":        schema_provider_azurerm_api_apis_cost_v1alpha1_ManagementExportResourceGroupSpecQueryCodec(ref),
		"kubeform.dev/provider-azurerm-api/apis/cost/v1alpha1.ManagementExportResourceGroupStatus":                schema_provider_azurerm_api_apis_cost_v1alpha1_ManagementExportResourceGroupStatus(ref),
	}
}
...
func schema_provider_azurerm_api_apis_cost_v1alpha1_ManagementExportResourceGroup(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/cost/v1alpha1.ManagementExportResourceGroupSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/cost/v1alpha1.ManagementExportResourceGroupStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-azurerm-api/apis/cost/v1alpha1.ManagementExportResourceGroupSpec", "kubeform.dev/provider-azurerm-api/apis/cost/v1alpha1.ManagementExportResourceGroupStatus"},
	}
}

func schema_provider_azurerm_api_apis_cost_v1alpha1_ManagementExportResourceGroupList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ManagementExportResourceGroupList is a list of ManagementExportResourceGroups",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							Description: "Items is a list of ManagementExportResourceGroup CRD objects",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-azurerm-api/apis/cost/v1alpha1.ManagementExportResourceGroup"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-azurerm-api/apis/cost/v1alpha1.ManagementExportResourceGroup"},
	}
}

func schema_provider_azurerm_api_apis_cost_v1alpha1_ManagementExportResourceGroupSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"deliveryInfo": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("kubeform.dev/provider-azurerm-api/apis/cost/v1alpha1.ManagementExportResourceGroupSpecDeliveryInfo"),
						},
					},
					"name": {
						SchemaProps: spec.SchemaProps{
					...
					"query": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("kubeform.dev/provider-azurerm-api/apis/cost/v1alpha1.ManagementExportResourceGroupSpecQuery"),
						},
					},
					"recurrencePeriodEnd": {
						SchemaProps: spec.SchemaProps{
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/cost/v1alpha1.ManagementExportResourceGroupSpec2"),
						},
					},
				},
				Required: []string{"providerRef", "deliveryInfo", "name", "query", "recurrencePeriodEnd", "recurrencePeriodStart", "recurrenceType", "resourceGroupID"},
			},
		},
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/apimachinery/api/v1alpha1.ResourceTimeout", "kubeform.dev/provider-azurerm-api/apis/cost/v1alpha1.ManagementExportResourceGroupSpec2", "kubeform.dev/provider-azurerm-api/apis/cost/v1alpha1.ManagementExportResourceGroupSpecDeliveryInfo", "kubeform.dev/provider-azurerm-api/apis/cost/v1alpha1.ManagementExportResourceGroupSpecQuery"},
	}
}

func schema_provider_azurerm_api_apis_cost_v1alpha1_ManagementExportResourceGroupSpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
		...
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/apimachinery/api/v1alpha1.ResourceTimeout", "kubeform.dev/provider-azurerm-api/apis/cost/v1alpha1.ManagementExportResourceGroupSpecDeliveryInfo", "kubeform.dev/provider-azurerm-api/apis/cost/v1alpha1.ManagementExportResourceGroupSpecQuery"},
	}
}

func schema_provider_azurerm_api_apis_cost_v1alpha1_ManagementExportResourceGroupSpecDeliveryInfo(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				...
				Required: []string{"containerName", "rootFolderPath", "storageAccountID"},
			},
		},
	}
}

func schema_provider_azurerm_api_apis_cost_v1alpha1_ManagementExportResourceGroupSpecDeliveryInfoCodec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_azurerm_api_apis_cost_v1alpha1_ManagementExportResourceGroupSpecQuery(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				...
				Required: []string{"timeFrame", "type"},
			},
		},
	}
}

func schema_provider_azurerm_api_apis_cost_v1alpha1_ManagementExportResourceGroupSpecQueryCodec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_azurerm_api_apis_cost_v1alpha1_ManagementExportResourceGroupStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
