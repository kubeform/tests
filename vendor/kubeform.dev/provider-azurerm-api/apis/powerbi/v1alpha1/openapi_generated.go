...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-azurerm-api/apis/powerbi/v1alpha1.Embedded":       schema_provider_azurerm_api_apis_powerbi_v1alpha1_Embedded(ref),
		"kubeform.dev/provider-azurerm-api/apis/powerbi/v1alpha1.EmbeddedList":   schema_provider_azurerm_api_apis_powerbi_v1alpha1_EmbeddedList(ref),
		"kubeform.dev/provider-azurerm-api/apis/powerbi/v1alpha1.EmbeddedSpec":   schema_provider_azurerm_api_apis_powerbi_v1alpha1_EmbeddedSpec(ref),
		"kubeform.dev/provider-azurerm-api/apis/powerbi/v1alpha1.EmbeddedSpec2":  schema_provider_azurerm_api_apis_powerbi_v1alpha1_EmbeddedSpec2(ref),
		"kubeform.dev/provider-azurerm-api/apis/powerbi/v1alpha1.EmbeddedStatus": schema_provider_azurerm_api_apis_powerbi_v1alpha1_EmbeddedStatus(ref),
	}
}
...
func schema_provider_azurerm_api_apis_powerbi_v1alpha1_Embedded(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/powerbi/v1alpha1.EmbeddedSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/powerbi/v1alpha1.EmbeddedStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-azurerm-api/apis/powerbi/v1alpha1.EmbeddedSpec", "kubeform.dev/provider-azurerm-api/apis/powerbi/v1alpha1.EmbeddedStatus"},
	}
}

func schema_provider_azurerm_api_apis_powerbi_v1alpha1_EmbeddedList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "EmbeddedList is a list of Embeddeds",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							Description: "Items is a list of Embedded CRD objects",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-azurerm-api/apis/powerbi/v1alpha1.Embedded"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-azurerm-api/apis/powerbi/v1alpha1.Embedded"},
	}
}

func schema_provider_azurerm_api_apis_powerbi_v1alpha1_EmbeddedSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/powerbi/v1alpha1.EmbeddedSpec2"),
						},
					},
				},
				Required: []string{"providerRef", "administrators", "location", "name", "resourceGroupName", "skuName"},
			},
		},
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/apimachinery/api/v1alpha1.ResourceTimeout", "kubeform.dev/provider-azurerm-api/apis/powerbi/v1alpha1.EmbeddedSpec2"},
	}
}

func schema_provider_azurerm_api_apis_powerbi_v1alpha1_EmbeddedSpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_azurerm_api_apis_powerbi_v1alpha1_EmbeddedStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
