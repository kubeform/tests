...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-azurerm-api/apis/template/v1alpha1.Deployment":       schema_provider_azurerm_api_apis_template_v1alpha1_Deployment(ref),
		"kubeform.dev/provider-azurerm-api/apis/template/v1alpha1.DeploymentList":   schema_provider_azurerm_api_apis_template_v1alpha1_DeploymentList(ref),
		"kubeform.dev/provider-azurerm-api/apis/template/v1alpha1.DeploymentSpec":   schema_provider_azurerm_api_apis_template_v1alpha1_DeploymentSpec(ref),
		"kubeform.dev/provider-azurerm-api/apis/template/v1alpha1.DeploymentSpec2":  schema_provider_azurerm_api_apis_template_v1alpha1_DeploymentSpec2(ref),
		"kubeform.dev/provider-azurerm-api/apis/template/v1alpha1.DeploymentStatus": schema_provider_azurerm_api_apis_template_v1alpha1_DeploymentStatus(ref),
	}
}
...
func schema_provider_azurerm_api_apis_template_v1alpha1_Deployment(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/template/v1alpha1.DeploymentSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/template/v1alpha1.DeploymentStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-azurerm-api/apis/template/v1alpha1.DeploymentSpec", "kubeform.dev/provider-azurerm-api/apis/template/v1alpha1.DeploymentStatus"},
	}
}

func schema_provider_azurerm_api_apis_template_v1alpha1_DeploymentList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-azurerm-api/apis/template/v1alpha1.Deployment"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-azurerm-api/apis/template/v1alpha1.Deployment"},
	}
}

func schema_provider_azurerm_api_apis_template_v1alpha1_DeploymentSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/template/v1alpha1.DeploymentSpec2"),
						},
					},
				},
		...
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/apimachinery/api/v1alpha1.ResourceTimeout", "kubeform.dev/provider-azurerm-api/apis/template/v1alpha1.DeploymentSpec2"},
	}
}

func schema_provider_azurerm_api_apis_template_v1alpha1_DeploymentSpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_azurerm_api_apis_template_v1alpha1_DeploymentStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
