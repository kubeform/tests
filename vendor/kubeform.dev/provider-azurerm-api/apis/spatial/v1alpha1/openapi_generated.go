...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-azurerm-api/apis/spatial/v1alpha1.AnchorsAccount":       schema_provider_azurerm_api_apis_spatial_v1alpha1_AnchorsAccount(ref),
		"kubeform.dev/provider-azurerm-api/apis/spatial/v1alpha1.AnchorsAccountList":   schema_provider_azurerm_api_apis_spatial_v1alpha1_AnchorsAccountList(ref),
		"kubeform.dev/provider-azurerm-api/apis/spatial/v1alpha1.AnchorsAccountSpec":   schema_provider_azurerm_api_apis_spatial_v1alpha1_AnchorsAccountSpec(ref),
		"kubeform.dev/provider-azurerm-api/apis/spatial/v1alpha1.AnchorsAccountSpec2":  schema_provider_azurerm_api_apis_spatial_v1alpha1_AnchorsAccountSpec2(ref),
		"kubeform.dev/provider-azurerm-api/apis/spatial/v1alpha1.AnchorsAccountStatus": schema_provider_azurerm_api_apis_spatial_v1alpha1_AnchorsAccountStatus(ref),
	}
}
...
func schema_provider_azurerm_api_apis_spatial_v1alpha1_AnchorsAccount(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/spatial/v1alpha1.AnchorsAccountSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/spatial/v1alpha1.AnchorsAccountStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-azurerm-api/apis/spatial/v1alpha1.AnchorsAccountSpec", "kubeform.dev/provider-azurerm-api/apis/spatial/v1alpha1.AnchorsAccountStatus"},
	}
}

func schema_provider_azurerm_api_apis_spatial_v1alpha1_AnchorsAccountList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "AnchorsAccountList is a list of AnchorsAccounts",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							Description: "Items is a list of AnchorsAccount CRD objects",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-azurerm-api/apis/spatial/v1alpha1.AnchorsAccount"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-azurerm-api/apis/spatial/v1alpha1.AnchorsAccount"},
	}
}

func schema_provider_azurerm_api_apis_spatial_v1alpha1_AnchorsAccountSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/spatial/v1alpha1.AnchorsAccountSpec2"),
						},
					},
				},
		...
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/apimachinery/api/v1alpha1.ResourceTimeout", "kubeform.dev/provider-azurerm-api/apis/spatial/v1alpha1.AnchorsAccountSpec2"},
	}
}

func schema_provider_azurerm_api_apis_spatial_v1alpha1_AnchorsAccountSpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_azurerm_api_apis_spatial_v1alpha1_AnchorsAccountStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
