...
type IdentityProviderGoogleSpec struct {
	IdentityProviderGoogleSpec2 `json:",inline"`
	// +optional
	KubeformOutput IdentityProviderGoogleSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type IdentityProviderGoogleSpec2 struct {
