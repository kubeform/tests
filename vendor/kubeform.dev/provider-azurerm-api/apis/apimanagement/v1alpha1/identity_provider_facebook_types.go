...
type IdentityProviderFacebookSpec struct {
	IdentityProviderFacebookSpec2 `json:",inline"`
	// +optional
	KubeformOutput IdentityProviderFacebookSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type IdentityProviderFacebookSpec2 struct {
