...
type IdentityProviderTwitterSpec struct {
	IdentityProviderTwitterSpec2 `json:",inline"`
	// +optional
	KubeformOutput IdentityProviderTwitterSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type IdentityProviderTwitterSpec2 struct {
