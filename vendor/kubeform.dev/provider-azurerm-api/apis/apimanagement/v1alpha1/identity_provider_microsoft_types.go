...
type IdentityProviderMicrosoftSpec struct {
	IdentityProviderMicrosoftSpec2 `json:",inline"`
	// +optional
	KubeformOutput IdentityProviderMicrosoftSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type IdentityProviderMicrosoftSpec2 struct {
