...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-relay-azurerm-kubeform-com-v1alpha1-namespace_,mutating=false,failurePolicy=fail,groups=relay.azurerm.kubeform.com,resources=namespace_s,versions=v1alpha1,name=namespace_.relay.azurerm.kubeform.io,sideEffects=None,admissionReviewVersions=v1
