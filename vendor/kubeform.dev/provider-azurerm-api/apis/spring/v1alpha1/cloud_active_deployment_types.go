...
type CloudActiveDeploymentSpec struct {
	CloudActiveDeploymentSpec2 `json:",inline"`
	// +optional
	KubeformOutput CloudActiveDeploymentSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type CloudActiveDeploymentSpec2 struct {
