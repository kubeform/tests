...
type CloudAppRedisAssociationSpec struct {
	CloudAppRedisAssociationSpec2 `json:",inline"`
	// +optional
	KubeformOutput CloudAppRedisAssociationSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type CloudAppRedisAssociationSpec2 struct {
