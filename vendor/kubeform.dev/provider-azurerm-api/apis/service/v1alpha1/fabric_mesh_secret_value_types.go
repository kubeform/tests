...
type FabricMeshSecretValueSpec struct {
	FabricMeshSecretValueSpec2 `json:",inline"`
	// +optional
	KubeformOutput FabricMeshSecretValueSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type FabricMeshSecretValueSpec2 struct {
