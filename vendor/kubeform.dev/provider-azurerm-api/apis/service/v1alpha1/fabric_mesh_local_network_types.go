...
type FabricMeshLocalNetworkSpec struct {
	FabricMeshLocalNetworkSpec2 `json:",inline"`
	// +optional
	KubeformOutput FabricMeshLocalNetworkSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type FabricMeshLocalNetworkSpec2 struct {
