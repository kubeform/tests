...
type AccountCustomerManagedKeySpec struct {
	AccountCustomerManagedKeySpec2 `json:",inline"`
	// +optional
	KubeformOutput AccountCustomerManagedKeySpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type AccountCustomerManagedKeySpec2 struct {
