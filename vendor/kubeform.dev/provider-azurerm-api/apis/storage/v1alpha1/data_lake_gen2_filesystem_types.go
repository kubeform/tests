...
type DataLakeGen2FilesystemSpec struct {
	DataLakeGen2FilesystemSpec2 `json:",inline"`
	// +optional
	KubeformOutput DataLakeGen2FilesystemSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type DataLakeGen2FilesystemSpec2 struct {
