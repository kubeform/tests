...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-azurerm-api/apis/proximity/v1alpha1.PlacementGroup":       schema_provider_azurerm_api_apis_proximity_v1alpha1_PlacementGroup(ref),
		"kubeform.dev/provider-azurerm-api/apis/proximity/v1alpha1.PlacementGroupList":   schema_provider_azurerm_api_apis_proximity_v1alpha1_PlacementGroupList(ref),
		"kubeform.dev/provider-azurerm-api/apis/proximity/v1alpha1.PlacementGroupSpec":   schema_provider_azurerm_api_apis_proximity_v1alpha1_PlacementGroupSpec(ref),
		"kubeform.dev/provider-azurerm-api/apis/proximity/v1alpha1.PlacementGroupSpec2":  schema_provider_azurerm_api_apis_proximity_v1alpha1_PlacementGroupSpec2(ref),
		"kubeform.dev/provider-azurerm-api/apis/proximity/v1alpha1.PlacementGroupStatus": schema_provider_azurerm_api_apis_proximity_v1alpha1_PlacementGroupStatus(ref),
	}
}
...
func schema_provider_azurerm_api_apis_proximity_v1alpha1_PlacementGroup(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/proximity/v1alpha1.PlacementGroupSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/proximity/v1alpha1.PlacementGroupStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-azurerm-api/apis/proximity/v1alpha1.PlacementGroupSpec", "kubeform.dev/provider-azurerm-api/apis/proximity/v1alpha1.PlacementGroupStatus"},
	}
}

func schema_provider_azurerm_api_apis_proximity_v1alpha1_PlacementGroupList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "PlacementGroupList is a list of PlacementGroups",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							Description: "Items is a list of PlacementGroup CRD objects",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-azurerm-api/apis/proximity/v1alpha1.PlacementGroup"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-azurerm-api/apis/proximity/v1alpha1.PlacementGroup"},
	}
}

func schema_provider_azurerm_api_apis_proximity_v1alpha1_PlacementGroupSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/proximity/v1alpha1.PlacementGroupSpec2"),
						},
					},
				},
		...
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/apimachinery/api/v1alpha1.ResourceTimeout", "kubeform.dev/provider-azurerm-api/apis/proximity/v1alpha1.PlacementGroupSpec2"},
	}
}

func schema_provider_azurerm_api_apis_proximity_v1alpha1_PlacementGroupSpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_azurerm_api_apis_proximity_v1alpha1_PlacementGroupStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
