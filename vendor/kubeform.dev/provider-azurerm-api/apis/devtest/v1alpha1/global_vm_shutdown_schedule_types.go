...
type GlobalVmShutdownScheduleSpec struct {
	GlobalVmShutdownScheduleSpec2 `json:",inline"`
	// +optional
	KubeformOutput GlobalVmShutdownScheduleSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type GlobalVmShutdownScheduleSpec2 struct {
