...
type WindowsVirtualMachineSpec struct {
	WindowsVirtualMachineSpec2 `json:",inline"`
	// +optional
	KubeformOutput WindowsVirtualMachineSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type WindowsVirtualMachineSpec2 struct {
