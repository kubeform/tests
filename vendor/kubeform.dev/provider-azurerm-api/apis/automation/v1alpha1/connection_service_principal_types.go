...
type ConnectionServicePrincipalSpec struct {
	ConnectionServicePrincipalSpec2 `json:",inline"`
	// +optional
	KubeformOutput ConnectionServicePrincipalSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type ConnectionServicePrincipalSpec2 struct {
