...
type FactoryLinkedServiceAzureSQLDatabaseSpec struct {
	FactoryLinkedServiceAzureSQLDatabaseSpec2 `json:",inline"`
	// +optional
	KubeformOutput FactoryLinkedServiceAzureSQLDatabaseSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type FactoryLinkedServiceAzureSQLDatabaseSpec2 struct {
