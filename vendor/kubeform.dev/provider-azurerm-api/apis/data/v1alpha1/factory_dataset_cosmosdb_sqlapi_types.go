...
type FactoryDatasetCosmosdbSqlapiSpec struct {
	FactoryDatasetCosmosdbSqlapiSpec2 `json:",inline"`
	// +optional
	KubeformOutput FactoryDatasetCosmosdbSqlapiSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type FactoryDatasetCosmosdbSqlapiSpec2 struct {
