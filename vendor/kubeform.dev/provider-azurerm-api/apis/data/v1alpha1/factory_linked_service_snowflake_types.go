...
type FactoryLinkedServiceSnowflakeSpec struct {
	FactoryLinkedServiceSnowflakeSpec2 `json:",inline"`
	// +optional
	KubeformOutput FactoryLinkedServiceSnowflakeSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type FactoryLinkedServiceSnowflakeSpec2 struct {
