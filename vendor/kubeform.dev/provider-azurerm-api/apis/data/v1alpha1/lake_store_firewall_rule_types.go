...
type LakeStoreFirewallRuleSpec struct {
	LakeStoreFirewallRuleSpec2 `json:",inline"`
	// +optional
	KubeformOutput LakeStoreFirewallRuleSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type LakeStoreFirewallRuleSpec2 struct {
