...
type FactoryTriggerScheduleSpec struct {
	FactoryTriggerScheduleSpec2 `json:",inline"`
	// +optional
	KubeformOutput FactoryTriggerScheduleSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type FactoryTriggerScheduleSpec2 struct {
