...
type FactoryLinkedServiceSQLServerSpec struct {
	FactoryLinkedServiceSQLServerSpec2 `json:",inline"`
	// +optional
	KubeformOutput FactoryLinkedServiceSQLServerSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type FactoryLinkedServiceSQLServerSpec2 struct {
