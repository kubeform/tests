...
type LakeAnalyticsFirewallRuleSpec struct {
	LakeAnalyticsFirewallRuleSpec2 `json:",inline"`
	// +optional
	KubeformOutput LakeAnalyticsFirewallRuleSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type LakeAnalyticsFirewallRuleSpec2 struct {
