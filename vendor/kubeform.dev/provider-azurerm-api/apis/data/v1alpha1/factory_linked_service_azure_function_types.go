...
type FactoryLinkedServiceAzureFunctionSpec struct {
	FactoryLinkedServiceAzureFunctionSpec2 `json:",inline"`
	// +optional
	KubeformOutput FactoryLinkedServiceAzureFunctionSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type FactoryLinkedServiceAzureFunctionSpec2 struct {
