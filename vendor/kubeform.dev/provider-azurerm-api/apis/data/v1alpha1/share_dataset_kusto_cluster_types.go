...
type ShareDatasetKustoClusterSpec struct {
	ShareDatasetKustoClusterSpec2 `json:",inline"`
	// +optional
	KubeformOutput ShareDatasetKustoClusterSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type ShareDatasetKustoClusterSpec2 struct {
