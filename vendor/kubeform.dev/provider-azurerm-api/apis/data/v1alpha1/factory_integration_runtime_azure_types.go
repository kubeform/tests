...
type FactoryIntegrationRuntimeAzureSpec struct {
	FactoryIntegrationRuntimeAzureSpec2 `json:",inline"`
	// +optional
	KubeformOutput FactoryIntegrationRuntimeAzureSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type FactoryIntegrationRuntimeAzureSpec2 struct {
