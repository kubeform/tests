...
type FactoryLinkedServiceAzureTableStorageSpec struct {
	FactoryLinkedServiceAzureTableStorageSpec2 `json:",inline"`
	// +optional
	KubeformOutput FactoryLinkedServiceAzureTableStorageSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type FactoryLinkedServiceAzureTableStorageSpec2 struct {
