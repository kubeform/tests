...
type FactoryDatasetPostgresqlSpec struct {
	FactoryDatasetPostgresqlSpec2 `json:",inline"`
	// +optional
	KubeformOutput FactoryDatasetPostgresqlSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type FactoryDatasetPostgresqlSpec2 struct {
