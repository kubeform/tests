...
type FactoryDatasetSnowflakeSpec struct {
	FactoryDatasetSnowflakeSpec2 `json:",inline"`
	// +optional
	KubeformOutput FactoryDatasetSnowflakeSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type FactoryDatasetSnowflakeSpec2 struct {
