...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-data-azurerm-kubeform-com-v1alpha1-factorylinkedservicesqlserver,mutating=false,failurePolicy=fail,groups=data.azurerm.kubeform.com,resources=factorylinkedservicesqlservers,versions=v1alpha1,name=factorylinkedservicesqlserver.data.azurerm.kubeform.io,sideEffects=None,admissionReviewVersions=v1
...
func (r *FactoryLinkedServiceSQLServer) ValidateDelete() error {
	if r.Spec.TerminationPolicy == base.TerminationPolicyDoNotTerminate {
		return fmt.Errorf(`factorylinkedservicesqlserver "%v/%v" can't be terminated. To delete, change spec.terminationPolicy to Delete`, r.Namespace, r.Name)
	}
	return nil
}
