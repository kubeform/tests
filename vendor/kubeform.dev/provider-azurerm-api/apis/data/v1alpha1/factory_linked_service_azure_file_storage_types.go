...
type FactoryLinkedServiceAzureFileStorageSpec struct {
	FactoryLinkedServiceAzureFileStorageSpec2 `json:",inline"`
	// +optional
	KubeformOutput FactoryLinkedServiceAzureFileStorageSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type FactoryLinkedServiceAzureFileStorageSpec2 struct {
