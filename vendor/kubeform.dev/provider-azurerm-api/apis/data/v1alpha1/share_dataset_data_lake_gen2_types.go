...
type ShareDatasetDataLakeGen2Spec struct {
	ShareDatasetDataLakeGen2Spec2 `json:",inline"`
	// +optional
	KubeformOutput ShareDatasetDataLakeGen2Spec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type ShareDatasetDataLakeGen2Spec2 struct {
