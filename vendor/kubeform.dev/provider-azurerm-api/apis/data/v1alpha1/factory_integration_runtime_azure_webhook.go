...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-data-azurerm-kubeform-com-v1alpha1-factoryintegrationruntimeazure,mutating=false,failurePolicy=fail,groups=data.azurerm.kubeform.com,resources=factoryintegrationruntimeazures,versions=v1alpha1,name=factoryintegrationruntimeazure.data.azurerm.kubeform.io,sideEffects=None,admissionReviewVersions=v1
...
func (r *FactoryIntegrationRuntimeAzure) ValidateDelete() error {
	if r.Spec.TerminationPolicy == base.TerminationPolicyDoNotTerminate {
		return fmt.Errorf(`factoryintegrationruntimeazure "%v/%v" can't be terminated. To delete, change spec.terminationPolicy to Delete`, r.Namespace, r.Name)
	}
	return nil
}
