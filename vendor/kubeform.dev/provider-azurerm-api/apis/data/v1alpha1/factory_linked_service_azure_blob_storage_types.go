...
type FactoryLinkedServiceAzureBlobStorageSpec struct {
	FactoryLinkedServiceAzureBlobStorageSpec2 `json:",inline"`
	// +optional
	KubeformOutput FactoryLinkedServiceAzureBlobStorageSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type FactoryLinkedServiceAzureBlobStorageSpec2 struct {
