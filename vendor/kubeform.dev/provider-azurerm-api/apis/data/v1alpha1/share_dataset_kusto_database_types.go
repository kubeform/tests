...
type ShareDatasetKustoDatabaseSpec struct {
	ShareDatasetKustoDatabaseSpec2 `json:",inline"`
	// +optional
	KubeformOutput ShareDatasetKustoDatabaseSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type ShareDatasetKustoDatabaseSpec2 struct {
