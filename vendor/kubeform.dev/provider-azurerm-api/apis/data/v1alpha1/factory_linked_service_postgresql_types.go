...
type FactoryLinkedServicePostgresqlSpec struct {
	FactoryLinkedServicePostgresqlSpec2 `json:",inline"`
	// +optional
	KubeformOutput FactoryLinkedServicePostgresqlSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type FactoryLinkedServicePostgresqlSpec2 struct {
