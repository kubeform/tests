...
type LakeStoreVirtualNetworkRuleSpec struct {
	LakeStoreVirtualNetworkRuleSpec2 `json:",inline"`
	// +optional
	KubeformOutput LakeStoreVirtualNetworkRuleSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type LakeStoreVirtualNetworkRuleSpec2 struct {
