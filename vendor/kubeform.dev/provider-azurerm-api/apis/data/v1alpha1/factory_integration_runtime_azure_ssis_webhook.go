...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-data-azurerm-kubeform-com-v1alpha1-factoryintegrationruntimeazuressis,mutating=false,failurePolicy=fail,groups=data.azurerm.kubeform.com,resources=factoryintegrationruntimeazuressis,versions=v1alpha1,name=factoryintegrationruntimeazuressis.data.azurerm.kubeform.io,sideEffects=None,admissionReviewVersions=v1
...
func (r *FactoryIntegrationRuntimeAzureSsis) ValidateDelete() error {
	if r.Spec.TerminationPolicy == base.TerminationPolicyDoNotTerminate {
		return fmt.Errorf(`factoryintegrationruntimeazuressis "%v/%v" can't be terminated. To delete, change spec.terminationPolicy to Delete`, r.Namespace, r.Name)
	}
	return nil
}
