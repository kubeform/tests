...
type FactoryDatasetSQLServerTableSpec struct {
	FactoryDatasetSQLServerTableSpec2 `json:",inline"`
	// +optional
	KubeformOutput FactoryDatasetSQLServerTableSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type FactoryDatasetSQLServerTableSpec2 struct {
