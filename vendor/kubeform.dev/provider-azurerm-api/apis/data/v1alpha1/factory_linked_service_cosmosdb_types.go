...
type FactoryLinkedServiceCosmosdbSpec struct {
	FactoryLinkedServiceCosmosdbSpec2 `json:",inline"`
	// +optional
	KubeformOutput FactoryLinkedServiceCosmosdbSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type FactoryLinkedServiceCosmosdbSpec2 struct {
