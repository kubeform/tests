...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-azurerm-api/apis/communication/v1alpha1.Service":       schema_provider_azurerm_api_apis_communication_v1alpha1_Service(ref),
		"kubeform.dev/provider-azurerm-api/apis/communication/v1alpha1.ServiceList":   schema_provider_azurerm_api_apis_communication_v1alpha1_ServiceList(ref),
		"kubeform.dev/provider-azurerm-api/apis/communication/v1alpha1.ServiceSpec":   schema_provider_azurerm_api_apis_communication_v1alpha1_ServiceSpec(ref),
		"kubeform.dev/provider-azurerm-api/apis/communication/v1alpha1.ServiceSpec2":  schema_provider_azurerm_api_apis_communication_v1alpha1_ServiceSpec2(ref),
		"kubeform.dev/provider-azurerm-api/apis/communication/v1alpha1.ServiceStatus": schema_provider_azurerm_api_apis_communication_v1alpha1_ServiceStatus(ref),
	}
}
...
func schema_provider_azurerm_api_apis_communication_v1alpha1_Service(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/communication/v1alpha1.ServiceSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/communication/v1alpha1.ServiceStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-azurerm-api/apis/communication/v1alpha1.ServiceSpec", "kubeform.dev/provider-azurerm-api/apis/communication/v1alpha1.ServiceStatus"},
	}
}

func schema_provider_azurerm_api_apis_communication_v1alpha1_ServiceList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-azurerm-api/apis/communication/v1alpha1.Service"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-azurerm-api/apis/communication/v1alpha1.Service"},
	}
}

func schema_provider_azurerm_api_apis_communication_v1alpha1_ServiceSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/communication/v1alpha1.ServiceSpec2"),
						},
					},
				},
		...
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/apimachinery/api/v1alpha1.ResourceTimeout", "kubeform.dev/provider-azurerm-api/apis/communication/v1alpha1.ServiceSpec2"},
	}
}

func schema_provider_azurerm_api_apis_communication_v1alpha1_ServiceSpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_azurerm_api_apis_communication_v1alpha1_ServiceStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
