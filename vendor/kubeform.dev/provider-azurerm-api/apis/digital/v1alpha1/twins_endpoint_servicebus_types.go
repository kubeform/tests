...
type TwinsEndpointServicebusSpec struct {
	TwinsEndpointServicebusSpec2 `json:",inline"`
	// +optional
	KubeformOutput TwinsEndpointServicebusSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type TwinsEndpointServicebusSpec2 struct {
