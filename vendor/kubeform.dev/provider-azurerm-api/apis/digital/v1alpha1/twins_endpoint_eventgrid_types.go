...
type TwinsEndpointEventgridSpec struct {
	TwinsEndpointEventgridSpec2 `json:",inline"`
	// +optional
	KubeformOutput TwinsEndpointEventgridSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type TwinsEndpointEventgridSpec2 struct {
