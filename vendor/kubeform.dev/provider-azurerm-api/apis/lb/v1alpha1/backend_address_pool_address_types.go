...
type BackendAddressPoolAddressSpec struct {
	BackendAddressPoolAddressSpec2 `json:",inline"`
	// +optional
	KubeformOutput BackendAddressPoolAddressSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type BackendAddressPoolAddressSpec2 struct {
