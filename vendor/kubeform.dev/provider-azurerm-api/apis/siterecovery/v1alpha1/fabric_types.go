...
type FabricSpec struct {
	FabricSpec2 `json:",inline"`
	// +optional
	KubeformOutput FabricSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type FabricSpec2 struct {
...
type FabricList struct {
	...
	// Items is a list of Fabric CRD objects
	Items []Fabric `json:"items,omitempty"`
}
