...
type ProtectionContainerMapping struct {
	...
	Spec              ProtectionContainerMappingSpec   `json:"spec,omitempty"`
	Status            ProtectionContainerMappingStatus `json:"status,omitempty"`
}

type ProtectionContainerMappingSpec struct {
	ProtectionContainerMappingSpec2 `json:",inline"`
	// +optional
	KubeformOutput ProtectionContainerMappingSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type ProtectionContainerMappingSpec2 struct {
...
type ProtectionContainerMappingStatus struct {
...
type ProtectionContainerMappingList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	// Items is a list of ProtectionContainerMapping CRD objects
	Items []ProtectionContainerMapping `json:"items,omitempty"`
}
