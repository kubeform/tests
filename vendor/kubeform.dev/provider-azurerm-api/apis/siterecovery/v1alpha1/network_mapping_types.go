...
type NetworkMappingSpec struct {
	NetworkMappingSpec2 `json:",inline"`
	// +optional
	KubeformOutput NetworkMappingSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type NetworkMappingSpec2 struct {
...
type NetworkMappingList struct {
	...
	// Items is a list of NetworkMapping CRD objects
	Items []NetworkMapping `json:"items,omitempty"`
}
