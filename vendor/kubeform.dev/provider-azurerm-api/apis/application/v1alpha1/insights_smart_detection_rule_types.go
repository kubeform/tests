...
type InsightsSmartDetectionRuleSpec struct {
	InsightsSmartDetectionRuleSpec2 `json:",inline"`
	// +optional
	KubeformOutput InsightsSmartDetectionRuleSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type InsightsSmartDetectionRuleSpec2 struct {
