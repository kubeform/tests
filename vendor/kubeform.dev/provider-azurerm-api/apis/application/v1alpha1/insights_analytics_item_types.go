...
type InsightsAnalyticsItemSpec struct {
	InsightsAnalyticsItemSpec2 `json:",inline"`
	// +optional
	KubeformOutput InsightsAnalyticsItemSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type InsightsAnalyticsItemSpec2 struct {
