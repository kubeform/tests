...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-azurerm-api/apis/marketplace/v1alpha1.Agreement":       schema_provider_azurerm_api_apis_marketplace_v1alpha1_Agreement(ref),
		"kubeform.dev/provider-azurerm-api/apis/marketplace/v1alpha1.AgreementList":   schema_provider_azurerm_api_apis_marketplace_v1alpha1_AgreementList(ref),
		"kubeform.dev/provider-azurerm-api/apis/marketplace/v1alpha1.AgreementSpec":   schema_provider_azurerm_api_apis_marketplace_v1alpha1_AgreementSpec(ref),
		"kubeform.dev/provider-azurerm-api/apis/marketplace/v1alpha1.AgreementSpec2":  schema_provider_azurerm_api_apis_marketplace_v1alpha1_AgreementSpec2(ref),
		"kubeform.dev/provider-azurerm-api/apis/marketplace/v1alpha1.AgreementStatus": schema_provider_azurerm_api_apis_marketplace_v1alpha1_AgreementStatus(ref),
	}
}
...
func schema_provider_azurerm_api_apis_marketplace_v1alpha1_Agreement(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/marketplace/v1alpha1.AgreementSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/marketplace/v1alpha1.AgreementStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-azurerm-api/apis/marketplace/v1alpha1.AgreementSpec", "kubeform.dev/provider-azurerm-api/apis/marketplace/v1alpha1.AgreementStatus"},
	}
}

func schema_provider_azurerm_api_apis_marketplace_v1alpha1_AgreementList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "AgreementList is a list of Agreements",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							Description: "Items is a list of Agreement CRD objects",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-azurerm-api/apis/marketplace/v1alpha1.Agreement"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-azurerm-api/apis/marketplace/v1alpha1.Agreement"},
	}
}

func schema_provider_azurerm_api_apis_marketplace_v1alpha1_AgreementSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/marketplace/v1alpha1.AgreementSpec2"),
						},
					},
				},
				Required: []string{"providerRef", "offer", "plan", "publisher"},
			},
		},
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/apimachinery/api/v1alpha1.ResourceTimeout", "kubeform.dev/provider-azurerm-api/apis/marketplace/v1alpha1.AgreementSpec2"},
	}
}

func schema_provider_azurerm_api_apis_marketplace_v1alpha1_AgreementSpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_azurerm_api_apis_marketplace_v1alpha1_AgreementStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
