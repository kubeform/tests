...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-azurerm-api/apis/maps/v1alpha1.Account":       schema_provider_azurerm_api_apis_maps_v1alpha1_Account(ref),
		"kubeform.dev/provider-azurerm-api/apis/maps/v1alpha1.AccountList":   schema_provider_azurerm_api_apis_maps_v1alpha1_AccountList(ref),
		"kubeform.dev/provider-azurerm-api/apis/maps/v1alpha1.AccountSpec":   schema_provider_azurerm_api_apis_maps_v1alpha1_AccountSpec(ref),
		"kubeform.dev/provider-azurerm-api/apis/maps/v1alpha1.AccountSpec2":  schema_provider_azurerm_api_apis_maps_v1alpha1_AccountSpec2(ref),
		"kubeform.dev/provider-azurerm-api/apis/maps/v1alpha1.AccountStatus": schema_provider_azurerm_api_apis_maps_v1alpha1_AccountStatus(ref),
	}
}
...
func schema_provider_azurerm_api_apis_maps_v1alpha1_Account(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/maps/v1alpha1.AccountSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/maps/v1alpha1.AccountStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-azurerm-api/apis/maps/v1alpha1.AccountSpec", "kubeform.dev/provider-azurerm-api/apis/maps/v1alpha1.AccountStatus"},
	}
}

func schema_provider_azurerm_api_apis_maps_v1alpha1_AccountList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-azurerm-api/apis/maps/v1alpha1.Account"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-azurerm-api/apis/maps/v1alpha1.Account"},
	}
}

func schema_provider_azurerm_api_apis_maps_v1alpha1_AccountSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/maps/v1alpha1.AccountSpec2"),
						},
					},
				},
		...
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/apimachinery/api/v1alpha1.ResourceTimeout", "kubeform.dev/provider-azurerm-api/apis/maps/v1alpha1.AccountSpec2"},
	}
}

func schema_provider_azurerm_api_apis_maps_v1alpha1_AccountSpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_azurerm_api_apis_maps_v1alpha1_AccountStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
