...
type ServiceSourceControlTokenSpec struct {
	ServiceSourceControlTokenSpec2 `json:",inline"`
	// +optional
	KubeformOutput ServiceSourceControlTokenSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type ServiceSourceControlTokenSpec2 struct {
