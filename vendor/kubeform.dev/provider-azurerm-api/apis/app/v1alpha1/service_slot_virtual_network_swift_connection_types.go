...
type ServiceSlotVirtualNetworkSwiftConnectionSpec struct {
	ServiceSlotVirtualNetworkSwiftConnectionSpec2 `json:",inline"`
	// +optional
	KubeformOutput ServiceSlotVirtualNetworkSwiftConnectionSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type ServiceSlotVirtualNetworkSwiftConnectionSpec2 struct {
