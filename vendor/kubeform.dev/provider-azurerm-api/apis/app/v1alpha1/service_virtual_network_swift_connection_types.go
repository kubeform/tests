...
type ServiceVirtualNetworkSwiftConnectionSpec struct {
	ServiceVirtualNetworkSwiftConnectionSpec2 `json:",inline"`
	// +optional
	KubeformOutput ServiceVirtualNetworkSwiftConnectionSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type ServiceVirtualNetworkSwiftConnectionSpec2 struct {
