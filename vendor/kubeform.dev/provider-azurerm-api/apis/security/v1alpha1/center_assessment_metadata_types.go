...
type CenterAssessmentMetadataSpec struct {
	CenterAssessmentMetadataSpec2 `json:",inline"`
	// +optional
	KubeformOutput CenterAssessmentMetadataSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type CenterAssessmentMetadataSpec2 struct {
