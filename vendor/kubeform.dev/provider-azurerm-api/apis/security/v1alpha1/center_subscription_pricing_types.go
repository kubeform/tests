...
type CenterSubscriptionPricingSpec struct {
	CenterSubscriptionPricingSpec2 `json:",inline"`
	// +optional
	KubeformOutput CenterSubscriptionPricingSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type CenterSubscriptionPricingSpec2 struct {
