...
type CenterAutoProvisioningSpec struct {
	CenterAutoProvisioningSpec2 `json:",inline"`
	// +optional
	KubeformOutput CenterAutoProvisioningSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type CenterAutoProvisioningSpec2 struct {
