...
type ContainerStorageAccountSpec struct {
	ContainerStorageAccountSpec2 `json:",inline"`
	// +optional
	KubeformOutput ContainerStorageAccountSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type ContainerStorageAccountSpec2 struct {
