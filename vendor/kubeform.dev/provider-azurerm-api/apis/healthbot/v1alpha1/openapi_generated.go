...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-azurerm-api/apis/healthbot/v1alpha1.Healthbot":       schema_provider_azurerm_api_apis_healthbot_v1alpha1_Healthbot(ref),
		"kubeform.dev/provider-azurerm-api/apis/healthbot/v1alpha1.HealthbotList":   schema_provider_azurerm_api_apis_healthbot_v1alpha1_HealthbotList(ref),
		"kubeform.dev/provider-azurerm-api/apis/healthbot/v1alpha1.HealthbotSpec":   schema_provider_azurerm_api_apis_healthbot_v1alpha1_HealthbotSpec(ref),
		"kubeform.dev/provider-azurerm-api/apis/healthbot/v1alpha1.HealthbotSpec2":  schema_provider_azurerm_api_apis_healthbot_v1alpha1_HealthbotSpec2(ref),
		"kubeform.dev/provider-azurerm-api/apis/healthbot/v1alpha1.HealthbotStatus": schema_provider_azurerm_api_apis_healthbot_v1alpha1_HealthbotStatus(ref),
	}
}
...
func schema_provider_azurerm_api_apis_healthbot_v1alpha1_Healthbot(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/healthbot/v1alpha1.HealthbotSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/healthbot/v1alpha1.HealthbotStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-azurerm-api/apis/healthbot/v1alpha1.HealthbotSpec", "kubeform.dev/provider-azurerm-api/apis/healthbot/v1alpha1.HealthbotStatus"},
	}
}

func schema_provider_azurerm_api_apis_healthbot_v1alpha1_HealthbotList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "HealthbotList is a list of Healthbots",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							Description: "Items is a list of Healthbot CRD objects",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-azurerm-api/apis/healthbot/v1alpha1.Healthbot"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-azurerm-api/apis/healthbot/v1alpha1.Healthbot"},
	}
}

func schema_provider_azurerm_api_apis_healthbot_v1alpha1_HealthbotSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/healthbot/v1alpha1.HealthbotSpec2"),
						},
					},
				},
		...
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/apimachinery/api/v1alpha1.ResourceTimeout", "kubeform.dev/provider-azurerm-api/apis/healthbot/v1alpha1.HealthbotSpec2"},
	}
}

func schema_provider_azurerm_api_apis_healthbot_v1alpha1_HealthbotSpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_azurerm_api_apis_healthbot_v1alpha1_HealthbotStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
