...
type EndpointServicebusTopicSpec struct {
	EndpointServicebusTopicSpec2 `json:",inline"`
	// +optional
	KubeformOutput EndpointServicebusTopicSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type EndpointServicebusTopicSpec2 struct {
