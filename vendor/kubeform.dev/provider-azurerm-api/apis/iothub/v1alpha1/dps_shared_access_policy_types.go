...
type DpsSharedAccessPolicySpec struct {
	DpsSharedAccessPolicySpec2 `json:",inline"`
	// +optional
	KubeformOutput DpsSharedAccessPolicySpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type DpsSharedAccessPolicySpec2 struct {
