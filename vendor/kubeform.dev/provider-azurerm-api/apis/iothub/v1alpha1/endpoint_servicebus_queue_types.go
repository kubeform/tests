...
type EndpointServicebusQueueSpec struct {
	EndpointServicebusQueueSpec2 `json:",inline"`
	// +optional
	KubeformOutput EndpointServicebusQueueSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type EndpointServicebusQueueSpec2 struct {
