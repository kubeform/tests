...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-azurerm-api/apis/attestation/v1alpha1.Provider":       schema_provider_azurerm_api_apis_attestation_v1alpha1_Provider(ref),
		"kubeform.dev/provider-azurerm-api/apis/attestation/v1alpha1.ProviderList":   schema_provider_azurerm_api_apis_attestation_v1alpha1_ProviderList(ref),
		"kubeform.dev/provider-azurerm-api/apis/attestation/v1alpha1.ProviderSpec":   schema_provider_azurerm_api_apis_attestation_v1alpha1_ProviderSpec(ref),
		"kubeform.dev/provider-azurerm-api/apis/attestation/v1alpha1.ProviderSpec2":  schema_provider_azurerm_api_apis_attestation_v1alpha1_ProviderSpec2(ref),
		"kubeform.dev/provider-azurerm-api/apis/attestation/v1alpha1.ProviderStatus": schema_provider_azurerm_api_apis_attestation_v1alpha1_ProviderStatus(ref),
	}
}
...
func schema_provider_azurerm_api_apis_attestation_v1alpha1_Provider(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/attestation/v1alpha1.ProviderSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/attestation/v1alpha1.ProviderStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-azurerm-api/apis/attestation/v1alpha1.ProviderSpec", "kubeform.dev/provider-azurerm-api/apis/attestation/v1alpha1.ProviderStatus"},
	}
}

func schema_provider_azurerm_api_apis_attestation_v1alpha1_ProviderList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-azurerm-api/apis/attestation/v1alpha1.Provider"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-azurerm-api/apis/attestation/v1alpha1.Provider"},
	}
}

func schema_provider_azurerm_api_apis_attestation_v1alpha1_ProviderSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/attestation/v1alpha1.ProviderSpec2"),
						},
					},
				},
		...
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/apimachinery/api/v1alpha1.ResourceTimeout", "kubeform.dev/provider-azurerm-api/apis/attestation/v1alpha1.ProviderSpec2"},
	}
}

func schema_provider_azurerm_api_apis_attestation_v1alpha1_ProviderSpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_azurerm_api_apis_attestation_v1alpha1_ProviderStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
