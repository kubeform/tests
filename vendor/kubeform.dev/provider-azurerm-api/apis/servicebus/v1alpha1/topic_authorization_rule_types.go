...
type TopicAuthorizationRuleSpec struct {
	TopicAuthorizationRuleSpec2 `json:",inline"`
	// +optional
	KubeformOutput TopicAuthorizationRuleSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type TopicAuthorizationRuleSpec2 struct {
