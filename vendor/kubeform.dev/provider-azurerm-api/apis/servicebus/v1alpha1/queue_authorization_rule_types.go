...
type QueueAuthorizationRuleSpec struct {
	QueueAuthorizationRuleSpec2 `json:",inline"`
	// +optional
	KubeformOutput QueueAuthorizationRuleSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type QueueAuthorizationRuleSpec2 struct {
