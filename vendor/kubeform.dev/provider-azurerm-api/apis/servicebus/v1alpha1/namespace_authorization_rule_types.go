...
type NamespaceAuthorizationRuleSpec struct {
	NamespaceAuthorizationRuleSpec2 `json:",inline"`
	// +optional
	KubeformOutput NamespaceAuthorizationRuleSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type NamespaceAuthorizationRuleSpec2 struct {
