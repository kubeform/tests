...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-route-azurerm-kubeform-com-v1alpha1-route,mutating=false,failurePolicy=fail,groups=route.azurerm.kubeform.com,resources=routes,versions=v1alpha1,name=route.route.azurerm.kubeform.io,sideEffects=None,admissionReviewVersions=v1
