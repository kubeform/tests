...
type AnalyticsOutputServicebusTopicSpec struct {
	AnalyticsOutputServicebusTopicSpec2 `json:",inline"`
	// +optional
	KubeformOutput AnalyticsOutputServicebusTopicSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type AnalyticsOutputServicebusTopicSpec2 struct {
