...
type AnalyticsStreamInputEventhubSpec struct {
	AnalyticsStreamInputEventhubSpec2 `json:",inline"`
	// +optional
	KubeformOutput AnalyticsStreamInputEventhubSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type AnalyticsStreamInputEventhubSpec2 struct {
