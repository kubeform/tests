...
type AnalyticsReferenceInputBlobSpec struct {
	AnalyticsReferenceInputBlobSpec2 `json:",inline"`
	// +optional
	KubeformOutput AnalyticsReferenceInputBlobSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type AnalyticsReferenceInputBlobSpec2 struct {
