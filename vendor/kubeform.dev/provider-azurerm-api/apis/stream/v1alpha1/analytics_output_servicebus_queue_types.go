...
type AnalyticsOutputServicebusQueueSpec struct {
	AnalyticsOutputServicebusQueueSpec2 `json:",inline"`
	// +optional
	KubeformOutput AnalyticsOutputServicebusQueueSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type AnalyticsOutputServicebusQueueSpec2 struct {
