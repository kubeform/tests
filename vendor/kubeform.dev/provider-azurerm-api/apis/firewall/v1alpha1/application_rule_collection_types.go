...
type ApplicationRuleCollectionSpec struct {
	ApplicationRuleCollectionSpec2 `json:",inline"`
	// +optional
	KubeformOutput ApplicationRuleCollectionSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type ApplicationRuleCollectionSpec2 struct {
