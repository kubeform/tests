...
type ClusterPrincipalAssignmentSpec struct {
	ClusterPrincipalAssignmentSpec2 `json:",inline"`
	// +optional
	KubeformOutput ClusterPrincipalAssignmentSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type ClusterPrincipalAssignmentSpec2 struct {
