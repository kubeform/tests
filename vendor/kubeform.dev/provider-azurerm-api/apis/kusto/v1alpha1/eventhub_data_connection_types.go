...
type EventhubDataConnectionSpec struct {
	EventhubDataConnectionSpec2 `json:",inline"`
	// +optional
	KubeformOutput EventhubDataConnectionSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type EventhubDataConnectionSpec2 struct {
