...
type AttachedDatabaseConfigurationSpec struct {
	AttachedDatabaseConfigurationSpec2 `json:",inline"`
	// +optional
	KubeformOutput AttachedDatabaseConfigurationSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type AttachedDatabaseConfigurationSpec2 struct {
