...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-azurerm-api/apis/ssh/v1alpha1.PublicKey":       schema_provider_azurerm_api_apis_ssh_v1alpha1_PublicKey(ref),
		"kubeform.dev/provider-azurerm-api/apis/ssh/v1alpha1.PublicKeyList":   schema_provider_azurerm_api_apis_ssh_v1alpha1_PublicKeyList(ref),
		"kubeform.dev/provider-azurerm-api/apis/ssh/v1alpha1.PublicKeySpec":   schema_provider_azurerm_api_apis_ssh_v1alpha1_PublicKeySpec(ref),
		"kubeform.dev/provider-azurerm-api/apis/ssh/v1alpha1.PublicKeySpec2":  schema_provider_azurerm_api_apis_ssh_v1alpha1_PublicKeySpec2(ref),
		"kubeform.dev/provider-azurerm-api/apis/ssh/v1alpha1.PublicKeyStatus": schema_provider_azurerm_api_apis_ssh_v1alpha1_PublicKeyStatus(ref),
	}
}
...
func schema_provider_azurerm_api_apis_ssh_v1alpha1_PublicKey(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/ssh/v1alpha1.PublicKeySpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/ssh/v1alpha1.PublicKeyStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-azurerm-api/apis/ssh/v1alpha1.PublicKeySpec", "kubeform.dev/provider-azurerm-api/apis/ssh/v1alpha1.PublicKeyStatus"},
	}
}

func schema_provider_azurerm_api_apis_ssh_v1alpha1_PublicKeyList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-azurerm-api/apis/ssh/v1alpha1.PublicKey"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-azurerm-api/apis/ssh/v1alpha1.PublicKey"},
	}
}

func schema_provider_azurerm_api_apis_ssh_v1alpha1_PublicKeySpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/ssh/v1alpha1.PublicKeySpec2"),
						},
					},
				},
				Required: []string{"providerRef", "location", "name", "publicKey", "resourceGroupName"},
			},
		},
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/apimachinery/api/v1alpha1.ResourceTimeout", "kubeform.dev/provider-azurerm-api/apis/ssh/v1alpha1.PublicKeySpec2"},
	}
}

func schema_provider_azurerm_api_apis_ssh_v1alpha1_PublicKeySpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_azurerm_api_apis_ssh_v1alpha1_PublicKeyStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
