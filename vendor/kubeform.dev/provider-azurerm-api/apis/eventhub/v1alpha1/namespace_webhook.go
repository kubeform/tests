...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-eventhub-azurerm-kubeform-com-v1alpha1-namespace_,mutating=false,failurePolicy=fail,groups=eventhub.azurerm.kubeform.com,resources=namespace_s,versions=v1alpha1,name=namespace_.eventhub.azurerm.kubeform.io,sideEffects=None,admissionReviewVersions=v1
