...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-azurerm-api/apis/static/v1alpha1.Site":       schema_provider_azurerm_api_apis_static_v1alpha1_Site(ref),
		"kubeform.dev/provider-azurerm-api/apis/static/v1alpha1.SiteList":   schema_provider_azurerm_api_apis_static_v1alpha1_SiteList(ref),
		"kubeform.dev/provider-azurerm-api/apis/static/v1alpha1.SiteSpec":   schema_provider_azurerm_api_apis_static_v1alpha1_SiteSpec(ref),
		"kubeform.dev/provider-azurerm-api/apis/static/v1alpha1.SiteSpec2":  schema_provider_azurerm_api_apis_static_v1alpha1_SiteSpec2(ref),
		"kubeform.dev/provider-azurerm-api/apis/static/v1alpha1.SiteStatus": schema_provider_azurerm_api_apis_static_v1alpha1_SiteStatus(ref),
	}
}
...
func schema_provider_azurerm_api_apis_static_v1alpha1_Site(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/static/v1alpha1.SiteSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/static/v1alpha1.SiteStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-azurerm-api/apis/static/v1alpha1.SiteSpec", "kubeform.dev/provider-azurerm-api/apis/static/v1alpha1.SiteStatus"},
	}
}

func schema_provider_azurerm_api_apis_static_v1alpha1_SiteList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-azurerm-api/apis/static/v1alpha1.Site"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-azurerm-api/apis/static/v1alpha1.Site"},
	}
}

func schema_provider_azurerm_api_apis_static_v1alpha1_SiteSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/static/v1alpha1.SiteSpec2"),
						},
					},
				},
		...
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/apimachinery/api/v1alpha1.ResourceTimeout", "kubeform.dev/provider-azurerm-api/apis/static/v1alpha1.SiteSpec2"},
	}
}

func schema_provider_azurerm_api_apis_static_v1alpha1_SiteSpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_azurerm_api_apis_static_v1alpha1_SiteStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
