...
type ActiveDirectoryAdministratorSpec struct {
	ActiveDirectoryAdministratorSpec2 `json:",inline"`
	// +optional
	KubeformOutput ActiveDirectoryAdministratorSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type ActiveDirectoryAdministratorSpec2 struct {
