...
func (ServiceSpecSkuCodec) IsEmpty(ptr unsafe.Pointer) bool {
	return (*ServiceSpecSku)(ptr) == nil
}

func (ServiceSpecSkuCodec) Encode(ptr unsafe.Pointer, stream *jsoniter.Stream) {
	obj := (*ServiceSpecSku)(ptr)
	var objs []ServiceSpecSku
	if obj != nil {
		objs = []ServiceSpecSku{*obj}
	}
	...
	jsonit := jsoniter.Config{
		...
		TagKey:                 "tf",
		TypeEncoders:           getEncodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(ServiceSpecSku{}).Type1())),
	}.Froze()
...
func (ServiceSpecSkuCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.NilValue:
		iter.Skip()
		*(*ServiceSpecSku)(ptr) = ServiceSpecSku{}
		return
	case jsoniter.ArrayValue:
		...
		if len(objsByte) > 0 {
			...
			jsonit := jsoniter.Config{
				...
				ValidateJsonRawMessage: true,
				TagKey:                 "tf",
				TypeDecoders:           getDecodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(ServiceSpecSku{}).Type1())),
			}.Froze()
			jsonit.Unmarshal(objsByte, &objs)

			if len(objs) > 0 {
				*(*ServiceSpecSku)(ptr) = objs[0]
			} else {
				*(*ServiceSpecSku)(ptr) = ServiceSpecSku{}
			}
		} else {
