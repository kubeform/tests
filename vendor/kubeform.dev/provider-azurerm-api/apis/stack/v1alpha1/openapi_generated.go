...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-azurerm-api/apis/stack/v1alpha1.HciCluster":       schema_provider_azurerm_api_apis_stack_v1alpha1_HciCluster(ref),
		"kubeform.dev/provider-azurerm-api/apis/stack/v1alpha1.HciClusterList":   schema_provider_azurerm_api_apis_stack_v1alpha1_HciClusterList(ref),
		"kubeform.dev/provider-azurerm-api/apis/stack/v1alpha1.HciClusterSpec":   schema_provider_azurerm_api_apis_stack_v1alpha1_HciClusterSpec(ref),
		"kubeform.dev/provider-azurerm-api/apis/stack/v1alpha1.HciClusterSpec2":  schema_provider_azurerm_api_apis_stack_v1alpha1_HciClusterSpec2(ref),
		"kubeform.dev/provider-azurerm-api/apis/stack/v1alpha1.HciClusterStatus": schema_provider_azurerm_api_apis_stack_v1alpha1_HciClusterStatus(ref),
	}
}
...
func schema_provider_azurerm_api_apis_stack_v1alpha1_HciCluster(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/stack/v1alpha1.HciClusterSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/stack/v1alpha1.HciClusterStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-azurerm-api/apis/stack/v1alpha1.HciClusterSpec", "kubeform.dev/provider-azurerm-api/apis/stack/v1alpha1.HciClusterStatus"},
	}
}

func schema_provider_azurerm_api_apis_stack_v1alpha1_HciClusterList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "HciClusterList is a list of HciClusters",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							Description: "Items is a list of HciCluster CRD objects",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-azurerm-api/apis/stack/v1alpha1.HciCluster"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-azurerm-api/apis/stack/v1alpha1.HciCluster"},
	}
}

func schema_provider_azurerm_api_apis_stack_v1alpha1_HciClusterSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/stack/v1alpha1.HciClusterSpec2"),
						},
					},
				},
				Required: []string{"providerRef", "clientID", "location", "name", "resourceGroupName"},
			},
		},
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/apimachinery/api/v1alpha1.ResourceTimeout", "kubeform.dev/provider-azurerm-api/apis/stack/v1alpha1.HciClusterSpec2"},
	}
}

func schema_provider_azurerm_api_apis_stack_v1alpha1_HciClusterSpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_azurerm_api_apis_stack_v1alpha1_HciClusterStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
