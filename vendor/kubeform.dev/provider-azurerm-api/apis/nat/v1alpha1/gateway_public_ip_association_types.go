...
type GatewayPublicIPAssociation struct {
	...
	Spec              GatewayPublicIPAssociationSpec   `json:"spec,omitempty"`
	Status            GatewayPublicIPAssociationStatus `json:"status,omitempty"`
}

type GatewayPublicIPAssociationSpec struct {
	GatewayPublicIPAssociationSpec2 `json:",inline"`
	// +optional
	KubeformOutput GatewayPublicIPAssociationSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type GatewayPublicIPAssociationSpec2 struct {
...
type GatewayPublicIPAssociationList struct {
	...
	// Items is a list of GatewayPublicIPAssociation CRD objects
	Items []GatewayPublicIPAssociation `json:"items,omitempty"`
}
