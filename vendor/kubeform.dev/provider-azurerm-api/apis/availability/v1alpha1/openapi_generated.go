...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-azurerm-api/apis/availability/v1alpha1.Set":       schema_provider_azurerm_api_apis_availability_v1alpha1_Set(ref),
		"kubeform.dev/provider-azurerm-api/apis/availability/v1alpha1.SetList":   schema_provider_azurerm_api_apis_availability_v1alpha1_SetList(ref),
		"kubeform.dev/provider-azurerm-api/apis/availability/v1alpha1.SetSpec":   schema_provider_azurerm_api_apis_availability_v1alpha1_SetSpec(ref),
		"kubeform.dev/provider-azurerm-api/apis/availability/v1alpha1.SetSpec2":  schema_provider_azurerm_api_apis_availability_v1alpha1_SetSpec2(ref),
		"kubeform.dev/provider-azurerm-api/apis/availability/v1alpha1.SetStatus": schema_provider_azurerm_api_apis_availability_v1alpha1_SetStatus(ref),
	}
}
...
func schema_provider_azurerm_api_apis_availability_v1alpha1_Set(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/availability/v1alpha1.SetSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/availability/v1alpha1.SetStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-azurerm-api/apis/availability/v1alpha1.SetSpec", "kubeform.dev/provider-azurerm-api/apis/availability/v1alpha1.SetStatus"},
	}
}

func schema_provider_azurerm_api_apis_availability_v1alpha1_SetList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-azurerm-api/apis/availability/v1alpha1.Set"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-azurerm-api/apis/availability/v1alpha1.Set"},
	}
}

func schema_provider_azurerm_api_apis_availability_v1alpha1_SetSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/availability/v1alpha1.SetSpec2"),
						},
					},
				},
		...
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/apimachinery/api/v1alpha1.ResourceTimeout", "kubeform.dev/provider-azurerm-api/apis/availability/v1alpha1.SetSpec2"},
	}
}

func schema_provider_azurerm_api_apis_availability_v1alpha1_SetSpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_azurerm_api_apis_availability_v1alpha1_SetStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
