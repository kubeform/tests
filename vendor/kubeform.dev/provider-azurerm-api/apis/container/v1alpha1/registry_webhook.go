...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-container-azurerm-kubeform-com-v1alpha1-registry,mutating=false,failurePolicy=fail,groups=container.azurerm.kubeform.com,resources=registries,versions=v1alpha1,name=registry.container.azurerm.kubeform.io,sideEffects=None,admissionReviewVersions=v1
