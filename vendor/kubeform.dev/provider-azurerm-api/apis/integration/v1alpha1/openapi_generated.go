...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-azurerm-api/apis/integration/v1alpha1.ServiceEnvironment":       schema_provider_azurerm_api_apis_integration_v1alpha1_ServiceEnvironment(ref),
		"kubeform.dev/provider-azurerm-api/apis/integration/v1alpha1.ServiceEnvironmentList":   schema_provider_azurerm_api_apis_integration_v1alpha1_ServiceEnvironmentList(ref),
		"kubeform.dev/provider-azurerm-api/apis/integration/v1alpha1.ServiceEnvironmentSpec":   schema_provider_azurerm_api_apis_integration_v1alpha1_ServiceEnvironmentSpec(ref),
		"kubeform.dev/provider-azurerm-api/apis/integration/v1alpha1.ServiceEnvironmentSpec2":  schema_provider_azurerm_api_apis_integration_v1alpha1_ServiceEnvironmentSpec2(ref),
		"kubeform.dev/provider-azurerm-api/apis/integration/v1alpha1.ServiceEnvironmentStatus": schema_provider_azurerm_api_apis_integration_v1alpha1_ServiceEnvironmentStatus(ref),
	}
}
...
func schema_provider_azurerm_api_apis_integration_v1alpha1_ServiceEnvironment(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/integration/v1alpha1.ServiceEnvironmentSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/integration/v1alpha1.ServiceEnvironmentStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-azurerm-api/apis/integration/v1alpha1.ServiceEnvironmentSpec", "kubeform.dev/provider-azurerm-api/apis/integration/v1alpha1.ServiceEnvironmentStatus"},
	}
}

func schema_provider_azurerm_api_apis_integration_v1alpha1_ServiceEnvironmentList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-azurerm-api/apis/integration/v1alpha1.ServiceEnvironment"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-azurerm-api/apis/integration/v1alpha1.ServiceEnvironment"},
	}
}

func schema_provider_azurerm_api_apis_integration_v1alpha1_ServiceEnvironmentSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/integration/v1alpha1.ServiceEnvironmentSpec2"),
						},
					},
				},
				Required: []string{"providerRef", "accessEndpointType", "location", "name", "resourceGroupName", "virtualNetworkSubnetIDS"},
			},
		},
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/apimachinery/api/v1alpha1.ResourceTimeout", "kubeform.dev/provider-azurerm-api/apis/integration/v1alpha1.ServiceEnvironmentSpec2"},
	}
}

func schema_provider_azurerm_api_apis_integration_v1alpha1_ServiceEnvironmentSpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_azurerm_api_apis_integration_v1alpha1_ServiceEnvironmentStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
