...
type ManagedPrivateEndpointSpec struct {
	ManagedPrivateEndpointSpec2 `json:",inline"`
	// +optional
	KubeformOutput ManagedPrivateEndpointSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type ManagedPrivateEndpointSpec2 struct {
