...
type NetworkSecurityGroupAssociationSpec struct {
	NetworkSecurityGroupAssociationSpec2 `json:",inline"`
	// +optional
	KubeformOutput NetworkSecurityGroupAssociationSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type NetworkSecurityGroupAssociationSpec2 struct {
