...
type RouteTableAssociationSpec struct {
	RouteTableAssociationSpec2 `json:",inline"`
	// +optional
	KubeformOutput RouteTableAssociationSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type RouteTableAssociationSpec2 struct {
