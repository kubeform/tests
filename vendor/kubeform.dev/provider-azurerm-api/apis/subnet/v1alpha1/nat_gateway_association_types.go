...
type NatGatewayAssociationSpec struct {
	NatGatewayAssociationSpec2 `json:",inline"`
	// +optional
	KubeformOutput NatGatewayAssociationSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type NatGatewayAssociationSpec2 struct {
