...
type ServiceEndpointStoragePolicySpec struct {
	ServiceEndpointStoragePolicySpec2 `json:",inline"`
	// +optional
	KubeformOutput ServiceEndpointStoragePolicySpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type ServiceEndpointStoragePolicySpec2 struct {
