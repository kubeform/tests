...
type DataConnectorAwsCloudTrailSpec struct {
	DataConnectorAwsCloudTrailSpec2 `json:",inline"`
	// +optional
	KubeformOutput DataConnectorAwsCloudTrailSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type DataConnectorAwsCloudTrailSpec2 struct {
