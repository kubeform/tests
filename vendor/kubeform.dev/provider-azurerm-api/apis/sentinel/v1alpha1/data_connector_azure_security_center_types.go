...
type DataConnectorAzureSecurityCenterSpec struct {
	DataConnectorAzureSecurityCenterSpec2 `json:",inline"`
	// +optional
	KubeformOutput DataConnectorAzureSecurityCenterSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type DataConnectorAzureSecurityCenterSpec2 struct {
