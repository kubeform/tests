...
type DataConnectorOffice365Spec struct {
	DataConnectorOffice365Spec2 `json:",inline"`
	// +optional
	KubeformOutput DataConnectorOffice365Spec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type DataConnectorOffice365Spec2 struct {
