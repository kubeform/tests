...
type DataConnectorAzureAdvancedThreatProtectionSpec struct {
	DataConnectorAzureAdvancedThreatProtectionSpec2 `json:",inline"`
	// +optional
	KubeformOutput DataConnectorAzureAdvancedThreatProtectionSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type DataConnectorAzureAdvancedThreatProtectionSpec2 struct {
