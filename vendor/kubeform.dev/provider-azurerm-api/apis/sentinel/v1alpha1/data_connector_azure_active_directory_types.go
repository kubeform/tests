...
type DataConnectorAzureActiveDirectorySpec struct {
	DataConnectorAzureActiveDirectorySpec2 `json:",inline"`
	// +optional
	KubeformOutput DataConnectorAzureActiveDirectorySpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type DataConnectorAzureActiveDirectorySpec2 struct {
