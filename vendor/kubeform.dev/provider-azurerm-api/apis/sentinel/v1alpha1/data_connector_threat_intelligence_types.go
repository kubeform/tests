...
type DataConnectorThreatIntelligenceSpec struct {
	DataConnectorThreatIntelligenceSpec2 `json:",inline"`
	// +optional
	KubeformOutput DataConnectorThreatIntelligenceSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type DataConnectorThreatIntelligenceSpec2 struct {
