...
type DataConnectorMicrosoftDefenderAdvancedThreatProtectionSpec struct {
	DataConnectorMicrosoftDefenderAdvancedThreatProtectionSpec2 `json:",inline"`
	// +optional
	KubeformOutput DataConnectorMicrosoftDefenderAdvancedThreatProtectionSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type DataConnectorMicrosoftDefenderAdvancedThreatProtectionSpec2 struct {
