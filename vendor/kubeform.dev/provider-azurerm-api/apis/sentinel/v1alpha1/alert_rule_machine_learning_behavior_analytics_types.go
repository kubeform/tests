...
type AlertRuleMachineLearningBehaviorAnalyticsSpec struct {
	AlertRuleMachineLearningBehaviorAnalyticsSpec2 `json:",inline"`
	// +optional
	KubeformOutput AlertRuleMachineLearningBehaviorAnalyticsSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type AlertRuleMachineLearningBehaviorAnalyticsSpec2 struct {
