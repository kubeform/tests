...
type DataConnectorMicrosoftCloudAppSecuritySpec struct {
	DataConnectorMicrosoftCloudAppSecuritySpec2 `json:",inline"`
	// +optional
	KubeformOutput DataConnectorMicrosoftCloudAppSecuritySpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type DataConnectorMicrosoftCloudAppSecuritySpec2 struct {
