...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-trafficmanager-azurerm-kubeform-com-v1alpha1-endpoint,mutating=false,failurePolicy=fail,groups=trafficmanager.azurerm.kubeform.com,resources=endpoints,versions=v1alpha1,name=endpoint.trafficmanager.azurerm.kubeform.io,sideEffects=None,admissionReviewVersions=v1
