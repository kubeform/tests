...
type ThreatProtection struct {
	...
	Spec              ThreatProtectionSpec   `json:"spec,omitempty"`
	Status            ThreatProtectionStatus `json:"status,omitempty"`
}

type ThreatProtectionSpec struct {
	ThreatProtectionSpec2 `json:",inline"`
	// +optional
	KubeformOutput ThreatProtectionSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type ThreatProtectionSpec2 struct {
...
type ThreatProtectionList struct {
	...
	// Items is a list of ThreatProtection CRD objects
	Items []ThreatProtection `json:"items,omitempty"`
}
