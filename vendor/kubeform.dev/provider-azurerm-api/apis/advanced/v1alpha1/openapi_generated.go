...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-azurerm-api/apis/advanced/v1alpha1.ThreatProtection":       schema_provider_azurerm_api_apis_advanced_v1alpha1_ThreatProtection(ref),
		"kubeform.dev/provider-azurerm-api/apis/advanced/v1alpha1.ThreatProtectionList":   schema_provider_azurerm_api_apis_advanced_v1alpha1_ThreatProtectionList(ref),
		"kubeform.dev/provider-azurerm-api/apis/advanced/v1alpha1.ThreatProtectionSpec":   schema_provider_azurerm_api_apis_advanced_v1alpha1_ThreatProtectionSpec(ref),
		"kubeform.dev/provider-azurerm-api/apis/advanced/v1alpha1.ThreatProtectionSpec2":  schema_provider_azurerm_api_apis_advanced_v1alpha1_ThreatProtectionSpec2(ref),
		"kubeform.dev/provider-azurerm-api/apis/advanced/v1alpha1.ThreatProtectionStatus": schema_provider_azurerm_api_apis_advanced_v1alpha1_ThreatProtectionStatus(ref),
	}
}
...
func schema_provider_azurerm_api_apis_advanced_v1alpha1_ThreatProtection(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/advanced/v1alpha1.ThreatProtectionSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/advanced/v1alpha1.ThreatProtectionStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-azurerm-api/apis/advanced/v1alpha1.ThreatProtectionSpec", "kubeform.dev/provider-azurerm-api/apis/advanced/v1alpha1.ThreatProtectionStatus"},
	}
}

func schema_provider_azurerm_api_apis_advanced_v1alpha1_ThreatProtectionList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ThreatProtectionList is a list of ThreatProtections",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							Description: "Items is a list of ThreatProtection CRD objects",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-azurerm-api/apis/advanced/v1alpha1.ThreatProtection"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-azurerm-api/apis/advanced/v1alpha1.ThreatProtection"},
	}
}

func schema_provider_azurerm_api_apis_advanced_v1alpha1_ThreatProtectionSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/advanced/v1alpha1.ThreatProtectionSpec2"),
						},
					},
				},
				Required: []string{"providerRef", "enabled", "targetResourceID"},
			},
		},
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/apimachinery/api/v1alpha1.ResourceTimeout", "kubeform.dev/provider-azurerm-api/apis/advanced/v1alpha1.ThreatProtectionSpec2"},
	}
}

func schema_provider_azurerm_api_apis_advanced_v1alpha1_ThreatProtectionSpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_azurerm_api_apis_advanced_v1alpha1_ThreatProtectionStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
