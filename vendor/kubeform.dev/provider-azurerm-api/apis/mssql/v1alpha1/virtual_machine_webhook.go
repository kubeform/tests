...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-mssql-azurerm-kubeform-com-v1alpha1-virtualmachine,mutating=false,failurePolicy=fail,groups=mssql.azurerm.kubeform.com,resources=virtualmachines,versions=v1alpha1,name=virtualmachine.mssql.azurerm.kubeform.io,sideEffects=None,admissionReviewVersions=v1
