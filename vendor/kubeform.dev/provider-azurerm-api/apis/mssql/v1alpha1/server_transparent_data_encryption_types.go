...
type ServerTransparentDataEncryptionSpec struct {
	ServerTransparentDataEncryptionSpec2 `json:",inline"`
	// +optional
	KubeformOutput ServerTransparentDataEncryptionSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type ServerTransparentDataEncryptionSpec2 struct {
