...
type ServerExtendedAuditingPolicySpec struct {
	ServerExtendedAuditingPolicySpec2 `json:",inline"`
	// +optional
	KubeformOutput ServerExtendedAuditingPolicySpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type ServerExtendedAuditingPolicySpec2 struct {
