...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-private-azurerm-kubeform-com-v1alpha1-endpoint,mutating=false,failurePolicy=fail,groups=private.azurerm.kubeform.com,resources=endpoints,versions=v1alpha1,name=endpoint.private.azurerm.kubeform.io,sideEffects=None,admissionReviewVersions=v1
