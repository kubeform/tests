...
func (in *ServiceSpec2) DeepCopyInto(out *ServiceSpec2) {
	*out = *in
	...
	if in.QueryKeys != nil {
		...
		*out = make([]ServiceSpecQueryKeys, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServiceSpecQueryKeys) DeepCopyInto(out *ServiceSpecQueryKeys) {
	*out = *in
	if in.Key != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServiceSpecQueryKeys.
func (in *ServiceSpecQueryKeys) DeepCopy() *ServiceSpecQueryKeys {
	if in == nil {
		return nil
	}
	out := new(ServiceSpecQueryKeys)
	in.DeepCopyInto(out)
	return out
}
