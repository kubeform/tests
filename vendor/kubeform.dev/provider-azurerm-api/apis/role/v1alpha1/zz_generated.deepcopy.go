...
func (in *DefinitionSpec2) DeepCopyInto(out *DefinitionSpec2) {
	*out = *in
	...
	if in.Permissions != nil {
		...
		*out = make([]DefinitionSpecPermissions, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DefinitionSpecPermissions) DeepCopyInto(out *DefinitionSpecPermissions) {
	*out = *in
	if in.Actions != nil {
...
func (in *DefinitionSpecPermissions) DeepCopy() *DefinitionSpecPermissions {
	if in == nil {
		return nil
	}
	out := new(DefinitionSpecPermissions)
	in.DeepCopyInto(out)
	return out
}
