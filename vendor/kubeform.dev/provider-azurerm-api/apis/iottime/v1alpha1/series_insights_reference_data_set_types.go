...
type SeriesInsightsReferenceDataSetSpec struct {
	SeriesInsightsReferenceDataSetSpec2 `json:",inline"`
	// +optional
	KubeformOutput SeriesInsightsReferenceDataSetSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type SeriesInsightsReferenceDataSetSpec2 struct {
