...
type SeriesInsightsAccessPolicySpec struct {
	SeriesInsightsAccessPolicySpec2 `json:",inline"`
	// +optional
	KubeformOutput SeriesInsightsAccessPolicySpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type SeriesInsightsAccessPolicySpec2 struct {
