...
type SeriesInsightsStandardEnvironmentSpec struct {
	SeriesInsightsStandardEnvironmentSpec2 `json:",inline"`
	// +optional
	KubeformOutput SeriesInsightsStandardEnvironmentSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type SeriesInsightsStandardEnvironmentSpec2 struct {
