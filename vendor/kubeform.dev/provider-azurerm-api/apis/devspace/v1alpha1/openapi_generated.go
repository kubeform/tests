...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-azurerm-api/apis/devspace/v1alpha1.Controller":       schema_provider_azurerm_api_apis_devspace_v1alpha1_Controller(ref),
		"kubeform.dev/provider-azurerm-api/apis/devspace/v1alpha1.ControllerList":   schema_provider_azurerm_api_apis_devspace_v1alpha1_ControllerList(ref),
		"kubeform.dev/provider-azurerm-api/apis/devspace/v1alpha1.ControllerSpec":   schema_provider_azurerm_api_apis_devspace_v1alpha1_ControllerSpec(ref),
		"kubeform.dev/provider-azurerm-api/apis/devspace/v1alpha1.ControllerSpec2":  schema_provider_azurerm_api_apis_devspace_v1alpha1_ControllerSpec2(ref),
		"kubeform.dev/provider-azurerm-api/apis/devspace/v1alpha1.ControllerStatus": schema_provider_azurerm_api_apis_devspace_v1alpha1_ControllerStatus(ref),
	}
}
...
func schema_provider_azurerm_api_apis_devspace_v1alpha1_Controller(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/devspace/v1alpha1.ControllerSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/devspace/v1alpha1.ControllerStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-azurerm-api/apis/devspace/v1alpha1.ControllerSpec", "kubeform.dev/provider-azurerm-api/apis/devspace/v1alpha1.ControllerStatus"},
	}
}

func schema_provider_azurerm_api_apis_devspace_v1alpha1_ControllerList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ControllerList is a list of Controllers",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							Description: "Items is a list of Controller CRD objects",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-azurerm-api/apis/devspace/v1alpha1.Controller"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-azurerm-api/apis/devspace/v1alpha1.Controller"},
	}
}

func schema_provider_azurerm_api_apis_devspace_v1alpha1_ControllerSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-azurerm-api/apis/devspace/v1alpha1.ControllerSpec2"),
						},
					},
				},
				Required: []string{"providerRef", "location", "name", "resourceGroupName", "skuName", "targetContainerHostResourceID"},
			},
		},
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/apimachinery/api/v1alpha1.ResourceTimeout", "kubeform.dev/provider-azurerm-api/apis/devspace/v1alpha1.ControllerSpec2"},
	}
}

func schema_provider_azurerm_api_apis_devspace_v1alpha1_ControllerSpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_azurerm_api_apis_devspace_v1alpha1_ControllerStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
