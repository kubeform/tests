...
type InterfaceApplicationGatewayBackendAddressPoolAssociationSpec struct {
	InterfaceApplicationGatewayBackendAddressPoolAssociationSpec2 `json:",inline"`
	// +optional
	KubeformOutput InterfaceApplicationGatewayBackendAddressPoolAssociationSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type InterfaceApplicationGatewayBackendAddressPoolAssociationSpec2 struct {
