...
type InterfaceSecurityGroupAssociationSpec struct {
	InterfaceSecurityGroupAssociationSpec2 `json:",inline"`
	// +optional
	KubeformOutput InterfaceSecurityGroupAssociationSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type InterfaceSecurityGroupAssociationSpec2 struct {
