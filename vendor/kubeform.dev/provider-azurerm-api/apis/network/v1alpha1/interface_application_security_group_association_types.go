...
type InterfaceApplicationSecurityGroupAssociationSpec struct {
	InterfaceApplicationSecurityGroupAssociationSpec2 `json:",inline"`
	// +optional
	KubeformOutput InterfaceApplicationSecurityGroupAssociationSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type InterfaceApplicationSecurityGroupAssociationSpec2 struct {
