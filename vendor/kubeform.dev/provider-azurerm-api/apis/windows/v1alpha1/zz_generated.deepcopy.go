...
func (in *VirtualMachineScaleSetSpec2) DeepCopyInto(out *VirtualMachineScaleSetSpec2) {
	*out = *in
	...
	if in.AdditionalUnattendContent != nil {
		...
		*out = make([]VirtualMachineScaleSetSpecAdditionalUnattendContent, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.WinrmListener != nil {
		...
		*out = make([]VirtualMachineScaleSetSpecWinrmListener, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *VirtualMachineScaleSetSpecAdditionalUnattendContent) DeepCopy() *VirtualMachineScaleSetSpecAdditionalUnattendContent {
	...
	out := new(VirtualMachineScaleSetSpecAdditionalUnattendContent)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VirtualMachineScaleSetSpecWinrmListener) DeepCopy() *VirtualMachineScaleSetSpecWinrmListener {
	...
	out := new(VirtualMachineScaleSetSpecWinrmListener)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VirtualMachineSpec2) DeepCopyInto(out *VirtualMachineSpec2) {
	*out = *in
	...
	if in.AdditionalUnattendContent != nil {
		in, out := &in.AdditionalUnattendContent, &out.AdditionalUnattendContent
		*out = make([]VirtualMachineSpecAdditionalUnattendContent, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.WinrmListener != nil {
		in, out := &in.WinrmListener, &out.WinrmListener
		*out = make([]VirtualMachineSpecWinrmListener, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *VirtualMachineSpecAdditionalUnattendContent) DeepCopy() *VirtualMachineSpecAdditionalUnattendContent {
	...
	out := new(VirtualMachineSpecAdditionalUnattendContent)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VirtualMachineSpecWinrmListener) DeepCopy() *VirtualMachineSpecWinrmListener {
	...
	out := new(VirtualMachineSpecWinrmListener)
	in.DeepCopyInto(out)
	return out
}
