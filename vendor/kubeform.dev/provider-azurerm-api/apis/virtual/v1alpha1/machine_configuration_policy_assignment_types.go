...
type MachineConfigurationPolicyAssignmentSpec struct {
	MachineConfigurationPolicyAssignmentSpec2 `json:",inline"`
	// +optional
	KubeformOutput MachineConfigurationPolicyAssignmentSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type MachineConfigurationPolicyAssignmentSpec2 struct {
