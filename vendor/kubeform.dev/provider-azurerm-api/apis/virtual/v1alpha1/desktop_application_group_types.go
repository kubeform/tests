...
type DesktopApplicationGroupSpec struct {
	DesktopApplicationGroupSpec2 `json:",inline"`
	// +optional
	KubeformOutput DesktopApplicationGroupSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type DesktopApplicationGroupSpec2 struct {
