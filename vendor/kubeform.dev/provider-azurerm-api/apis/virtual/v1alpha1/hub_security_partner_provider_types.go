...
type HubSecurityPartnerProviderSpec struct {
	HubSecurityPartnerProviderSpec2 `json:",inline"`
	// +optional
	KubeformOutput HubSecurityPartnerProviderSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type HubSecurityPartnerProviderSpec2 struct {
