...
type MachineScaleSetExtensionSpec struct {
	MachineScaleSetExtensionSpec2 `json:",inline"`
	// +optional
	KubeformOutput MachineScaleSetExtensionSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type MachineScaleSetExtensionSpec2 struct {
