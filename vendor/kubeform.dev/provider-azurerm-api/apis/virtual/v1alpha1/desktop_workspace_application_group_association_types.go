...
type DesktopWorkspaceApplicationGroupAssociationSpec struct {
	DesktopWorkspaceApplicationGroupAssociationSpec2 `json:",inline"`
	// +optional
	KubeformOutput DesktopWorkspaceApplicationGroupAssociationSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type DesktopWorkspaceApplicationGroupAssociationSpec2 struct {
