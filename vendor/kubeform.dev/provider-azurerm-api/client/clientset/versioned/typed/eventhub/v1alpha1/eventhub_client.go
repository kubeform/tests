...
type EventhubV1alpha1Interface interface {
...
func NewForConfig(c *rest.Config) (*EventhubV1alpha1Client, error) {
	...
	return &EventhubV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new EventhubV1alpha1Client for the given config and
...
func New(c rest.Interface) *EventhubV1alpha1Client {
	return &EventhubV1alpha1Client{c}
}
