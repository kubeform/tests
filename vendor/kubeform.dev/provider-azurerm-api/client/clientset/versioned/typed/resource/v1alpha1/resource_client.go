...
// ResourceV1alpha1Client is used to interact with features provided by the resource.azurerm.kubeform.com group.
...
func (c *ResourceV1alpha1Client) GroupTemplateDeployments(namespace string) GroupTemplateDeploymentInterface {
	return newGroupTemplateDeployments(c, namespace)
}

func (c *ResourceV1alpha1Client) ProviderRegistrations(namespace string) ProviderRegistrationInterface {
	return newProviderRegistrations(c, namespace)
}
