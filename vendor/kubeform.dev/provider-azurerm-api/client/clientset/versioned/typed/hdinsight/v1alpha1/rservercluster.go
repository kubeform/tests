...
// RserverClustersGetter has a method to return a RserverClusterInterface.
...
// rserverClusters implements RserverClusterInterface
type rserverClusters struct {
	client rest.Interface
	ns     string
}

// newRserverClusters returns a RserverClusters
func newRserverClusters(c *HdinsightV1alpha1Client, namespace string) *rserverClusters {
	return &rserverClusters{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *rserverClusters) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.RserverCluster, err error) {
	result = &v1alpha1.RserverCluster{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *rserverClusters) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RserverClusterList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.RserverClusterList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("rserverclusters").
...
func (c *rserverClusters) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *rserverClusters) Create(ctx context.Context, rserverCluster *v1alpha1.RserverCluster, opts v1.CreateOptions) (result *v1alpha1.RserverCluster, err error) {
	result = &v1alpha1.RserverCluster{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("rserverclusters").
...
func (c *rserverClusters) Update(ctx context.Context, rserverCluster *v1alpha1.RserverCluster, opts v1.UpdateOptions) (result *v1alpha1.RserverCluster, err error) {
	result = &v1alpha1.RserverCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("rserverclusters").
		Name(rserverCluster.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(rserverCluster).
		Do(ctx).
		Into(result)
...
func (c *rserverClusters) UpdateStatus(ctx context.Context, rserverCluster *v1alpha1.RserverCluster, opts v1.UpdateOptions) (result *v1alpha1.RserverCluster, err error) {
	result = &v1alpha1.RserverCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("rserverclusters").
...
func (c *rserverClusters) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *rserverClusters) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *rserverClusters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.RserverCluster, err error) {
	result = &v1alpha1.RserverCluster{}
