...
type HdinsightV1alpha1Interface interface {
	RESTClient() rest.Interface
	HadoopClustersGetter
	HbaseClustersGetter
	InteractiveQueryClustersGetter
	KafkaClustersGetter
	MlServicesClustersGetter
	RserverClustersGetter
	SparkClustersGetter
	StormClustersGetter
}
...
func (c *HdinsightV1alpha1Client) StormClusters(namespace string) StormClusterInterface {
	return newStormClusters(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*HdinsightV1alpha1Client, error) {
	...
	return &HdinsightV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new HdinsightV1alpha1Client for the given config and
...
func New(c rest.Interface) *HdinsightV1alpha1Client {
	return &HdinsightV1alpha1Client{c}
}
