...
// StormClustersGetter has a method to return a StormClusterInterface.
...
// stormClusters implements StormClusterInterface
type stormClusters struct {
	client rest.Interface
	ns     string
}

// newStormClusters returns a StormClusters
func newStormClusters(c *HdinsightV1alpha1Client, namespace string) *stormClusters {
...
func (c *stormClusters) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.StormCluster, err error) {
	result = &v1alpha1.StormCluster{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *stormClusters) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.StormClusterList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.StormClusterList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("stormclusters").
...
func (c *stormClusters) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *stormClusters) Create(ctx context.Context, stormCluster *v1alpha1.StormCluster, opts v1.CreateOptions) (result *v1alpha1.StormCluster, err error) {
	result = &v1alpha1.StormCluster{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("stormclusters").
...
func (c *stormClusters) Update(ctx context.Context, stormCluster *v1alpha1.StormCluster, opts v1.UpdateOptions) (result *v1alpha1.StormCluster, err error) {
	result = &v1alpha1.StormCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("stormclusters").
		Name(stormCluster.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(stormCluster).
		Do(ctx).
		Into(result)
...
func (c *stormClusters) UpdateStatus(ctx context.Context, stormCluster *v1alpha1.StormCluster, opts v1.UpdateOptions) (result *v1alpha1.StormCluster, err error) {
	result = &v1alpha1.StormCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("stormclusters").
...
func (c *stormClusters) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *stormClusters) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *stormClusters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.StormCluster, err error) {
	result = &v1alpha1.StormCluster{}
