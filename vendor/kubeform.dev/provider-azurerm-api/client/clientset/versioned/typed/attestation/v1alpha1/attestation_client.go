...
// AttestationV1alpha1Client is used to interact with features provided by the attestation.azurerm.kubeform.com group.
type AttestationV1alpha1Client struct {
	restClient rest.Interface
}

func (c *AttestationV1alpha1Client) Providers(namespace string) ProviderInterface {
...
// NewForConfigOrDie creates a new AttestationV1alpha1Client for the given config and
