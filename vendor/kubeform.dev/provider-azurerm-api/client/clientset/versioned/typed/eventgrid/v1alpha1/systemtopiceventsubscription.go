...
// SystemTopicEventSubscriptionsGetter has a method to return a SystemTopicEventSubscriptionInterface.
...
// systemTopicEventSubscriptions implements SystemTopicEventSubscriptionInterface
type systemTopicEventSubscriptions struct {
	client rest.Interface
	ns     string
}

// newSystemTopicEventSubscriptions returns a SystemTopicEventSubscriptions
func newSystemTopicEventSubscriptions(c *EventgridV1alpha1Client, namespace string) *systemTopicEventSubscriptions {
...
func (c *systemTopicEventSubscriptions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SystemTopicEventSubscription, err error) {
	result = &v1alpha1.SystemTopicEventSubscription{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *systemTopicEventSubscriptions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SystemTopicEventSubscriptionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.SystemTopicEventSubscriptionList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("systemtopiceventsubscriptions").
...
func (c *systemTopicEventSubscriptions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *systemTopicEventSubscriptions) Create(ctx context.Context, systemTopicEventSubscription *v1alpha1.SystemTopicEventSubscription, opts v1.CreateOptions) (result *v1alpha1.SystemTopicEventSubscription, err error) {
	result = &v1alpha1.SystemTopicEventSubscription{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("systemtopiceventsubscriptions").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(systemTopicEventSubscription).
		Do(ctx).
		Into(result)
	return
}
...
func (c *systemTopicEventSubscriptions) Update(ctx context.Context, systemTopicEventSubscription *v1alpha1.SystemTopicEventSubscription, opts v1.UpdateOptions) (result *v1alpha1.SystemTopicEventSubscription, err error) {
	result = &v1alpha1.SystemTopicEventSubscription{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("systemtopiceventsubscriptions").
		Name(systemTopicEventSubscription.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(systemTopicEventSubscription).
		Do(ctx).
		Into(result)
...
func (c *systemTopicEventSubscriptions) UpdateStatus(ctx context.Context, systemTopicEventSubscription *v1alpha1.SystemTopicEventSubscription, opts v1.UpdateOptions) (result *v1alpha1.SystemTopicEventSubscription, err error) {
	result = &v1alpha1.SystemTopicEventSubscription{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("systemtopiceventsubscriptions").
...
func (c *systemTopicEventSubscriptions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *systemTopicEventSubscriptions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *systemTopicEventSubscriptions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SystemTopicEventSubscription, err error) {
	result = &v1alpha1.SystemTopicEventSubscription{}
