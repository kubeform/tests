...
// DomainTopicsGetter has a method to return a DomainTopicInterface.
...
// domainTopics implements DomainTopicInterface
type domainTopics struct {
	client rest.Interface
	ns     string
}

// newDomainTopics returns a DomainTopics
func newDomainTopics(c *EventgridV1alpha1Client, namespace string) *domainTopics {
	return &domainTopics{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *domainTopics) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DomainTopic, err error) {
	result = &v1alpha1.DomainTopic{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *domainTopics) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DomainTopicList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.DomainTopicList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("domaintopics").
...
func (c *domainTopics) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *domainTopics) Create(ctx context.Context, domainTopic *v1alpha1.DomainTopic, opts v1.CreateOptions) (result *v1alpha1.DomainTopic, err error) {
	result = &v1alpha1.DomainTopic{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("domaintopics").
...
func (c *domainTopics) Update(ctx context.Context, domainTopic *v1alpha1.DomainTopic, opts v1.UpdateOptions) (result *v1alpha1.DomainTopic, err error) {
	result = &v1alpha1.DomainTopic{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("domaintopics").
...
func (c *domainTopics) UpdateStatus(ctx context.Context, domainTopic *v1alpha1.DomainTopic, opts v1.UpdateOptions) (result *v1alpha1.DomainTopic, err error) {
	result = &v1alpha1.DomainTopic{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("domaintopics").
...
func (c *domainTopics) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *domainTopics) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *domainTopics) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DomainTopic, err error) {
	result = &v1alpha1.DomainTopic{}
