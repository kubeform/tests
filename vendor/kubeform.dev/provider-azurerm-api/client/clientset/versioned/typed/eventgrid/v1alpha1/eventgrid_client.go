...
type EventgridV1alpha1Interface interface {
	RESTClient() rest.Interface
	DomainsGetter
	DomainTopicsGetter
	EventSubscriptionsGetter
	SystemTopicsGetter
	SystemTopicEventSubscriptionsGetter
	TopicsGetter
}
...
func (c *EventgridV1alpha1Client) DomainTopics(namespace string) DomainTopicInterface {
	return newDomainTopics(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*EventgridV1alpha1Client, error) {
	...
	return &EventgridV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new EventgridV1alpha1Client for the given config and
...
func New(c rest.Interface) *EventgridV1alpha1Client {
	return &EventgridV1alpha1Client{c}
}
