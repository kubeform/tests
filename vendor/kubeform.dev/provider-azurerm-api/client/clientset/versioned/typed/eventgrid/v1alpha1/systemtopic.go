...
// SystemTopicsGetter has a method to return a SystemTopicInterface.
...
// systemTopics implements SystemTopicInterface
type systemTopics struct {
	client rest.Interface
	ns     string
}

// newSystemTopics returns a SystemTopics
func newSystemTopics(c *EventgridV1alpha1Client, namespace string) *systemTopics {
	return &systemTopics{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *systemTopics) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SystemTopic, err error) {
	result = &v1alpha1.SystemTopic{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *systemTopics) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SystemTopicList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.SystemTopicList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("systemtopics").
...
func (c *systemTopics) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *systemTopics) Create(ctx context.Context, systemTopic *v1alpha1.SystemTopic, opts v1.CreateOptions) (result *v1alpha1.SystemTopic, err error) {
	result = &v1alpha1.SystemTopic{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("systemtopics").
...
func (c *systemTopics) Update(ctx context.Context, systemTopic *v1alpha1.SystemTopic, opts v1.UpdateOptions) (result *v1alpha1.SystemTopic, err error) {
	result = &v1alpha1.SystemTopic{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("systemtopics").
...
func (c *systemTopics) UpdateStatus(ctx context.Context, systemTopic *v1alpha1.SystemTopic, opts v1.UpdateOptions) (result *v1alpha1.SystemTopic, err error) {
	result = &v1alpha1.SystemTopic{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("systemtopics").
...
func (c *systemTopics) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *systemTopics) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *systemTopics) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SystemTopic, err error) {
	result = &v1alpha1.SystemTopic{}
