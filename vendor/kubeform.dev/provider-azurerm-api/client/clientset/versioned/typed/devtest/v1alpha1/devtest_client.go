...
type DevtestV1alpha1Interface interface {
	RESTClient() rest.Interface
	GlobalVmShutdownSchedulesGetter
	LabsGetter
...
func (c *DevtestV1alpha1Client) GlobalVmShutdownSchedules(namespace string) GlobalVmShutdownScheduleInterface {
	return newGlobalVmShutdownSchedules(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*DevtestV1alpha1Client, error) {
	...
	return &DevtestV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new DevtestV1alpha1Client for the given config and
...
func New(c rest.Interface) *DevtestV1alpha1Client {
	return &DevtestV1alpha1Client{c}
}
