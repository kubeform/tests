...
func newLinuxVirtualMachines(c *DevtestV1alpha1Client, namespace string) *linuxVirtualMachines {
...
func (c *linuxVirtualMachines) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LinuxVirtualMachine, err error) {
...
func (c *linuxVirtualMachines) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LinuxVirtualMachineList, err error) {
...
func (c *linuxVirtualMachines) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *linuxVirtualMachines) Create(ctx context.Context, linuxVirtualMachine *v1alpha1.LinuxVirtualMachine, opts v1.CreateOptions) (result *v1alpha1.LinuxVirtualMachine, err error) {
	result = &v1alpha1.LinuxVirtualMachine{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("linuxvirtualmachines").
...
func (c *linuxVirtualMachines) Update(ctx context.Context, linuxVirtualMachine *v1alpha1.LinuxVirtualMachine, opts v1.UpdateOptions) (result *v1alpha1.LinuxVirtualMachine, err error) {
	result = &v1alpha1.LinuxVirtualMachine{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("linuxvirtualmachines").
...
func (c *linuxVirtualMachines) UpdateStatus(ctx context.Context, linuxVirtualMachine *v1alpha1.LinuxVirtualMachine, opts v1.UpdateOptions) (result *v1alpha1.LinuxVirtualMachine, err error) {
	result = &v1alpha1.LinuxVirtualMachine{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("linuxvirtualmachines").
...
func (c *linuxVirtualMachines) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *linuxVirtualMachines) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *linuxVirtualMachines) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LinuxVirtualMachine, err error) {
	result = &v1alpha1.LinuxVirtualMachine{}
