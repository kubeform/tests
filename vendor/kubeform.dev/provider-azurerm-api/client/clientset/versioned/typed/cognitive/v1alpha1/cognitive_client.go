...
func NewForConfig(c *rest.Config) (*CognitiveV1alpha1Client, error) {
	...
	return &CognitiveV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new CognitiveV1alpha1Client for the given config and
...
func New(c rest.Interface) *CognitiveV1alpha1Client {
	return &CognitiveV1alpha1Client{c}
}
