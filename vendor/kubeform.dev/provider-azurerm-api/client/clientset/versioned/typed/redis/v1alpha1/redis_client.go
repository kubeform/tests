...
type RedisV1alpha1Interface interface {
	...
	CachesGetter
	EnterpriseClustersGetter
	EnterpriseDatabasesGetter
	FirewallRulesGetter
	LinkedServersGetter
}
...
func (c *RedisV1alpha1Client) LinkedServers(namespace string) LinkedServerInterface {
	return newLinkedServers(c, namespace)
}
