...
// LinkedServersGetter has a method to return a LinkedServerInterface.
...
// linkedServers implements LinkedServerInterface
type linkedServers struct {
	client rest.Interface
	ns     string
}

// newLinkedServers returns a LinkedServers
func newLinkedServers(c *RedisV1alpha1Client, namespace string) *linkedServers {
...
func (c *linkedServers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LinkedServer, err error) {
	result = &v1alpha1.LinkedServer{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *linkedServers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LinkedServerList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.LinkedServerList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("linkedservers").
...
func (c *linkedServers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *linkedServers) Create(ctx context.Context, linkedServer *v1alpha1.LinkedServer, opts v1.CreateOptions) (result *v1alpha1.LinkedServer, err error) {
	result = &v1alpha1.LinkedServer{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("linkedservers").
...
func (c *linkedServers) Update(ctx context.Context, linkedServer *v1alpha1.LinkedServer, opts v1.UpdateOptions) (result *v1alpha1.LinkedServer, err error) {
	result = &v1alpha1.LinkedServer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("linkedservers").
...
func (c *linkedServers) UpdateStatus(ctx context.Context, linkedServer *v1alpha1.LinkedServer, opts v1.UpdateOptions) (result *v1alpha1.LinkedServer, err error) {
	result = &v1alpha1.LinkedServer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("linkedservers").
...
func (c *linkedServers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *linkedServers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *linkedServers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LinkedServer, err error) {
	result = &v1alpha1.LinkedServer{}
