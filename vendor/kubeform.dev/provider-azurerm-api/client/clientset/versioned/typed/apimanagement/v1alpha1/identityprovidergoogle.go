...
// IdentityProviderGooglesGetter has a method to return a IdentityProviderGoogleInterface.
...
// identityProviderGoogles implements IdentityProviderGoogleInterface
type identityProviderGoogles struct {
	client rest.Interface
	ns     string
}

// newIdentityProviderGoogles returns a IdentityProviderGoogles
func newIdentityProviderGoogles(c *ApimanagementV1alpha1Client, namespace string) *identityProviderGoogles {
	return &identityProviderGoogles{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *identityProviderGoogles) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IdentityProviderGoogle, err error) {
	result = &v1alpha1.IdentityProviderGoogle{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *identityProviderGoogles) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IdentityProviderGoogleList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.IdentityProviderGoogleList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("identityprovidergoogles").
...
func (c *identityProviderGoogles) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *identityProviderGoogles) Create(ctx context.Context, identityProviderGoogle *v1alpha1.IdentityProviderGoogle, opts v1.CreateOptions) (result *v1alpha1.IdentityProviderGoogle, err error) {
	result = &v1alpha1.IdentityProviderGoogle{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("identityprovidergoogles").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(identityProviderGoogle).
		Do(ctx).
		Into(result)
	return
}
...
func (c *identityProviderGoogles) Update(ctx context.Context, identityProviderGoogle *v1alpha1.IdentityProviderGoogle, opts v1.UpdateOptions) (result *v1alpha1.IdentityProviderGoogle, err error) {
	result = &v1alpha1.IdentityProviderGoogle{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("identityprovidergoogles").
		Name(identityProviderGoogle.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(identityProviderGoogle).
		Do(ctx).
		Into(result)
...
func (c *identityProviderGoogles) UpdateStatus(ctx context.Context, identityProviderGoogle *v1alpha1.IdentityProviderGoogle, opts v1.UpdateOptions) (result *v1alpha1.IdentityProviderGoogle, err error) {
	result = &v1alpha1.IdentityProviderGoogle{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("identityprovidergoogles").
...
func (c *identityProviderGoogles) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *identityProviderGoogles) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *identityProviderGoogles) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IdentityProviderGoogle, err error) {
	result = &v1alpha1.IdentityProviderGoogle{}
