...
// EmailTemplatesGetter has a method to return a EmailTemplateInterface.
...
// emailTemplates implements EmailTemplateInterface
type emailTemplates struct {
	client rest.Interface
	ns     string
}

// newEmailTemplates returns a EmailTemplates
func newEmailTemplates(c *ApimanagementV1alpha1Client, namespace string) *emailTemplates {
...
func (c *emailTemplates) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.EmailTemplate, err error) {
	result = &v1alpha1.EmailTemplate{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *emailTemplates) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EmailTemplateList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.EmailTemplateList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("emailtemplates").
...
func (c *emailTemplates) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *emailTemplates) Create(ctx context.Context, emailTemplate *v1alpha1.EmailTemplate, opts v1.CreateOptions) (result *v1alpha1.EmailTemplate, err error) {
	result = &v1alpha1.EmailTemplate{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("emailtemplates").
...
func (c *emailTemplates) Update(ctx context.Context, emailTemplate *v1alpha1.EmailTemplate, opts v1.UpdateOptions) (result *v1alpha1.EmailTemplate, err error) {
	result = &v1alpha1.EmailTemplate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("emailtemplates").
...
func (c *emailTemplates) UpdateStatus(ctx context.Context, emailTemplate *v1alpha1.EmailTemplate, opts v1.UpdateOptions) (result *v1alpha1.EmailTemplate, err error) {
	result = &v1alpha1.EmailTemplate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("emailtemplates").
...
func (c *emailTemplates) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *emailTemplates) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *emailTemplates) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.EmailTemplate, err error) {
	result = &v1alpha1.EmailTemplate{}
