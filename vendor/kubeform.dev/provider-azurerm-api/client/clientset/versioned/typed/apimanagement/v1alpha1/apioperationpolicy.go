...
// ApiOperationPoliciesGetter has a method to return a ApiOperationPolicyInterface.
...
// apiOperationPolicies implements ApiOperationPolicyInterface
type apiOperationPolicies struct {
	client rest.Interface
	ns     string
}

// newApiOperationPolicies returns a ApiOperationPolicies
func newApiOperationPolicies(c *ApimanagementV1alpha1Client, namespace string) *apiOperationPolicies {
...
func (c *apiOperationPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ApiOperationPolicy, err error) {
	result = &v1alpha1.ApiOperationPolicy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *apiOperationPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ApiOperationPolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ApiOperationPolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("apioperationpolicies").
...
func (c *apiOperationPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *apiOperationPolicies) Create(ctx context.Context, apiOperationPolicy *v1alpha1.ApiOperationPolicy, opts v1.CreateOptions) (result *v1alpha1.ApiOperationPolicy, err error) {
	result = &v1alpha1.ApiOperationPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("apioperationpolicies").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(apiOperationPolicy).
		Do(ctx).
		Into(result)
	return
}
...
func (c *apiOperationPolicies) Update(ctx context.Context, apiOperationPolicy *v1alpha1.ApiOperationPolicy, opts v1.UpdateOptions) (result *v1alpha1.ApiOperationPolicy, err error) {
	result = &v1alpha1.ApiOperationPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apioperationpolicies").
		Name(apiOperationPolicy.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(apiOperationPolicy).
		Do(ctx).
		Into(result)
...
func (c *apiOperationPolicies) UpdateStatus(ctx context.Context, apiOperationPolicy *v1alpha1.ApiOperationPolicy, opts v1.UpdateOptions) (result *v1alpha1.ApiOperationPolicy, err error) {
	result = &v1alpha1.ApiOperationPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apioperationpolicies").
...
func (c *apiOperationPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *apiOperationPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *apiOperationPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ApiOperationPolicy, err error) {
	result = &v1alpha1.ApiOperationPolicy{}
