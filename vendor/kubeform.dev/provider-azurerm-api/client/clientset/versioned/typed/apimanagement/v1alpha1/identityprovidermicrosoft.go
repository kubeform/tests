...
// IdentityProviderMicrosoftsGetter has a method to return a IdentityProviderMicrosoftInterface.
...
// identityProviderMicrosofts implements IdentityProviderMicrosoftInterface
type identityProviderMicrosofts struct {
	client rest.Interface
	ns     string
}

// newIdentityProviderMicrosofts returns a IdentityProviderMicrosofts
func newIdentityProviderMicrosofts(c *ApimanagementV1alpha1Client, namespace string) *identityProviderMicrosofts {
	return &identityProviderMicrosofts{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *identityProviderMicrosofts) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IdentityProviderMicrosoft, err error) {
	result = &v1alpha1.IdentityProviderMicrosoft{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *identityProviderMicrosofts) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IdentityProviderMicrosoftList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.IdentityProviderMicrosoftList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("identityprovidermicrosofts").
...
func (c *identityProviderMicrosofts) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *identityProviderMicrosofts) Create(ctx context.Context, identityProviderMicrosoft *v1alpha1.IdentityProviderMicrosoft, opts v1.CreateOptions) (result *v1alpha1.IdentityProviderMicrosoft, err error) {
	result = &v1alpha1.IdentityProviderMicrosoft{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("identityprovidermicrosofts").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(identityProviderMicrosoft).
		Do(ctx).
		Into(result)
	return
}
...
func (c *identityProviderMicrosofts) Update(ctx context.Context, identityProviderMicrosoft *v1alpha1.IdentityProviderMicrosoft, opts v1.UpdateOptions) (result *v1alpha1.IdentityProviderMicrosoft, err error) {
	result = &v1alpha1.IdentityProviderMicrosoft{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("identityprovidermicrosofts").
		Name(identityProviderMicrosoft.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(identityProviderMicrosoft).
		Do(ctx).
		Into(result)
...
func (c *identityProviderMicrosofts) UpdateStatus(ctx context.Context, identityProviderMicrosoft *v1alpha1.IdentityProviderMicrosoft, opts v1.UpdateOptions) (result *v1alpha1.IdentityProviderMicrosoft, err error) {
	result = &v1alpha1.IdentityProviderMicrosoft{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("identityprovidermicrosofts").
...
func (c *identityProviderMicrosofts) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *identityProviderMicrosofts) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *identityProviderMicrosofts) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IdentityProviderMicrosoft, err error) {
	result = &v1alpha1.IdentityProviderMicrosoft{}
