...
// IdentityProviderAadsGetter has a method to return a IdentityProviderAadInterface.
...
// identityProviderAads implements IdentityProviderAadInterface
type identityProviderAads struct {
	client rest.Interface
	ns     string
}

// newIdentityProviderAads returns a IdentityProviderAads
func newIdentityProviderAads(c *ApimanagementV1alpha1Client, namespace string) *identityProviderAads {
	return &identityProviderAads{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *identityProviderAads) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IdentityProviderAad, err error) {
	result = &v1alpha1.IdentityProviderAad{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *identityProviderAads) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IdentityProviderAadList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.IdentityProviderAadList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("identityprovideraads").
...
func (c *identityProviderAads) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *identityProviderAads) Create(ctx context.Context, identityProviderAad *v1alpha1.IdentityProviderAad, opts v1.CreateOptions) (result *v1alpha1.IdentityProviderAad, err error) {
	result = &v1alpha1.IdentityProviderAad{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("identityprovideraads").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(identityProviderAad).
		Do(ctx).
		Into(result)
	return
}
...
func (c *identityProviderAads) Update(ctx context.Context, identityProviderAad *v1alpha1.IdentityProviderAad, opts v1.UpdateOptions) (result *v1alpha1.IdentityProviderAad, err error) {
	result = &v1alpha1.IdentityProviderAad{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("identityprovideraads").
		Name(identityProviderAad.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(identityProviderAad).
		Do(ctx).
		Into(result)
...
func (c *identityProviderAads) UpdateStatus(ctx context.Context, identityProviderAad *v1alpha1.IdentityProviderAad, opts v1.UpdateOptions) (result *v1alpha1.IdentityProviderAad, err error) {
	result = &v1alpha1.IdentityProviderAad{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("identityprovideraads").
...
func (c *identityProviderAads) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *identityProviderAads) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *identityProviderAads) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IdentityProviderAad, err error) {
	result = &v1alpha1.IdentityProviderAad{}
