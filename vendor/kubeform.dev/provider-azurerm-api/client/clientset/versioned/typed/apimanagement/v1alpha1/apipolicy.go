...
// ApiPoliciesGetter has a method to return a ApiPolicyInterface.
...
// apiPolicies implements ApiPolicyInterface
type apiPolicies struct {
	client rest.Interface
	ns     string
}

// newApiPolicies returns a ApiPolicies
func newApiPolicies(c *ApimanagementV1alpha1Client, namespace string) *apiPolicies {
	return &apiPolicies{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *apiPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ApiPolicy, err error) {
	result = &v1alpha1.ApiPolicy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *apiPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ApiPolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ApiPolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("apipolicies").
...
func (c *apiPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *apiPolicies) Create(ctx context.Context, apiPolicy *v1alpha1.ApiPolicy, opts v1.CreateOptions) (result *v1alpha1.ApiPolicy, err error) {
	result = &v1alpha1.ApiPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("apipolicies").
...
func (c *apiPolicies) Update(ctx context.Context, apiPolicy *v1alpha1.ApiPolicy, opts v1.UpdateOptions) (result *v1alpha1.ApiPolicy, err error) {
	result = &v1alpha1.ApiPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apipolicies").
...
func (c *apiPolicies) UpdateStatus(ctx context.Context, apiPolicy *v1alpha1.ApiPolicy, opts v1.UpdateOptions) (result *v1alpha1.ApiPolicy, err error) {
	result = &v1alpha1.ApiPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apipolicies").
...
func (c *apiPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *apiPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *apiPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ApiPolicy, err error) {
	result = &v1alpha1.ApiPolicy{}
