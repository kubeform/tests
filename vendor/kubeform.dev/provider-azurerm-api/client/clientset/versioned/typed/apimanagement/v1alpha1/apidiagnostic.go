...
// ApiDiagnosticsGetter has a method to return a ApiDiagnosticInterface.
...
// apiDiagnostics implements ApiDiagnosticInterface
type apiDiagnostics struct {
	client rest.Interface
	ns     string
}

// newApiDiagnostics returns a ApiDiagnostics
func newApiDiagnostics(c *ApimanagementV1alpha1Client, namespace string) *apiDiagnostics {
...
func (c *apiDiagnostics) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ApiDiagnostic, err error) {
	result = &v1alpha1.ApiDiagnostic{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *apiDiagnostics) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ApiDiagnosticList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ApiDiagnosticList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("apidiagnostics").
...
func (c *apiDiagnostics) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *apiDiagnostics) Create(ctx context.Context, apiDiagnostic *v1alpha1.ApiDiagnostic, opts v1.CreateOptions) (result *v1alpha1.ApiDiagnostic, err error) {
	result = &v1alpha1.ApiDiagnostic{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("apidiagnostics").
...
func (c *apiDiagnostics) Update(ctx context.Context, apiDiagnostic *v1alpha1.ApiDiagnostic, opts v1.UpdateOptions) (result *v1alpha1.ApiDiagnostic, err error) {
	result = &v1alpha1.ApiDiagnostic{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apidiagnostics").
...
func (c *apiDiagnostics) UpdateStatus(ctx context.Context, apiDiagnostic *v1alpha1.ApiDiagnostic, opts v1.UpdateOptions) (result *v1alpha1.ApiDiagnostic, err error) {
	result = &v1alpha1.ApiDiagnostic{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apidiagnostics").
...
func (c *apiDiagnostics) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *apiDiagnostics) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *apiDiagnostics) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ApiDiagnostic, err error) {
	result = &v1alpha1.ApiDiagnostic{}
