...
// ProductPoliciesGetter has a method to return a ProductPolicyInterface.
...
// productPolicies implements ProductPolicyInterface
type productPolicies struct {
	client rest.Interface
	ns     string
}

// newProductPolicies returns a ProductPolicies
func newProductPolicies(c *ApimanagementV1alpha1Client, namespace string) *productPolicies {
...
func (c *productPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ProductPolicy, err error) {
	result = &v1alpha1.ProductPolicy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *productPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ProductPolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ProductPolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("productpolicies").
...
func (c *productPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *productPolicies) Create(ctx context.Context, productPolicy *v1alpha1.ProductPolicy, opts v1.CreateOptions) (result *v1alpha1.ProductPolicy, err error) {
	result = &v1alpha1.ProductPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("productpolicies").
...
func (c *productPolicies) Update(ctx context.Context, productPolicy *v1alpha1.ProductPolicy, opts v1.UpdateOptions) (result *v1alpha1.ProductPolicy, err error) {
	result = &v1alpha1.ProductPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("productpolicies").
		Name(productPolicy.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(productPolicy).
		Do(ctx).
		Into(result)
...
func (c *productPolicies) UpdateStatus(ctx context.Context, productPolicy *v1alpha1.ProductPolicy, opts v1.UpdateOptions) (result *v1alpha1.ProductPolicy, err error) {
	result = &v1alpha1.ProductPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("productpolicies").
...
func (c *productPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *productPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *productPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ProductPolicy, err error) {
	result = &v1alpha1.ProductPolicy{}
