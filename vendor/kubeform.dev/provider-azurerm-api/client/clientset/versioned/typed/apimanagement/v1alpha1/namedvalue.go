...
// NamedValuesGetter has a method to return a NamedValueInterface.
...
// namedValues implements NamedValueInterface
type namedValues struct {
	client rest.Interface
	ns     string
}

// newNamedValues returns a NamedValues
func newNamedValues(c *ApimanagementV1alpha1Client, namespace string) *namedValues {
	return &namedValues{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *namedValues) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.NamedValue, err error) {
	result = &v1alpha1.NamedValue{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *namedValues) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.NamedValueList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.NamedValueList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("namedvalues").
...
func (c *namedValues) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *namedValues) Create(ctx context.Context, namedValue *v1alpha1.NamedValue, opts v1.CreateOptions) (result *v1alpha1.NamedValue, err error) {
	result = &v1alpha1.NamedValue{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("namedvalues").
...
func (c *namedValues) Update(ctx context.Context, namedValue *v1alpha1.NamedValue, opts v1.UpdateOptions) (result *v1alpha1.NamedValue, err error) {
	result = &v1alpha1.NamedValue{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("namedvalues").
...
func (c *namedValues) UpdateStatus(ctx context.Context, namedValue *v1alpha1.NamedValue, opts v1.UpdateOptions) (result *v1alpha1.NamedValue, err error) {
	result = &v1alpha1.NamedValue{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("namedvalues").
...
func (c *namedValues) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *namedValues) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *namedValues) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.NamedValue, err error) {
	result = &v1alpha1.NamedValue{}
