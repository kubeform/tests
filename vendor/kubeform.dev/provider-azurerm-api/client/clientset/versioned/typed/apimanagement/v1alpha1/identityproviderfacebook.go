...
// IdentityProviderFacebooksGetter has a method to return a IdentityProviderFacebookInterface.
...
// identityProviderFacebooks implements IdentityProviderFacebookInterface
type identityProviderFacebooks struct {
	client rest.Interface
	ns     string
}

// newIdentityProviderFacebooks returns a IdentityProviderFacebooks
func newIdentityProviderFacebooks(c *ApimanagementV1alpha1Client, namespace string) *identityProviderFacebooks {
	return &identityProviderFacebooks{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *identityProviderFacebooks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IdentityProviderFacebook, err error) {
	result = &v1alpha1.IdentityProviderFacebook{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *identityProviderFacebooks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IdentityProviderFacebookList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.IdentityProviderFacebookList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("identityproviderfacebooks").
...
func (c *identityProviderFacebooks) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *identityProviderFacebooks) Create(ctx context.Context, identityProviderFacebook *v1alpha1.IdentityProviderFacebook, opts v1.CreateOptions) (result *v1alpha1.IdentityProviderFacebook, err error) {
	result = &v1alpha1.IdentityProviderFacebook{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("identityproviderfacebooks").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(identityProviderFacebook).
		Do(ctx).
		Into(result)
	return
}
...
func (c *identityProviderFacebooks) Update(ctx context.Context, identityProviderFacebook *v1alpha1.IdentityProviderFacebook, opts v1.UpdateOptions) (result *v1alpha1.IdentityProviderFacebook, err error) {
	result = &v1alpha1.IdentityProviderFacebook{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("identityproviderfacebooks").
		Name(identityProviderFacebook.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(identityProviderFacebook).
		Do(ctx).
		Into(result)
...
func (c *identityProviderFacebooks) UpdateStatus(ctx context.Context, identityProviderFacebook *v1alpha1.IdentityProviderFacebook, opts v1.UpdateOptions) (result *v1alpha1.IdentityProviderFacebook, err error) {
	result = &v1alpha1.IdentityProviderFacebook{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("identityproviderfacebooks").
...
func (c *identityProviderFacebooks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *identityProviderFacebooks) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *identityProviderFacebooks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IdentityProviderFacebook, err error) {
	result = &v1alpha1.IdentityProviderFacebook{}
