...
// AuthorizationServersGetter has a method to return a AuthorizationServerInterface.
...
// authorizationServers implements AuthorizationServerInterface
type authorizationServers struct {
	client rest.Interface
	ns     string
}

// newAuthorizationServers returns a AuthorizationServers
func newAuthorizationServers(c *ApimanagementV1alpha1Client, namespace string) *authorizationServers {
...
func (c *authorizationServers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AuthorizationServer, err error) {
	result = &v1alpha1.AuthorizationServer{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *authorizationServers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AuthorizationServerList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.AuthorizationServerList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("authorizationservers").
...
func (c *authorizationServers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *authorizationServers) Create(ctx context.Context, authorizationServer *v1alpha1.AuthorizationServer, opts v1.CreateOptions) (result *v1alpha1.AuthorizationServer, err error) {
	result = &v1alpha1.AuthorizationServer{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("authorizationservers").
...
func (c *authorizationServers) Update(ctx context.Context, authorizationServer *v1alpha1.AuthorizationServer, opts v1.UpdateOptions) (result *v1alpha1.AuthorizationServer, err error) {
	result = &v1alpha1.AuthorizationServer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("authorizationservers").
...
func (c *authorizationServers) UpdateStatus(ctx context.Context, authorizationServer *v1alpha1.AuthorizationServer, opts v1.UpdateOptions) (result *v1alpha1.AuthorizationServer, err error) {
	result = &v1alpha1.AuthorizationServer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("authorizationservers").
...
func (c *authorizationServers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *authorizationServers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *authorizationServers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AuthorizationServer, err error) {
	result = &v1alpha1.AuthorizationServer{}
