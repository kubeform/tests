...
func NewForConfig(c *rest.Config) (*RelayV1alpha1Client, error) {
	...
	return &RelayV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new RelayV1alpha1Client for the given config and
...
func New(c rest.Interface) *RelayV1alpha1Client {
	return &RelayV1alpha1Client{c}
}
