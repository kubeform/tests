...
type FirewallV1alpha1Interface interface {
	...
	ApplicationRuleCollectionsGetter
	FirewallsGetter
	NatRuleCollectionsGetter
	NetworkRuleCollectionsGetter
	PoliciesGetter
	PolicyRuleCollectionGroupsGetter
}
...
func (c *FirewallV1alpha1Client) ApplicationRuleCollections(namespace string) ApplicationRuleCollectionInterface {
	return newApplicationRuleCollections(c, namespace)
}
...
func (c *FirewallV1alpha1Client) PolicyRuleCollectionGroups(namespace string) PolicyRuleCollectionGroupInterface {
	return newPolicyRuleCollectionGroups(c, namespace)
}
