...
// NetworkRuleCollectionsGetter has a method to return a NetworkRuleCollectionInterface.
...
// networkRuleCollections implements NetworkRuleCollectionInterface
type networkRuleCollections struct {
	client rest.Interface
	ns     string
}

// newNetworkRuleCollections returns a NetworkRuleCollections
func newNetworkRuleCollections(c *FirewallV1alpha1Client, namespace string) *networkRuleCollections {
...
func (c *networkRuleCollections) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.NetworkRuleCollection, err error) {
	result = &v1alpha1.NetworkRuleCollection{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *networkRuleCollections) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.NetworkRuleCollectionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.NetworkRuleCollectionList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("networkrulecollections").
...
func (c *networkRuleCollections) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *networkRuleCollections) Create(ctx context.Context, networkRuleCollection *v1alpha1.NetworkRuleCollection, opts v1.CreateOptions) (result *v1alpha1.NetworkRuleCollection, err error) {
	result = &v1alpha1.NetworkRuleCollection{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("networkrulecollections").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(networkRuleCollection).
		Do(ctx).
		Into(result)
	return
}
...
func (c *networkRuleCollections) Update(ctx context.Context, networkRuleCollection *v1alpha1.NetworkRuleCollection, opts v1.UpdateOptions) (result *v1alpha1.NetworkRuleCollection, err error) {
	result = &v1alpha1.NetworkRuleCollection{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("networkrulecollections").
...
func (c *networkRuleCollections) UpdateStatus(ctx context.Context, networkRuleCollection *v1alpha1.NetworkRuleCollection, opts v1.UpdateOptions) (result *v1alpha1.NetworkRuleCollection, err error) {
	result = &v1alpha1.NetworkRuleCollection{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("networkrulecollections").
...
func (c *networkRuleCollections) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *networkRuleCollections) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *networkRuleCollections) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.NetworkRuleCollection, err error) {
	result = &v1alpha1.NetworkRuleCollection{}
