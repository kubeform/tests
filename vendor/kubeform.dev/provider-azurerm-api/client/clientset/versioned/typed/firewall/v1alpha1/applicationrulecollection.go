...
// ApplicationRuleCollectionsGetter has a method to return a ApplicationRuleCollectionInterface.
...
// applicationRuleCollections implements ApplicationRuleCollectionInterface
type applicationRuleCollections struct {
	client rest.Interface
	ns     string
}

// newApplicationRuleCollections returns a ApplicationRuleCollections
func newApplicationRuleCollections(c *FirewallV1alpha1Client, namespace string) *applicationRuleCollections {
...
func (c *applicationRuleCollections) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ApplicationRuleCollection, err error) {
	result = &v1alpha1.ApplicationRuleCollection{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *applicationRuleCollections) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ApplicationRuleCollectionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ApplicationRuleCollectionList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("applicationrulecollections").
...
func (c *applicationRuleCollections) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *applicationRuleCollections) Create(ctx context.Context, applicationRuleCollection *v1alpha1.ApplicationRuleCollection, opts v1.CreateOptions) (result *v1alpha1.ApplicationRuleCollection, err error) {
	result = &v1alpha1.ApplicationRuleCollection{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("applicationrulecollections").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(applicationRuleCollection).
		Do(ctx).
		Into(result)
	return
}
...
func (c *applicationRuleCollections) Update(ctx context.Context, applicationRuleCollection *v1alpha1.ApplicationRuleCollection, opts v1.UpdateOptions) (result *v1alpha1.ApplicationRuleCollection, err error) {
	result = &v1alpha1.ApplicationRuleCollection{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("applicationrulecollections").
		Name(applicationRuleCollection.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(applicationRuleCollection).
		Do(ctx).
		Into(result)
...
func (c *applicationRuleCollections) UpdateStatus(ctx context.Context, applicationRuleCollection *v1alpha1.ApplicationRuleCollection, opts v1.UpdateOptions) (result *v1alpha1.ApplicationRuleCollection, err error) {
	result = &v1alpha1.ApplicationRuleCollection{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("applicationrulecollections").
...
func (c *applicationRuleCollections) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *applicationRuleCollections) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *applicationRuleCollections) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ApplicationRuleCollection, err error) {
	result = &v1alpha1.ApplicationRuleCollection{}
