...
// AlertRuleMsSecurityIncidentsGetter has a method to return a AlertRuleMsSecurityIncidentInterface.
...
// alertRuleMsSecurityIncidents implements AlertRuleMsSecurityIncidentInterface
type alertRuleMsSecurityIncidents struct {
	client rest.Interface
	ns     string
}

// newAlertRuleMsSecurityIncidents returns a AlertRuleMsSecurityIncidents
func newAlertRuleMsSecurityIncidents(c *SentinelV1alpha1Client, namespace string) *alertRuleMsSecurityIncidents {
	return &alertRuleMsSecurityIncidents{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *alertRuleMsSecurityIncidents) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AlertRuleMsSecurityIncident, err error) {
	result = &v1alpha1.AlertRuleMsSecurityIncident{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *alertRuleMsSecurityIncidents) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AlertRuleMsSecurityIncidentList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.AlertRuleMsSecurityIncidentList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("alertrulemssecurityincidents").
...
func (c *alertRuleMsSecurityIncidents) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *alertRuleMsSecurityIncidents) Create(ctx context.Context, alertRuleMsSecurityIncident *v1alpha1.AlertRuleMsSecurityIncident, opts v1.CreateOptions) (result *v1alpha1.AlertRuleMsSecurityIncident, err error) {
	result = &v1alpha1.AlertRuleMsSecurityIncident{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("alertrulemssecurityincidents").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(alertRuleMsSecurityIncident).
		Do(ctx).
		Into(result)
	return
}
...
func (c *alertRuleMsSecurityIncidents) Update(ctx context.Context, alertRuleMsSecurityIncident *v1alpha1.AlertRuleMsSecurityIncident, opts v1.UpdateOptions) (result *v1alpha1.AlertRuleMsSecurityIncident, err error) {
	result = &v1alpha1.AlertRuleMsSecurityIncident{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("alertrulemssecurityincidents").
		Name(alertRuleMsSecurityIncident.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(alertRuleMsSecurityIncident).
		Do(ctx).
		Into(result)
...
func (c *alertRuleMsSecurityIncidents) UpdateStatus(ctx context.Context, alertRuleMsSecurityIncident *v1alpha1.AlertRuleMsSecurityIncident, opts v1.UpdateOptions) (result *v1alpha1.AlertRuleMsSecurityIncident, err error) {
	result = &v1alpha1.AlertRuleMsSecurityIncident{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("alertrulemssecurityincidents").
...
func (c *alertRuleMsSecurityIncidents) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *alertRuleMsSecurityIncidents) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *alertRuleMsSecurityIncidents) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AlertRuleMsSecurityIncident, err error) {
	result = &v1alpha1.AlertRuleMsSecurityIncident{}
