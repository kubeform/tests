...
// AlertRuleFusionsGetter has a method to return a AlertRuleFusionInterface.
...
// alertRuleFusions implements AlertRuleFusionInterface
type alertRuleFusions struct {
	client rest.Interface
	ns     string
}

// newAlertRuleFusions returns a AlertRuleFusions
func newAlertRuleFusions(c *SentinelV1alpha1Client, namespace string) *alertRuleFusions {
	return &alertRuleFusions{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *alertRuleFusions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AlertRuleFusion, err error) {
	result = &v1alpha1.AlertRuleFusion{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *alertRuleFusions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AlertRuleFusionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.AlertRuleFusionList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("alertrulefusions").
...
func (c *alertRuleFusions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *alertRuleFusions) Create(ctx context.Context, alertRuleFusion *v1alpha1.AlertRuleFusion, opts v1.CreateOptions) (result *v1alpha1.AlertRuleFusion, err error) {
	result = &v1alpha1.AlertRuleFusion{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("alertrulefusions").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(alertRuleFusion).
		Do(ctx).
		Into(result)
	return
}
...
func (c *alertRuleFusions) Update(ctx context.Context, alertRuleFusion *v1alpha1.AlertRuleFusion, opts v1.UpdateOptions) (result *v1alpha1.AlertRuleFusion, err error) {
	result = &v1alpha1.AlertRuleFusion{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("alertrulefusions").
		Name(alertRuleFusion.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(alertRuleFusion).
		Do(ctx).
		Into(result)
...
func (c *alertRuleFusions) UpdateStatus(ctx context.Context, alertRuleFusion *v1alpha1.AlertRuleFusion, opts v1.UpdateOptions) (result *v1alpha1.AlertRuleFusion, err error) {
	result = &v1alpha1.AlertRuleFusion{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("alertrulefusions").
...
func (c *alertRuleFusions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *alertRuleFusions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *alertRuleFusions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AlertRuleFusion, err error) {
	result = &v1alpha1.AlertRuleFusion{}
