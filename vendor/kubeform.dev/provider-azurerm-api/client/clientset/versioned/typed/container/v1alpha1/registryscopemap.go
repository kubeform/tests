...
// RegistryScopeMapsGetter has a method to return a RegistryScopeMapInterface.
...
// registryScopeMaps implements RegistryScopeMapInterface
type registryScopeMaps struct {
	client rest.Interface
	ns     string
}

// newRegistryScopeMaps returns a RegistryScopeMaps
func newRegistryScopeMaps(c *ContainerV1alpha1Client, namespace string) *registryScopeMaps {
	return &registryScopeMaps{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *registryScopeMaps) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.RegistryScopeMap, err error) {
	result = &v1alpha1.RegistryScopeMap{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *registryScopeMaps) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RegistryScopeMapList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.RegistryScopeMapList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("registryscopemaps").
...
func (c *registryScopeMaps) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *registryScopeMaps) Create(ctx context.Context, registryScopeMap *v1alpha1.RegistryScopeMap, opts v1.CreateOptions) (result *v1alpha1.RegistryScopeMap, err error) {
	result = &v1alpha1.RegistryScopeMap{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("registryscopemaps").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(registryScopeMap).
		Do(ctx).
		Into(result)
	return
}
...
func (c *registryScopeMaps) Update(ctx context.Context, registryScopeMap *v1alpha1.RegistryScopeMap, opts v1.UpdateOptions) (result *v1alpha1.RegistryScopeMap, err error) {
	result = &v1alpha1.RegistryScopeMap{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("registryscopemaps").
		Name(registryScopeMap.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(registryScopeMap).
		Do(ctx).
		Into(result)
...
func (c *registryScopeMaps) UpdateStatus(ctx context.Context, registryScopeMap *v1alpha1.RegistryScopeMap, opts v1.UpdateOptions) (result *v1alpha1.RegistryScopeMap, err error) {
	result = &v1alpha1.RegistryScopeMap{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("registryscopemaps").
...
func (c *registryScopeMaps) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *registryScopeMaps) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *registryScopeMaps) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.RegistryScopeMap, err error) {
	result = &v1alpha1.RegistryScopeMap{}
