...
// ManagedPrivateEndpointsGetter has a method to return a ManagedPrivateEndpointInterface.
...
// managedPrivateEndpoints implements ManagedPrivateEndpointInterface
type managedPrivateEndpoints struct {
	client rest.Interface
	ns     string
}

// newManagedPrivateEndpoints returns a ManagedPrivateEndpoints
func newManagedPrivateEndpoints(c *SynapseV1alpha1Client, namespace string) *managedPrivateEndpoints {
...
func (c *managedPrivateEndpoints) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ManagedPrivateEndpoint, err error) {
	result = &v1alpha1.ManagedPrivateEndpoint{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *managedPrivateEndpoints) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ManagedPrivateEndpointList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ManagedPrivateEndpointList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("managedprivateendpoints").
...
func (c *managedPrivateEndpoints) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *managedPrivateEndpoints) Create(ctx context.Context, managedPrivateEndpoint *v1alpha1.ManagedPrivateEndpoint, opts v1.CreateOptions) (result *v1alpha1.ManagedPrivateEndpoint, err error) {
	result = &v1alpha1.ManagedPrivateEndpoint{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("managedprivateendpoints").
...
func (c *managedPrivateEndpoints) Update(ctx context.Context, managedPrivateEndpoint *v1alpha1.ManagedPrivateEndpoint, opts v1.UpdateOptions) (result *v1alpha1.ManagedPrivateEndpoint, err error) {
	result = &v1alpha1.ManagedPrivateEndpoint{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("managedprivateendpoints").
...
func (c *managedPrivateEndpoints) UpdateStatus(ctx context.Context, managedPrivateEndpoint *v1alpha1.ManagedPrivateEndpoint, opts v1.UpdateOptions) (result *v1alpha1.ManagedPrivateEndpoint, err error) {
	result = &v1alpha1.ManagedPrivateEndpoint{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("managedprivateendpoints").
...
func (c *managedPrivateEndpoints) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *managedPrivateEndpoints) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *managedPrivateEndpoints) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ManagedPrivateEndpoint, err error) {
	result = &v1alpha1.ManagedPrivateEndpoint{}
