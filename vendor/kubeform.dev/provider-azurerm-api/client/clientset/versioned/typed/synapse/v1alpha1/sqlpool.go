...
// SqlPoolsGetter has a method to return a SqlPoolInterface.
...
// sqlPools implements SqlPoolInterface
type sqlPools struct {
	client rest.Interface
	ns     string
}

// newSqlPools returns a SqlPools
func newSqlPools(c *SynapseV1alpha1Client, namespace string) *sqlPools {
	return &sqlPools{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *sqlPools) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SqlPool, err error) {
	result = &v1alpha1.SqlPool{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("sqlpools").
		Name(name).
...
func (c *sqlPools) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SqlPoolList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.SqlPoolList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("sqlpools").
...
func (c *sqlPools) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *sqlPools) Create(ctx context.Context, sqlPool *v1alpha1.SqlPool, opts v1.CreateOptions) (result *v1alpha1.SqlPool, err error) {
	result = &v1alpha1.SqlPool{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("sqlpools").
...
func (c *sqlPools) Update(ctx context.Context, sqlPool *v1alpha1.SqlPool, opts v1.UpdateOptions) (result *v1alpha1.SqlPool, err error) {
	result = &v1alpha1.SqlPool{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sqlpools").
...
func (c *sqlPools) UpdateStatus(ctx context.Context, sqlPool *v1alpha1.SqlPool, opts v1.UpdateOptions) (result *v1alpha1.SqlPool, err error) {
	result = &v1alpha1.SqlPool{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sqlpools").
...
func (c *sqlPools) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *sqlPools) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *sqlPools) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SqlPool, err error) {
	result = &v1alpha1.SqlPool{}
