...
func newRoleAssignments(c *SynapseV1alpha1Client, namespace string) *roleAssignments {
...
func (c *roleAssignments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.RoleAssignment, err error) {
...
func (c *roleAssignments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RoleAssignmentList, err error) {
...
func (c *roleAssignments) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *roleAssignments) Create(ctx context.Context, roleAssignment *v1alpha1.RoleAssignment, opts v1.CreateOptions) (result *v1alpha1.RoleAssignment, err error) {
	result = &v1alpha1.RoleAssignment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("roleassignments").
...
func (c *roleAssignments) Update(ctx context.Context, roleAssignment *v1alpha1.RoleAssignment, opts v1.UpdateOptions) (result *v1alpha1.RoleAssignment, err error) {
	result = &v1alpha1.RoleAssignment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("roleassignments").
...
func (c *roleAssignments) UpdateStatus(ctx context.Context, roleAssignment *v1alpha1.RoleAssignment, opts v1.UpdateOptions) (result *v1alpha1.RoleAssignment, err error) {
	result = &v1alpha1.RoleAssignment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("roleassignments").
...
func (c *roleAssignments) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *roleAssignments) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *roleAssignments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.RoleAssignment, err error) {
	result = &v1alpha1.RoleAssignment{}
