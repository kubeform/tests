...
import (
	v1alpha1 "kubeform.dev/provider-azurerm-api/apis/tenant/v1alpha1"
...
// TenantV1alpha1Client is used to interact with features provided by the tenant.azurerm.kubeform.com group.
type TenantV1alpha1Client struct {
	restClient rest.Interface
}

func (c *TenantV1alpha1Client) TemplateDeployments(namespace string) TemplateDeploymentInterface {
