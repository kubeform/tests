...
// SeriesInsightsAccessPoliciesGetter has a method to return a SeriesInsightsAccessPolicyInterface.
...
// seriesInsightsAccessPolicies implements SeriesInsightsAccessPolicyInterface
type seriesInsightsAccessPolicies struct {
	client rest.Interface
	ns     string
}

// newSeriesInsightsAccessPolicies returns a SeriesInsightsAccessPolicies
func newSeriesInsightsAccessPolicies(c *IottimeV1alpha1Client, namespace string) *seriesInsightsAccessPolicies {
	return &seriesInsightsAccessPolicies{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *seriesInsightsAccessPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SeriesInsightsAccessPolicy, err error) {
	result = &v1alpha1.SeriesInsightsAccessPolicy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *seriesInsightsAccessPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SeriesInsightsAccessPolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.SeriesInsightsAccessPolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("seriesinsightsaccesspolicies").
...
func (c *seriesInsightsAccessPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *seriesInsightsAccessPolicies) Create(ctx context.Context, seriesInsightsAccessPolicy *v1alpha1.SeriesInsightsAccessPolicy, opts v1.CreateOptions) (result *v1alpha1.SeriesInsightsAccessPolicy, err error) {
	result = &v1alpha1.SeriesInsightsAccessPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("seriesinsightsaccesspolicies").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(seriesInsightsAccessPolicy).
		Do(ctx).
		Into(result)
	return
}
...
func (c *seriesInsightsAccessPolicies) Update(ctx context.Context, seriesInsightsAccessPolicy *v1alpha1.SeriesInsightsAccessPolicy, opts v1.UpdateOptions) (result *v1alpha1.SeriesInsightsAccessPolicy, err error) {
	result = &v1alpha1.SeriesInsightsAccessPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("seriesinsightsaccesspolicies").
		Name(seriesInsightsAccessPolicy.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(seriesInsightsAccessPolicy).
		Do(ctx).
		Into(result)
...
func (c *seriesInsightsAccessPolicies) UpdateStatus(ctx context.Context, seriesInsightsAccessPolicy *v1alpha1.SeriesInsightsAccessPolicy, opts v1.UpdateOptions) (result *v1alpha1.SeriesInsightsAccessPolicy, err error) {
	result = &v1alpha1.SeriesInsightsAccessPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("seriesinsightsaccesspolicies").
...
func (c *seriesInsightsAccessPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *seriesInsightsAccessPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *seriesInsightsAccessPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SeriesInsightsAccessPolicy, err error) {
	result = &v1alpha1.SeriesInsightsAccessPolicy{}
