...
// InsightsAnalyticsItemsGetter has a method to return a InsightsAnalyticsItemInterface.
...
// insightsAnalyticsItems implements InsightsAnalyticsItemInterface
type insightsAnalyticsItems struct {
	client rest.Interface
	ns     string
}

// newInsightsAnalyticsItems returns a InsightsAnalyticsItems
func newInsightsAnalyticsItems(c *ApplicationV1alpha1Client, namespace string) *insightsAnalyticsItems {
	return &insightsAnalyticsItems{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *insightsAnalyticsItems) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.InsightsAnalyticsItem, err error) {
	result = &v1alpha1.InsightsAnalyticsItem{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *insightsAnalyticsItems) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.InsightsAnalyticsItemList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.InsightsAnalyticsItemList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("insightsanalyticsitems").
...
func (c *insightsAnalyticsItems) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *insightsAnalyticsItems) Create(ctx context.Context, insightsAnalyticsItem *v1alpha1.InsightsAnalyticsItem, opts v1.CreateOptions) (result *v1alpha1.InsightsAnalyticsItem, err error) {
	result = &v1alpha1.InsightsAnalyticsItem{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("insightsanalyticsitems").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(insightsAnalyticsItem).
		Do(ctx).
		Into(result)
	return
}
...
func (c *insightsAnalyticsItems) Update(ctx context.Context, insightsAnalyticsItem *v1alpha1.InsightsAnalyticsItem, opts v1.UpdateOptions) (result *v1alpha1.InsightsAnalyticsItem, err error) {
	result = &v1alpha1.InsightsAnalyticsItem{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("insightsanalyticsitems").
		Name(insightsAnalyticsItem.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(insightsAnalyticsItem).
		Do(ctx).
		Into(result)
...
func (c *insightsAnalyticsItems) UpdateStatus(ctx context.Context, insightsAnalyticsItem *v1alpha1.InsightsAnalyticsItem, opts v1.UpdateOptions) (result *v1alpha1.InsightsAnalyticsItem, err error) {
	result = &v1alpha1.InsightsAnalyticsItem{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("insightsanalyticsitems").
...
func (c *insightsAnalyticsItems) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *insightsAnalyticsItems) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *insightsAnalyticsItems) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.InsightsAnalyticsItem, err error) {
	result = &v1alpha1.InsightsAnalyticsItem{}
