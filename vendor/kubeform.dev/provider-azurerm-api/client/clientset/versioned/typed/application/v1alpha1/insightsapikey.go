...
// InsightsAPIKeysGetter has a method to return a InsightsAPIKeyInterface.
...
// insightsAPIKeys implements InsightsAPIKeyInterface
type insightsAPIKeys struct {
	client rest.Interface
	ns     string
}

// newInsightsAPIKeys returns a InsightsAPIKeys
func newInsightsAPIKeys(c *ApplicationV1alpha1Client, namespace string) *insightsAPIKeys {
	return &insightsAPIKeys{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *insightsAPIKeys) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.InsightsAPIKey, err error) {
	result = &v1alpha1.InsightsAPIKey{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *insightsAPIKeys) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.InsightsAPIKeyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.InsightsAPIKeyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("insightsapikeys").
...
func (c *insightsAPIKeys) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *insightsAPIKeys) Create(ctx context.Context, insightsAPIKey *v1alpha1.InsightsAPIKey, opts v1.CreateOptions) (result *v1alpha1.InsightsAPIKey, err error) {
	result = &v1alpha1.InsightsAPIKey{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("insightsapikeys").
...
func (c *insightsAPIKeys) Update(ctx context.Context, insightsAPIKey *v1alpha1.InsightsAPIKey, opts v1.UpdateOptions) (result *v1alpha1.InsightsAPIKey, err error) {
	result = &v1alpha1.InsightsAPIKey{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("insightsapikeys").
		Name(insightsAPIKey.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(insightsAPIKey).
		Do(ctx).
		Into(result)
...
func (c *insightsAPIKeys) UpdateStatus(ctx context.Context, insightsAPIKey *v1alpha1.InsightsAPIKey, opts v1.UpdateOptions) (result *v1alpha1.InsightsAPIKey, err error) {
	result = &v1alpha1.InsightsAPIKey{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("insightsapikeys").
...
func (c *insightsAPIKeys) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *insightsAPIKeys) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *insightsAPIKeys) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.InsightsAPIKey, err error) {
	result = &v1alpha1.InsightsAPIKey{}
