...
// InsightsesGetter has a method to return a InsightsInterface.
...
// insightses implements InsightsInterface
type insightses struct {
	client rest.Interface
	ns     string
}

// newInsightses returns a Insightses
func newInsightses(c *ApplicationV1alpha1Client, namespace string) *insightses {
	return &insightses{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *insightses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Insights, err error) {
	result = &v1alpha1.Insights{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("insightses").
		Name(name).
...
func (c *insightses) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.InsightsList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.InsightsList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("insightses").
...
func (c *insightses) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *insightses) Create(ctx context.Context, insights *v1alpha1.Insights, opts v1.CreateOptions) (result *v1alpha1.Insights, err error) {
	result = &v1alpha1.Insights{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("insightses").
...
func (c *insightses) Update(ctx context.Context, insights *v1alpha1.Insights, opts v1.UpdateOptions) (result *v1alpha1.Insights, err error) {
	result = &v1alpha1.Insights{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("insightses").
...
func (c *insightses) UpdateStatus(ctx context.Context, insights *v1alpha1.Insights, opts v1.UpdateOptions) (result *v1alpha1.Insights, err error) {
	result = &v1alpha1.Insights{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("insightses").
...
func (c *insightses) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *insightses) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *insightses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Insights, err error) {
	result = &v1alpha1.Insights{}
