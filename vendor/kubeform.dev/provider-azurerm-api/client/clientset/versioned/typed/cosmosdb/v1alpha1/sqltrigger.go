...
// SqlTriggersGetter has a method to return a SqlTriggerInterface.
...
// sqlTriggers implements SqlTriggerInterface
type sqlTriggers struct {
	client rest.Interface
	ns     string
}

// newSqlTriggers returns a SqlTriggers
func newSqlTriggers(c *CosmosdbV1alpha1Client, namespace string) *sqlTriggers {
	return &sqlTriggers{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *sqlTriggers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SqlTrigger, err error) {
	result = &v1alpha1.SqlTrigger{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *sqlTriggers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SqlTriggerList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.SqlTriggerList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("sqltriggers").
...
func (c *sqlTriggers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *sqlTriggers) Create(ctx context.Context, sqlTrigger *v1alpha1.SqlTrigger, opts v1.CreateOptions) (result *v1alpha1.SqlTrigger, err error) {
	result = &v1alpha1.SqlTrigger{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("sqltriggers").
...
func (c *sqlTriggers) Update(ctx context.Context, sqlTrigger *v1alpha1.SqlTrigger, opts v1.UpdateOptions) (result *v1alpha1.SqlTrigger, err error) {
	result = &v1alpha1.SqlTrigger{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sqltriggers").
...
func (c *sqlTriggers) UpdateStatus(ctx context.Context, sqlTrigger *v1alpha1.SqlTrigger, opts v1.UpdateOptions) (result *v1alpha1.SqlTrigger, err error) {
	result = &v1alpha1.SqlTrigger{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sqltriggers").
...
func (c *sqlTriggers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *sqlTriggers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *sqlTriggers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SqlTrigger, err error) {
	result = &v1alpha1.SqlTrigger{}
