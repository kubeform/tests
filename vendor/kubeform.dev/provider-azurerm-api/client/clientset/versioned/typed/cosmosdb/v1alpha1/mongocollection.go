...
// MongoCollectionsGetter has a method to return a MongoCollectionInterface.
...
// mongoCollections implements MongoCollectionInterface
type mongoCollections struct {
	client rest.Interface
	ns     string
}

// newMongoCollections returns a MongoCollections
func newMongoCollections(c *CosmosdbV1alpha1Client, namespace string) *mongoCollections {
...
func (c *mongoCollections) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MongoCollection, err error) {
	result = &v1alpha1.MongoCollection{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *mongoCollections) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MongoCollectionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.MongoCollectionList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("mongocollections").
...
func (c *mongoCollections) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *mongoCollections) Create(ctx context.Context, mongoCollection *v1alpha1.MongoCollection, opts v1.CreateOptions) (result *v1alpha1.MongoCollection, err error) {
	result = &v1alpha1.MongoCollection{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("mongocollections").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(mongoCollection).
		Do(ctx).
		Into(result)
	return
}
...
func (c *mongoCollections) Update(ctx context.Context, mongoCollection *v1alpha1.MongoCollection, opts v1.UpdateOptions) (result *v1alpha1.MongoCollection, err error) {
	result = &v1alpha1.MongoCollection{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mongocollections").
...
func (c *mongoCollections) UpdateStatus(ctx context.Context, mongoCollection *v1alpha1.MongoCollection, opts v1.UpdateOptions) (result *v1alpha1.MongoCollection, err error) {
	result = &v1alpha1.MongoCollection{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mongocollections").
...
func (c *mongoCollections) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *mongoCollections) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *mongoCollections) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MongoCollection, err error) {
	result = &v1alpha1.MongoCollection{}
