...
type CosmosdbV1alpha1Interface interface {
	...
	MongoDatabasesGetter
	NotebookWorkspacesGetter
	SqlContainersGetter
	SqlDatabasesGetter
	SqlFunctionsGetter
	SqlStoredProceduresGetter
	SqlTriggersGetter
	TablesGetter
}
...
func NewForConfig(c *rest.Config) (*CosmosdbV1alpha1Client, error) {
	...
	return &CosmosdbV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new CosmosdbV1alpha1Client for the given config and
...
func New(c rest.Interface) *CosmosdbV1alpha1Client {
	return &CosmosdbV1alpha1Client{c}
}
