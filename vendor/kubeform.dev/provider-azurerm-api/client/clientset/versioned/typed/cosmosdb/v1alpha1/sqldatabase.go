...
func newSqlDatabases(c *CosmosdbV1alpha1Client, namespace string) *sqlDatabases {
	return &sqlDatabases{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *sqlDatabases) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SqlDatabase, err error) {
...
func (c *sqlDatabases) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SqlDatabaseList, err error) {
...
func (c *sqlDatabases) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *sqlDatabases) Create(ctx context.Context, sqlDatabase *v1alpha1.SqlDatabase, opts v1.CreateOptions) (result *v1alpha1.SqlDatabase, err error) {
	result = &v1alpha1.SqlDatabase{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("sqldatabases").
...
func (c *sqlDatabases) Update(ctx context.Context, sqlDatabase *v1alpha1.SqlDatabase, opts v1.UpdateOptions) (result *v1alpha1.SqlDatabase, err error) {
	result = &v1alpha1.SqlDatabase{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sqldatabases").
...
func (c *sqlDatabases) UpdateStatus(ctx context.Context, sqlDatabase *v1alpha1.SqlDatabase, opts v1.UpdateOptions) (result *v1alpha1.SqlDatabase, err error) {
	result = &v1alpha1.SqlDatabase{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sqldatabases").
...
func (c *sqlDatabases) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *sqlDatabases) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *sqlDatabases) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SqlDatabase, err error) {
	result = &v1alpha1.SqlDatabase{}
