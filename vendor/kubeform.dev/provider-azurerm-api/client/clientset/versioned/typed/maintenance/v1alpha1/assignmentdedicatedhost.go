...
// AssignmentDedicatedHostsGetter has a method to return a AssignmentDedicatedHostInterface.
...
// assignmentDedicatedHosts implements AssignmentDedicatedHostInterface
type assignmentDedicatedHosts struct {
	client rest.Interface
	ns     string
}

// newAssignmentDedicatedHosts returns a AssignmentDedicatedHosts
func newAssignmentDedicatedHosts(c *MaintenanceV1alpha1Client, namespace string) *assignmentDedicatedHosts {
	return &assignmentDedicatedHosts{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *assignmentDedicatedHosts) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AssignmentDedicatedHost, err error) {
	result = &v1alpha1.AssignmentDedicatedHost{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *assignmentDedicatedHosts) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AssignmentDedicatedHostList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.AssignmentDedicatedHostList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("assignmentdedicatedhosts").
...
func (c *assignmentDedicatedHosts) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *assignmentDedicatedHosts) Create(ctx context.Context, assignmentDedicatedHost *v1alpha1.AssignmentDedicatedHost, opts v1.CreateOptions) (result *v1alpha1.AssignmentDedicatedHost, err error) {
	result = &v1alpha1.AssignmentDedicatedHost{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("assignmentdedicatedhosts").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(assignmentDedicatedHost).
		Do(ctx).
		Into(result)
	return
}
...
func (c *assignmentDedicatedHosts) Update(ctx context.Context, assignmentDedicatedHost *v1alpha1.AssignmentDedicatedHost, opts v1.UpdateOptions) (result *v1alpha1.AssignmentDedicatedHost, err error) {
	result = &v1alpha1.AssignmentDedicatedHost{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("assignmentdedicatedhosts").
		Name(assignmentDedicatedHost.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(assignmentDedicatedHost).
		Do(ctx).
		Into(result)
...
func (c *assignmentDedicatedHosts) UpdateStatus(ctx context.Context, assignmentDedicatedHost *v1alpha1.AssignmentDedicatedHost, opts v1.UpdateOptions) (result *v1alpha1.AssignmentDedicatedHost, err error) {
	result = &v1alpha1.AssignmentDedicatedHost{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("assignmentdedicatedhosts").
...
func (c *assignmentDedicatedHosts) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *assignmentDedicatedHosts) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *assignmentDedicatedHosts) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AssignmentDedicatedHost, err error) {
	result = &v1alpha1.AssignmentDedicatedHost{}
