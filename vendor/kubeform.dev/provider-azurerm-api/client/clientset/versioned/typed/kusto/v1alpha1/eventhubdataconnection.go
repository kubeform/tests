...
// EventhubDataConnectionsGetter has a method to return a EventhubDataConnectionInterface.
...
// eventhubDataConnections implements EventhubDataConnectionInterface
type eventhubDataConnections struct {
	client rest.Interface
	ns     string
}

// newEventhubDataConnections returns a EventhubDataConnections
func newEventhubDataConnections(c *KustoV1alpha1Client, namespace string) *eventhubDataConnections {
	return &eventhubDataConnections{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *eventhubDataConnections) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.EventhubDataConnection, err error) {
	result = &v1alpha1.EventhubDataConnection{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *eventhubDataConnections) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EventhubDataConnectionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.EventhubDataConnectionList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("eventhubdataconnections").
...
func (c *eventhubDataConnections) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *eventhubDataConnections) Create(ctx context.Context, eventhubDataConnection *v1alpha1.EventhubDataConnection, opts v1.CreateOptions) (result *v1alpha1.EventhubDataConnection, err error) {
	result = &v1alpha1.EventhubDataConnection{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("eventhubdataconnections").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(eventhubDataConnection).
		Do(ctx).
		Into(result)
	return
}
...
func (c *eventhubDataConnections) Update(ctx context.Context, eventhubDataConnection *v1alpha1.EventhubDataConnection, opts v1.UpdateOptions) (result *v1alpha1.EventhubDataConnection, err error) {
	result = &v1alpha1.EventhubDataConnection{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("eventhubdataconnections").
		Name(eventhubDataConnection.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(eventhubDataConnection).
		Do(ctx).
		Into(result)
...
func (c *eventhubDataConnections) UpdateStatus(ctx context.Context, eventhubDataConnection *v1alpha1.EventhubDataConnection, opts v1.UpdateOptions) (result *v1alpha1.EventhubDataConnection, err error) {
	result = &v1alpha1.EventhubDataConnection{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("eventhubdataconnections").
...
func (c *eventhubDataConnections) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *eventhubDataConnections) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *eventhubDataConnections) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.EventhubDataConnection, err error) {
	result = &v1alpha1.EventhubDataConnection{}
