...
// ClusterPrincipalAssignmentsGetter has a method to return a ClusterPrincipalAssignmentInterface.
...
// clusterPrincipalAssignments implements ClusterPrincipalAssignmentInterface
type clusterPrincipalAssignments struct {
	client rest.Interface
	ns     string
}

// newClusterPrincipalAssignments returns a ClusterPrincipalAssignments
func newClusterPrincipalAssignments(c *KustoV1alpha1Client, namespace string) *clusterPrincipalAssignments {
...
func (c *clusterPrincipalAssignments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ClusterPrincipalAssignment, err error) {
	result = &v1alpha1.ClusterPrincipalAssignment{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *clusterPrincipalAssignments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ClusterPrincipalAssignmentList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ClusterPrincipalAssignmentList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("clusterprincipalassignments").
...
func (c *clusterPrincipalAssignments) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *clusterPrincipalAssignments) Create(ctx context.Context, clusterPrincipalAssignment *v1alpha1.ClusterPrincipalAssignment, opts v1.CreateOptions) (result *v1alpha1.ClusterPrincipalAssignment, err error) {
	result = &v1alpha1.ClusterPrincipalAssignment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("clusterprincipalassignments").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(clusterPrincipalAssignment).
		Do(ctx).
		Into(result)
	return
}
...
func (c *clusterPrincipalAssignments) Update(ctx context.Context, clusterPrincipalAssignment *v1alpha1.ClusterPrincipalAssignment, opts v1.UpdateOptions) (result *v1alpha1.ClusterPrincipalAssignment, err error) {
	result = &v1alpha1.ClusterPrincipalAssignment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("clusterprincipalassignments").
		Name(clusterPrincipalAssignment.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(clusterPrincipalAssignment).
		Do(ctx).
		Into(result)
...
func (c *clusterPrincipalAssignments) UpdateStatus(ctx context.Context, clusterPrincipalAssignment *v1alpha1.ClusterPrincipalAssignment, opts v1.UpdateOptions) (result *v1alpha1.ClusterPrincipalAssignment, err error) {
	result = &v1alpha1.ClusterPrincipalAssignment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("clusterprincipalassignments").
...
func (c *clusterPrincipalAssignments) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *clusterPrincipalAssignments) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *clusterPrincipalAssignments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ClusterPrincipalAssignment, err error) {
	result = &v1alpha1.ClusterPrincipalAssignment{}
