...
type KustoV1alpha1Interface interface {
	RESTClient() rest.Interface
	AttachedDatabaseConfigurationsGetter
	ClustersGetter
	ClusterCustomerManagedKeysGetter
	ClusterPrincipalAssignmentsGetter
	DatabasesGetter
	DatabasePrincipalsGetter
	DatabasePrincipalAssignmentsGetter
...
func (c *KustoV1alpha1Client) AttachedDatabaseConfigurations(namespace string) AttachedDatabaseConfigurationInterface {
	return newAttachedDatabaseConfigurations(c, namespace)
}
...
func (c *KustoV1alpha1Client) ClusterPrincipalAssignments(namespace string) ClusterPrincipalAssignmentInterface {
	return newClusterPrincipalAssignments(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*KustoV1alpha1Client, error) {
	...
	return &KustoV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new KustoV1alpha1Client for the given config and
...
func New(c rest.Interface) *KustoV1alpha1Client {
	return &KustoV1alpha1Client{c}
}
