...
// DatabasePrincipalsGetter has a method to return a DatabasePrincipalInterface.
...
// databasePrincipals implements DatabasePrincipalInterface
type databasePrincipals struct {
	client rest.Interface
	ns     string
}

// newDatabasePrincipals returns a DatabasePrincipals
func newDatabasePrincipals(c *KustoV1alpha1Client, namespace string) *databasePrincipals {
...
func (c *databasePrincipals) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DatabasePrincipal, err error) {
	result = &v1alpha1.DatabasePrincipal{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *databasePrincipals) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DatabasePrincipalList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.DatabasePrincipalList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("databaseprincipals").
...
func (c *databasePrincipals) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *databasePrincipals) Create(ctx context.Context, databasePrincipal *v1alpha1.DatabasePrincipal, opts v1.CreateOptions) (result *v1alpha1.DatabasePrincipal, err error) {
	result = &v1alpha1.DatabasePrincipal{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("databaseprincipals").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(databasePrincipal).
		Do(ctx).
		Into(result)
	return
}
...
func (c *databasePrincipals) Update(ctx context.Context, databasePrincipal *v1alpha1.DatabasePrincipal, opts v1.UpdateOptions) (result *v1alpha1.DatabasePrincipal, err error) {
	result = &v1alpha1.DatabasePrincipal{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("databaseprincipals").
		Name(databasePrincipal.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(databasePrincipal).
		Do(ctx).
		Into(result)
...
func (c *databasePrincipals) UpdateStatus(ctx context.Context, databasePrincipal *v1alpha1.DatabasePrincipal, opts v1.UpdateOptions) (result *v1alpha1.DatabasePrincipal, err error) {
	result = &v1alpha1.DatabasePrincipal{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("databaseprincipals").
...
func (c *databasePrincipals) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *databasePrincipals) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *databasePrincipals) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DatabasePrincipal, err error) {
	result = &v1alpha1.DatabasePrincipal{}
