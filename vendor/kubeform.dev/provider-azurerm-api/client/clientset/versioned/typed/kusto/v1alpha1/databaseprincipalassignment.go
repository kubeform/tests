...
// DatabasePrincipalAssignmentsGetter has a method to return a DatabasePrincipalAssignmentInterface.
...
// databasePrincipalAssignments implements DatabasePrincipalAssignmentInterface
type databasePrincipalAssignments struct {
	client rest.Interface
	ns     string
}

// newDatabasePrincipalAssignments returns a DatabasePrincipalAssignments
func newDatabasePrincipalAssignments(c *KustoV1alpha1Client, namespace string) *databasePrincipalAssignments {
...
func (c *databasePrincipalAssignments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DatabasePrincipalAssignment, err error) {
	result = &v1alpha1.DatabasePrincipalAssignment{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *databasePrincipalAssignments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DatabasePrincipalAssignmentList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.DatabasePrincipalAssignmentList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("databaseprincipalassignments").
...
func (c *databasePrincipalAssignments) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *databasePrincipalAssignments) Create(ctx context.Context, databasePrincipalAssignment *v1alpha1.DatabasePrincipalAssignment, opts v1.CreateOptions) (result *v1alpha1.DatabasePrincipalAssignment, err error) {
	result = &v1alpha1.DatabasePrincipalAssignment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("databaseprincipalassignments").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(databasePrincipalAssignment).
		Do(ctx).
		Into(result)
	return
}
...
func (c *databasePrincipalAssignments) Update(ctx context.Context, databasePrincipalAssignment *v1alpha1.DatabasePrincipalAssignment, opts v1.UpdateOptions) (result *v1alpha1.DatabasePrincipalAssignment, err error) {
	result = &v1alpha1.DatabasePrincipalAssignment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("databaseprincipalassignments").
		Name(databasePrincipalAssignment.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(databasePrincipalAssignment).
		Do(ctx).
		Into(result)
...
func (c *databasePrincipalAssignments) UpdateStatus(ctx context.Context, databasePrincipalAssignment *v1alpha1.DatabasePrincipalAssignment, opts v1.UpdateOptions) (result *v1alpha1.DatabasePrincipalAssignment, err error) {
	result = &v1alpha1.DatabasePrincipalAssignment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("databaseprincipalassignments").
...
func (c *databasePrincipalAssignments) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *databasePrincipalAssignments) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *databasePrincipalAssignments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DatabasePrincipalAssignment, err error) {
	result = &v1alpha1.DatabasePrincipalAssignment{}
