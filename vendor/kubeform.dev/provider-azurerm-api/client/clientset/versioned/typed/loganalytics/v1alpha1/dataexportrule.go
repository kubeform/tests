...
// DataExportRulesGetter has a method to return a DataExportRuleInterface.
...
// dataExportRules implements DataExportRuleInterface
type dataExportRules struct {
	client rest.Interface
	ns     string
}

// newDataExportRules returns a DataExportRules
func newDataExportRules(c *LoganalyticsV1alpha1Client, namespace string) *dataExportRules {
	return &dataExportRules{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *dataExportRules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DataExportRule, err error) {
	result = &v1alpha1.DataExportRule{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *dataExportRules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DataExportRuleList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.DataExportRuleList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("dataexportrules").
...
func (c *dataExportRules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dataExportRules) Create(ctx context.Context, dataExportRule *v1alpha1.DataExportRule, opts v1.CreateOptions) (result *v1alpha1.DataExportRule, err error) {
	result = &v1alpha1.DataExportRule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("dataexportrules").
...
func (c *dataExportRules) Update(ctx context.Context, dataExportRule *v1alpha1.DataExportRule, opts v1.UpdateOptions) (result *v1alpha1.DataExportRule, err error) {
	result = &v1alpha1.DataExportRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dataexportrules").
		Name(dataExportRule.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(dataExportRule).
		Do(ctx).
		Into(result)
...
func (c *dataExportRules) UpdateStatus(ctx context.Context, dataExportRule *v1alpha1.DataExportRule, opts v1.UpdateOptions) (result *v1alpha1.DataExportRule, err error) {
	result = &v1alpha1.DataExportRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dataexportrules").
...
func (c *dataExportRules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *dataExportRules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *dataExportRules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DataExportRule, err error) {
	result = &v1alpha1.DataExportRule{}
