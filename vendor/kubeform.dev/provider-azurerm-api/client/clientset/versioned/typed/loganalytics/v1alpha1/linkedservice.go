...
// LinkedServicesGetter has a method to return a LinkedServiceInterface.
...
// linkedServices implements LinkedServiceInterface
type linkedServices struct {
	client rest.Interface
	ns     string
}

// newLinkedServices returns a LinkedServices
func newLinkedServices(c *LoganalyticsV1alpha1Client, namespace string) *linkedServices {
...
func (c *linkedServices) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LinkedService, err error) {
	result = &v1alpha1.LinkedService{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *linkedServices) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LinkedServiceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.LinkedServiceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("linkedservices").
...
func (c *linkedServices) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *linkedServices) Create(ctx context.Context, linkedService *v1alpha1.LinkedService, opts v1.CreateOptions) (result *v1alpha1.LinkedService, err error) {
	result = &v1alpha1.LinkedService{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("linkedservices").
...
func (c *linkedServices) Update(ctx context.Context, linkedService *v1alpha1.LinkedService, opts v1.UpdateOptions) (result *v1alpha1.LinkedService, err error) {
	result = &v1alpha1.LinkedService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("linkedservices").
...
func (c *linkedServices) UpdateStatus(ctx context.Context, linkedService *v1alpha1.LinkedService, opts v1.UpdateOptions) (result *v1alpha1.LinkedService, err error) {
	result = &v1alpha1.LinkedService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("linkedservices").
...
func (c *linkedServices) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *linkedServices) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *linkedServices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LinkedService, err error) {
	result = &v1alpha1.LinkedService{}
