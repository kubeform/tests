...
// SavedSearchesGetter has a method to return a SavedSearchInterface.
...
// savedSearches implements SavedSearchInterface
type savedSearches struct {
	client rest.Interface
	ns     string
}

// newSavedSearches returns a SavedSearches
func newSavedSearches(c *LoganalyticsV1alpha1Client, namespace string) *savedSearches {
...
func (c *savedSearches) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SavedSearch, err error) {
	result = &v1alpha1.SavedSearch{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *savedSearches) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SavedSearchList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.SavedSearchList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("savedsearches").
...
func (c *savedSearches) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *savedSearches) Create(ctx context.Context, savedSearch *v1alpha1.SavedSearch, opts v1.CreateOptions) (result *v1alpha1.SavedSearch, err error) {
	result = &v1alpha1.SavedSearch{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("savedsearches").
...
func (c *savedSearches) Update(ctx context.Context, savedSearch *v1alpha1.SavedSearch, opts v1.UpdateOptions) (result *v1alpha1.SavedSearch, err error) {
	result = &v1alpha1.SavedSearch{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("savedsearches").
...
func (c *savedSearches) UpdateStatus(ctx context.Context, savedSearch *v1alpha1.SavedSearch, opts v1.UpdateOptions) (result *v1alpha1.SavedSearch, err error) {
	result = &v1alpha1.SavedSearch{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("savedsearches").
...
func (c *savedSearches) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *savedSearches) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *savedSearches) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SavedSearch, err error) {
	result = &v1alpha1.SavedSearch{}
