...
// StorageInsightsesGetter has a method to return a StorageInsightsInterface.
...
// storageInsightses implements StorageInsightsInterface
type storageInsightses struct {
	client rest.Interface
	ns     string
}

// newStorageInsightses returns a StorageInsightses
func newStorageInsightses(c *LoganalyticsV1alpha1Client, namespace string) *storageInsightses {
	return &storageInsightses{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *storageInsightses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.StorageInsights, err error) {
	result = &v1alpha1.StorageInsights{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("storageinsightses").
		Name(name).
...
func (c *storageInsightses) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.StorageInsightsList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.StorageInsightsList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("storageinsightses").
...
func (c *storageInsightses) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *storageInsightses) Create(ctx context.Context, storageInsights *v1alpha1.StorageInsights, opts v1.CreateOptions) (result *v1alpha1.StorageInsights, err error) {
	result = &v1alpha1.StorageInsights{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("storageinsightses").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(storageInsights).
		Do(ctx).
		Into(result)
	return
}
...
func (c *storageInsightses) Update(ctx context.Context, storageInsights *v1alpha1.StorageInsights, opts v1.UpdateOptions) (result *v1alpha1.StorageInsights, err error) {
	result = &v1alpha1.StorageInsights{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("storageinsightses").
		Name(storageInsights.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(storageInsights).
		Do(ctx).
		Into(result)
...
func (c *storageInsightses) UpdateStatus(ctx context.Context, storageInsights *v1alpha1.StorageInsights, opts v1.UpdateOptions) (result *v1alpha1.StorageInsights, err error) {
	result = &v1alpha1.StorageInsights{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("storageinsightses").
...
func (c *storageInsightses) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *storageInsightses) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *storageInsightses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.StorageInsights, err error) {
	result = &v1alpha1.StorageInsights{}
