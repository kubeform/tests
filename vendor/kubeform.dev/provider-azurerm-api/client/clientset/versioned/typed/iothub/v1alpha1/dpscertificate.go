...
// DpsCertificatesGetter has a method to return a DpsCertificateInterface.
...
// dpsCertificates implements DpsCertificateInterface
type dpsCertificates struct {
	client rest.Interface
	ns     string
}

// newDpsCertificates returns a DpsCertificates
func newDpsCertificates(c *IothubV1alpha1Client, namespace string) *dpsCertificates {
...
func (c *dpsCertificates) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DpsCertificate, err error) {
	result = &v1alpha1.DpsCertificate{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *dpsCertificates) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DpsCertificateList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.DpsCertificateList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("dpscertificates").
...
func (c *dpsCertificates) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dpsCertificates) Create(ctx context.Context, dpsCertificate *v1alpha1.DpsCertificate, opts v1.CreateOptions) (result *v1alpha1.DpsCertificate, err error) {
	result = &v1alpha1.DpsCertificate{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("dpscertificates").
...
func (c *dpsCertificates) Update(ctx context.Context, dpsCertificate *v1alpha1.DpsCertificate, opts v1.UpdateOptions) (result *v1alpha1.DpsCertificate, err error) {
	result = &v1alpha1.DpsCertificate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dpscertificates").
		Name(dpsCertificate.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(dpsCertificate).
		Do(ctx).
		Into(result)
...
func (c *dpsCertificates) UpdateStatus(ctx context.Context, dpsCertificate *v1alpha1.DpsCertificate, opts v1.UpdateOptions) (result *v1alpha1.DpsCertificate, err error) {
	result = &v1alpha1.DpsCertificate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dpscertificates").
...
func (c *dpsCertificates) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *dpsCertificates) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *dpsCertificates) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DpsCertificate, err error) {
	result = &v1alpha1.DpsCertificate{}
