...
// EndpointServicebusTopicsGetter has a method to return a EndpointServicebusTopicInterface.
...
// endpointServicebusTopics implements EndpointServicebusTopicInterface
type endpointServicebusTopics struct {
	client rest.Interface
	ns     string
}

// newEndpointServicebusTopics returns a EndpointServicebusTopics
func newEndpointServicebusTopics(c *IothubV1alpha1Client, namespace string) *endpointServicebusTopics {
	return &endpointServicebusTopics{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *endpointServicebusTopics) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.EndpointServicebusTopic, err error) {
	result = &v1alpha1.EndpointServicebusTopic{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *endpointServicebusTopics) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EndpointServicebusTopicList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.EndpointServicebusTopicList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("endpointservicebustopics").
...
func (c *endpointServicebusTopics) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *endpointServicebusTopics) Create(ctx context.Context, endpointServicebusTopic *v1alpha1.EndpointServicebusTopic, opts v1.CreateOptions) (result *v1alpha1.EndpointServicebusTopic, err error) {
	result = &v1alpha1.EndpointServicebusTopic{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("endpointservicebustopics").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(endpointServicebusTopic).
		Do(ctx).
		Into(result)
	return
}
...
func (c *endpointServicebusTopics) Update(ctx context.Context, endpointServicebusTopic *v1alpha1.EndpointServicebusTopic, opts v1.UpdateOptions) (result *v1alpha1.EndpointServicebusTopic, err error) {
	result = &v1alpha1.EndpointServicebusTopic{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("endpointservicebustopics").
		Name(endpointServicebusTopic.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(endpointServicebusTopic).
		Do(ctx).
		Into(result)
...
func (c *endpointServicebusTopics) UpdateStatus(ctx context.Context, endpointServicebusTopic *v1alpha1.EndpointServicebusTopic, opts v1.UpdateOptions) (result *v1alpha1.EndpointServicebusTopic, err error) {
	result = &v1alpha1.EndpointServicebusTopic{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("endpointservicebustopics").
...
func (c *endpointServicebusTopics) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *endpointServicebusTopics) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *endpointServicebusTopics) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.EndpointServicebusTopic, err error) {
	result = &v1alpha1.EndpointServicebusTopic{}
