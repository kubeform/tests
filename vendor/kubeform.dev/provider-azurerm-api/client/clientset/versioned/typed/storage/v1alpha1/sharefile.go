...
// ShareFilesGetter has a method to return a ShareFileInterface.
...
// shareFiles implements ShareFileInterface
type shareFiles struct {
	client rest.Interface
	ns     string
}

// newShareFiles returns a ShareFiles
func newShareFiles(c *StorageV1alpha1Client, namespace string) *shareFiles {
	return &shareFiles{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *shareFiles) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ShareFile, err error) {
	result = &v1alpha1.ShareFile{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("sharefiles").
		Name(name).
...
func (c *shareFiles) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ShareFileList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ShareFileList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("sharefiles").
...
func (c *shareFiles) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *shareFiles) Create(ctx context.Context, shareFile *v1alpha1.ShareFile, opts v1.CreateOptions) (result *v1alpha1.ShareFile, err error) {
	result = &v1alpha1.ShareFile{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("sharefiles").
...
func (c *shareFiles) Update(ctx context.Context, shareFile *v1alpha1.ShareFile, opts v1.UpdateOptions) (result *v1alpha1.ShareFile, err error) {
	result = &v1alpha1.ShareFile{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sharefiles").
...
func (c *shareFiles) UpdateStatus(ctx context.Context, shareFile *v1alpha1.ShareFile, opts v1.UpdateOptions) (result *v1alpha1.ShareFile, err error) {
	result = &v1alpha1.ShareFile{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sharefiles").
...
func (c *shareFiles) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *shareFiles) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *shareFiles) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ShareFile, err error) {
	result = &v1alpha1.ShareFile{}
