...
// SyncCloudEndpointsGetter has a method to return a SyncCloudEndpointInterface.
...
// syncCloudEndpoints implements SyncCloudEndpointInterface
type syncCloudEndpoints struct {
	client rest.Interface
	ns     string
}

// newSyncCloudEndpoints returns a SyncCloudEndpoints
func newSyncCloudEndpoints(c *StorageV1alpha1Client, namespace string) *syncCloudEndpoints {
	return &syncCloudEndpoints{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *syncCloudEndpoints) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SyncCloudEndpoint, err error) {
	result = &v1alpha1.SyncCloudEndpoint{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *syncCloudEndpoints) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SyncCloudEndpointList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.SyncCloudEndpointList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("synccloudendpoints").
...
func (c *syncCloudEndpoints) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *syncCloudEndpoints) Create(ctx context.Context, syncCloudEndpoint *v1alpha1.SyncCloudEndpoint, opts v1.CreateOptions) (result *v1alpha1.SyncCloudEndpoint, err error) {
	result = &v1alpha1.SyncCloudEndpoint{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("synccloudendpoints").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(syncCloudEndpoint).
		Do(ctx).
		Into(result)
	return
}
...
func (c *syncCloudEndpoints) Update(ctx context.Context, syncCloudEndpoint *v1alpha1.SyncCloudEndpoint, opts v1.UpdateOptions) (result *v1alpha1.SyncCloudEndpoint, err error) {
	result = &v1alpha1.SyncCloudEndpoint{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("synccloudendpoints").
		Name(syncCloudEndpoint.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(syncCloudEndpoint).
		Do(ctx).
		Into(result)
...
func (c *syncCloudEndpoints) UpdateStatus(ctx context.Context, syncCloudEndpoint *v1alpha1.SyncCloudEndpoint, opts v1.UpdateOptions) (result *v1alpha1.SyncCloudEndpoint, err error) {
	result = &v1alpha1.SyncCloudEndpoint{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("synccloudendpoints").
...
func (c *syncCloudEndpoints) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *syncCloudEndpoints) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *syncCloudEndpoints) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SyncCloudEndpoint, err error) {
	result = &v1alpha1.SyncCloudEndpoint{}
