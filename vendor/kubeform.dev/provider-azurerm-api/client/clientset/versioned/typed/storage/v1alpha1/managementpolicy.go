...
// ManagementPoliciesGetter has a method to return a ManagementPolicyInterface.
...
// managementPolicies implements ManagementPolicyInterface
type managementPolicies struct {
	client rest.Interface
	ns     string
}

// newManagementPolicies returns a ManagementPolicies
func newManagementPolicies(c *StorageV1alpha1Client, namespace string) *managementPolicies {
...
func (c *managementPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ManagementPolicy, err error) {
	result = &v1alpha1.ManagementPolicy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *managementPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ManagementPolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ManagementPolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("managementpolicies").
...
func (c *managementPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *managementPolicies) Create(ctx context.Context, managementPolicy *v1alpha1.ManagementPolicy, opts v1.CreateOptions) (result *v1alpha1.ManagementPolicy, err error) {
	result = &v1alpha1.ManagementPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("managementpolicies").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(managementPolicy).
		Do(ctx).
		Into(result)
	return
}
...
func (c *managementPolicies) Update(ctx context.Context, managementPolicy *v1alpha1.ManagementPolicy, opts v1.UpdateOptions) (result *v1alpha1.ManagementPolicy, err error) {
	result = &v1alpha1.ManagementPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("managementpolicies").
		Name(managementPolicy.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(managementPolicy).
		Do(ctx).
		Into(result)
...
func (c *managementPolicies) UpdateStatus(ctx context.Context, managementPolicy *v1alpha1.ManagementPolicy, opts v1.UpdateOptions) (result *v1alpha1.ManagementPolicy, err error) {
	result = &v1alpha1.ManagementPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("managementpolicies").
...
func (c *managementPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *managementPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *managementPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ManagementPolicy, err error) {
	result = &v1alpha1.ManagementPolicy{}
