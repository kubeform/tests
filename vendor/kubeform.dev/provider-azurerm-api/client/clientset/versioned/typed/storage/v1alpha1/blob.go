...
func newBlobs(c *StorageV1alpha1Client, namespace string) *blobs {
	return &blobs{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *blobs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Blob, err error) {
	result = &v1alpha1.Blob{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("blobs").
		Name(name).
...
func (c *blobs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.BlobList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.BlobList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("blobs").
...
func (c *blobs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *blobs) Create(ctx context.Context, blob *v1alpha1.Blob, opts v1.CreateOptions) (result *v1alpha1.Blob, err error) {
	result = &v1alpha1.Blob{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("blobs").
...
func (c *blobs) Update(ctx context.Context, blob *v1alpha1.Blob, opts v1.UpdateOptions) (result *v1alpha1.Blob, err error) {
	result = &v1alpha1.Blob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("blobs").
...
func (c *blobs) UpdateStatus(ctx context.Context, blob *v1alpha1.Blob, opts v1.UpdateOptions) (result *v1alpha1.Blob, err error) {
	result = &v1alpha1.Blob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("blobs").
...
func (c *blobs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *blobs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *blobs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Blob, err error) {
	result = &v1alpha1.Blob{}
