...
// TableEntitiesGetter has a method to return a TableEntityInterface.
...
// tableEntities implements TableEntityInterface
type tableEntities struct {
	client rest.Interface
	ns     string
}

// newTableEntities returns a TableEntities
func newTableEntities(c *StorageV1alpha1Client, namespace string) *tableEntities {
...
func (c *tableEntities) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TableEntity, err error) {
	result = &v1alpha1.TableEntity{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *tableEntities) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TableEntityList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.TableEntityList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("tableentities").
...
func (c *tableEntities) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *tableEntities) Create(ctx context.Context, tableEntity *v1alpha1.TableEntity, opts v1.CreateOptions) (result *v1alpha1.TableEntity, err error) {
	result = &v1alpha1.TableEntity{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("tableentities").
...
func (c *tableEntities) Update(ctx context.Context, tableEntity *v1alpha1.TableEntity, opts v1.UpdateOptions) (result *v1alpha1.TableEntity, err error) {
	result = &v1alpha1.TableEntity{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tableentities").
...
func (c *tableEntities) UpdateStatus(ctx context.Context, tableEntity *v1alpha1.TableEntity, opts v1.UpdateOptions) (result *v1alpha1.TableEntity, err error) {
	result = &v1alpha1.TableEntity{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tableentities").
...
func (c *tableEntities) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *tableEntities) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *tableEntities) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TableEntity, err error) {
	result = &v1alpha1.TableEntity{}
