...
// ShareDirectoriesGetter has a method to return a ShareDirectoryInterface.
...
// shareDirectories implements ShareDirectoryInterface
type shareDirectories struct {
	client rest.Interface
	ns     string
}

// newShareDirectories returns a ShareDirectories
func newShareDirectories(c *StorageV1alpha1Client, namespace string) *shareDirectories {
	return &shareDirectories{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *shareDirectories) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ShareDirectory, err error) {
	result = &v1alpha1.ShareDirectory{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *shareDirectories) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ShareDirectoryList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ShareDirectoryList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("sharedirectories").
...
func (c *shareDirectories) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *shareDirectories) Create(ctx context.Context, shareDirectory *v1alpha1.ShareDirectory, opts v1.CreateOptions) (result *v1alpha1.ShareDirectory, err error) {
	result = &v1alpha1.ShareDirectory{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("sharedirectories").
...
func (c *shareDirectories) Update(ctx context.Context, shareDirectory *v1alpha1.ShareDirectory, opts v1.UpdateOptions) (result *v1alpha1.ShareDirectory, err error) {
	result = &v1alpha1.ShareDirectory{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sharedirectories").
		Name(shareDirectory.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(shareDirectory).
		Do(ctx).
		Into(result)
...
func (c *shareDirectories) UpdateStatus(ctx context.Context, shareDirectory *v1alpha1.ShareDirectory, opts v1.UpdateOptions) (result *v1alpha1.ShareDirectory, err error) {
	result = &v1alpha1.ShareDirectory{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sharedirectories").
...
func (c *shareDirectories) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *shareDirectories) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *shareDirectories) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ShareDirectory, err error) {
	result = &v1alpha1.ShareDirectory{}
