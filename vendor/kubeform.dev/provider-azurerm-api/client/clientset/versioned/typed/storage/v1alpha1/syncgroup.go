...
// SyncGroupsGetter has a method to return a SyncGroupInterface.
...
// syncGroups implements SyncGroupInterface
type syncGroups struct {
	client rest.Interface
	ns     string
}

// newSyncGroups returns a SyncGroups
func newSyncGroups(c *StorageV1alpha1Client, namespace string) *syncGroups {
	return &syncGroups{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *syncGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SyncGroup, err error) {
	result = &v1alpha1.SyncGroup{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("syncgroups").
		Name(name).
...
func (c *syncGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SyncGroupList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.SyncGroupList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("syncgroups").
...
func (c *syncGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *syncGroups) Create(ctx context.Context, syncGroup *v1alpha1.SyncGroup, opts v1.CreateOptions) (result *v1alpha1.SyncGroup, err error) {
	result = &v1alpha1.SyncGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("syncgroups").
...
func (c *syncGroups) Update(ctx context.Context, syncGroup *v1alpha1.SyncGroup, opts v1.UpdateOptions) (result *v1alpha1.SyncGroup, err error) {
	result = &v1alpha1.SyncGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("syncgroups").
...
func (c *syncGroups) UpdateStatus(ctx context.Context, syncGroup *v1alpha1.SyncGroup, opts v1.UpdateOptions) (result *v1alpha1.SyncGroup, err error) {
	result = &v1alpha1.SyncGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("syncgroups").
...
func (c *syncGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *syncGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *syncGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SyncGroup, err error) {
	result = &v1alpha1.SyncGroup{}
