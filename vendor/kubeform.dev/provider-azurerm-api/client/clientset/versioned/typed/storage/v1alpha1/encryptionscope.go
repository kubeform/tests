...
// EncryptionScopesGetter has a method to return a EncryptionScopeInterface.
...
// encryptionScopes implements EncryptionScopeInterface
type encryptionScopes struct {
	client rest.Interface
	ns     string
}

// newEncryptionScopes returns a EncryptionScopes
func newEncryptionScopes(c *StorageV1alpha1Client, namespace string) *encryptionScopes {
...
func (c *encryptionScopes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.EncryptionScope, err error) {
	result = &v1alpha1.EncryptionScope{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *encryptionScopes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EncryptionScopeList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.EncryptionScopeList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("encryptionscopes").
...
func (c *encryptionScopes) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *encryptionScopes) Create(ctx context.Context, encryptionScope *v1alpha1.EncryptionScope, opts v1.CreateOptions) (result *v1alpha1.EncryptionScope, err error) {
	result = &v1alpha1.EncryptionScope{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("encryptionscopes").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(encryptionScope).
		Do(ctx).
		Into(result)
	return
}
...
func (c *encryptionScopes) Update(ctx context.Context, encryptionScope *v1alpha1.EncryptionScope, opts v1.UpdateOptions) (result *v1alpha1.EncryptionScope, err error) {
	result = &v1alpha1.EncryptionScope{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("encryptionscopes").
		Name(encryptionScope.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(encryptionScope).
		Do(ctx).
		Into(result)
...
func (c *encryptionScopes) UpdateStatus(ctx context.Context, encryptionScope *v1alpha1.EncryptionScope, opts v1.UpdateOptions) (result *v1alpha1.EncryptionScope, err error) {
	result = &v1alpha1.EncryptionScope{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("encryptionscopes").
...
func (c *encryptionScopes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *encryptionScopes) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *encryptionScopes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.EncryptionScope, err error) {
	result = &v1alpha1.EncryptionScope{}
