...
// AccountCustomerManagedKeysGetter has a method to return a AccountCustomerManagedKeyInterface.
...
// accountCustomerManagedKeys implements AccountCustomerManagedKeyInterface
type accountCustomerManagedKeys struct {
	client rest.Interface
	ns     string
}

// newAccountCustomerManagedKeys returns a AccountCustomerManagedKeys
func newAccountCustomerManagedKeys(c *StorageV1alpha1Client, namespace string) *accountCustomerManagedKeys {
	return &accountCustomerManagedKeys{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *accountCustomerManagedKeys) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AccountCustomerManagedKey, err error) {
	result = &v1alpha1.AccountCustomerManagedKey{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *accountCustomerManagedKeys) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AccountCustomerManagedKeyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.AccountCustomerManagedKeyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("accountcustomermanagedkeys").
...
func (c *accountCustomerManagedKeys) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *accountCustomerManagedKeys) Create(ctx context.Context, accountCustomerManagedKey *v1alpha1.AccountCustomerManagedKey, opts v1.CreateOptions) (result *v1alpha1.AccountCustomerManagedKey, err error) {
	result = &v1alpha1.AccountCustomerManagedKey{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("accountcustomermanagedkeys").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(accountCustomerManagedKey).
		Do(ctx).
		Into(result)
	return
}
...
func (c *accountCustomerManagedKeys) Update(ctx context.Context, accountCustomerManagedKey *v1alpha1.AccountCustomerManagedKey, opts v1.UpdateOptions) (result *v1alpha1.AccountCustomerManagedKey, err error) {
	result = &v1alpha1.AccountCustomerManagedKey{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("accountcustomermanagedkeys").
		Name(accountCustomerManagedKey.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(accountCustomerManagedKey).
		Do(ctx).
		Into(result)
...
func (c *accountCustomerManagedKeys) UpdateStatus(ctx context.Context, accountCustomerManagedKey *v1alpha1.AccountCustomerManagedKey, opts v1.UpdateOptions) (result *v1alpha1.AccountCustomerManagedKey, err error) {
	result = &v1alpha1.AccountCustomerManagedKey{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("accountcustomermanagedkeys").
...
func (c *accountCustomerManagedKeys) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *accountCustomerManagedKeys) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *accountCustomerManagedKeys) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AccountCustomerManagedKey, err error) {
	result = &v1alpha1.AccountCustomerManagedKey{}
