...
import (
	v1alpha1 "kubeform.dev/provider-azurerm-api/apis/healthcare/v1alpha1"
...
// HealthcareV1alpha1Client is used to interact with features provided by the healthcare.azurerm.kubeform.com group.
type HealthcareV1alpha1Client struct {
	restClient rest.Interface
}

func (c *HealthcareV1alpha1Client) Services(namespace string) ServiceInterface {
