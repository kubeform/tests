...
// SubscriptionRulesGetter has a method to return a SubscriptionRuleInterface.
...
// subscriptionRules implements SubscriptionRuleInterface
type subscriptionRules struct {
	client rest.Interface
	ns     string
}

// newSubscriptionRules returns a SubscriptionRules
func newSubscriptionRules(c *ServicebusV1alpha1Client, namespace string) *subscriptionRules {
...
func (c *subscriptionRules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SubscriptionRule, err error) {
	result = &v1alpha1.SubscriptionRule{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *subscriptionRules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SubscriptionRuleList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.SubscriptionRuleList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("subscriptionrules").
...
func (c *subscriptionRules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *subscriptionRules) Create(ctx context.Context, subscriptionRule *v1alpha1.SubscriptionRule, opts v1.CreateOptions) (result *v1alpha1.SubscriptionRule, err error) {
	result = &v1alpha1.SubscriptionRule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("subscriptionrules").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(subscriptionRule).
		Do(ctx).
		Into(result)
	return
}
...
func (c *subscriptionRules) Update(ctx context.Context, subscriptionRule *v1alpha1.SubscriptionRule, opts v1.UpdateOptions) (result *v1alpha1.SubscriptionRule, err error) {
	result = &v1alpha1.SubscriptionRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("subscriptionrules").
		Name(subscriptionRule.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(subscriptionRule).
		Do(ctx).
		Into(result)
...
func (c *subscriptionRules) UpdateStatus(ctx context.Context, subscriptionRule *v1alpha1.SubscriptionRule, opts v1.UpdateOptions) (result *v1alpha1.SubscriptionRule, err error) {
	result = &v1alpha1.SubscriptionRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("subscriptionrules").
...
func (c *subscriptionRules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *subscriptionRules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *subscriptionRules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SubscriptionRule, err error) {
	result = &v1alpha1.SubscriptionRule{}
