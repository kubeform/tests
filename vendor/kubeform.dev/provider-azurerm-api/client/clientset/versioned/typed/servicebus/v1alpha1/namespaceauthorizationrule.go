...
// NamespaceAuthorizationRulesGetter has a method to return a NamespaceAuthorizationRuleInterface.
...
// namespaceAuthorizationRules implements NamespaceAuthorizationRuleInterface
type namespaceAuthorizationRules struct {
	client rest.Interface
	ns     string
}

// newNamespaceAuthorizationRules returns a NamespaceAuthorizationRules
func newNamespaceAuthorizationRules(c *ServicebusV1alpha1Client, namespace string) *namespaceAuthorizationRules {
	return &namespaceAuthorizationRules{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *namespaceAuthorizationRules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.NamespaceAuthorizationRule, err error) {
	result = &v1alpha1.NamespaceAuthorizationRule{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *namespaceAuthorizationRules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.NamespaceAuthorizationRuleList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.NamespaceAuthorizationRuleList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("namespaceauthorizationrules").
...
func (c *namespaceAuthorizationRules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *namespaceAuthorizationRules) Create(ctx context.Context, namespaceAuthorizationRule *v1alpha1.NamespaceAuthorizationRule, opts v1.CreateOptions) (result *v1alpha1.NamespaceAuthorizationRule, err error) {
	result = &v1alpha1.NamespaceAuthorizationRule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("namespaceauthorizationrules").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(namespaceAuthorizationRule).
		Do(ctx).
		Into(result)
	return
}
...
func (c *namespaceAuthorizationRules) Update(ctx context.Context, namespaceAuthorizationRule *v1alpha1.NamespaceAuthorizationRule, opts v1.UpdateOptions) (result *v1alpha1.NamespaceAuthorizationRule, err error) {
	result = &v1alpha1.NamespaceAuthorizationRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("namespaceauthorizationrules").
		Name(namespaceAuthorizationRule.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(namespaceAuthorizationRule).
		Do(ctx).
		Into(result)
...
func (c *namespaceAuthorizationRules) UpdateStatus(ctx context.Context, namespaceAuthorizationRule *v1alpha1.NamespaceAuthorizationRule, opts v1.UpdateOptions) (result *v1alpha1.NamespaceAuthorizationRule, err error) {
	result = &v1alpha1.NamespaceAuthorizationRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("namespaceauthorizationrules").
...
func (c *namespaceAuthorizationRules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *namespaceAuthorizationRules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *namespaceAuthorizationRules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.NamespaceAuthorizationRule, err error) {
	result = &v1alpha1.NamespaceAuthorizationRule{}
