...
// FunctionV1alpha1Client is used to interact with features provided by the function.azurerm.kubeform.com group.
type FunctionV1alpha1Client struct {
	restClient rest.Interface
}

func (c *FunctionV1alpha1Client) Apps(namespace string) AppInterface {
	return newApps(c, namespace)
}

func (c *FunctionV1alpha1Client) AppSlots(namespace string) AppSlotInterface {
	return newAppSlots(c, namespace)
}
