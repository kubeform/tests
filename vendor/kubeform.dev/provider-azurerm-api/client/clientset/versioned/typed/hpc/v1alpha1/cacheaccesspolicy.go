...
// CacheAccessPoliciesGetter has a method to return a CacheAccessPolicyInterface.
...
// cacheAccessPolicies implements CacheAccessPolicyInterface
type cacheAccessPolicies struct {
	client rest.Interface
	ns     string
}

// newCacheAccessPolicies returns a CacheAccessPolicies
func newCacheAccessPolicies(c *HpcV1alpha1Client, namespace string) *cacheAccessPolicies {
	return &cacheAccessPolicies{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *cacheAccessPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CacheAccessPolicy, err error) {
	result = &v1alpha1.CacheAccessPolicy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *cacheAccessPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CacheAccessPolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.CacheAccessPolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("cacheaccesspolicies").
...
func (c *cacheAccessPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cacheAccessPolicies) Create(ctx context.Context, cacheAccessPolicy *v1alpha1.CacheAccessPolicy, opts v1.CreateOptions) (result *v1alpha1.CacheAccessPolicy, err error) {
	result = &v1alpha1.CacheAccessPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cacheaccesspolicies").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(cacheAccessPolicy).
		Do(ctx).
		Into(result)
	return
}
...
func (c *cacheAccessPolicies) Update(ctx context.Context, cacheAccessPolicy *v1alpha1.CacheAccessPolicy, opts v1.UpdateOptions) (result *v1alpha1.CacheAccessPolicy, err error) {
	result = &v1alpha1.CacheAccessPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cacheaccesspolicies").
		Name(cacheAccessPolicy.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(cacheAccessPolicy).
		Do(ctx).
		Into(result)
...
func (c *cacheAccessPolicies) UpdateStatus(ctx context.Context, cacheAccessPolicy *v1alpha1.CacheAccessPolicy, opts v1.UpdateOptions) (result *v1alpha1.CacheAccessPolicy, err error) {
	result = &v1alpha1.CacheAccessPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cacheaccesspolicies").
...
func (c *cacheAccessPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *cacheAccessPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *cacheAccessPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CacheAccessPolicy, err error) {
	result = &v1alpha1.CacheAccessPolicy{}
