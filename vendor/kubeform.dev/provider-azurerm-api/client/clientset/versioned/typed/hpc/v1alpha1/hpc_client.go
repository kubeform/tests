...
type HpcV1alpha1Interface interface {
	RESTClient() rest.Interface
	CachesGetter
	CacheAccessPoliciesGetter
	CacheBlobTargetsGetter
	CacheNfsTargetsGetter
}
...
func NewForConfig(c *rest.Config) (*HpcV1alpha1Client, error) {
	...
	return &HpcV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new HpcV1alpha1Client for the given config and
...
func New(c rest.Interface) *HpcV1alpha1Client {
	return &HpcV1alpha1Client{c}
}
