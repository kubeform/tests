...
// CaaRecordsGetter has a method to return a CaaRecordInterface.
...
// caaRecords implements CaaRecordInterface
type caaRecords struct {
	client rest.Interface
	ns     string
}

// newCaaRecords returns a CaaRecords
func newCaaRecords(c *DnsV1alpha1Client, namespace string) *caaRecords {
	return &caaRecords{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *caaRecords) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CaaRecord, err error) {
	result = &v1alpha1.CaaRecord{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("caarecords").
		Name(name).
...
func (c *caaRecords) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CaaRecordList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.CaaRecordList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("caarecords").
...
func (c *caaRecords) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *caaRecords) Create(ctx context.Context, caaRecord *v1alpha1.CaaRecord, opts v1.CreateOptions) (result *v1alpha1.CaaRecord, err error) {
	result = &v1alpha1.CaaRecord{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("caarecords").
...
func (c *caaRecords) Update(ctx context.Context, caaRecord *v1alpha1.CaaRecord, opts v1.UpdateOptions) (result *v1alpha1.CaaRecord, err error) {
	result = &v1alpha1.CaaRecord{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("caarecords").
...
func (c *caaRecords) UpdateStatus(ctx context.Context, caaRecord *v1alpha1.CaaRecord, opts v1.UpdateOptions) (result *v1alpha1.CaaRecord, err error) {
	result = &v1alpha1.CaaRecord{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("caarecords").
...
func (c *caaRecords) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *caaRecords) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *caaRecords) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CaaRecord, err error) {
	result = &v1alpha1.CaaRecord{}
