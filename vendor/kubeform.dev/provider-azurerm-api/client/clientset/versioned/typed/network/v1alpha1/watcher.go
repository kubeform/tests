...
func newWatchers(c *NetworkV1alpha1Client, namespace string) *watchers {
	return &watchers{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *watchers) UpdateStatus(ctx context.Context, watcher *v1alpha1.Watcher, opts v1.UpdateOptions) (result *v1alpha1.Watcher, err error) {
	result = &v1alpha1.Watcher{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("watchers").
