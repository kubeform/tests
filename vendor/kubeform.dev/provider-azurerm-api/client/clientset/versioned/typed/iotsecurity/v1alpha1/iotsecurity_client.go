...
type IotsecurityV1alpha1Interface interface {
...
func NewForConfig(c *rest.Config) (*IotsecurityV1alpha1Client, error) {
	...
	return &IotsecurityV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new IotsecurityV1alpha1Client for the given config and
...
func New(c rest.Interface) *IotsecurityV1alpha1Client {
	return &IotsecurityV1alpha1Client{c}
}
