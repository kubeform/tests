...
func newFrontdoors(c *FrontdoorV1alpha1Client, namespace string) *frontdoors {
	return &frontdoors{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *frontdoors) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Frontdoor, err error) {
...
func (c *frontdoors) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FrontdoorList, err error) {
...
func (c *frontdoors) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *frontdoors) Create(ctx context.Context, frontdoor *v1alpha1.Frontdoor, opts v1.CreateOptions) (result *v1alpha1.Frontdoor, err error) {
	result = &v1alpha1.Frontdoor{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("frontdoors").
...
func (c *frontdoors) Update(ctx context.Context, frontdoor *v1alpha1.Frontdoor, opts v1.UpdateOptions) (result *v1alpha1.Frontdoor, err error) {
	result = &v1alpha1.Frontdoor{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("frontdoors").
...
func (c *frontdoors) UpdateStatus(ctx context.Context, frontdoor *v1alpha1.Frontdoor, opts v1.UpdateOptions) (result *v1alpha1.Frontdoor, err error) {
	result = &v1alpha1.Frontdoor{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("frontdoors").
...
func (c *frontdoors) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *frontdoors) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *frontdoors) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Frontdoor, err error) {
	result = &v1alpha1.Frontdoor{}
