...
type FrontdoorV1alpha1Interface interface {
...
func (c *FrontdoorV1alpha1Client) CustomHTTPSConfigurations(namespace string) CustomHTTPSConfigurationInterface {
	return newCustomHTTPSConfigurations(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*FrontdoorV1alpha1Client, error) {
	...
	return &FrontdoorV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new FrontdoorV1alpha1Client for the given config and
...
func New(c rest.Interface) *FrontdoorV1alpha1Client {
	return &FrontdoorV1alpha1Client{c}
}
