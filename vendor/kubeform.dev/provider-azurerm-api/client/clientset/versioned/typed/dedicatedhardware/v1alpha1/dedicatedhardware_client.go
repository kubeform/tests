...
type DedicatedhardwareV1alpha1Interface interface {
	RESTClient() rest.Interface
	SecurityModulesGetter
}
...
func (c *DedicatedhardwareV1alpha1Client) SecurityModules(namespace string) SecurityModuleInterface {
	return newSecurityModules(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*DedicatedhardwareV1alpha1Client, error) {
	...
	return &DedicatedhardwareV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new DedicatedhardwareV1alpha1Client for the given config and
...
func New(c rest.Interface) *DedicatedhardwareV1alpha1Client {
	return &DedicatedhardwareV1alpha1Client{c}
}
