...
// FabricMeshSecretValuesGetter has a method to return a FabricMeshSecretValueInterface.
...
// fabricMeshSecretValues implements FabricMeshSecretValueInterface
type fabricMeshSecretValues struct {
	client rest.Interface
	ns     string
}

// newFabricMeshSecretValues returns a FabricMeshSecretValues
func newFabricMeshSecretValues(c *ServiceV1alpha1Client, namespace string) *fabricMeshSecretValues {
	return &fabricMeshSecretValues{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *fabricMeshSecretValues) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.FabricMeshSecretValue, err error) {
	result = &v1alpha1.FabricMeshSecretValue{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *fabricMeshSecretValues) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FabricMeshSecretValueList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.FabricMeshSecretValueList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("fabricmeshsecretvalues").
...
func (c *fabricMeshSecretValues) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *fabricMeshSecretValues) Create(ctx context.Context, fabricMeshSecretValue *v1alpha1.FabricMeshSecretValue, opts v1.CreateOptions) (result *v1alpha1.FabricMeshSecretValue, err error) {
	result = &v1alpha1.FabricMeshSecretValue{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("fabricmeshsecretvalues").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(fabricMeshSecretValue).
		Do(ctx).
		Into(result)
	return
}
...
func (c *fabricMeshSecretValues) Update(ctx context.Context, fabricMeshSecretValue *v1alpha1.FabricMeshSecretValue, opts v1.UpdateOptions) (result *v1alpha1.FabricMeshSecretValue, err error) {
	result = &v1alpha1.FabricMeshSecretValue{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("fabricmeshsecretvalues").
		Name(fabricMeshSecretValue.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(fabricMeshSecretValue).
		Do(ctx).
		Into(result)
...
func (c *fabricMeshSecretValues) UpdateStatus(ctx context.Context, fabricMeshSecretValue *v1alpha1.FabricMeshSecretValue, opts v1.UpdateOptions) (result *v1alpha1.FabricMeshSecretValue, err error) {
	result = &v1alpha1.FabricMeshSecretValue{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("fabricmeshsecretvalues").
...
func (c *fabricMeshSecretValues) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *fabricMeshSecretValues) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *fabricMeshSecretValues) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.FabricMeshSecretValue, err error) {
	result = &v1alpha1.FabricMeshSecretValue{}
