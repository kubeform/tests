...
// FabricMeshApplicationsGetter has a method to return a FabricMeshApplicationInterface.
...
// fabricMeshApplications implements FabricMeshApplicationInterface
type fabricMeshApplications struct {
	client rest.Interface
	ns     string
}

// newFabricMeshApplications returns a FabricMeshApplications
func newFabricMeshApplications(c *ServiceV1alpha1Client, namespace string) *fabricMeshApplications {
	return &fabricMeshApplications{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *fabricMeshApplications) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.FabricMeshApplication, err error) {
	result = &v1alpha1.FabricMeshApplication{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *fabricMeshApplications) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FabricMeshApplicationList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.FabricMeshApplicationList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("fabricmeshapplications").
...
func (c *fabricMeshApplications) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *fabricMeshApplications) Create(ctx context.Context, fabricMeshApplication *v1alpha1.FabricMeshApplication, opts v1.CreateOptions) (result *v1alpha1.FabricMeshApplication, err error) {
	result = &v1alpha1.FabricMeshApplication{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("fabricmeshapplications").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(fabricMeshApplication).
		Do(ctx).
		Into(result)
	return
}
...
func (c *fabricMeshApplications) Update(ctx context.Context, fabricMeshApplication *v1alpha1.FabricMeshApplication, opts v1.UpdateOptions) (result *v1alpha1.FabricMeshApplication, err error) {
	result = &v1alpha1.FabricMeshApplication{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("fabricmeshapplications").
		Name(fabricMeshApplication.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(fabricMeshApplication).
		Do(ctx).
		Into(result)
...
func (c *fabricMeshApplications) UpdateStatus(ctx context.Context, fabricMeshApplication *v1alpha1.FabricMeshApplication, opts v1.UpdateOptions) (result *v1alpha1.FabricMeshApplication, err error) {
	result = &v1alpha1.FabricMeshApplication{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("fabricmeshapplications").
...
func (c *fabricMeshApplications) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *fabricMeshApplications) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *fabricMeshApplications) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.FabricMeshApplication, err error) {
	result = &v1alpha1.FabricMeshApplication{}
