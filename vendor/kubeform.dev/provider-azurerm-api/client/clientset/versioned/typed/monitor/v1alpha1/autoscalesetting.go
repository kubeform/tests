...
func newAutoscaleSettings(c *MonitorV1alpha1Client, namespace string) *autoscaleSettings {
...
func (c *autoscaleSettings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AutoscaleSetting, err error) {
...
func (c *autoscaleSettings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AutoscaleSettingList, err error) {
...
func (c *autoscaleSettings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *autoscaleSettings) Create(ctx context.Context, autoscaleSetting *v1alpha1.AutoscaleSetting, opts v1.CreateOptions) (result *v1alpha1.AutoscaleSetting, err error) {
	result = &v1alpha1.AutoscaleSetting{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("autoscalesettings").
...
func (c *autoscaleSettings) Update(ctx context.Context, autoscaleSetting *v1alpha1.AutoscaleSetting, opts v1.UpdateOptions) (result *v1alpha1.AutoscaleSetting, err error) {
	result = &v1alpha1.AutoscaleSetting{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("autoscalesettings").
...
func (c *autoscaleSettings) UpdateStatus(ctx context.Context, autoscaleSetting *v1alpha1.AutoscaleSetting, opts v1.UpdateOptions) (result *v1alpha1.AutoscaleSetting, err error) {
	result = &v1alpha1.AutoscaleSetting{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("autoscalesettings").
...
func (c *autoscaleSettings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *autoscaleSettings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *autoscaleSettings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AutoscaleSetting, err error) {
	result = &v1alpha1.AutoscaleSetting{}
