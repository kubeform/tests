...
// ActionGroupsGetter has a method to return a ActionGroupInterface.
...
// actionGroups implements ActionGroupInterface
type actionGroups struct {
	client rest.Interface
	ns     string
}

// newActionGroups returns a ActionGroups
func newActionGroups(c *MonitorV1alpha1Client, namespace string) *actionGroups {
	return &actionGroups{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *actionGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ActionGroup, err error) {
	result = &v1alpha1.ActionGroup{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *actionGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ActionGroupList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ActionGroupList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("actiongroups").
...
func (c *actionGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *actionGroups) Create(ctx context.Context, actionGroup *v1alpha1.ActionGroup, opts v1.CreateOptions) (result *v1alpha1.ActionGroup, err error) {
	result = &v1alpha1.ActionGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("actiongroups").
...
func (c *actionGroups) Update(ctx context.Context, actionGroup *v1alpha1.ActionGroup, opts v1.UpdateOptions) (result *v1alpha1.ActionGroup, err error) {
	result = &v1alpha1.ActionGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("actiongroups").
...
func (c *actionGroups) UpdateStatus(ctx context.Context, actionGroup *v1alpha1.ActionGroup, opts v1.UpdateOptions) (result *v1alpha1.ActionGroup, err error) {
	result = &v1alpha1.ActionGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("actiongroups").
...
func (c *actionGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *actionGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *actionGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ActionGroup, err error) {
	result = &v1alpha1.ActionGroup{}
