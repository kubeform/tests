...
// LogProfilesGetter has a method to return a LogProfileInterface.
...
// logProfiles implements LogProfileInterface
type logProfiles struct {
	client rest.Interface
	ns     string
}

// newLogProfiles returns a LogProfiles
func newLogProfiles(c *MonitorV1alpha1Client, namespace string) *logProfiles {
	return &logProfiles{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *logProfiles) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LogProfile, err error) {
	result = &v1alpha1.LogProfile{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *logProfiles) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LogProfileList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.LogProfileList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("logprofiles").
...
func (c *logProfiles) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *logProfiles) Create(ctx context.Context, logProfile *v1alpha1.LogProfile, opts v1.CreateOptions) (result *v1alpha1.LogProfile, err error) {
	result = &v1alpha1.LogProfile{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("logprofiles").
...
func (c *logProfiles) Update(ctx context.Context, logProfile *v1alpha1.LogProfile, opts v1.UpdateOptions) (result *v1alpha1.LogProfile, err error) {
	result = &v1alpha1.LogProfile{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("logprofiles").
...
func (c *logProfiles) UpdateStatus(ctx context.Context, logProfile *v1alpha1.LogProfile, opts v1.UpdateOptions) (result *v1alpha1.LogProfile, err error) {
	result = &v1alpha1.LogProfile{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("logprofiles").
...
func (c *logProfiles) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *logProfiles) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *logProfiles) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LogProfile, err error) {
	result = &v1alpha1.LogProfile{}
