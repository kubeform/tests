...
// ActionRuleSuppressionsGetter has a method to return a ActionRuleSuppressionInterface.
...
// actionRuleSuppressions implements ActionRuleSuppressionInterface
type actionRuleSuppressions struct {
	client rest.Interface
	ns     string
}

// newActionRuleSuppressions returns a ActionRuleSuppressions
func newActionRuleSuppressions(c *MonitorV1alpha1Client, namespace string) *actionRuleSuppressions {
	return &actionRuleSuppressions{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *actionRuleSuppressions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ActionRuleSuppression, err error) {
	result = &v1alpha1.ActionRuleSuppression{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *actionRuleSuppressions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ActionRuleSuppressionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ActionRuleSuppressionList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("actionrulesuppressions").
...
func (c *actionRuleSuppressions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *actionRuleSuppressions) Create(ctx context.Context, actionRuleSuppression *v1alpha1.ActionRuleSuppression, opts v1.CreateOptions) (result *v1alpha1.ActionRuleSuppression, err error) {
	result = &v1alpha1.ActionRuleSuppression{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("actionrulesuppressions").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(actionRuleSuppression).
		Do(ctx).
		Into(result)
	return
}
...
func (c *actionRuleSuppressions) Update(ctx context.Context, actionRuleSuppression *v1alpha1.ActionRuleSuppression, opts v1.UpdateOptions) (result *v1alpha1.ActionRuleSuppression, err error) {
	result = &v1alpha1.ActionRuleSuppression{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("actionrulesuppressions").
		Name(actionRuleSuppression.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(actionRuleSuppression).
		Do(ctx).
		Into(result)
...
func (c *actionRuleSuppressions) UpdateStatus(ctx context.Context, actionRuleSuppression *v1alpha1.ActionRuleSuppression, opts v1.UpdateOptions) (result *v1alpha1.ActionRuleSuppression, err error) {
	result = &v1alpha1.ActionRuleSuppression{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("actionrulesuppressions").
...
func (c *actionRuleSuppressions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *actionRuleSuppressions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *actionRuleSuppressions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ActionRuleSuppression, err error) {
	result = &v1alpha1.ActionRuleSuppression{}
