...
// SmartDetectorAlertRulesGetter has a method to return a SmartDetectorAlertRuleInterface.
...
// smartDetectorAlertRules implements SmartDetectorAlertRuleInterface
type smartDetectorAlertRules struct {
	client rest.Interface
	ns     string
}

// newSmartDetectorAlertRules returns a SmartDetectorAlertRules
func newSmartDetectorAlertRules(c *MonitorV1alpha1Client, namespace string) *smartDetectorAlertRules {
	return &smartDetectorAlertRules{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *smartDetectorAlertRules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SmartDetectorAlertRule, err error) {
	result = &v1alpha1.SmartDetectorAlertRule{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *smartDetectorAlertRules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SmartDetectorAlertRuleList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.SmartDetectorAlertRuleList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("smartdetectoralertrules").
...
func (c *smartDetectorAlertRules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *smartDetectorAlertRules) Create(ctx context.Context, smartDetectorAlertRule *v1alpha1.SmartDetectorAlertRule, opts v1.CreateOptions) (result *v1alpha1.SmartDetectorAlertRule, err error) {
	result = &v1alpha1.SmartDetectorAlertRule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("smartdetectoralertrules").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(smartDetectorAlertRule).
		Do(ctx).
		Into(result)
	return
}
...
func (c *smartDetectorAlertRules) Update(ctx context.Context, smartDetectorAlertRule *v1alpha1.SmartDetectorAlertRule, opts v1.UpdateOptions) (result *v1alpha1.SmartDetectorAlertRule, err error) {
	result = &v1alpha1.SmartDetectorAlertRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("smartdetectoralertrules").
		Name(smartDetectorAlertRule.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(smartDetectorAlertRule).
		Do(ctx).
		Into(result)
...
func (c *smartDetectorAlertRules) UpdateStatus(ctx context.Context, smartDetectorAlertRule *v1alpha1.SmartDetectorAlertRule, opts v1.UpdateOptions) (result *v1alpha1.SmartDetectorAlertRule, err error) {
	result = &v1alpha1.SmartDetectorAlertRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("smartdetectoralertrules").
...
func (c *smartDetectorAlertRules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *smartDetectorAlertRules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *smartDetectorAlertRules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SmartDetectorAlertRule, err error) {
	result = &v1alpha1.SmartDetectorAlertRule{}
