...
// DiagnosticSettingsGetter has a method to return a DiagnosticSettingInterface.
...
// diagnosticSettings implements DiagnosticSettingInterface
type diagnosticSettings struct {
	client rest.Interface
	ns     string
}

// newDiagnosticSettings returns a DiagnosticSettings
func newDiagnosticSettings(c *MonitorV1alpha1Client, namespace string) *diagnosticSettings {
...
func (c *diagnosticSettings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DiagnosticSetting, err error) {
	result = &v1alpha1.DiagnosticSetting{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *diagnosticSettings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DiagnosticSettingList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.DiagnosticSettingList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("diagnosticsettings").
...
func (c *diagnosticSettings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *diagnosticSettings) Create(ctx context.Context, diagnosticSetting *v1alpha1.DiagnosticSetting, opts v1.CreateOptions) (result *v1alpha1.DiagnosticSetting, err error) {
	result = &v1alpha1.DiagnosticSetting{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("diagnosticsettings").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(diagnosticSetting).
		Do(ctx).
		Into(result)
	return
}
...
func (c *diagnosticSettings) Update(ctx context.Context, diagnosticSetting *v1alpha1.DiagnosticSetting, opts v1.UpdateOptions) (result *v1alpha1.DiagnosticSetting, err error) {
	result = &v1alpha1.DiagnosticSetting{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("diagnosticsettings").
...
func (c *diagnosticSettings) UpdateStatus(ctx context.Context, diagnosticSetting *v1alpha1.DiagnosticSetting, opts v1.UpdateOptions) (result *v1alpha1.DiagnosticSetting, err error) {
	result = &v1alpha1.DiagnosticSetting{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("diagnosticsettings").
...
func (c *diagnosticSettings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *diagnosticSettings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *diagnosticSettings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DiagnosticSetting, err error) {
	result = &v1alpha1.DiagnosticSetting{}
