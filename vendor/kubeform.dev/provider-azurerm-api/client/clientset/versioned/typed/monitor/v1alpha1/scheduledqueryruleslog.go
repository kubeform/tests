...
// ScheduledQueryRulesLogsGetter has a method to return a ScheduledQueryRulesLogInterface.
...
// scheduledQueryRulesLogs implements ScheduledQueryRulesLogInterface
type scheduledQueryRulesLogs struct {
	client rest.Interface
	ns     string
}

// newScheduledQueryRulesLogs returns a ScheduledQueryRulesLogs
func newScheduledQueryRulesLogs(c *MonitorV1alpha1Client, namespace string) *scheduledQueryRulesLogs {
	return &scheduledQueryRulesLogs{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *scheduledQueryRulesLogs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ScheduledQueryRulesLog, err error) {
	result = &v1alpha1.ScheduledQueryRulesLog{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *scheduledQueryRulesLogs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ScheduledQueryRulesLogList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ScheduledQueryRulesLogList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("scheduledqueryruleslogs").
...
func (c *scheduledQueryRulesLogs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *scheduledQueryRulesLogs) Create(ctx context.Context, scheduledQueryRulesLog *v1alpha1.ScheduledQueryRulesLog, opts v1.CreateOptions) (result *v1alpha1.ScheduledQueryRulesLog, err error) {
	result = &v1alpha1.ScheduledQueryRulesLog{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("scheduledqueryruleslogs").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(scheduledQueryRulesLog).
		Do(ctx).
		Into(result)
	return
}
...
func (c *scheduledQueryRulesLogs) Update(ctx context.Context, scheduledQueryRulesLog *v1alpha1.ScheduledQueryRulesLog, opts v1.UpdateOptions) (result *v1alpha1.ScheduledQueryRulesLog, err error) {
	result = &v1alpha1.ScheduledQueryRulesLog{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("scheduledqueryruleslogs").
		Name(scheduledQueryRulesLog.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(scheduledQueryRulesLog).
		Do(ctx).
		Into(result)
...
func (c *scheduledQueryRulesLogs) UpdateStatus(ctx context.Context, scheduledQueryRulesLog *v1alpha1.ScheduledQueryRulesLog, opts v1.UpdateOptions) (result *v1alpha1.ScheduledQueryRulesLog, err error) {
	result = &v1alpha1.ScheduledQueryRulesLog{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("scheduledqueryruleslogs").
...
func (c *scheduledQueryRulesLogs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *scheduledQueryRulesLogs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *scheduledQueryRulesLogs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ScheduledQueryRulesLog, err error) {
	result = &v1alpha1.ScheduledQueryRulesLog{}
