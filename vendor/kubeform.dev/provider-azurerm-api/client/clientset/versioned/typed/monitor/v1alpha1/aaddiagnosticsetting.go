...
// AadDiagnosticSettingsGetter has a method to return a AadDiagnosticSettingInterface.
...
// aadDiagnosticSettings implements AadDiagnosticSettingInterface
type aadDiagnosticSettings struct {
	client rest.Interface
	ns     string
}

// newAadDiagnosticSettings returns a AadDiagnosticSettings
func newAadDiagnosticSettings(c *MonitorV1alpha1Client, namespace string) *aadDiagnosticSettings {
	return &aadDiagnosticSettings{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *aadDiagnosticSettings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AadDiagnosticSetting, err error) {
	result = &v1alpha1.AadDiagnosticSetting{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *aadDiagnosticSettings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AadDiagnosticSettingList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.AadDiagnosticSettingList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("aaddiagnosticsettings").
...
func (c *aadDiagnosticSettings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *aadDiagnosticSettings) Create(ctx context.Context, aadDiagnosticSetting *v1alpha1.AadDiagnosticSetting, opts v1.CreateOptions) (result *v1alpha1.AadDiagnosticSetting, err error) {
	result = &v1alpha1.AadDiagnosticSetting{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("aaddiagnosticsettings").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(aadDiagnosticSetting).
		Do(ctx).
		Into(result)
	return
}
...
func (c *aadDiagnosticSettings) Update(ctx context.Context, aadDiagnosticSetting *v1alpha1.AadDiagnosticSetting, opts v1.UpdateOptions) (result *v1alpha1.AadDiagnosticSetting, err error) {
	result = &v1alpha1.AadDiagnosticSetting{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("aaddiagnosticsettings").
		Name(aadDiagnosticSetting.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(aadDiagnosticSetting).
		Do(ctx).
		Into(result)
...
func (c *aadDiagnosticSettings) UpdateStatus(ctx context.Context, aadDiagnosticSetting *v1alpha1.AadDiagnosticSetting, opts v1.UpdateOptions) (result *v1alpha1.AadDiagnosticSetting, err error) {
	result = &v1alpha1.AadDiagnosticSetting{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("aaddiagnosticsettings").
...
func (c *aadDiagnosticSettings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *aadDiagnosticSettings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *aadDiagnosticSettings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AadDiagnosticSetting, err error) {
	result = &v1alpha1.AadDiagnosticSetting{}
