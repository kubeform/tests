...
// ScheduledQueryRulesAlertsGetter has a method to return a ScheduledQueryRulesAlertInterface.
...
// scheduledQueryRulesAlerts implements ScheduledQueryRulesAlertInterface
type scheduledQueryRulesAlerts struct {
	client rest.Interface
	ns     string
}

// newScheduledQueryRulesAlerts returns a ScheduledQueryRulesAlerts
func newScheduledQueryRulesAlerts(c *MonitorV1alpha1Client, namespace string) *scheduledQueryRulesAlerts {
	return &scheduledQueryRulesAlerts{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *scheduledQueryRulesAlerts) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ScheduledQueryRulesAlert, err error) {
	result = &v1alpha1.ScheduledQueryRulesAlert{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *scheduledQueryRulesAlerts) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ScheduledQueryRulesAlertList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ScheduledQueryRulesAlertList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("scheduledqueryrulesalerts").
...
func (c *scheduledQueryRulesAlerts) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *scheduledQueryRulesAlerts) Create(ctx context.Context, scheduledQueryRulesAlert *v1alpha1.ScheduledQueryRulesAlert, opts v1.CreateOptions) (result *v1alpha1.ScheduledQueryRulesAlert, err error) {
	result = &v1alpha1.ScheduledQueryRulesAlert{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("scheduledqueryrulesalerts").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(scheduledQueryRulesAlert).
		Do(ctx).
		Into(result)
	return
}
...
func (c *scheduledQueryRulesAlerts) Update(ctx context.Context, scheduledQueryRulesAlert *v1alpha1.ScheduledQueryRulesAlert, opts v1.UpdateOptions) (result *v1alpha1.ScheduledQueryRulesAlert, err error) {
	result = &v1alpha1.ScheduledQueryRulesAlert{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("scheduledqueryrulesalerts").
		Name(scheduledQueryRulesAlert.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(scheduledQueryRulesAlert).
		Do(ctx).
		Into(result)
...
func (c *scheduledQueryRulesAlerts) UpdateStatus(ctx context.Context, scheduledQueryRulesAlert *v1alpha1.ScheduledQueryRulesAlert, opts v1.UpdateOptions) (result *v1alpha1.ScheduledQueryRulesAlert, err error) {
	result = &v1alpha1.ScheduledQueryRulesAlert{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("scheduledqueryrulesalerts").
...
func (c *scheduledQueryRulesAlerts) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *scheduledQueryRulesAlerts) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *scheduledQueryRulesAlerts) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ScheduledQueryRulesAlert, err error) {
	result = &v1alpha1.ScheduledQueryRulesAlert{}
