...
// MetricAlertsGetter has a method to return a MetricAlertInterface.
...
// metricAlerts implements MetricAlertInterface
type metricAlerts struct {
	client rest.Interface
	ns     string
}

// newMetricAlerts returns a MetricAlerts
func newMetricAlerts(c *MonitorV1alpha1Client, namespace string) *metricAlerts {
	return &metricAlerts{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *metricAlerts) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MetricAlert, err error) {
	result = &v1alpha1.MetricAlert{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *metricAlerts) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MetricAlertList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.MetricAlertList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("metricalerts").
...
func (c *metricAlerts) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *metricAlerts) Create(ctx context.Context, metricAlert *v1alpha1.MetricAlert, opts v1.CreateOptions) (result *v1alpha1.MetricAlert, err error) {
	result = &v1alpha1.MetricAlert{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("metricalerts").
...
func (c *metricAlerts) Update(ctx context.Context, metricAlert *v1alpha1.MetricAlert, opts v1.UpdateOptions) (result *v1alpha1.MetricAlert, err error) {
	result = &v1alpha1.MetricAlert{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("metricalerts").
...
func (c *metricAlerts) UpdateStatus(ctx context.Context, metricAlert *v1alpha1.MetricAlert, opts v1.UpdateOptions) (result *v1alpha1.MetricAlert, err error) {
	result = &v1alpha1.MetricAlert{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("metricalerts").
...
func (c *metricAlerts) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *metricAlerts) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *metricAlerts) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MetricAlert, err error) {
	result = &v1alpha1.MetricAlert{}
