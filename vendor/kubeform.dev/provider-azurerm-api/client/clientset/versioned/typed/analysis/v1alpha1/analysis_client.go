...
type AnalysisV1alpha1Interface interface {
	...
	ServicesServersGetter
}

// AnalysisV1alpha1Client is used to interact with features provided by the analysis.azurerm.kubeform.com group.
type AnalysisV1alpha1Client struct {
	restClient rest.Interface
}

func (c *AnalysisV1alpha1Client) ServicesServers(namespace string) ServicesServerInterface {
	return newServicesServers(c, namespace)
}
