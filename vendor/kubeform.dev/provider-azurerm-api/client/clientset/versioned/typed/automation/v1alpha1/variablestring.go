...
// VariableStringsGetter has a method to return a VariableStringInterface.
...
// variableStrings implements VariableStringInterface
type variableStrings struct {
	client rest.Interface
	ns     string
}

// newVariableStrings returns a VariableStrings
func newVariableStrings(c *AutomationV1alpha1Client, namespace string) *variableStrings {
...
func (c *variableStrings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.VariableString, err error) {
	result = &v1alpha1.VariableString{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *variableStrings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.VariableStringList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.VariableStringList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("variablestrings").
...
func (c *variableStrings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *variableStrings) Create(ctx context.Context, variableString *v1alpha1.VariableString, opts v1.CreateOptions) (result *v1alpha1.VariableString, err error) {
	result = &v1alpha1.VariableString{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("variablestrings").
...
func (c *variableStrings) Update(ctx context.Context, variableString *v1alpha1.VariableString, opts v1.UpdateOptions) (result *v1alpha1.VariableString, err error) {
	result = &v1alpha1.VariableString{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("variablestrings").
...
func (c *variableStrings) UpdateStatus(ctx context.Context, variableString *v1alpha1.VariableString, opts v1.UpdateOptions) (result *v1alpha1.VariableString, err error) {
	result = &v1alpha1.VariableString{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("variablestrings").
...
func (c *variableStrings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *variableStrings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *variableStrings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.VariableString, err error) {
	result = &v1alpha1.VariableString{}
