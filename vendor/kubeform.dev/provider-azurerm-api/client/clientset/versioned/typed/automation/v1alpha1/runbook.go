...
// RunbooksGetter has a method to return a RunbookInterface.
...
// runbooks implements RunbookInterface
type runbooks struct {
	client rest.Interface
	ns     string
}

// newRunbooks returns a Runbooks
func newRunbooks(c *AutomationV1alpha1Client, namespace string) *runbooks {
	return &runbooks{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *runbooks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Runbook, err error) {
	result = &v1alpha1.Runbook{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("runbooks").
		Name(name).
...
func (c *runbooks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RunbookList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.RunbookList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("runbooks").
...
func (c *runbooks) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *runbooks) Create(ctx context.Context, runbook *v1alpha1.Runbook, opts v1.CreateOptions) (result *v1alpha1.Runbook, err error) {
	result = &v1alpha1.Runbook{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("runbooks").
...
func (c *runbooks) Update(ctx context.Context, runbook *v1alpha1.Runbook, opts v1.UpdateOptions) (result *v1alpha1.Runbook, err error) {
	result = &v1alpha1.Runbook{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("runbooks").
...
func (c *runbooks) UpdateStatus(ctx context.Context, runbook *v1alpha1.Runbook, opts v1.UpdateOptions) (result *v1alpha1.Runbook, err error) {
	result = &v1alpha1.Runbook{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("runbooks").
...
func (c *runbooks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *runbooks) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *runbooks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Runbook, err error) {
	result = &v1alpha1.Runbook{}
