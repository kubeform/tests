...
// MarketplaceV1alpha1Client is used to interact with features provided by the marketplace.azurerm.kubeform.com group.
type MarketplaceV1alpha1Client struct {
	restClient rest.Interface
}

func (c *MarketplaceV1alpha1Client) Agreements(namespace string) AgreementInterface {
	return newAgreements(c, namespace)
}
