...
// MachineDataDiskAttachmentsGetter has a method to return a MachineDataDiskAttachmentInterface.
...
// machineDataDiskAttachments implements MachineDataDiskAttachmentInterface
type machineDataDiskAttachments struct {
	client rest.Interface
	ns     string
}

// newMachineDataDiskAttachments returns a MachineDataDiskAttachments
func newMachineDataDiskAttachments(c *VirtualV1alpha1Client, namespace string) *machineDataDiskAttachments {
	return &machineDataDiskAttachments{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *machineDataDiskAttachments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MachineDataDiskAttachment, err error) {
	result = &v1alpha1.MachineDataDiskAttachment{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *machineDataDiskAttachments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MachineDataDiskAttachmentList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.MachineDataDiskAttachmentList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("machinedatadiskattachments").
...
func (c *machineDataDiskAttachments) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *machineDataDiskAttachments) Create(ctx context.Context, machineDataDiskAttachment *v1alpha1.MachineDataDiskAttachment, opts v1.CreateOptions) (result *v1alpha1.MachineDataDiskAttachment, err error) {
	result = &v1alpha1.MachineDataDiskAttachment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("machinedatadiskattachments").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(machineDataDiskAttachment).
		Do(ctx).
		Into(result)
	return
}
...
func (c *machineDataDiskAttachments) Update(ctx context.Context, machineDataDiskAttachment *v1alpha1.MachineDataDiskAttachment, opts v1.UpdateOptions) (result *v1alpha1.MachineDataDiskAttachment, err error) {
	result = &v1alpha1.MachineDataDiskAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("machinedatadiskattachments").
		Name(machineDataDiskAttachment.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(machineDataDiskAttachment).
		Do(ctx).
		Into(result)
...
func (c *machineDataDiskAttachments) UpdateStatus(ctx context.Context, machineDataDiskAttachment *v1alpha1.MachineDataDiskAttachment, opts v1.UpdateOptions) (result *v1alpha1.MachineDataDiskAttachment, err error) {
	result = &v1alpha1.MachineDataDiskAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("machinedatadiskattachments").
...
func (c *machineDataDiskAttachments) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *machineDataDiskAttachments) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *machineDataDiskAttachments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MachineDataDiskAttachment, err error) {
	result = &v1alpha1.MachineDataDiskAttachment{}
