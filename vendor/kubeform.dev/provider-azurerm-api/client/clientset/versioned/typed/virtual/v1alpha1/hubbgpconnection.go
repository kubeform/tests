...
// HubBGPConnectionsGetter has a method to return a HubBGPConnectionInterface.
...
// hubBGPConnections implements HubBGPConnectionInterface
type hubBGPConnections struct {
	client rest.Interface
	ns     string
}

// newHubBGPConnections returns a HubBGPConnections
func newHubBGPConnections(c *VirtualV1alpha1Client, namespace string) *hubBGPConnections {
	return &hubBGPConnections{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *hubBGPConnections) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.HubBGPConnection, err error) {
	result = &v1alpha1.HubBGPConnection{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *hubBGPConnections) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.HubBGPConnectionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.HubBGPConnectionList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("hubbgpconnections").
...
func (c *hubBGPConnections) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *hubBGPConnections) Create(ctx context.Context, hubBGPConnection *v1alpha1.HubBGPConnection, opts v1.CreateOptions) (result *v1alpha1.HubBGPConnection, err error) {
	result = &v1alpha1.HubBGPConnection{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("hubbgpconnections").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(hubBGPConnection).
		Do(ctx).
		Into(result)
	return
}
...
func (c *hubBGPConnections) Update(ctx context.Context, hubBGPConnection *v1alpha1.HubBGPConnection, opts v1.UpdateOptions) (result *v1alpha1.HubBGPConnection, err error) {
	result = &v1alpha1.HubBGPConnection{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("hubbgpconnections").
		Name(hubBGPConnection.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(hubBGPConnection).
		Do(ctx).
		Into(result)
...
func (c *hubBGPConnections) UpdateStatus(ctx context.Context, hubBGPConnection *v1alpha1.HubBGPConnection, opts v1.UpdateOptions) (result *v1alpha1.HubBGPConnection, err error) {
	result = &v1alpha1.HubBGPConnection{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("hubbgpconnections").
...
func (c *hubBGPConnections) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *hubBGPConnections) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *hubBGPConnections) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.HubBGPConnection, err error) {
	result = &v1alpha1.HubBGPConnection{}
