...
// MachineScaleSetExtensionsGetter has a method to return a MachineScaleSetExtensionInterface.
...
// machineScaleSetExtensions implements MachineScaleSetExtensionInterface
type machineScaleSetExtensions struct {
	client rest.Interface
	ns     string
}

// newMachineScaleSetExtensions returns a MachineScaleSetExtensions
func newMachineScaleSetExtensions(c *VirtualV1alpha1Client, namespace string) *machineScaleSetExtensions {
	return &machineScaleSetExtensions{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *machineScaleSetExtensions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MachineScaleSetExtension, err error) {
	result = &v1alpha1.MachineScaleSetExtension{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *machineScaleSetExtensions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MachineScaleSetExtensionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.MachineScaleSetExtensionList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("machinescalesetextensions").
...
func (c *machineScaleSetExtensions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *machineScaleSetExtensions) Create(ctx context.Context, machineScaleSetExtension *v1alpha1.MachineScaleSetExtension, opts v1.CreateOptions) (result *v1alpha1.MachineScaleSetExtension, err error) {
	result = &v1alpha1.MachineScaleSetExtension{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("machinescalesetextensions").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(machineScaleSetExtension).
		Do(ctx).
		Into(result)
	return
}
...
func (c *machineScaleSetExtensions) Update(ctx context.Context, machineScaleSetExtension *v1alpha1.MachineScaleSetExtension, opts v1.UpdateOptions) (result *v1alpha1.MachineScaleSetExtension, err error) {
	result = &v1alpha1.MachineScaleSetExtension{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("machinescalesetextensions").
		Name(machineScaleSetExtension.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(machineScaleSetExtension).
		Do(ctx).
		Into(result)
...
func (c *machineScaleSetExtensions) UpdateStatus(ctx context.Context, machineScaleSetExtension *v1alpha1.MachineScaleSetExtension, opts v1.UpdateOptions) (result *v1alpha1.MachineScaleSetExtension, err error) {
	result = &v1alpha1.MachineScaleSetExtension{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("machinescalesetextensions").
...
func (c *machineScaleSetExtensions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *machineScaleSetExtensions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *machineScaleSetExtensions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MachineScaleSetExtension, err error) {
	result = &v1alpha1.MachineScaleSetExtension{}
