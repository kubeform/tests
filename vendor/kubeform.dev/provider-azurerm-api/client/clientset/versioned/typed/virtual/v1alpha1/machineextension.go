...
// MachineExtensionsGetter has a method to return a MachineExtensionInterface.
...
// machineExtensions implements MachineExtensionInterface
type machineExtensions struct {
	client rest.Interface
	ns     string
}

// newMachineExtensions returns a MachineExtensions
func newMachineExtensions(c *VirtualV1alpha1Client, namespace string) *machineExtensions {
...
func (c *machineExtensions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MachineExtension, err error) {
	result = &v1alpha1.MachineExtension{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *machineExtensions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MachineExtensionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.MachineExtensionList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("machineextensions").
...
func (c *machineExtensions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *machineExtensions) Create(ctx context.Context, machineExtension *v1alpha1.MachineExtension, opts v1.CreateOptions) (result *v1alpha1.MachineExtension, err error) {
	result = &v1alpha1.MachineExtension{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("machineextensions").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(machineExtension).
		Do(ctx).
		Into(result)
	return
}
...
func (c *machineExtensions) Update(ctx context.Context, machineExtension *v1alpha1.MachineExtension, opts v1.UpdateOptions) (result *v1alpha1.MachineExtension, err error) {
	result = &v1alpha1.MachineExtension{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("machineextensions").
		Name(machineExtension.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(machineExtension).
		Do(ctx).
		Into(result)
...
func (c *machineExtensions) UpdateStatus(ctx context.Context, machineExtension *v1alpha1.MachineExtension, opts v1.UpdateOptions) (result *v1alpha1.MachineExtension, err error) {
	result = &v1alpha1.MachineExtension{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("machineextensions").
...
func (c *machineExtensions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *machineExtensions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *machineExtensions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MachineExtension, err error) {
	result = &v1alpha1.MachineExtension{}
