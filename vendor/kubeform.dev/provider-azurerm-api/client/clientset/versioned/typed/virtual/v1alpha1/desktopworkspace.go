...
// DesktopWorkspacesGetter has a method to return a DesktopWorkspaceInterface.
...
// desktopWorkspaces implements DesktopWorkspaceInterface
type desktopWorkspaces struct {
	client rest.Interface
	ns     string
}

// newDesktopWorkspaces returns a DesktopWorkspaces
func newDesktopWorkspaces(c *VirtualV1alpha1Client, namespace string) *desktopWorkspaces {
	return &desktopWorkspaces{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *desktopWorkspaces) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DesktopWorkspace, err error) {
	result = &v1alpha1.DesktopWorkspace{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *desktopWorkspaces) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DesktopWorkspaceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.DesktopWorkspaceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("desktopworkspaces").
...
func (c *desktopWorkspaces) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *desktopWorkspaces) Create(ctx context.Context, desktopWorkspace *v1alpha1.DesktopWorkspace, opts v1.CreateOptions) (result *v1alpha1.DesktopWorkspace, err error) {
	result = &v1alpha1.DesktopWorkspace{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("desktopworkspaces").
...
func (c *desktopWorkspaces) Update(ctx context.Context, desktopWorkspace *v1alpha1.DesktopWorkspace, opts v1.UpdateOptions) (result *v1alpha1.DesktopWorkspace, err error) {
	result = &v1alpha1.DesktopWorkspace{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("desktopworkspaces").
		Name(desktopWorkspace.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(desktopWorkspace).
		Do(ctx).
		Into(result)
...
func (c *desktopWorkspaces) UpdateStatus(ctx context.Context, desktopWorkspace *v1alpha1.DesktopWorkspace, opts v1.UpdateOptions) (result *v1alpha1.DesktopWorkspace, err error) {
	result = &v1alpha1.DesktopWorkspace{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("desktopworkspaces").
...
func (c *desktopWorkspaces) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *desktopWorkspaces) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *desktopWorkspaces) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DesktopWorkspace, err error) {
	result = &v1alpha1.DesktopWorkspace{}
