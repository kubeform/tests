...
// MachineScaleSetsGetter has a method to return a MachineScaleSetInterface.
...
// machineScaleSets implements MachineScaleSetInterface
type machineScaleSets struct {
	client rest.Interface
	ns     string
}

// newMachineScaleSets returns a MachineScaleSets
func newMachineScaleSets(c *VirtualV1alpha1Client, namespace string) *machineScaleSets {
	return &machineScaleSets{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *machineScaleSets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MachineScaleSet, err error) {
	result = &v1alpha1.MachineScaleSet{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *machineScaleSets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MachineScaleSetList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.MachineScaleSetList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("machinescalesets").
...
func (c *machineScaleSets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *machineScaleSets) Create(ctx context.Context, machineScaleSet *v1alpha1.MachineScaleSet, opts v1.CreateOptions) (result *v1alpha1.MachineScaleSet, err error) {
	result = &v1alpha1.MachineScaleSet{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("machinescalesets").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(machineScaleSet).
		Do(ctx).
		Into(result)
	return
}
...
func (c *machineScaleSets) Update(ctx context.Context, machineScaleSet *v1alpha1.MachineScaleSet, opts v1.UpdateOptions) (result *v1alpha1.MachineScaleSet, err error) {
	result = &v1alpha1.MachineScaleSet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("machinescalesets").
		Name(machineScaleSet.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(machineScaleSet).
		Do(ctx).
		Into(result)
...
func (c *machineScaleSets) UpdateStatus(ctx context.Context, machineScaleSet *v1alpha1.MachineScaleSet, opts v1.UpdateOptions) (result *v1alpha1.MachineScaleSet, err error) {
	result = &v1alpha1.MachineScaleSet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("machinescalesets").
...
func (c *machineScaleSets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *machineScaleSets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *machineScaleSets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MachineScaleSet, err error) {
	result = &v1alpha1.MachineScaleSet{}
