...
func newHubs(c *VirtualV1alpha1Client, namespace string) *hubs {
	return &hubs{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *hubs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Hub, err error) {
	result = &v1alpha1.Hub{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("hubs").
...
func (c *hubs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.HubList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.HubList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("hubs").
...
func (c *hubs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *hubs) Create(ctx context.Context, hub *v1alpha1.Hub, opts v1.CreateOptions) (result *v1alpha1.Hub, err error) {
	result = &v1alpha1.Hub{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("hubs").
...
func (c *hubs) Update(ctx context.Context, hub *v1alpha1.Hub, opts v1.UpdateOptions) (result *v1alpha1.Hub, err error) {
	result = &v1alpha1.Hub{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("hubs").
...
func (c *hubs) UpdateStatus(ctx context.Context, hub *v1alpha1.Hub, opts v1.UpdateOptions) (result *v1alpha1.Hub, err error) {
	result = &v1alpha1.Hub{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("hubs").
...
func (c *hubs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *hubs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *hubs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Hub, err error) {
	result = &v1alpha1.Hub{}
