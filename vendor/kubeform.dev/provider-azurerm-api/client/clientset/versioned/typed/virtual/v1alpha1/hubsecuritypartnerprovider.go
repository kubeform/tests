...
// HubSecurityPartnerProvidersGetter has a method to return a HubSecurityPartnerProviderInterface.
...
// hubSecurityPartnerProviders implements HubSecurityPartnerProviderInterface
type hubSecurityPartnerProviders struct {
	client rest.Interface
	ns     string
}

// newHubSecurityPartnerProviders returns a HubSecurityPartnerProviders
func newHubSecurityPartnerProviders(c *VirtualV1alpha1Client, namespace string) *hubSecurityPartnerProviders {
	return &hubSecurityPartnerProviders{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *hubSecurityPartnerProviders) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.HubSecurityPartnerProvider, err error) {
	result = &v1alpha1.HubSecurityPartnerProvider{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *hubSecurityPartnerProviders) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.HubSecurityPartnerProviderList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.HubSecurityPartnerProviderList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("hubsecuritypartnerproviders").
...
func (c *hubSecurityPartnerProviders) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *hubSecurityPartnerProviders) Create(ctx context.Context, hubSecurityPartnerProvider *v1alpha1.HubSecurityPartnerProvider, opts v1.CreateOptions) (result *v1alpha1.HubSecurityPartnerProvider, err error) {
	result = &v1alpha1.HubSecurityPartnerProvider{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("hubsecuritypartnerproviders").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(hubSecurityPartnerProvider).
		Do(ctx).
		Into(result)
	return
}
...
func (c *hubSecurityPartnerProviders) Update(ctx context.Context, hubSecurityPartnerProvider *v1alpha1.HubSecurityPartnerProvider, opts v1.UpdateOptions) (result *v1alpha1.HubSecurityPartnerProvider, err error) {
	result = &v1alpha1.HubSecurityPartnerProvider{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("hubsecuritypartnerproviders").
		Name(hubSecurityPartnerProvider.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(hubSecurityPartnerProvider).
		Do(ctx).
		Into(result)
...
func (c *hubSecurityPartnerProviders) UpdateStatus(ctx context.Context, hubSecurityPartnerProvider *v1alpha1.HubSecurityPartnerProvider, opts v1.UpdateOptions) (result *v1alpha1.HubSecurityPartnerProvider, err error) {
	result = &v1alpha1.HubSecurityPartnerProvider{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("hubsecuritypartnerproviders").
...
func (c *hubSecurityPartnerProviders) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *hubSecurityPartnerProviders) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *hubSecurityPartnerProviders) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.HubSecurityPartnerProvider, err error) {
	result = &v1alpha1.HubSecurityPartnerProvider{}
