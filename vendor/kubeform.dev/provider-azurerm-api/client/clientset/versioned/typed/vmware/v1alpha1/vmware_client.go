...
type VmwareV1alpha1Interface interface {
...
func (c *VmwareV1alpha1Client) PrivateClouds(namespace string) PrivateCloudInterface {
	return newPrivateClouds(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*VmwareV1alpha1Client, error) {
	...
	return &VmwareV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new VmwareV1alpha1Client for the given config and
