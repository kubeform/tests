...
// FactoryDatasetAzureBlobsGetter has a method to return a FactoryDatasetAzureBlobInterface.
...
// factoryDatasetAzureBlobs implements FactoryDatasetAzureBlobInterface
type factoryDatasetAzureBlobs struct {
	client rest.Interface
	ns     string
}

// newFactoryDatasetAzureBlobs returns a FactoryDatasetAzureBlobs
func newFactoryDatasetAzureBlobs(c *DataV1alpha1Client, namespace string) *factoryDatasetAzureBlobs {
	return &factoryDatasetAzureBlobs{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *factoryDatasetAzureBlobs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.FactoryDatasetAzureBlob, err error) {
	result = &v1alpha1.FactoryDatasetAzureBlob{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *factoryDatasetAzureBlobs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FactoryDatasetAzureBlobList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.FactoryDatasetAzureBlobList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("factorydatasetazureblobs").
...
func (c *factoryDatasetAzureBlobs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *factoryDatasetAzureBlobs) Create(ctx context.Context, factoryDatasetAzureBlob *v1alpha1.FactoryDatasetAzureBlob, opts v1.CreateOptions) (result *v1alpha1.FactoryDatasetAzureBlob, err error) {
	result = &v1alpha1.FactoryDatasetAzureBlob{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("factorydatasetazureblobs").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(factoryDatasetAzureBlob).
		Do(ctx).
		Into(result)
	return
}
...
func (c *factoryDatasetAzureBlobs) Update(ctx context.Context, factoryDatasetAzureBlob *v1alpha1.FactoryDatasetAzureBlob, opts v1.UpdateOptions) (result *v1alpha1.FactoryDatasetAzureBlob, err error) {
	result = &v1alpha1.FactoryDatasetAzureBlob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("factorydatasetazureblobs").
		Name(factoryDatasetAzureBlob.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(factoryDatasetAzureBlob).
		Do(ctx).
		Into(result)
...
func (c *factoryDatasetAzureBlobs) UpdateStatus(ctx context.Context, factoryDatasetAzureBlob *v1alpha1.FactoryDatasetAzureBlob, opts v1.UpdateOptions) (result *v1alpha1.FactoryDatasetAzureBlob, err error) {
	result = &v1alpha1.FactoryDatasetAzureBlob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("factorydatasetazureblobs").
...
func (c *factoryDatasetAzureBlobs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *factoryDatasetAzureBlobs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *factoryDatasetAzureBlobs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.FactoryDatasetAzureBlob, err error) {
	result = &v1alpha1.FactoryDatasetAzureBlob{}
