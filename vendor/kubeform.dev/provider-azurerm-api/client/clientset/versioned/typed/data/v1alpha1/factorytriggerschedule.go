...
// FactoryTriggerSchedulesGetter has a method to return a FactoryTriggerScheduleInterface.
...
// factoryTriggerSchedules implements FactoryTriggerScheduleInterface
type factoryTriggerSchedules struct {
	client rest.Interface
	ns     string
}

// newFactoryTriggerSchedules returns a FactoryTriggerSchedules
func newFactoryTriggerSchedules(c *DataV1alpha1Client, namespace string) *factoryTriggerSchedules {
	return &factoryTriggerSchedules{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *factoryTriggerSchedules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.FactoryTriggerSchedule, err error) {
	result = &v1alpha1.FactoryTriggerSchedule{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *factoryTriggerSchedules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FactoryTriggerScheduleList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.FactoryTriggerScheduleList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("factorytriggerschedules").
...
func (c *factoryTriggerSchedules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *factoryTriggerSchedules) Create(ctx context.Context, factoryTriggerSchedule *v1alpha1.FactoryTriggerSchedule, opts v1.CreateOptions) (result *v1alpha1.FactoryTriggerSchedule, err error) {
	result = &v1alpha1.FactoryTriggerSchedule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("factorytriggerschedules").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(factoryTriggerSchedule).
		Do(ctx).
		Into(result)
	return
}
...
func (c *factoryTriggerSchedules) Update(ctx context.Context, factoryTriggerSchedule *v1alpha1.FactoryTriggerSchedule, opts v1.UpdateOptions) (result *v1alpha1.FactoryTriggerSchedule, err error) {
	result = &v1alpha1.FactoryTriggerSchedule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("factorytriggerschedules").
		Name(factoryTriggerSchedule.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(factoryTriggerSchedule).
		Do(ctx).
		Into(result)
...
func (c *factoryTriggerSchedules) UpdateStatus(ctx context.Context, factoryTriggerSchedule *v1alpha1.FactoryTriggerSchedule, opts v1.UpdateOptions) (result *v1alpha1.FactoryTriggerSchedule, err error) {
	result = &v1alpha1.FactoryTriggerSchedule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("factorytriggerschedules").
...
func (c *factoryTriggerSchedules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *factoryTriggerSchedules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *factoryTriggerSchedules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.FactoryTriggerSchedule, err error) {
	result = &v1alpha1.FactoryTriggerSchedule{}
