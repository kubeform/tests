...
// FactoryDatasetParquetsGetter has a method to return a FactoryDatasetParquetInterface.
...
// factoryDatasetParquets implements FactoryDatasetParquetInterface
type factoryDatasetParquets struct {
	client rest.Interface
	ns     string
}

// newFactoryDatasetParquets returns a FactoryDatasetParquets
func newFactoryDatasetParquets(c *DataV1alpha1Client, namespace string) *factoryDatasetParquets {
	return &factoryDatasetParquets{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *factoryDatasetParquets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.FactoryDatasetParquet, err error) {
	result = &v1alpha1.FactoryDatasetParquet{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *factoryDatasetParquets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FactoryDatasetParquetList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.FactoryDatasetParquetList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("factorydatasetparquets").
...
func (c *factoryDatasetParquets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *factoryDatasetParquets) Create(ctx context.Context, factoryDatasetParquet *v1alpha1.FactoryDatasetParquet, opts v1.CreateOptions) (result *v1alpha1.FactoryDatasetParquet, err error) {
	result = &v1alpha1.FactoryDatasetParquet{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("factorydatasetparquets").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(factoryDatasetParquet).
		Do(ctx).
		Into(result)
	return
}
...
func (c *factoryDatasetParquets) Update(ctx context.Context, factoryDatasetParquet *v1alpha1.FactoryDatasetParquet, opts v1.UpdateOptions) (result *v1alpha1.FactoryDatasetParquet, err error) {
	result = &v1alpha1.FactoryDatasetParquet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("factorydatasetparquets").
		Name(factoryDatasetParquet.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(factoryDatasetParquet).
		Do(ctx).
		Into(result)
...
func (c *factoryDatasetParquets) UpdateStatus(ctx context.Context, factoryDatasetParquet *v1alpha1.FactoryDatasetParquet, opts v1.UpdateOptions) (result *v1alpha1.FactoryDatasetParquet, err error) {
	result = &v1alpha1.FactoryDatasetParquet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("factorydatasetparquets").
...
func (c *factoryDatasetParquets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *factoryDatasetParquets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *factoryDatasetParquets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.FactoryDatasetParquet, err error) {
	result = &v1alpha1.FactoryDatasetParquet{}
