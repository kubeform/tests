...
// FactoryDatasetDelimitedTextsGetter has a method to return a FactoryDatasetDelimitedTextInterface.
...
// factoryDatasetDelimitedTexts implements FactoryDatasetDelimitedTextInterface
type factoryDatasetDelimitedTexts struct {
	client rest.Interface
	ns     string
}

// newFactoryDatasetDelimitedTexts returns a FactoryDatasetDelimitedTexts
func newFactoryDatasetDelimitedTexts(c *DataV1alpha1Client, namespace string) *factoryDatasetDelimitedTexts {
	return &factoryDatasetDelimitedTexts{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *factoryDatasetDelimitedTexts) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.FactoryDatasetDelimitedText, err error) {
	result = &v1alpha1.FactoryDatasetDelimitedText{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *factoryDatasetDelimitedTexts) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FactoryDatasetDelimitedTextList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.FactoryDatasetDelimitedTextList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("factorydatasetdelimitedtexts").
...
func (c *factoryDatasetDelimitedTexts) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *factoryDatasetDelimitedTexts) Create(ctx context.Context, factoryDatasetDelimitedText *v1alpha1.FactoryDatasetDelimitedText, opts v1.CreateOptions) (result *v1alpha1.FactoryDatasetDelimitedText, err error) {
	result = &v1alpha1.FactoryDatasetDelimitedText{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("factorydatasetdelimitedtexts").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(factoryDatasetDelimitedText).
		Do(ctx).
		Into(result)
	return
}
...
func (c *factoryDatasetDelimitedTexts) Update(ctx context.Context, factoryDatasetDelimitedText *v1alpha1.FactoryDatasetDelimitedText, opts v1.UpdateOptions) (result *v1alpha1.FactoryDatasetDelimitedText, err error) {
	result = &v1alpha1.FactoryDatasetDelimitedText{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("factorydatasetdelimitedtexts").
		Name(factoryDatasetDelimitedText.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(factoryDatasetDelimitedText).
		Do(ctx).
		Into(result)
...
func (c *factoryDatasetDelimitedTexts) UpdateStatus(ctx context.Context, factoryDatasetDelimitedText *v1alpha1.FactoryDatasetDelimitedText, opts v1.UpdateOptions) (result *v1alpha1.FactoryDatasetDelimitedText, err error) {
	result = &v1alpha1.FactoryDatasetDelimitedText{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("factorydatasetdelimitedtexts").
...
func (c *factoryDatasetDelimitedTexts) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *factoryDatasetDelimitedTexts) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *factoryDatasetDelimitedTexts) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.FactoryDatasetDelimitedText, err error) {
	result = &v1alpha1.FactoryDatasetDelimitedText{}
