...
// LakeAnalyticsAccountsGetter has a method to return a LakeAnalyticsAccountInterface.
...
// lakeAnalyticsAccounts implements LakeAnalyticsAccountInterface
type lakeAnalyticsAccounts struct {
	client rest.Interface
	ns     string
}

// newLakeAnalyticsAccounts returns a LakeAnalyticsAccounts
func newLakeAnalyticsAccounts(c *DataV1alpha1Client, namespace string) *lakeAnalyticsAccounts {
	return &lakeAnalyticsAccounts{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *lakeAnalyticsAccounts) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LakeAnalyticsAccount, err error) {
	result = &v1alpha1.LakeAnalyticsAccount{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *lakeAnalyticsAccounts) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LakeAnalyticsAccountList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.LakeAnalyticsAccountList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("lakeanalyticsaccounts").
...
func (c *lakeAnalyticsAccounts) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *lakeAnalyticsAccounts) Create(ctx context.Context, lakeAnalyticsAccount *v1alpha1.LakeAnalyticsAccount, opts v1.CreateOptions) (result *v1alpha1.LakeAnalyticsAccount, err error) {
	result = &v1alpha1.LakeAnalyticsAccount{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("lakeanalyticsaccounts").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(lakeAnalyticsAccount).
		Do(ctx).
		Into(result)
	return
}
...
func (c *lakeAnalyticsAccounts) Update(ctx context.Context, lakeAnalyticsAccount *v1alpha1.LakeAnalyticsAccount, opts v1.UpdateOptions) (result *v1alpha1.LakeAnalyticsAccount, err error) {
	result = &v1alpha1.LakeAnalyticsAccount{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("lakeanalyticsaccounts").
		Name(lakeAnalyticsAccount.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(lakeAnalyticsAccount).
		Do(ctx).
		Into(result)
...
func (c *lakeAnalyticsAccounts) UpdateStatus(ctx context.Context, lakeAnalyticsAccount *v1alpha1.LakeAnalyticsAccount, opts v1.UpdateOptions) (result *v1alpha1.LakeAnalyticsAccount, err error) {
	result = &v1alpha1.LakeAnalyticsAccount{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("lakeanalyticsaccounts").
...
func (c *lakeAnalyticsAccounts) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *lakeAnalyticsAccounts) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *lakeAnalyticsAccounts) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LakeAnalyticsAccount, err error) {
	result = &v1alpha1.LakeAnalyticsAccount{}
