...
// FactoryLinkedServiceSftpsGetter has a method to return a FactoryLinkedServiceSftpInterface.
...
// factoryLinkedServiceSftps implements FactoryLinkedServiceSftpInterface
type factoryLinkedServiceSftps struct {
	client rest.Interface
	ns     string
}

// newFactoryLinkedServiceSftps returns a FactoryLinkedServiceSftps
func newFactoryLinkedServiceSftps(c *DataV1alpha1Client, namespace string) *factoryLinkedServiceSftps {
	return &factoryLinkedServiceSftps{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *factoryLinkedServiceSftps) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.FactoryLinkedServiceSftp, err error) {
	result = &v1alpha1.FactoryLinkedServiceSftp{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *factoryLinkedServiceSftps) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FactoryLinkedServiceSftpList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.FactoryLinkedServiceSftpList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("factorylinkedservicesftps").
...
func (c *factoryLinkedServiceSftps) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *factoryLinkedServiceSftps) Create(ctx context.Context, factoryLinkedServiceSftp *v1alpha1.FactoryLinkedServiceSftp, opts v1.CreateOptions) (result *v1alpha1.FactoryLinkedServiceSftp, err error) {
	result = &v1alpha1.FactoryLinkedServiceSftp{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("factorylinkedservicesftps").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(factoryLinkedServiceSftp).
		Do(ctx).
		Into(result)
	return
}
...
func (c *factoryLinkedServiceSftps) Update(ctx context.Context, factoryLinkedServiceSftp *v1alpha1.FactoryLinkedServiceSftp, opts v1.UpdateOptions) (result *v1alpha1.FactoryLinkedServiceSftp, err error) {
	result = &v1alpha1.FactoryLinkedServiceSftp{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("factorylinkedservicesftps").
		Name(factoryLinkedServiceSftp.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(factoryLinkedServiceSftp).
		Do(ctx).
		Into(result)
...
func (c *factoryLinkedServiceSftps) UpdateStatus(ctx context.Context, factoryLinkedServiceSftp *v1alpha1.FactoryLinkedServiceSftp, opts v1.UpdateOptions) (result *v1alpha1.FactoryLinkedServiceSftp, err error) {
	result = &v1alpha1.FactoryLinkedServiceSftp{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("factorylinkedservicesftps").
...
func (c *factoryLinkedServiceSftps) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *factoryLinkedServiceSftps) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *factoryLinkedServiceSftps) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.FactoryLinkedServiceSftp, err error) {
	result = &v1alpha1.FactoryLinkedServiceSftp{}
