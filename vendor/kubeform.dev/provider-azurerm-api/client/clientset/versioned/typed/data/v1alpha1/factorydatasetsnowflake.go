...
// FactoryDatasetSnowflakesGetter has a method to return a FactoryDatasetSnowflakeInterface.
...
// factoryDatasetSnowflakes implements FactoryDatasetSnowflakeInterface
type factoryDatasetSnowflakes struct {
	client rest.Interface
	ns     string
}

// newFactoryDatasetSnowflakes returns a FactoryDatasetSnowflakes
func newFactoryDatasetSnowflakes(c *DataV1alpha1Client, namespace string) *factoryDatasetSnowflakes {
	return &factoryDatasetSnowflakes{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *factoryDatasetSnowflakes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.FactoryDatasetSnowflake, err error) {
	result = &v1alpha1.FactoryDatasetSnowflake{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *factoryDatasetSnowflakes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FactoryDatasetSnowflakeList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.FactoryDatasetSnowflakeList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("factorydatasetsnowflakes").
...
func (c *factoryDatasetSnowflakes) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *factoryDatasetSnowflakes) Create(ctx context.Context, factoryDatasetSnowflake *v1alpha1.FactoryDatasetSnowflake, opts v1.CreateOptions) (result *v1alpha1.FactoryDatasetSnowflake, err error) {
	result = &v1alpha1.FactoryDatasetSnowflake{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("factorydatasetsnowflakes").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(factoryDatasetSnowflake).
		Do(ctx).
		Into(result)
	return
}
...
func (c *factoryDatasetSnowflakes) Update(ctx context.Context, factoryDatasetSnowflake *v1alpha1.FactoryDatasetSnowflake, opts v1.UpdateOptions) (result *v1alpha1.FactoryDatasetSnowflake, err error) {
	result = &v1alpha1.FactoryDatasetSnowflake{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("factorydatasetsnowflakes").
		Name(factoryDatasetSnowflake.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(factoryDatasetSnowflake).
		Do(ctx).
		Into(result)
...
func (c *factoryDatasetSnowflakes) UpdateStatus(ctx context.Context, factoryDatasetSnowflake *v1alpha1.FactoryDatasetSnowflake, opts v1.UpdateOptions) (result *v1alpha1.FactoryDatasetSnowflake, err error) {
	result = &v1alpha1.FactoryDatasetSnowflake{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("factorydatasetsnowflakes").
...
func (c *factoryDatasetSnowflakes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *factoryDatasetSnowflakes) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *factoryDatasetSnowflakes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.FactoryDatasetSnowflake, err error) {
	result = &v1alpha1.FactoryDatasetSnowflake{}
