...
// FactoryLinkedServiceKeyVaultsGetter has a method to return a FactoryLinkedServiceKeyVaultInterface.
...
// factoryLinkedServiceKeyVaults implements FactoryLinkedServiceKeyVaultInterface
type factoryLinkedServiceKeyVaults struct {
	client rest.Interface
	ns     string
}

// newFactoryLinkedServiceKeyVaults returns a FactoryLinkedServiceKeyVaults
func newFactoryLinkedServiceKeyVaults(c *DataV1alpha1Client, namespace string) *factoryLinkedServiceKeyVaults {
	return &factoryLinkedServiceKeyVaults{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *factoryLinkedServiceKeyVaults) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.FactoryLinkedServiceKeyVault, err error) {
	result = &v1alpha1.FactoryLinkedServiceKeyVault{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *factoryLinkedServiceKeyVaults) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FactoryLinkedServiceKeyVaultList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.FactoryLinkedServiceKeyVaultList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("factorylinkedservicekeyvaults").
...
func (c *factoryLinkedServiceKeyVaults) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *factoryLinkedServiceKeyVaults) Create(ctx context.Context, factoryLinkedServiceKeyVault *v1alpha1.FactoryLinkedServiceKeyVault, opts v1.CreateOptions) (result *v1alpha1.FactoryLinkedServiceKeyVault, err error) {
	result = &v1alpha1.FactoryLinkedServiceKeyVault{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("factorylinkedservicekeyvaults").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(factoryLinkedServiceKeyVault).
		Do(ctx).
		Into(result)
	return
}
...
func (c *factoryLinkedServiceKeyVaults) Update(ctx context.Context, factoryLinkedServiceKeyVault *v1alpha1.FactoryLinkedServiceKeyVault, opts v1.UpdateOptions) (result *v1alpha1.FactoryLinkedServiceKeyVault, err error) {
	result = &v1alpha1.FactoryLinkedServiceKeyVault{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("factorylinkedservicekeyvaults").
		Name(factoryLinkedServiceKeyVault.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(factoryLinkedServiceKeyVault).
		Do(ctx).
		Into(result)
...
func (c *factoryLinkedServiceKeyVaults) UpdateStatus(ctx context.Context, factoryLinkedServiceKeyVault *v1alpha1.FactoryLinkedServiceKeyVault, opts v1.UpdateOptions) (result *v1alpha1.FactoryLinkedServiceKeyVault, err error) {
	result = &v1alpha1.FactoryLinkedServiceKeyVault{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("factorylinkedservicekeyvaults").
...
func (c *factoryLinkedServiceKeyVaults) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *factoryLinkedServiceKeyVaults) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *factoryLinkedServiceKeyVaults) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.FactoryLinkedServiceKeyVault, err error) {
	result = &v1alpha1.FactoryLinkedServiceKeyVault{}
