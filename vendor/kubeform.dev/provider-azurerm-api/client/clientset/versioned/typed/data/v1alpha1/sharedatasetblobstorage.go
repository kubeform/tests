...
// ShareDatasetBlobStoragesGetter has a method to return a ShareDatasetBlobStorageInterface.
...
// shareDatasetBlobStorages implements ShareDatasetBlobStorageInterface
type shareDatasetBlobStorages struct {
	client rest.Interface
	ns     string
}

// newShareDatasetBlobStorages returns a ShareDatasetBlobStorages
func newShareDatasetBlobStorages(c *DataV1alpha1Client, namespace string) *shareDatasetBlobStorages {
	return &shareDatasetBlobStorages{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *shareDatasetBlobStorages) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ShareDatasetBlobStorage, err error) {
	result = &v1alpha1.ShareDatasetBlobStorage{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *shareDatasetBlobStorages) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ShareDatasetBlobStorageList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ShareDatasetBlobStorageList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("sharedatasetblobstorages").
...
func (c *shareDatasetBlobStorages) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *shareDatasetBlobStorages) Create(ctx context.Context, shareDatasetBlobStorage *v1alpha1.ShareDatasetBlobStorage, opts v1.CreateOptions) (result *v1alpha1.ShareDatasetBlobStorage, err error) {
	result = &v1alpha1.ShareDatasetBlobStorage{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("sharedatasetblobstorages").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(shareDatasetBlobStorage).
		Do(ctx).
		Into(result)
	return
}
...
func (c *shareDatasetBlobStorages) Update(ctx context.Context, shareDatasetBlobStorage *v1alpha1.ShareDatasetBlobStorage, opts v1.UpdateOptions) (result *v1alpha1.ShareDatasetBlobStorage, err error) {
	result = &v1alpha1.ShareDatasetBlobStorage{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sharedatasetblobstorages").
		Name(shareDatasetBlobStorage.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(shareDatasetBlobStorage).
		Do(ctx).
		Into(result)
...
func (c *shareDatasetBlobStorages) UpdateStatus(ctx context.Context, shareDatasetBlobStorage *v1alpha1.ShareDatasetBlobStorage, opts v1.UpdateOptions) (result *v1alpha1.ShareDatasetBlobStorage, err error) {
	result = &v1alpha1.ShareDatasetBlobStorage{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sharedatasetblobstorages").
...
func (c *shareDatasetBlobStorages) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *shareDatasetBlobStorages) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *shareDatasetBlobStorages) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ShareDatasetBlobStorage, err error) {
	result = &v1alpha1.ShareDatasetBlobStorage{}
