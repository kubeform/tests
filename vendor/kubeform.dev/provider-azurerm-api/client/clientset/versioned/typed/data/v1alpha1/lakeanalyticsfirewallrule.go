...
// LakeAnalyticsFirewallRulesGetter has a method to return a LakeAnalyticsFirewallRuleInterface.
...
// lakeAnalyticsFirewallRules implements LakeAnalyticsFirewallRuleInterface
type lakeAnalyticsFirewallRules struct {
	client rest.Interface
	ns     string
}

// newLakeAnalyticsFirewallRules returns a LakeAnalyticsFirewallRules
func newLakeAnalyticsFirewallRules(c *DataV1alpha1Client, namespace string) *lakeAnalyticsFirewallRules {
	return &lakeAnalyticsFirewallRules{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *lakeAnalyticsFirewallRules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LakeAnalyticsFirewallRule, err error) {
	result = &v1alpha1.LakeAnalyticsFirewallRule{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *lakeAnalyticsFirewallRules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LakeAnalyticsFirewallRuleList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.LakeAnalyticsFirewallRuleList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("lakeanalyticsfirewallrules").
...
func (c *lakeAnalyticsFirewallRules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *lakeAnalyticsFirewallRules) Create(ctx context.Context, lakeAnalyticsFirewallRule *v1alpha1.LakeAnalyticsFirewallRule, opts v1.CreateOptions) (result *v1alpha1.LakeAnalyticsFirewallRule, err error) {
	result = &v1alpha1.LakeAnalyticsFirewallRule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("lakeanalyticsfirewallrules").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(lakeAnalyticsFirewallRule).
		Do(ctx).
		Into(result)
	return
}
...
func (c *lakeAnalyticsFirewallRules) Update(ctx context.Context, lakeAnalyticsFirewallRule *v1alpha1.LakeAnalyticsFirewallRule, opts v1.UpdateOptions) (result *v1alpha1.LakeAnalyticsFirewallRule, err error) {
	result = &v1alpha1.LakeAnalyticsFirewallRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("lakeanalyticsfirewallrules").
		Name(lakeAnalyticsFirewallRule.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(lakeAnalyticsFirewallRule).
		Do(ctx).
		Into(result)
...
func (c *lakeAnalyticsFirewallRules) UpdateStatus(ctx context.Context, lakeAnalyticsFirewallRule *v1alpha1.LakeAnalyticsFirewallRule, opts v1.UpdateOptions) (result *v1alpha1.LakeAnalyticsFirewallRule, err error) {
	result = &v1alpha1.LakeAnalyticsFirewallRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("lakeanalyticsfirewallrules").
...
func (c *lakeAnalyticsFirewallRules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *lakeAnalyticsFirewallRules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *lakeAnalyticsFirewallRules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LakeAnalyticsFirewallRule, err error) {
	result = &v1alpha1.LakeAnalyticsFirewallRule{}
