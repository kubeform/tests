...
// FactoriesGetter has a method to return a FactoryInterface.
...
// factories implements FactoryInterface
type factories struct {
	client rest.Interface
	ns     string
}

// newFactories returns a Factories
func newFactories(c *DataV1alpha1Client, namespace string) *factories {
	return &factories{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *factories) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Factory, err error) {
	result = &v1alpha1.Factory{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("factories").
		Name(name).
...
func (c *factories) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FactoryList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.FactoryList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("factories").
...
func (c *factories) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *factories) Create(ctx context.Context, factory *v1alpha1.Factory, opts v1.CreateOptions) (result *v1alpha1.Factory, err error) {
	result = &v1alpha1.Factory{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("factories").
...
func (c *factories) Update(ctx context.Context, factory *v1alpha1.Factory, opts v1.UpdateOptions) (result *v1alpha1.Factory, err error) {
	result = &v1alpha1.Factory{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("factories").
...
func (c *factories) UpdateStatus(ctx context.Context, factory *v1alpha1.Factory, opts v1.UpdateOptions) (result *v1alpha1.Factory, err error) {
	result = &v1alpha1.Factory{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("factories").
...
func (c *factories) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *factories) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *factories) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Factory, err error) {
	result = &v1alpha1.Factory{}
