...
// ShareDatasetKustoClustersGetter has a method to return a ShareDatasetKustoClusterInterface.
...
// shareDatasetKustoClusters implements ShareDatasetKustoClusterInterface
type shareDatasetKustoClusters struct {
	client rest.Interface
	ns     string
}

// newShareDatasetKustoClusters returns a ShareDatasetKustoClusters
func newShareDatasetKustoClusters(c *DataV1alpha1Client, namespace string) *shareDatasetKustoClusters {
	return &shareDatasetKustoClusters{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *shareDatasetKustoClusters) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ShareDatasetKustoCluster, err error) {
	result = &v1alpha1.ShareDatasetKustoCluster{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *shareDatasetKustoClusters) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ShareDatasetKustoClusterList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ShareDatasetKustoClusterList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("sharedatasetkustoclusters").
...
func (c *shareDatasetKustoClusters) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *shareDatasetKustoClusters) Create(ctx context.Context, shareDatasetKustoCluster *v1alpha1.ShareDatasetKustoCluster, opts v1.CreateOptions) (result *v1alpha1.ShareDatasetKustoCluster, err error) {
	result = &v1alpha1.ShareDatasetKustoCluster{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("sharedatasetkustoclusters").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(shareDatasetKustoCluster).
		Do(ctx).
		Into(result)
	return
}
...
func (c *shareDatasetKustoClusters) Update(ctx context.Context, shareDatasetKustoCluster *v1alpha1.ShareDatasetKustoCluster, opts v1.UpdateOptions) (result *v1alpha1.ShareDatasetKustoCluster, err error) {
	result = &v1alpha1.ShareDatasetKustoCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sharedatasetkustoclusters").
		Name(shareDatasetKustoCluster.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(shareDatasetKustoCluster).
		Do(ctx).
		Into(result)
...
func (c *shareDatasetKustoClusters) UpdateStatus(ctx context.Context, shareDatasetKustoCluster *v1alpha1.ShareDatasetKustoCluster, opts v1.UpdateOptions) (result *v1alpha1.ShareDatasetKustoCluster, err error) {
	result = &v1alpha1.ShareDatasetKustoCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sharedatasetkustoclusters").
...
func (c *shareDatasetKustoClusters) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *shareDatasetKustoClusters) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *shareDatasetKustoClusters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ShareDatasetKustoCluster, err error) {
	result = &v1alpha1.ShareDatasetKustoCluster{}
