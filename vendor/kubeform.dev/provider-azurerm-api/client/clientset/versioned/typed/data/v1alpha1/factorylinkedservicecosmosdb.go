...
// FactoryLinkedServiceCosmosdbsGetter has a method to return a FactoryLinkedServiceCosmosdbInterface.
...
// factoryLinkedServiceCosmosdbs implements FactoryLinkedServiceCosmosdbInterface
type factoryLinkedServiceCosmosdbs struct {
	client rest.Interface
	ns     string
}

// newFactoryLinkedServiceCosmosdbs returns a FactoryLinkedServiceCosmosdbs
func newFactoryLinkedServiceCosmosdbs(c *DataV1alpha1Client, namespace string) *factoryLinkedServiceCosmosdbs {
	return &factoryLinkedServiceCosmosdbs{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *factoryLinkedServiceCosmosdbs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.FactoryLinkedServiceCosmosdb, err error) {
	result = &v1alpha1.FactoryLinkedServiceCosmosdb{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *factoryLinkedServiceCosmosdbs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FactoryLinkedServiceCosmosdbList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.FactoryLinkedServiceCosmosdbList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("factorylinkedservicecosmosdbs").
...
func (c *factoryLinkedServiceCosmosdbs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *factoryLinkedServiceCosmosdbs) Create(ctx context.Context, factoryLinkedServiceCosmosdb *v1alpha1.FactoryLinkedServiceCosmosdb, opts v1.CreateOptions) (result *v1alpha1.FactoryLinkedServiceCosmosdb, err error) {
	result = &v1alpha1.FactoryLinkedServiceCosmosdb{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("factorylinkedservicecosmosdbs").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(factoryLinkedServiceCosmosdb).
		Do(ctx).
		Into(result)
	return
}
...
func (c *factoryLinkedServiceCosmosdbs) Update(ctx context.Context, factoryLinkedServiceCosmosdb *v1alpha1.FactoryLinkedServiceCosmosdb, opts v1.UpdateOptions) (result *v1alpha1.FactoryLinkedServiceCosmosdb, err error) {
	result = &v1alpha1.FactoryLinkedServiceCosmosdb{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("factorylinkedservicecosmosdbs").
		Name(factoryLinkedServiceCosmosdb.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(factoryLinkedServiceCosmosdb).
		Do(ctx).
		Into(result)
...
func (c *factoryLinkedServiceCosmosdbs) UpdateStatus(ctx context.Context, factoryLinkedServiceCosmosdb *v1alpha1.FactoryLinkedServiceCosmosdb, opts v1.UpdateOptions) (result *v1alpha1.FactoryLinkedServiceCosmosdb, err error) {
	result = &v1alpha1.FactoryLinkedServiceCosmosdb{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("factorylinkedservicecosmosdbs").
...
func (c *factoryLinkedServiceCosmosdbs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *factoryLinkedServiceCosmosdbs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *factoryLinkedServiceCosmosdbs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.FactoryLinkedServiceCosmosdb, err error) {
	result = &v1alpha1.FactoryLinkedServiceCosmosdb{}
