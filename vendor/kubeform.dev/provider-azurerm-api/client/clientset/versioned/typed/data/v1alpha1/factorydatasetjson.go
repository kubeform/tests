...
// FactoryDatasetJSONsGetter has a method to return a FactoryDatasetJSONInterface.
...
// factoryDatasetJSONs implements FactoryDatasetJSONInterface
type factoryDatasetJSONs struct {
	client rest.Interface
	ns     string
}

// newFactoryDatasetJSONs returns a FactoryDatasetJSONs
func newFactoryDatasetJSONs(c *DataV1alpha1Client, namespace string) *factoryDatasetJSONs {
	return &factoryDatasetJSONs{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *factoryDatasetJSONs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.FactoryDatasetJSON, err error) {
	result = &v1alpha1.FactoryDatasetJSON{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *factoryDatasetJSONs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FactoryDatasetJSONList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.FactoryDatasetJSONList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("factorydatasetjsons").
...
func (c *factoryDatasetJSONs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *factoryDatasetJSONs) Create(ctx context.Context, factoryDatasetJSON *v1alpha1.FactoryDatasetJSON, opts v1.CreateOptions) (result *v1alpha1.FactoryDatasetJSON, err error) {
	result = &v1alpha1.FactoryDatasetJSON{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("factorydatasetjsons").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(factoryDatasetJSON).
		Do(ctx).
		Into(result)
	return
}
...
func (c *factoryDatasetJSONs) Update(ctx context.Context, factoryDatasetJSON *v1alpha1.FactoryDatasetJSON, opts v1.UpdateOptions) (result *v1alpha1.FactoryDatasetJSON, err error) {
	result = &v1alpha1.FactoryDatasetJSON{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("factorydatasetjsons").
		Name(factoryDatasetJSON.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(factoryDatasetJSON).
		Do(ctx).
		Into(result)
...
func (c *factoryDatasetJSONs) UpdateStatus(ctx context.Context, factoryDatasetJSON *v1alpha1.FactoryDatasetJSON, opts v1.UpdateOptions) (result *v1alpha1.FactoryDatasetJSON, err error) {
	result = &v1alpha1.FactoryDatasetJSON{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("factorydatasetjsons").
...
func (c *factoryDatasetJSONs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *factoryDatasetJSONs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *factoryDatasetJSONs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.FactoryDatasetJSON, err error) {
	result = &v1alpha1.FactoryDatasetJSON{}
