...
// ShareDatasetDataLakeGen2sGetter has a method to return a ShareDatasetDataLakeGen2Interface.
...
// shareDatasetDataLakeGen2s implements ShareDatasetDataLakeGen2Interface
type shareDatasetDataLakeGen2s struct {
	client rest.Interface
	ns     string
}

// newShareDatasetDataLakeGen2s returns a ShareDatasetDataLakeGen2s
func newShareDatasetDataLakeGen2s(c *DataV1alpha1Client, namespace string) *shareDatasetDataLakeGen2s {
	return &shareDatasetDataLakeGen2s{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *shareDatasetDataLakeGen2s) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ShareDatasetDataLakeGen2, err error) {
	result = &v1alpha1.ShareDatasetDataLakeGen2{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *shareDatasetDataLakeGen2s) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ShareDatasetDataLakeGen2List, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ShareDatasetDataLakeGen2List{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("sharedatasetdatalakegen2s").
...
func (c *shareDatasetDataLakeGen2s) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *shareDatasetDataLakeGen2s) Create(ctx context.Context, shareDatasetDataLakeGen2 *v1alpha1.ShareDatasetDataLakeGen2, opts v1.CreateOptions) (result *v1alpha1.ShareDatasetDataLakeGen2, err error) {
	result = &v1alpha1.ShareDatasetDataLakeGen2{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("sharedatasetdatalakegen2s").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(shareDatasetDataLakeGen2).
		Do(ctx).
		Into(result)
	return
}
...
func (c *shareDatasetDataLakeGen2s) Update(ctx context.Context, shareDatasetDataLakeGen2 *v1alpha1.ShareDatasetDataLakeGen2, opts v1.UpdateOptions) (result *v1alpha1.ShareDatasetDataLakeGen2, err error) {
	result = &v1alpha1.ShareDatasetDataLakeGen2{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sharedatasetdatalakegen2s").
		Name(shareDatasetDataLakeGen2.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(shareDatasetDataLakeGen2).
		Do(ctx).
		Into(result)
...
func (c *shareDatasetDataLakeGen2s) UpdateStatus(ctx context.Context, shareDatasetDataLakeGen2 *v1alpha1.ShareDatasetDataLakeGen2, opts v1.UpdateOptions) (result *v1alpha1.ShareDatasetDataLakeGen2, err error) {
	result = &v1alpha1.ShareDatasetDataLakeGen2{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sharedatasetdatalakegen2s").
...
func (c *shareDatasetDataLakeGen2s) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *shareDatasetDataLakeGen2s) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *shareDatasetDataLakeGen2s) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ShareDatasetDataLakeGen2, err error) {
	result = &v1alpha1.ShareDatasetDataLakeGen2{}
