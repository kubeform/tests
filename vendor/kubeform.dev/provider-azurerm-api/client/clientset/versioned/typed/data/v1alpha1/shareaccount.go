...
// ShareAccountsGetter has a method to return a ShareAccountInterface.
...
// shareAccounts implements ShareAccountInterface
type shareAccounts struct {
	client rest.Interface
	ns     string
}

// newShareAccounts returns a ShareAccounts
func newShareAccounts(c *DataV1alpha1Client, namespace string) *shareAccounts {
...
func (c *shareAccounts) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ShareAccount, err error) {
	result = &v1alpha1.ShareAccount{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *shareAccounts) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ShareAccountList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ShareAccountList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("shareaccounts").
...
func (c *shareAccounts) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *shareAccounts) Create(ctx context.Context, shareAccount *v1alpha1.ShareAccount, opts v1.CreateOptions) (result *v1alpha1.ShareAccount, err error) {
	result = &v1alpha1.ShareAccount{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("shareaccounts").
...
func (c *shareAccounts) Update(ctx context.Context, shareAccount *v1alpha1.ShareAccount, opts v1.UpdateOptions) (result *v1alpha1.ShareAccount, err error) {
	result = &v1alpha1.ShareAccount{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("shareaccounts").
...
func (c *shareAccounts) UpdateStatus(ctx context.Context, shareAccount *v1alpha1.ShareAccount, opts v1.UpdateOptions) (result *v1alpha1.ShareAccount, err error) {
	result = &v1alpha1.ShareAccount{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("shareaccounts").
...
func (c *shareAccounts) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *shareAccounts) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *shareAccounts) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ShareAccount, err error) {
	result = &v1alpha1.ShareAccount{}
