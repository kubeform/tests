...
// LakeStoreFirewallRulesGetter has a method to return a LakeStoreFirewallRuleInterface.
...
// lakeStoreFirewallRules implements LakeStoreFirewallRuleInterface
type lakeStoreFirewallRules struct {
	client rest.Interface
	ns     string
}

// newLakeStoreFirewallRules returns a LakeStoreFirewallRules
func newLakeStoreFirewallRules(c *DataV1alpha1Client, namespace string) *lakeStoreFirewallRules {
	return &lakeStoreFirewallRules{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *lakeStoreFirewallRules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LakeStoreFirewallRule, err error) {
	result = &v1alpha1.LakeStoreFirewallRule{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *lakeStoreFirewallRules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LakeStoreFirewallRuleList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.LakeStoreFirewallRuleList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("lakestorefirewallrules").
...
func (c *lakeStoreFirewallRules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *lakeStoreFirewallRules) Create(ctx context.Context, lakeStoreFirewallRule *v1alpha1.LakeStoreFirewallRule, opts v1.CreateOptions) (result *v1alpha1.LakeStoreFirewallRule, err error) {
	result = &v1alpha1.LakeStoreFirewallRule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("lakestorefirewallrules").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(lakeStoreFirewallRule).
		Do(ctx).
		Into(result)
	return
}
...
func (c *lakeStoreFirewallRules) Update(ctx context.Context, lakeStoreFirewallRule *v1alpha1.LakeStoreFirewallRule, opts v1.UpdateOptions) (result *v1alpha1.LakeStoreFirewallRule, err error) {
	result = &v1alpha1.LakeStoreFirewallRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("lakestorefirewallrules").
		Name(lakeStoreFirewallRule.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(lakeStoreFirewallRule).
		Do(ctx).
		Into(result)
...
func (c *lakeStoreFirewallRules) UpdateStatus(ctx context.Context, lakeStoreFirewallRule *v1alpha1.LakeStoreFirewallRule, opts v1.UpdateOptions) (result *v1alpha1.LakeStoreFirewallRule, err error) {
	result = &v1alpha1.LakeStoreFirewallRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("lakestorefirewallrules").
...
func (c *lakeStoreFirewallRules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *lakeStoreFirewallRules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *lakeStoreFirewallRules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LakeStoreFirewallRule, err error) {
	result = &v1alpha1.LakeStoreFirewallRule{}
