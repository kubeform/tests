...
// FactoryPipelinesGetter has a method to return a FactoryPipelineInterface.
...
// factoryPipelines implements FactoryPipelineInterface
type factoryPipelines struct {
	client rest.Interface
	ns     string
}

// newFactoryPipelines returns a FactoryPipelines
func newFactoryPipelines(c *DataV1alpha1Client, namespace string) *factoryPipelines {
...
func (c *factoryPipelines) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.FactoryPipeline, err error) {
	result = &v1alpha1.FactoryPipeline{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *factoryPipelines) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FactoryPipelineList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.FactoryPipelineList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("factorypipelines").
...
func (c *factoryPipelines) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *factoryPipelines) Create(ctx context.Context, factoryPipeline *v1alpha1.FactoryPipeline, opts v1.CreateOptions) (result *v1alpha1.FactoryPipeline, err error) {
	result = &v1alpha1.FactoryPipeline{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("factorypipelines").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(factoryPipeline).
		Do(ctx).
		Into(result)
	return
}
...
func (c *factoryPipelines) Update(ctx context.Context, factoryPipeline *v1alpha1.FactoryPipeline, opts v1.UpdateOptions) (result *v1alpha1.FactoryPipeline, err error) {
	result = &v1alpha1.FactoryPipeline{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("factorypipelines").
		Name(factoryPipeline.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(factoryPipeline).
		Do(ctx).
		Into(result)
...
func (c *factoryPipelines) UpdateStatus(ctx context.Context, factoryPipeline *v1alpha1.FactoryPipeline, opts v1.UpdateOptions) (result *v1alpha1.FactoryPipeline, err error) {
	result = &v1alpha1.FactoryPipeline{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("factorypipelines").
...
func (c *factoryPipelines) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *factoryPipelines) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *factoryPipelines) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.FactoryPipeline, err error) {
	result = &v1alpha1.FactoryPipeline{}
