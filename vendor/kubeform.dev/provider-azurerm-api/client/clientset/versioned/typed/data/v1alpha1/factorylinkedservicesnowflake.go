...
// FactoryLinkedServiceSnowflakesGetter has a method to return a FactoryLinkedServiceSnowflakeInterface.
...
// factoryLinkedServiceSnowflakes implements FactoryLinkedServiceSnowflakeInterface
type factoryLinkedServiceSnowflakes struct {
	client rest.Interface
	ns     string
}

// newFactoryLinkedServiceSnowflakes returns a FactoryLinkedServiceSnowflakes
func newFactoryLinkedServiceSnowflakes(c *DataV1alpha1Client, namespace string) *factoryLinkedServiceSnowflakes {
	return &factoryLinkedServiceSnowflakes{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *factoryLinkedServiceSnowflakes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.FactoryLinkedServiceSnowflake, err error) {
	result = &v1alpha1.FactoryLinkedServiceSnowflake{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *factoryLinkedServiceSnowflakes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FactoryLinkedServiceSnowflakeList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.FactoryLinkedServiceSnowflakeList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("factorylinkedservicesnowflakes").
...
func (c *factoryLinkedServiceSnowflakes) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *factoryLinkedServiceSnowflakes) Create(ctx context.Context, factoryLinkedServiceSnowflake *v1alpha1.FactoryLinkedServiceSnowflake, opts v1.CreateOptions) (result *v1alpha1.FactoryLinkedServiceSnowflake, err error) {
	result = &v1alpha1.FactoryLinkedServiceSnowflake{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("factorylinkedservicesnowflakes").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(factoryLinkedServiceSnowflake).
		Do(ctx).
		Into(result)
	return
}
...
func (c *factoryLinkedServiceSnowflakes) Update(ctx context.Context, factoryLinkedServiceSnowflake *v1alpha1.FactoryLinkedServiceSnowflake, opts v1.UpdateOptions) (result *v1alpha1.FactoryLinkedServiceSnowflake, err error) {
	result = &v1alpha1.FactoryLinkedServiceSnowflake{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("factorylinkedservicesnowflakes").
		Name(factoryLinkedServiceSnowflake.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(factoryLinkedServiceSnowflake).
		Do(ctx).
		Into(result)
...
func (c *factoryLinkedServiceSnowflakes) UpdateStatus(ctx context.Context, factoryLinkedServiceSnowflake *v1alpha1.FactoryLinkedServiceSnowflake, opts v1.UpdateOptions) (result *v1alpha1.FactoryLinkedServiceSnowflake, err error) {
	result = &v1alpha1.FactoryLinkedServiceSnowflake{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("factorylinkedservicesnowflakes").
...
func (c *factoryLinkedServiceSnowflakes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *factoryLinkedServiceSnowflakes) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *factoryLinkedServiceSnowflakes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.FactoryLinkedServiceSnowflake, err error) {
	result = &v1alpha1.FactoryLinkedServiceSnowflake{}
