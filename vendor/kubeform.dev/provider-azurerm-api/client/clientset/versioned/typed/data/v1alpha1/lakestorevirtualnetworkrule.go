...
// LakeStoreVirtualNetworkRulesGetter has a method to return a LakeStoreVirtualNetworkRuleInterface.
...
// lakeStoreVirtualNetworkRules implements LakeStoreVirtualNetworkRuleInterface
type lakeStoreVirtualNetworkRules struct {
	client rest.Interface
	ns     string
}

// newLakeStoreVirtualNetworkRules returns a LakeStoreVirtualNetworkRules
func newLakeStoreVirtualNetworkRules(c *DataV1alpha1Client, namespace string) *lakeStoreVirtualNetworkRules {
	return &lakeStoreVirtualNetworkRules{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *lakeStoreVirtualNetworkRules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LakeStoreVirtualNetworkRule, err error) {
	result = &v1alpha1.LakeStoreVirtualNetworkRule{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *lakeStoreVirtualNetworkRules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LakeStoreVirtualNetworkRuleList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.LakeStoreVirtualNetworkRuleList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("lakestorevirtualnetworkrules").
...
func (c *lakeStoreVirtualNetworkRules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *lakeStoreVirtualNetworkRules) Create(ctx context.Context, lakeStoreVirtualNetworkRule *v1alpha1.LakeStoreVirtualNetworkRule, opts v1.CreateOptions) (result *v1alpha1.LakeStoreVirtualNetworkRule, err error) {
	result = &v1alpha1.LakeStoreVirtualNetworkRule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("lakestorevirtualnetworkrules").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(lakeStoreVirtualNetworkRule).
		Do(ctx).
		Into(result)
	return
}
...
func (c *lakeStoreVirtualNetworkRules) Update(ctx context.Context, lakeStoreVirtualNetworkRule *v1alpha1.LakeStoreVirtualNetworkRule, opts v1.UpdateOptions) (result *v1alpha1.LakeStoreVirtualNetworkRule, err error) {
	result = &v1alpha1.LakeStoreVirtualNetworkRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("lakestorevirtualnetworkrules").
		Name(lakeStoreVirtualNetworkRule.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(lakeStoreVirtualNetworkRule).
		Do(ctx).
		Into(result)
...
func (c *lakeStoreVirtualNetworkRules) UpdateStatus(ctx context.Context, lakeStoreVirtualNetworkRule *v1alpha1.LakeStoreVirtualNetworkRule, opts v1.UpdateOptions) (result *v1alpha1.LakeStoreVirtualNetworkRule, err error) {
	result = &v1alpha1.LakeStoreVirtualNetworkRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("lakestorevirtualnetworkrules").
...
func (c *lakeStoreVirtualNetworkRules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *lakeStoreVirtualNetworkRules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *lakeStoreVirtualNetworkRules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LakeStoreVirtualNetworkRule, err error) {
	result = &v1alpha1.LakeStoreVirtualNetworkRule{}
