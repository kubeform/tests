...
import (
	v1alpha1 "kubeform.dev/provider-azurerm-api/apis/kubernetescluster/v1alpha1"
	"kubeform.dev/provider-azurerm-api/client/clientset/versioned/scheme"

	rest "k8s.io/client-go/rest"
)

type KubernetesclusterV1alpha1Interface interface {
...
func NewForConfig(c *rest.Config) (*KubernetesclusterV1alpha1Client, error) {
	...
	return &KubernetesclusterV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new KubernetesclusterV1alpha1Client for the given config and
...
func New(c rest.Interface) *KubernetesclusterV1alpha1Client {
	return &KubernetesclusterV1alpha1Client{c}
}
