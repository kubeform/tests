...
func NewForConfig(c *rest.Config) (*TrafficmanagerV1alpha1Client, error) {
	...
	return &TrafficmanagerV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new TrafficmanagerV1alpha1Client for the given config and
...
func New(c rest.Interface) *TrafficmanagerV1alpha1Client {
	return &TrafficmanagerV1alpha1Client{c}
}
...
func (c *TrafficmanagerV1alpha1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
