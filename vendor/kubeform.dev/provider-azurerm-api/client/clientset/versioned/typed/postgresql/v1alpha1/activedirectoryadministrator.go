...
// ActiveDirectoryAdministratorsGetter has a method to return a ActiveDirectoryAdministratorInterface.
...
// activeDirectoryAdministrators implements ActiveDirectoryAdministratorInterface
type activeDirectoryAdministrators struct {
	client rest.Interface
	ns     string
}

// newActiveDirectoryAdministrators returns a ActiveDirectoryAdministrators
func newActiveDirectoryAdministrators(c *PostgresqlV1alpha1Client, namespace string) *activeDirectoryAdministrators {
	return &activeDirectoryAdministrators{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *activeDirectoryAdministrators) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ActiveDirectoryAdministrator, err error) {
	result = &v1alpha1.ActiveDirectoryAdministrator{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *activeDirectoryAdministrators) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ActiveDirectoryAdministratorList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ActiveDirectoryAdministratorList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("activedirectoryadministrators").
...
func (c *activeDirectoryAdministrators) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *activeDirectoryAdministrators) Create(ctx context.Context, activeDirectoryAdministrator *v1alpha1.ActiveDirectoryAdministrator, opts v1.CreateOptions) (result *v1alpha1.ActiveDirectoryAdministrator, err error) {
	result = &v1alpha1.ActiveDirectoryAdministrator{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("activedirectoryadministrators").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(activeDirectoryAdministrator).
		Do(ctx).
		Into(result)
	return
}
...
func (c *activeDirectoryAdministrators) Update(ctx context.Context, activeDirectoryAdministrator *v1alpha1.ActiveDirectoryAdministrator, opts v1.UpdateOptions) (result *v1alpha1.ActiveDirectoryAdministrator, err error) {
	result = &v1alpha1.ActiveDirectoryAdministrator{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("activedirectoryadministrators").
		Name(activeDirectoryAdministrator.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(activeDirectoryAdministrator).
		Do(ctx).
		Into(result)
...
func (c *activeDirectoryAdministrators) UpdateStatus(ctx context.Context, activeDirectoryAdministrator *v1alpha1.ActiveDirectoryAdministrator, opts v1.UpdateOptions) (result *v1alpha1.ActiveDirectoryAdministrator, err error) {
	result = &v1alpha1.ActiveDirectoryAdministrator{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("activedirectoryadministrators").
...
func (c *activeDirectoryAdministrators) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *activeDirectoryAdministrators) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *activeDirectoryAdministrators) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ActiveDirectoryAdministrator, err error) {
	result = &v1alpha1.ActiveDirectoryAdministrator{}
