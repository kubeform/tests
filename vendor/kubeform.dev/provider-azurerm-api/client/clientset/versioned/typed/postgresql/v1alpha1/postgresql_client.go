...
type PostgresqlV1alpha1Interface interface {
...
func NewForConfig(c *rest.Config) (*PostgresqlV1alpha1Client, error) {
	...
	return &PostgresqlV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new PostgresqlV1alpha1Client for the given config and
...
func New(c rest.Interface) *PostgresqlV1alpha1Client {
	return &PostgresqlV1alpha1Client{c}
}
