...
// VpnV1alpha1Client is used to interact with features provided by the vpn.azurerm.kubeform.com group.
...
func (c *VpnV1alpha1Client) ServerConfigurations(namespace string) ServerConfigurationInterface {
	return newServerConfigurations(c, namespace)
}

func (c *VpnV1alpha1Client) Sites(namespace string) SiteInterface {
