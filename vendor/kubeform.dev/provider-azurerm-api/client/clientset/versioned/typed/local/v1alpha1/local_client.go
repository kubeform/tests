...
// LocalV1alpha1Client is used to interact with features provided by the local.azurerm.kubeform.com group.
type LocalV1alpha1Client struct {
	restClient rest.Interface
}

func (c *LocalV1alpha1Client) NetworkGateways(namespace string) NetworkGatewayInterface {
