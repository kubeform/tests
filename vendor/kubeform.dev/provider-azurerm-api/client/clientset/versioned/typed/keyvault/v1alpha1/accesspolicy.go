...
func newAccessPolicies(c *KeyvaultV1alpha1Client, namespace string) *accessPolicies {
...
func (c *accessPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AccessPolicy, err error) {
...
func (c *accessPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AccessPolicyList, err error) {
...
func (c *accessPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *accessPolicies) Create(ctx context.Context, accessPolicy *v1alpha1.AccessPolicy, opts v1.CreateOptions) (result *v1alpha1.AccessPolicy, err error) {
	result = &v1alpha1.AccessPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("accesspolicies").
...
func (c *accessPolicies) Update(ctx context.Context, accessPolicy *v1alpha1.AccessPolicy, opts v1.UpdateOptions) (result *v1alpha1.AccessPolicy, err error) {
	result = &v1alpha1.AccessPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("accesspolicies").
...
func (c *accessPolicies) UpdateStatus(ctx context.Context, accessPolicy *v1alpha1.AccessPolicy, opts v1.UpdateOptions) (result *v1alpha1.AccessPolicy, err error) {
	result = &v1alpha1.AccessPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("accesspolicies").
...
func (c *accessPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *accessPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *accessPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AccessPolicy, err error) {
	result = &v1alpha1.AccessPolicy{}
