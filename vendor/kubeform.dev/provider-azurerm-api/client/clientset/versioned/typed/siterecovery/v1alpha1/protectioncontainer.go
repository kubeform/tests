...
// ProtectionContainersGetter has a method to return a ProtectionContainerInterface.
...
// protectionContainers implements ProtectionContainerInterface
type protectionContainers struct {
	client rest.Interface
	ns     string
}

// newProtectionContainers returns a ProtectionContainers
func newProtectionContainers(c *SiterecoveryV1alpha1Client, namespace string) *protectionContainers {
...
func (c *protectionContainers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ProtectionContainer, err error) {
	result = &v1alpha1.ProtectionContainer{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *protectionContainers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ProtectionContainerList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ProtectionContainerList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("protectioncontainers").
...
func (c *protectionContainers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *protectionContainers) Create(ctx context.Context, protectionContainer *v1alpha1.ProtectionContainer, opts v1.CreateOptions) (result *v1alpha1.ProtectionContainer, err error) {
	result = &v1alpha1.ProtectionContainer{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("protectioncontainers").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(protectionContainer).
		Do(ctx).
		Into(result)
	return
}
...
func (c *protectionContainers) Update(ctx context.Context, protectionContainer *v1alpha1.ProtectionContainer, opts v1.UpdateOptions) (result *v1alpha1.ProtectionContainer, err error) {
	result = &v1alpha1.ProtectionContainer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("protectioncontainers").
...
func (c *protectionContainers) UpdateStatus(ctx context.Context, protectionContainer *v1alpha1.ProtectionContainer, opts v1.UpdateOptions) (result *v1alpha1.ProtectionContainer, err error) {
	result = &v1alpha1.ProtectionContainer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("protectioncontainers").
...
func (c *protectionContainers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *protectionContainers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *protectionContainers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ProtectionContainer, err error) {
	result = &v1alpha1.ProtectionContainer{}
