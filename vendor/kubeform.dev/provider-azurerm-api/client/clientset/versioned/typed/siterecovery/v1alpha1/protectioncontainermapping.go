...
// ProtectionContainerMappingsGetter has a method to return a ProtectionContainerMappingInterface.
...
// protectionContainerMappings implements ProtectionContainerMappingInterface
type protectionContainerMappings struct {
	client rest.Interface
	ns     string
}

// newProtectionContainerMappings returns a ProtectionContainerMappings
func newProtectionContainerMappings(c *SiterecoveryV1alpha1Client, namespace string) *protectionContainerMappings {
	return &protectionContainerMappings{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *protectionContainerMappings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ProtectionContainerMapping, err error) {
	result = &v1alpha1.ProtectionContainerMapping{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *protectionContainerMappings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ProtectionContainerMappingList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ProtectionContainerMappingList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("protectioncontainermappings").
...
func (c *protectionContainerMappings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *protectionContainerMappings) Create(ctx context.Context, protectionContainerMapping *v1alpha1.ProtectionContainerMapping, opts v1.CreateOptions) (result *v1alpha1.ProtectionContainerMapping, err error) {
	result = &v1alpha1.ProtectionContainerMapping{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("protectioncontainermappings").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(protectionContainerMapping).
		Do(ctx).
		Into(result)
	return
}
...
func (c *protectionContainerMappings) Update(ctx context.Context, protectionContainerMapping *v1alpha1.ProtectionContainerMapping, opts v1.UpdateOptions) (result *v1alpha1.ProtectionContainerMapping, err error) {
	result = &v1alpha1.ProtectionContainerMapping{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("protectioncontainermappings").
		Name(protectionContainerMapping.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(protectionContainerMapping).
		Do(ctx).
		Into(result)
...
func (c *protectionContainerMappings) UpdateStatus(ctx context.Context, protectionContainerMapping *v1alpha1.ProtectionContainerMapping, opts v1.UpdateOptions) (result *v1alpha1.ProtectionContainerMapping, err error) {
	result = &v1alpha1.ProtectionContainerMapping{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("protectioncontainermappings").
...
func (c *protectionContainerMappings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *protectionContainerMappings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *protectionContainerMappings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ProtectionContainerMapping, err error) {
	result = &v1alpha1.ProtectionContainerMapping{}
