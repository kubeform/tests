...
// FabricsGetter has a method to return a FabricInterface.
...
// fabrics implements FabricInterface
type fabrics struct {
	client rest.Interface
	ns     string
}

// newFabrics returns a Fabrics
func newFabrics(c *SiterecoveryV1alpha1Client, namespace string) *fabrics {
	return &fabrics{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *fabrics) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Fabric, err error) {
	result = &v1alpha1.Fabric{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("fabrics").
		Name(name).
...
func (c *fabrics) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FabricList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.FabricList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("fabrics").
...
func (c *fabrics) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *fabrics) Create(ctx context.Context, fabric *v1alpha1.Fabric, opts v1.CreateOptions) (result *v1alpha1.Fabric, err error) {
	result = &v1alpha1.Fabric{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("fabrics").
...
func (c *fabrics) Update(ctx context.Context, fabric *v1alpha1.Fabric, opts v1.UpdateOptions) (result *v1alpha1.Fabric, err error) {
	result = &v1alpha1.Fabric{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("fabrics").
...
func (c *fabrics) UpdateStatus(ctx context.Context, fabric *v1alpha1.Fabric, opts v1.UpdateOptions) (result *v1alpha1.Fabric, err error) {
	result = &v1alpha1.Fabric{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("fabrics").
...
func (c *fabrics) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *fabrics) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *fabrics) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Fabric, err error) {
	result = &v1alpha1.Fabric{}
