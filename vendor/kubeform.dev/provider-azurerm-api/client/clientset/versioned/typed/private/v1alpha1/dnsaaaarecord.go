...
func newDnsAaaaRecords(c *PrivateV1alpha1Client, namespace string) *dnsAaaaRecords {
...
func (c *dnsAaaaRecords) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DnsAaaaRecord, err error) {
...
func (c *dnsAaaaRecords) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DnsAaaaRecordList, err error) {
...
func (c *dnsAaaaRecords) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dnsAaaaRecords) Create(ctx context.Context, dnsAaaaRecord *v1alpha1.DnsAaaaRecord, opts v1.CreateOptions) (result *v1alpha1.DnsAaaaRecord, err error) {
	result = &v1alpha1.DnsAaaaRecord{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("dnsaaaarecords").
...
func (c *dnsAaaaRecords) Update(ctx context.Context, dnsAaaaRecord *v1alpha1.DnsAaaaRecord, opts v1.UpdateOptions) (result *v1alpha1.DnsAaaaRecord, err error) {
	result = &v1alpha1.DnsAaaaRecord{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dnsaaaarecords").
...
func (c *dnsAaaaRecords) UpdateStatus(ctx context.Context, dnsAaaaRecord *v1alpha1.DnsAaaaRecord, opts v1.UpdateOptions) (result *v1alpha1.DnsAaaaRecord, err error) {
	result = &v1alpha1.DnsAaaaRecord{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dnsaaaarecords").
...
func (c *dnsAaaaRecords) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *dnsAaaaRecords) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *dnsAaaaRecords) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DnsAaaaRecord, err error) {
	result = &v1alpha1.DnsAaaaRecord{}
