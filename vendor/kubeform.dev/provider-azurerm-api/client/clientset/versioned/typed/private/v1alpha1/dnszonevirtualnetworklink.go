...
// DnsZoneVirtualNetworkLinksGetter has a method to return a DnsZoneVirtualNetworkLinkInterface.
...
// dnsZoneVirtualNetworkLinks implements DnsZoneVirtualNetworkLinkInterface
type dnsZoneVirtualNetworkLinks struct {
	client rest.Interface
	ns     string
}

// newDnsZoneVirtualNetworkLinks returns a DnsZoneVirtualNetworkLinks
func newDnsZoneVirtualNetworkLinks(c *PrivateV1alpha1Client, namespace string) *dnsZoneVirtualNetworkLinks {
	return &dnsZoneVirtualNetworkLinks{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *dnsZoneVirtualNetworkLinks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DnsZoneVirtualNetworkLink, err error) {
	result = &v1alpha1.DnsZoneVirtualNetworkLink{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *dnsZoneVirtualNetworkLinks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DnsZoneVirtualNetworkLinkList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.DnsZoneVirtualNetworkLinkList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("dnszonevirtualnetworklinks").
...
func (c *dnsZoneVirtualNetworkLinks) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dnsZoneVirtualNetworkLinks) Create(ctx context.Context, dnsZoneVirtualNetworkLink *v1alpha1.DnsZoneVirtualNetworkLink, opts v1.CreateOptions) (result *v1alpha1.DnsZoneVirtualNetworkLink, err error) {
	result = &v1alpha1.DnsZoneVirtualNetworkLink{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("dnszonevirtualnetworklinks").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(dnsZoneVirtualNetworkLink).
		Do(ctx).
		Into(result)
	return
}
...
func (c *dnsZoneVirtualNetworkLinks) Update(ctx context.Context, dnsZoneVirtualNetworkLink *v1alpha1.DnsZoneVirtualNetworkLink, opts v1.UpdateOptions) (result *v1alpha1.DnsZoneVirtualNetworkLink, err error) {
	result = &v1alpha1.DnsZoneVirtualNetworkLink{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dnszonevirtualnetworklinks").
		Name(dnsZoneVirtualNetworkLink.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(dnsZoneVirtualNetworkLink).
		Do(ctx).
		Into(result)
...
func (c *dnsZoneVirtualNetworkLinks) UpdateStatus(ctx context.Context, dnsZoneVirtualNetworkLink *v1alpha1.DnsZoneVirtualNetworkLink, opts v1.UpdateOptions) (result *v1alpha1.DnsZoneVirtualNetworkLink, err error) {
	result = &v1alpha1.DnsZoneVirtualNetworkLink{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dnszonevirtualnetworklinks").
...
func (c *dnsZoneVirtualNetworkLinks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *dnsZoneVirtualNetworkLinks) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *dnsZoneVirtualNetworkLinks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DnsZoneVirtualNetworkLink, err error) {
	result = &v1alpha1.DnsZoneVirtualNetworkLink{}
