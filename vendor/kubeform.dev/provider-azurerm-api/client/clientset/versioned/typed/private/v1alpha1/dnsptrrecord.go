...
func newDnsPtrRecords(c *PrivateV1alpha1Client, namespace string) *dnsPtrRecords {
...
func (c *dnsPtrRecords) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DnsPtrRecord, err error) {
...
func (c *dnsPtrRecords) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DnsPtrRecordList, err error) {
...
func (c *dnsPtrRecords) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dnsPtrRecords) Create(ctx context.Context, dnsPtrRecord *v1alpha1.DnsPtrRecord, opts v1.CreateOptions) (result *v1alpha1.DnsPtrRecord, err error) {
	result = &v1alpha1.DnsPtrRecord{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("dnsptrrecords").
...
func (c *dnsPtrRecords) Update(ctx context.Context, dnsPtrRecord *v1alpha1.DnsPtrRecord, opts v1.UpdateOptions) (result *v1alpha1.DnsPtrRecord, err error) {
	result = &v1alpha1.DnsPtrRecord{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dnsptrrecords").
...
func (c *dnsPtrRecords) UpdateStatus(ctx context.Context, dnsPtrRecord *v1alpha1.DnsPtrRecord, opts v1.UpdateOptions) (result *v1alpha1.DnsPtrRecord, err error) {
	result = &v1alpha1.DnsPtrRecord{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dnsptrrecords").
...
func (c *dnsPtrRecords) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *dnsPtrRecords) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *dnsPtrRecords) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DnsPtrRecord, err error) {
	result = &v1alpha1.DnsPtrRecord{}
