...
func newDnsTxtRecords(c *PrivateV1alpha1Client, namespace string) *dnsTxtRecords {
...
func (c *dnsTxtRecords) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DnsTxtRecord, err error) {
...
func (c *dnsTxtRecords) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DnsTxtRecordList, err error) {
...
func (c *dnsTxtRecords) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dnsTxtRecords) Create(ctx context.Context, dnsTxtRecord *v1alpha1.DnsTxtRecord, opts v1.CreateOptions) (result *v1alpha1.DnsTxtRecord, err error) {
	result = &v1alpha1.DnsTxtRecord{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("dnstxtrecords").
...
func (c *dnsTxtRecords) Update(ctx context.Context, dnsTxtRecord *v1alpha1.DnsTxtRecord, opts v1.UpdateOptions) (result *v1alpha1.DnsTxtRecord, err error) {
	result = &v1alpha1.DnsTxtRecord{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dnstxtrecords").
...
func (c *dnsTxtRecords) UpdateStatus(ctx context.Context, dnsTxtRecord *v1alpha1.DnsTxtRecord, opts v1.UpdateOptions) (result *v1alpha1.DnsTxtRecord, err error) {
	result = &v1alpha1.DnsTxtRecord{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dnstxtrecords").
...
func (c *dnsTxtRecords) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *dnsTxtRecords) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *dnsTxtRecords) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DnsTxtRecord, err error) {
	result = &v1alpha1.DnsTxtRecord{}
