...
func newDnsSrvRecords(c *PrivateV1alpha1Client, namespace string) *dnsSrvRecords {
...
func (c *dnsSrvRecords) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DnsSrvRecord, err error) {
...
func (c *dnsSrvRecords) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DnsSrvRecordList, err error) {
...
func (c *dnsSrvRecords) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dnsSrvRecords) Create(ctx context.Context, dnsSrvRecord *v1alpha1.DnsSrvRecord, opts v1.CreateOptions) (result *v1alpha1.DnsSrvRecord, err error) {
	result = &v1alpha1.DnsSrvRecord{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("dnssrvrecords").
...
func (c *dnsSrvRecords) Update(ctx context.Context, dnsSrvRecord *v1alpha1.DnsSrvRecord, opts v1.UpdateOptions) (result *v1alpha1.DnsSrvRecord, err error) {
	result = &v1alpha1.DnsSrvRecord{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dnssrvrecords").
...
func (c *dnsSrvRecords) UpdateStatus(ctx context.Context, dnsSrvRecord *v1alpha1.DnsSrvRecord, opts v1.UpdateOptions) (result *v1alpha1.DnsSrvRecord, err error) {
	result = &v1alpha1.DnsSrvRecord{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dnssrvrecords").
...
func (c *dnsSrvRecords) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *dnsSrvRecords) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *dnsSrvRecords) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DnsSrvRecord, err error) {
	result = &v1alpha1.DnsSrvRecord{}
