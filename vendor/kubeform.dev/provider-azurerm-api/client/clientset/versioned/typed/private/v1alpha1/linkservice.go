...
// LinkServicesGetter has a method to return a LinkServiceInterface.
...
// linkServices implements LinkServiceInterface
type linkServices struct {
	client rest.Interface
	ns     string
}

// newLinkServices returns a LinkServices
func newLinkServices(c *PrivateV1alpha1Client, namespace string) *linkServices {
	return &linkServices{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *linkServices) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LinkService, err error) {
	result = &v1alpha1.LinkService{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *linkServices) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LinkServiceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.LinkServiceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("linkservices").
...
func (c *linkServices) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *linkServices) Create(ctx context.Context, linkService *v1alpha1.LinkService, opts v1.CreateOptions) (result *v1alpha1.LinkService, err error) {
	result = &v1alpha1.LinkService{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("linkservices").
...
func (c *linkServices) Update(ctx context.Context, linkService *v1alpha1.LinkService, opts v1.UpdateOptions) (result *v1alpha1.LinkService, err error) {
	result = &v1alpha1.LinkService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("linkservices").
...
func (c *linkServices) UpdateStatus(ctx context.Context, linkService *v1alpha1.LinkService, opts v1.UpdateOptions) (result *v1alpha1.LinkService, err error) {
	result = &v1alpha1.LinkService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("linkservices").
...
func (c *linkServices) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *linkServices) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *linkServices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LinkService, err error) {
	result = &v1alpha1.LinkService{}
