...
func newVersions(c *SharedimageV1alpha1Client, namespace string) *versions {
	return &versions{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *versions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Version, err error) {
...
func (c *versions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.VersionList, err error) {
...
func (c *versions) Create(ctx context.Context, version *v1alpha1.Version, opts v1.CreateOptions) (result *v1alpha1.Version, err error) {
	result = &v1alpha1.Version{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("versions").
...
func (c *versions) Update(ctx context.Context, version *v1alpha1.Version, opts v1.UpdateOptions) (result *v1alpha1.Version, err error) {
	result = &v1alpha1.Version{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("versions").
...
func (c *versions) UpdateStatus(ctx context.Context, version *v1alpha1.Version, opts v1.UpdateOptions) (result *v1alpha1.Version, err error) {
	result = &v1alpha1.Version{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("versions").
...
func (c *versions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Version, err error) {
	result = &v1alpha1.Version{}
