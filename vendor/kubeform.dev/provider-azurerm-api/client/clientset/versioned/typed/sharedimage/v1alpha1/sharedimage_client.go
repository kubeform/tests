...
func (c *SharedimageV1alpha1Client) Galleries(namespace string) GalleryInterface {
	return newGalleries(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*SharedimageV1alpha1Client, error) {
	...
	return &SharedimageV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new SharedimageV1alpha1Client for the given config and
...
func New(c rest.Interface) *SharedimageV1alpha1Client {
	return &SharedimageV1alpha1Client{c}
}
