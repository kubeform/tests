...
// GalleriesGetter has a method to return a GalleryInterface.
...
// galleries implements GalleryInterface
type galleries struct {
	client rest.Interface
	ns     string
}

// newGalleries returns a Galleries
func newGalleries(c *SharedimageV1alpha1Client, namespace string) *galleries {
	return &galleries{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *galleries) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Gallery, err error) {
	result = &v1alpha1.Gallery{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("galleries").
		Name(name).
...
func (c *galleries) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.GalleryList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.GalleryList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("galleries").
...
func (c *galleries) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *galleries) Create(ctx context.Context, gallery *v1alpha1.Gallery, opts v1.CreateOptions) (result *v1alpha1.Gallery, err error) {
	result = &v1alpha1.Gallery{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("galleries").
...
func (c *galleries) Update(ctx context.Context, gallery *v1alpha1.Gallery, opts v1.UpdateOptions) (result *v1alpha1.Gallery, err error) {
	result = &v1alpha1.Gallery{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("galleries").
...
func (c *galleries) UpdateStatus(ctx context.Context, gallery *v1alpha1.Gallery, opts v1.UpdateOptions) (result *v1alpha1.Gallery, err error) {
	result = &v1alpha1.Gallery{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("galleries").
...
func (c *galleries) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *galleries) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *galleries) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Gallery, err error) {
	result = &v1alpha1.Gallery{}
