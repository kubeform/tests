...
// ServiceCertificateOrdersGetter has a method to return a ServiceCertificateOrderInterface.
...
// serviceCertificateOrders implements ServiceCertificateOrderInterface
type serviceCertificateOrders struct {
	client rest.Interface
	ns     string
}

// newServiceCertificateOrders returns a ServiceCertificateOrders
func newServiceCertificateOrders(c *AppV1alpha1Client, namespace string) *serviceCertificateOrders {
	return &serviceCertificateOrders{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *serviceCertificateOrders) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ServiceCertificateOrder, err error) {
	result = &v1alpha1.ServiceCertificateOrder{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *serviceCertificateOrders) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ServiceCertificateOrderList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ServiceCertificateOrderList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("servicecertificateorders").
...
func (c *serviceCertificateOrders) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *serviceCertificateOrders) Create(ctx context.Context, serviceCertificateOrder *v1alpha1.ServiceCertificateOrder, opts v1.CreateOptions) (result *v1alpha1.ServiceCertificateOrder, err error) {
	result = &v1alpha1.ServiceCertificateOrder{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("servicecertificateorders").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(serviceCertificateOrder).
		Do(ctx).
		Into(result)
	return
}
...
func (c *serviceCertificateOrders) Update(ctx context.Context, serviceCertificateOrder *v1alpha1.ServiceCertificateOrder, opts v1.UpdateOptions) (result *v1alpha1.ServiceCertificateOrder, err error) {
	result = &v1alpha1.ServiceCertificateOrder{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("servicecertificateorders").
		Name(serviceCertificateOrder.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(serviceCertificateOrder).
		Do(ctx).
		Into(result)
...
func (c *serviceCertificateOrders) UpdateStatus(ctx context.Context, serviceCertificateOrder *v1alpha1.ServiceCertificateOrder, opts v1.UpdateOptions) (result *v1alpha1.ServiceCertificateOrder, err error) {
	result = &v1alpha1.ServiceCertificateOrder{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("servicecertificateorders").
...
func (c *serviceCertificateOrders) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *serviceCertificateOrders) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *serviceCertificateOrders) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ServiceCertificateOrder, err error) {
	result = &v1alpha1.ServiceCertificateOrder{}
