...
func newServicePlans(c *AppV1alpha1Client, namespace string) *servicePlans {
	return &servicePlans{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *servicePlans) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ServicePlan, err error) {
...
func (c *servicePlans) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ServicePlanList, err error) {
...
func (c *servicePlans) Create(ctx context.Context, servicePlan *v1alpha1.ServicePlan, opts v1.CreateOptions) (result *v1alpha1.ServicePlan, err error) {
	result = &v1alpha1.ServicePlan{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("serviceplans").
...
func (c *servicePlans) Update(ctx context.Context, servicePlan *v1alpha1.ServicePlan, opts v1.UpdateOptions) (result *v1alpha1.ServicePlan, err error) {
	result = &v1alpha1.ServicePlan{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("serviceplans").
...
func (c *servicePlans) UpdateStatus(ctx context.Context, servicePlan *v1alpha1.ServicePlan, opts v1.UpdateOptions) (result *v1alpha1.ServicePlan, err error) {
	result = &v1alpha1.ServicePlan{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("serviceplans").
...
func (c *servicePlans) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ServicePlan, err error) {
	result = &v1alpha1.ServicePlan{}
