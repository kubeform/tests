...
// ServiceCustomHostnameBindingsGetter has a method to return a ServiceCustomHostnameBindingInterface.
...
// serviceCustomHostnameBindings implements ServiceCustomHostnameBindingInterface
type serviceCustomHostnameBindings struct {
	client rest.Interface
	ns     string
}

// newServiceCustomHostnameBindings returns a ServiceCustomHostnameBindings
func newServiceCustomHostnameBindings(c *AppV1alpha1Client, namespace string) *serviceCustomHostnameBindings {
	return &serviceCustomHostnameBindings{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *serviceCustomHostnameBindings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ServiceCustomHostnameBinding, err error) {
	result = &v1alpha1.ServiceCustomHostnameBinding{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *serviceCustomHostnameBindings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ServiceCustomHostnameBindingList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ServiceCustomHostnameBindingList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("servicecustomhostnamebindings").
...
func (c *serviceCustomHostnameBindings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *serviceCustomHostnameBindings) Create(ctx context.Context, serviceCustomHostnameBinding *v1alpha1.ServiceCustomHostnameBinding, opts v1.CreateOptions) (result *v1alpha1.ServiceCustomHostnameBinding, err error) {
	result = &v1alpha1.ServiceCustomHostnameBinding{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("servicecustomhostnamebindings").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(serviceCustomHostnameBinding).
		Do(ctx).
		Into(result)
	return
}
...
func (c *serviceCustomHostnameBindings) Update(ctx context.Context, serviceCustomHostnameBinding *v1alpha1.ServiceCustomHostnameBinding, opts v1.UpdateOptions) (result *v1alpha1.ServiceCustomHostnameBinding, err error) {
	result = &v1alpha1.ServiceCustomHostnameBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("servicecustomhostnamebindings").
		Name(serviceCustomHostnameBinding.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(serviceCustomHostnameBinding).
		Do(ctx).
		Into(result)
...
func (c *serviceCustomHostnameBindings) UpdateStatus(ctx context.Context, serviceCustomHostnameBinding *v1alpha1.ServiceCustomHostnameBinding, opts v1.UpdateOptions) (result *v1alpha1.ServiceCustomHostnameBinding, err error) {
	result = &v1alpha1.ServiceCustomHostnameBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("servicecustomhostnamebindings").
...
func (c *serviceCustomHostnameBindings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *serviceCustomHostnameBindings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *serviceCustomHostnameBindings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ServiceCustomHostnameBinding, err error) {
	result = &v1alpha1.ServiceCustomHostnameBinding{}
