...
// TwinsEndpointEventhubsGetter has a method to return a TwinsEndpointEventhubInterface.
...
// twinsEndpointEventhubs implements TwinsEndpointEventhubInterface
type twinsEndpointEventhubs struct {
	client rest.Interface
	ns     string
}

// newTwinsEndpointEventhubs returns a TwinsEndpointEventhubs
func newTwinsEndpointEventhubs(c *DigitalV1alpha1Client, namespace string) *twinsEndpointEventhubs {
	return &twinsEndpointEventhubs{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *twinsEndpointEventhubs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TwinsEndpointEventhub, err error) {
	result = &v1alpha1.TwinsEndpointEventhub{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *twinsEndpointEventhubs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TwinsEndpointEventhubList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.TwinsEndpointEventhubList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("twinsendpointeventhubs").
...
func (c *twinsEndpointEventhubs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *twinsEndpointEventhubs) Create(ctx context.Context, twinsEndpointEventhub *v1alpha1.TwinsEndpointEventhub, opts v1.CreateOptions) (result *v1alpha1.TwinsEndpointEventhub, err error) {
	result = &v1alpha1.TwinsEndpointEventhub{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("twinsendpointeventhubs").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(twinsEndpointEventhub).
		Do(ctx).
		Into(result)
	return
}
...
func (c *twinsEndpointEventhubs) Update(ctx context.Context, twinsEndpointEventhub *v1alpha1.TwinsEndpointEventhub, opts v1.UpdateOptions) (result *v1alpha1.TwinsEndpointEventhub, err error) {
	result = &v1alpha1.TwinsEndpointEventhub{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("twinsendpointeventhubs").
		Name(twinsEndpointEventhub.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(twinsEndpointEventhub).
		Do(ctx).
		Into(result)
...
func (c *twinsEndpointEventhubs) UpdateStatus(ctx context.Context, twinsEndpointEventhub *v1alpha1.TwinsEndpointEventhub, opts v1.UpdateOptions) (result *v1alpha1.TwinsEndpointEventhub, err error) {
	result = &v1alpha1.TwinsEndpointEventhub{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("twinsendpointeventhubs").
...
func (c *twinsEndpointEventhubs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *twinsEndpointEventhubs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *twinsEndpointEventhubs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TwinsEndpointEventhub, err error) {
	result = &v1alpha1.TwinsEndpointEventhub{}
