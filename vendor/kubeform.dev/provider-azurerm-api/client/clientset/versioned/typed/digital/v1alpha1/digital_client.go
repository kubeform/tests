...
type DigitalV1alpha1Interface interface {
	RESTClient() rest.Interface
	TwinsEndpointEventgridsGetter
	TwinsEndpointEventhubsGetter
	TwinsEndpointServicebusesGetter
	TwinsInstancesGetter
}
...
func NewForConfig(c *rest.Config) (*DigitalV1alpha1Client, error) {
	...
	return &DigitalV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new DigitalV1alpha1Client for the given config and
...
func New(c rest.Interface) *DigitalV1alpha1Client {
	return &DigitalV1alpha1Client{c}
}
