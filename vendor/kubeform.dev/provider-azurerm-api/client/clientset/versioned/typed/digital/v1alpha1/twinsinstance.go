...
// TwinsInstancesGetter has a method to return a TwinsInstanceInterface.
...
// twinsInstances implements TwinsInstanceInterface
type twinsInstances struct {
	client rest.Interface
	ns     string
}

// newTwinsInstances returns a TwinsInstances
func newTwinsInstances(c *DigitalV1alpha1Client, namespace string) *twinsInstances {
	return &twinsInstances{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *twinsInstances) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TwinsInstance, err error) {
	result = &v1alpha1.TwinsInstance{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *twinsInstances) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TwinsInstanceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.TwinsInstanceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("twinsinstances").
...
func (c *twinsInstances) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *twinsInstances) Create(ctx context.Context, twinsInstance *v1alpha1.TwinsInstance, opts v1.CreateOptions) (result *v1alpha1.TwinsInstance, err error) {
	result = &v1alpha1.TwinsInstance{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("twinsinstances").
...
func (c *twinsInstances) Update(ctx context.Context, twinsInstance *v1alpha1.TwinsInstance, opts v1.UpdateOptions) (result *v1alpha1.TwinsInstance, err error) {
	result = &v1alpha1.TwinsInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("twinsinstances").
		Name(twinsInstance.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(twinsInstance).
		Do(ctx).
		Into(result)
...
func (c *twinsInstances) UpdateStatus(ctx context.Context, twinsInstance *v1alpha1.TwinsInstance, opts v1.UpdateOptions) (result *v1alpha1.TwinsInstance, err error) {
	result = &v1alpha1.TwinsInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("twinsinstances").
...
func (c *twinsInstances) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *twinsInstances) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *twinsInstances) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TwinsInstance, err error) {
	result = &v1alpha1.TwinsInstance{}
