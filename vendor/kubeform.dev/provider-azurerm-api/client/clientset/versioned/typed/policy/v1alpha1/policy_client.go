...
func (c *PolicyV1alpha1Client) Assignments(namespace string) AssignmentInterface {
	return newAssignments(c, namespace)
}

func (c *PolicyV1alpha1Client) Definitions(namespace string) DefinitionInterface {
	return newDefinitions(c, namespace)
}

func (c *PolicyV1alpha1Client) Remediations(namespace string) RemediationInterface {
	return newRemediations(c, namespace)
}
