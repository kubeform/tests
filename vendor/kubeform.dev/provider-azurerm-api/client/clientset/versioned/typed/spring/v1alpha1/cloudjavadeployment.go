...
// CloudJavaDeploymentsGetter has a method to return a CloudJavaDeploymentInterface.
...
// cloudJavaDeployments implements CloudJavaDeploymentInterface
type cloudJavaDeployments struct {
	client rest.Interface
	ns     string
}

// newCloudJavaDeployments returns a CloudJavaDeployments
func newCloudJavaDeployments(c *SpringV1alpha1Client, namespace string) *cloudJavaDeployments {
	return &cloudJavaDeployments{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *cloudJavaDeployments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CloudJavaDeployment, err error) {
	result = &v1alpha1.CloudJavaDeployment{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *cloudJavaDeployments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CloudJavaDeploymentList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.CloudJavaDeploymentList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("cloudjavadeployments").
...
func (c *cloudJavaDeployments) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cloudJavaDeployments) Create(ctx context.Context, cloudJavaDeployment *v1alpha1.CloudJavaDeployment, opts v1.CreateOptions) (result *v1alpha1.CloudJavaDeployment, err error) {
	result = &v1alpha1.CloudJavaDeployment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cloudjavadeployments").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(cloudJavaDeployment).
		Do(ctx).
		Into(result)
	return
}
...
func (c *cloudJavaDeployments) Update(ctx context.Context, cloudJavaDeployment *v1alpha1.CloudJavaDeployment, opts v1.UpdateOptions) (result *v1alpha1.CloudJavaDeployment, err error) {
	result = &v1alpha1.CloudJavaDeployment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cloudjavadeployments").
		Name(cloudJavaDeployment.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(cloudJavaDeployment).
		Do(ctx).
		Into(result)
...
func (c *cloudJavaDeployments) UpdateStatus(ctx context.Context, cloudJavaDeployment *v1alpha1.CloudJavaDeployment, opts v1.UpdateOptions) (result *v1alpha1.CloudJavaDeployment, err error) {
	result = &v1alpha1.CloudJavaDeployment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cloudjavadeployments").
...
func (c *cloudJavaDeployments) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *cloudJavaDeployments) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *cloudJavaDeployments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CloudJavaDeployment, err error) {
	result = &v1alpha1.CloudJavaDeployment{}
