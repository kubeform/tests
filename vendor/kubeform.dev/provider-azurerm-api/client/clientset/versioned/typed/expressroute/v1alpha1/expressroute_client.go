...
type ExpressrouteV1alpha1Interface interface {
	RESTClient() rest.Interface
	CircuitsGetter
	CircuitAuthorizationsGetter
	CircuitPeeringsGetter
	GatewaysGetter
	PortsGetter
}
...
func NewForConfig(c *rest.Config) (*ExpressrouteV1alpha1Client, error) {
	...
	return &ExpressrouteV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new ExpressrouteV1alpha1Client for the given config and
...
func New(c rest.Interface) *ExpressrouteV1alpha1Client {
	return &ExpressrouteV1alpha1Client{c}
}
