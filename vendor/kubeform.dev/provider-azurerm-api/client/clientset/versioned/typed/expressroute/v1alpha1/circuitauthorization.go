...
// CircuitAuthorizationsGetter has a method to return a CircuitAuthorizationInterface.
...
// circuitAuthorizations implements CircuitAuthorizationInterface
type circuitAuthorizations struct {
	client rest.Interface
	ns     string
}

// newCircuitAuthorizations returns a CircuitAuthorizations
func newCircuitAuthorizations(c *ExpressrouteV1alpha1Client, namespace string) *circuitAuthorizations {
	return &circuitAuthorizations{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *circuitAuthorizations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CircuitAuthorization, err error) {
	result = &v1alpha1.CircuitAuthorization{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *circuitAuthorizations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CircuitAuthorizationList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.CircuitAuthorizationList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("circuitauthorizations").
...
func (c *circuitAuthorizations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *circuitAuthorizations) Create(ctx context.Context, circuitAuthorization *v1alpha1.CircuitAuthorization, opts v1.CreateOptions) (result *v1alpha1.CircuitAuthorization, err error) {
	result = &v1alpha1.CircuitAuthorization{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("circuitauthorizations").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(circuitAuthorization).
		Do(ctx).
		Into(result)
	return
}
...
func (c *circuitAuthorizations) Update(ctx context.Context, circuitAuthorization *v1alpha1.CircuitAuthorization, opts v1.UpdateOptions) (result *v1alpha1.CircuitAuthorization, err error) {
	result = &v1alpha1.CircuitAuthorization{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("circuitauthorizations").
		Name(circuitAuthorization.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(circuitAuthorization).
		Do(ctx).
		Into(result)
...
func (c *circuitAuthorizations) UpdateStatus(ctx context.Context, circuitAuthorization *v1alpha1.CircuitAuthorization, opts v1.UpdateOptions) (result *v1alpha1.CircuitAuthorization, err error) {
	result = &v1alpha1.CircuitAuthorization{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("circuitauthorizations").
...
func (c *circuitAuthorizations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *circuitAuthorizations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *circuitAuthorizations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CircuitAuthorization, err error) {
	result = &v1alpha1.CircuitAuthorization{}
