...
// JobCredentialsGetter has a method to return a JobCredentialInterface.
...
// jobCredentials implements JobCredentialInterface
type jobCredentials struct {
	client rest.Interface
	ns     string
}

// newJobCredentials returns a JobCredentials
func newJobCredentials(c *MssqlV1alpha1Client, namespace string) *jobCredentials {
...
func (c *jobCredentials) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.JobCredential, err error) {
	result = &v1alpha1.JobCredential{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *jobCredentials) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.JobCredentialList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.JobCredentialList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("jobcredentials").
...
func (c *jobCredentials) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *jobCredentials) Create(ctx context.Context, jobCredential *v1alpha1.JobCredential, opts v1.CreateOptions) (result *v1alpha1.JobCredential, err error) {
	result = &v1alpha1.JobCredential{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("jobcredentials").
...
func (c *jobCredentials) Update(ctx context.Context, jobCredential *v1alpha1.JobCredential, opts v1.UpdateOptions) (result *v1alpha1.JobCredential, err error) {
	result = &v1alpha1.JobCredential{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("jobcredentials").
		Name(jobCredential.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(jobCredential).
		Do(ctx).
		Into(result)
...
func (c *jobCredentials) UpdateStatus(ctx context.Context, jobCredential *v1alpha1.JobCredential, opts v1.UpdateOptions) (result *v1alpha1.JobCredential, err error) {
	result = &v1alpha1.JobCredential{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("jobcredentials").
...
func (c *jobCredentials) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *jobCredentials) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *jobCredentials) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.JobCredential, err error) {
	result = &v1alpha1.JobCredential{}
