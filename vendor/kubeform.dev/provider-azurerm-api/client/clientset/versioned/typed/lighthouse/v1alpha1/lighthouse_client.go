...
// LighthouseV1alpha1Client is used to interact with features provided by the lighthouse.azurerm.kubeform.com group.
type LighthouseV1alpha1Client struct {
	restClient rest.Interface
}

func (c *LighthouseV1alpha1Client) Assignments(namespace string) AssignmentInterface {
	return newAssignments(c, namespace)
}

func (c *LighthouseV1alpha1Client) Definitions(namespace string) DefinitionInterface {
