...
type BackupV1alpha1Interface interface {
	...
	ContainerStorageAccountsGetter
	PolicyFileSharesGetter
	PolicyVmsGetter
	ProtectedFileSharesGetter
	ProtectedVmsGetter
}
