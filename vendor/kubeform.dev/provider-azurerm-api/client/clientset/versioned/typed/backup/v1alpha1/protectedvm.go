...
// ProtectedVmsGetter has a method to return a ProtectedVmInterface.
...
// protectedVms implements ProtectedVmInterface
type protectedVms struct {
	client rest.Interface
	ns     string
}

// newProtectedVms returns a ProtectedVms
func newProtectedVms(c *BackupV1alpha1Client, namespace string) *protectedVms {
	return &protectedVms{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *protectedVms) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ProtectedVm, err error) {
	result = &v1alpha1.ProtectedVm{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *protectedVms) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ProtectedVmList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ProtectedVmList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("protectedvms").
...
func (c *protectedVms) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *protectedVms) Create(ctx context.Context, protectedVm *v1alpha1.ProtectedVm, opts v1.CreateOptions) (result *v1alpha1.ProtectedVm, err error) {
	result = &v1alpha1.ProtectedVm{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("protectedvms").
...
func (c *protectedVms) Update(ctx context.Context, protectedVm *v1alpha1.ProtectedVm, opts v1.UpdateOptions) (result *v1alpha1.ProtectedVm, err error) {
	result = &v1alpha1.ProtectedVm{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("protectedvms").
		Name(protectedVm.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(protectedVm).
		Do(ctx).
		Into(result)
...
func (c *protectedVms) UpdateStatus(ctx context.Context, protectedVm *v1alpha1.ProtectedVm, opts v1.UpdateOptions) (result *v1alpha1.ProtectedVm, err error) {
	result = &v1alpha1.ProtectedVm{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("protectedvms").
...
func (c *protectedVms) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *protectedVms) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *protectedVms) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ProtectedVm, err error) {
	result = &v1alpha1.ProtectedVm{}
