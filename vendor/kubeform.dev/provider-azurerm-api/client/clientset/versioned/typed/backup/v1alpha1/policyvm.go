...
// PolicyVmsGetter has a method to return a PolicyVmInterface.
...
// policyVms implements PolicyVmInterface
type policyVms struct {
	client rest.Interface
	ns     string
}

// newPolicyVms returns a PolicyVms
func newPolicyVms(c *BackupV1alpha1Client, namespace string) *policyVms {
	return &policyVms{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *policyVms) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.PolicyVm, err error) {
	result = &v1alpha1.PolicyVm{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("policyvms").
		Name(name).
...
func (c *policyVms) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PolicyVmList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.PolicyVmList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("policyvms").
...
func (c *policyVms) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *policyVms) Create(ctx context.Context, policyVm *v1alpha1.PolicyVm, opts v1.CreateOptions) (result *v1alpha1.PolicyVm, err error) {
	result = &v1alpha1.PolicyVm{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("policyvms").
...
func (c *policyVms) Update(ctx context.Context, policyVm *v1alpha1.PolicyVm, opts v1.UpdateOptions) (result *v1alpha1.PolicyVm, err error) {
	result = &v1alpha1.PolicyVm{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("policyvms").
...
func (c *policyVms) UpdateStatus(ctx context.Context, policyVm *v1alpha1.PolicyVm, opts v1.UpdateOptions) (result *v1alpha1.PolicyVm, err error) {
	result = &v1alpha1.PolicyVm{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("policyvms").
...
func (c *policyVms) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *policyVms) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *policyVms) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.PolicyVm, err error) {
	result = &v1alpha1.PolicyVm{}
