...
// CustomV1alpha1Client is used to interact with features provided by the custom.azurerm.kubeform.com group.
type CustomV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CustomV1alpha1Client) Providers(namespace string) ProviderInterface {
