...
func NewForConfig(c *rest.Config) (*NotificationhubV1alpha1Client, error) {
	...
	return &NotificationhubV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new NotificationhubV1alpha1Client for the given config and
...
func New(c rest.Interface) *NotificationhubV1alpha1Client {
	return &NotificationhubV1alpha1Client{c}
}
...
func (c *NotificationhubV1alpha1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
