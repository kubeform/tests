...
import (
	v1alpha1 "kubeform.dev/provider-azurerm-api/apis/search/v1alpha1"
...
// SearchV1alpha1Client is used to interact with features provided by the search.azurerm.kubeform.com group.
type SearchV1alpha1Client struct {
	restClient rest.Interface
}

func (c *SearchV1alpha1Client) Services(namespace string) ServiceInterface {
