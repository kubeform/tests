...
import (
	v1alpha1 "kubeform.dev/provider-azurerm-api/apis/snapshot/v1alpha1"
...
// SnapshotV1alpha1Client is used to interact with features provided by the snapshot.azurerm.kubeform.com group.
