...
import (
	v1alpha1 "kubeform.dev/provider-azurerm-api/apis/ip/v1alpha1"
...
// IpV1alpha1Client is used to interact with features provided by the ip.azurerm.kubeform.com group.
type IpV1alpha1Client struct {
	restClient rest.Interface
}

func (c *IpV1alpha1Client) Groups(namespace string) GroupInterface {
