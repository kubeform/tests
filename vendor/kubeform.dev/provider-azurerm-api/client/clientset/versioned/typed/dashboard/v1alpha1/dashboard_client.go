...
import (
	v1alpha1 "kubeform.dev/provider-azurerm-api/apis/dashboard/v1alpha1"
...
// DashboardV1alpha1Client is used to interact with features provided by the dashboard.azurerm.kubeform.com group.
