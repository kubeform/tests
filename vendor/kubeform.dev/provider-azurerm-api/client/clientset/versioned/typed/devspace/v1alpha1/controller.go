...
import (
	...
	v1alpha1 "kubeform.dev/provider-azurerm-api/apis/devspace/v1alpha1"
...
func newControllers(c *DevspaceV1alpha1Client, namespace string) *controllers {
	return &controllers{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *controllers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Controller, err error) {
...
func (c *controllers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ControllerList, err error) {
...
func (c *controllers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *controllers) Create(ctx context.Context, controller *v1alpha1.Controller, opts v1.CreateOptions) (result *v1alpha1.Controller, err error) {
	result = &v1alpha1.Controller{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("controllers").
...
func (c *controllers) Update(ctx context.Context, controller *v1alpha1.Controller, opts v1.UpdateOptions) (result *v1alpha1.Controller, err error) {
	result = &v1alpha1.Controller{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("controllers").
...
func (c *controllers) UpdateStatus(ctx context.Context, controller *v1alpha1.Controller, opts v1.UpdateOptions) (result *v1alpha1.Controller, err error) {
	result = &v1alpha1.Controller{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("controllers").
...
func (c *controllers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *controllers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *controllers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Controller, err error) {
	result = &v1alpha1.Controller{}
