...
// ServicesAccountsGetter has a method to return a ServicesAccountInterface.
...
// servicesAccounts implements ServicesAccountInterface
type servicesAccounts struct {
	client rest.Interface
	ns     string
}

// newServicesAccounts returns a ServicesAccounts
func newServicesAccounts(c *MediaV1alpha1Client, namespace string) *servicesAccounts {
...
func (c *servicesAccounts) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ServicesAccount, err error) {
	result = &v1alpha1.ServicesAccount{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *servicesAccounts) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ServicesAccountList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ServicesAccountList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("servicesaccounts").
...
func (c *servicesAccounts) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *servicesAccounts) Create(ctx context.Context, servicesAccount *v1alpha1.ServicesAccount, opts v1.CreateOptions) (result *v1alpha1.ServicesAccount, err error) {
	result = &v1alpha1.ServicesAccount{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("servicesaccounts").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(servicesAccount).
		Do(ctx).
		Into(result)
	return
}
...
func (c *servicesAccounts) Update(ctx context.Context, servicesAccount *v1alpha1.ServicesAccount, opts v1.UpdateOptions) (result *v1alpha1.ServicesAccount, err error) {
	result = &v1alpha1.ServicesAccount{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("servicesaccounts").
		Name(servicesAccount.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(servicesAccount).
		Do(ctx).
		Into(result)
...
func (c *servicesAccounts) UpdateStatus(ctx context.Context, servicesAccount *v1alpha1.ServicesAccount, opts v1.UpdateOptions) (result *v1alpha1.ServicesAccount, err error) {
	result = &v1alpha1.ServicesAccount{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("servicesaccounts").
...
func (c *servicesAccounts) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *servicesAccounts) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *servicesAccounts) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ServicesAccount, err error) {
	result = &v1alpha1.ServicesAccount{}
