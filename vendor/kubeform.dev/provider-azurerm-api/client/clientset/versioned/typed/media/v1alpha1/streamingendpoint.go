...
// StreamingEndpointsGetter has a method to return a StreamingEndpointInterface.
...
// streamingEndpoints implements StreamingEndpointInterface
type streamingEndpoints struct {
	client rest.Interface
	ns     string
}

// newStreamingEndpoints returns a StreamingEndpoints
func newStreamingEndpoints(c *MediaV1alpha1Client, namespace string) *streamingEndpoints {
...
func (c *streamingEndpoints) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.StreamingEndpoint, err error) {
	result = &v1alpha1.StreamingEndpoint{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *streamingEndpoints) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.StreamingEndpointList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.StreamingEndpointList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("streamingendpoints").
...
func (c *streamingEndpoints) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *streamingEndpoints) Create(ctx context.Context, streamingEndpoint *v1alpha1.StreamingEndpoint, opts v1.CreateOptions) (result *v1alpha1.StreamingEndpoint, err error) {
	result = &v1alpha1.StreamingEndpoint{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("streamingendpoints").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(streamingEndpoint).
		Do(ctx).
		Into(result)
	return
}
...
func (c *streamingEndpoints) Update(ctx context.Context, streamingEndpoint *v1alpha1.StreamingEndpoint, opts v1.UpdateOptions) (result *v1alpha1.StreamingEndpoint, err error) {
	result = &v1alpha1.StreamingEndpoint{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("streamingendpoints").
...
func (c *streamingEndpoints) UpdateStatus(ctx context.Context, streamingEndpoint *v1alpha1.StreamingEndpoint, opts v1.UpdateOptions) (result *v1alpha1.StreamingEndpoint, err error) {
	result = &v1alpha1.StreamingEndpoint{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("streamingendpoints").
...
func (c *streamingEndpoints) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *streamingEndpoints) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *streamingEndpoints) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.StreamingEndpoint, err error) {
	result = &v1alpha1.StreamingEndpoint{}
