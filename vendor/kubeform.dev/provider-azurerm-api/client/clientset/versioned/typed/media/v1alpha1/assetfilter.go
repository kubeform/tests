...
// AssetFiltersGetter has a method to return a AssetFilterInterface.
...
// assetFilters implements AssetFilterInterface
type assetFilters struct {
	client rest.Interface
	ns     string
}

// newAssetFilters returns a AssetFilters
func newAssetFilters(c *MediaV1alpha1Client, namespace string) *assetFilters {
	return &assetFilters{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *assetFilters) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AssetFilter, err error) {
	result = &v1alpha1.AssetFilter{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *assetFilters) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AssetFilterList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.AssetFilterList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("assetfilters").
...
func (c *assetFilters) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *assetFilters) Create(ctx context.Context, assetFilter *v1alpha1.AssetFilter, opts v1.CreateOptions) (result *v1alpha1.AssetFilter, err error) {
	result = &v1alpha1.AssetFilter{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("assetfilters").
...
func (c *assetFilters) Update(ctx context.Context, assetFilter *v1alpha1.AssetFilter, opts v1.UpdateOptions) (result *v1alpha1.AssetFilter, err error) {
	result = &v1alpha1.AssetFilter{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("assetfilters").
...
func (c *assetFilters) UpdateStatus(ctx context.Context, assetFilter *v1alpha1.AssetFilter, opts v1.UpdateOptions) (result *v1alpha1.AssetFilter, err error) {
	result = &v1alpha1.AssetFilter{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("assetfilters").
...
func (c *assetFilters) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *assetFilters) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *assetFilters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AssetFilter, err error) {
	result = &v1alpha1.AssetFilter{}
