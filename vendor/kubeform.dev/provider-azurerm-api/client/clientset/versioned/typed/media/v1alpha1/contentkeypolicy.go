...
// ContentKeyPoliciesGetter has a method to return a ContentKeyPolicyInterface.
...
// contentKeyPolicies implements ContentKeyPolicyInterface
type contentKeyPolicies struct {
	client rest.Interface
	ns     string
}

// newContentKeyPolicies returns a ContentKeyPolicies
func newContentKeyPolicies(c *MediaV1alpha1Client, namespace string) *contentKeyPolicies {
...
func (c *contentKeyPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ContentKeyPolicy, err error) {
	result = &v1alpha1.ContentKeyPolicy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *contentKeyPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ContentKeyPolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ContentKeyPolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("contentkeypolicies").
...
func (c *contentKeyPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *contentKeyPolicies) Create(ctx context.Context, contentKeyPolicy *v1alpha1.ContentKeyPolicy, opts v1.CreateOptions) (result *v1alpha1.ContentKeyPolicy, err error) {
	result = &v1alpha1.ContentKeyPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("contentkeypolicies").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(contentKeyPolicy).
		Do(ctx).
		Into(result)
	return
}
...
func (c *contentKeyPolicies) Update(ctx context.Context, contentKeyPolicy *v1alpha1.ContentKeyPolicy, opts v1.UpdateOptions) (result *v1alpha1.ContentKeyPolicy, err error) {
	result = &v1alpha1.ContentKeyPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("contentkeypolicies").
		Name(contentKeyPolicy.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(contentKeyPolicy).
		Do(ctx).
		Into(result)
...
func (c *contentKeyPolicies) UpdateStatus(ctx context.Context, contentKeyPolicy *v1alpha1.ContentKeyPolicy, opts v1.UpdateOptions) (result *v1alpha1.ContentKeyPolicy, err error) {
	result = &v1alpha1.ContentKeyPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("contentkeypolicies").
...
func (c *contentKeyPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *contentKeyPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *contentKeyPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ContentKeyPolicy, err error) {
	result = &v1alpha1.ContentKeyPolicy{}
