...
func newStorageBuckets(c *ObjectV1alpha1Client, namespace string) *storageBuckets {
...
func (c *storageBuckets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.StorageBucket, err error) {
...
func (c *storageBuckets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.StorageBucketList, err error) {
...
func (c *storageBuckets) Create(ctx context.Context, storageBucket *v1alpha1.StorageBucket, opts v1.CreateOptions) (result *v1alpha1.StorageBucket, err error) {
	result = &v1alpha1.StorageBucket{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("storagebuckets").
...
func (c *storageBuckets) Update(ctx context.Context, storageBucket *v1alpha1.StorageBucket, opts v1.UpdateOptions) (result *v1alpha1.StorageBucket, err error) {
	result = &v1alpha1.StorageBucket{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("storagebuckets").
...
func (c *storageBuckets) UpdateStatus(ctx context.Context, storageBucket *v1alpha1.StorageBucket, opts v1.UpdateOptions) (result *v1alpha1.StorageBucket, err error) {
	result = &v1alpha1.StorageBucket{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("storagebuckets").
...
func (c *storageBuckets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.StorageBucket, err error) {
	result = &v1alpha1.StorageBucket{}
