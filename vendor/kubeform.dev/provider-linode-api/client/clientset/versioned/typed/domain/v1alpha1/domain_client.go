...
// DomainV1alpha1Client is used to interact with features provided by the domain.linode.kubeform.com group.
...
func (c *DomainV1alpha1Client) Records(namespace string) RecordInterface {
