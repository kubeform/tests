...
func newRdnses(c *RdnsV1alpha1Client, namespace string) *rdnses {
	return &rdnses{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *rdnses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Rdns, err error) {
...
func (c *rdnses) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RdnsList, err error) {
...
func (c *rdnses) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *rdnses) Create(ctx context.Context, rdns *v1alpha1.Rdns, opts v1.CreateOptions) (result *v1alpha1.Rdns, err error) {
	result = &v1alpha1.Rdns{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("rdnses").
...
func (c *rdnses) Update(ctx context.Context, rdns *v1alpha1.Rdns, opts v1.UpdateOptions) (result *v1alpha1.Rdns, err error) {
	result = &v1alpha1.Rdns{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("rdnses").
...
func (c *rdnses) UpdateStatus(ctx context.Context, rdns *v1alpha1.Rdns, opts v1.UpdateOptions) (result *v1alpha1.Rdns, err error) {
	result = &v1alpha1.Rdns{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("rdnses").
...
func (c *rdnses) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *rdnses) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *rdnses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Rdns, err error) {
	result = &v1alpha1.Rdns{}
