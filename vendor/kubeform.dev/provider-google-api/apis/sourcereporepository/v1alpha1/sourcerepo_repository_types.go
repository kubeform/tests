...
type SourcerepoRepositorySpec struct {
	SourcerepoRepositorySpec2 `json:",inline"`
	// +optional
	KubeformOutput SourcerepoRepositorySpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type SourcerepoRepositorySpecPubsubConfigs struct {
	// The format of the Cloud Pub/Sub messages.
	// - PROTOBUF: The message payload is a serialized protocol buffer of SourceRepoEvent.
	// - JSON: The message payload is a JSON string of SourceRepoEvent. Possible values: ["PROTOBUF", "JSON"]
	MessageFormat *string `json:"messageFormat" tf:"message_format"`
...
type SourcerepoRepositorySpec2 struct {
	...
	// +optional
	PubsubConfigs []SourcerepoRepositorySpecPubsubConfigs `json:"pubsubConfigs,omitempty" tf:"pubsub_configs"`
