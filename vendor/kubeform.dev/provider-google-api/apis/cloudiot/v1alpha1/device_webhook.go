...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-cloudiot-google-kubeform-com-v1alpha1-device,mutating=false,failurePolicy=fail,groups=cloudiot.google.kubeform.com,resources=devices,versions=v1alpha1,name=device.cloudiot.google.kubeform.io,sideEffects=None,admissionReviewVersions=v1
