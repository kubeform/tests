...
type IndexSpecProperties struct {
...
type IndexSpec2 struct {
	...
	// +optional
	Ancestor *string `json:"ancestor,omitempty" tf:"ancestor"`
	// The index id.
	// +optional
	...
	Properties []IndexSpecProperties `json:"properties,omitempty" tf:"properties"`
}
