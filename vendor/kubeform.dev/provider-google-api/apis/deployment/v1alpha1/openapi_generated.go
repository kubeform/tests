...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-google-api/apis/deployment/v1alpha1.ManagerDeployment":                      schema_provider_google_api_apis_deployment_v1alpha1_ManagerDeployment(ref),
		"kubeform.dev/provider-google-api/apis/deployment/v1alpha1.ManagerDeploymentList":                  schema_provider_google_api_apis_deployment_v1alpha1_ManagerDeploymentList(ref),
		"kubeform.dev/provider-google-api/apis/deployment/v1alpha1.ManagerDeploymentSpec":                  schema_provider_google_api_apis_deployment_v1alpha1_ManagerDeploymentSpec(ref),
		"kubeform.dev/provider-google-api/apis/deployment/v1alpha1.ManagerDeploymentSpec2":                 schema_provider_google_api_apis_deployment_v1alpha1_ManagerDeploymentSpec2(ref),
		"kubeform.dev/provider-google-api/apis/deployment/v1alpha1.ManagerDeploymentSpecLabels":            schema_provider_google_api_apis_deployment_v1alpha1_ManagerDeploymentSpecLabels(ref),
		"kubeform.dev/provider-google-api/apis/deployment/v1alpha1.ManagerDeploymentSpecTarget":            schema_provider_google_api_apis_deployment_v1alpha1_ManagerDeploymentSpecTarget(ref),
		"kubeform.dev/provider-google-api/apis/deployment/v1alpha1.ManagerDeploymentSpecTargetCodec":       schema_provider_google_api_apis_deployment_v1alpha1_ManagerDeploymentSpecTargetCodec(ref),
		"kubeform.dev/provider-google-api/apis/deployment/v1alpha1.ManagerDeploymentSpecTargetConfig":      schema_provider_google_api_apis_deployment_v1alpha1_ManagerDeploymentSpecTargetConfig(ref),
		"kubeform.dev/provider-google-api/apis/deployment/v1alpha1.ManagerDeploymentSpecTargetConfigCodec": schema_provider_google_api_apis_deployment_v1alpha1_ManagerDeploymentSpecTargetConfigCodec(ref),
		"kubeform.dev/provider-google-api/apis/deployment/v1alpha1.ManagerDeploymentSpecTargetImports":     schema_provider_google_api_apis_deployment_v1alpha1_ManagerDeploymentSpecTargetImports(ref),
		"kubeform.dev/provider-google-api/apis/deployment/v1alpha1.ManagerDeploymentStatus":                schema_provider_google_api_apis_deployment_v1alpha1_ManagerDeploymentStatus(ref),
	}
}
...
func schema_provider_google_api_apis_deployment_v1alpha1_ManagerDeployment(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-google-api/apis/deployment/v1alpha1.ManagerDeploymentSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-google-api/apis/deployment/v1alpha1.ManagerDeploymentStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-google-api/apis/deployment/v1alpha1.ManagerDeploymentSpec", "kubeform.dev/provider-google-api/apis/deployment/v1alpha1.ManagerDeploymentStatus"},
	}
}

func schema_provider_google_api_apis_deployment_v1alpha1_ManagerDeploymentList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ManagerDeploymentList is a list of ManagerDeployments",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							Description: "Items is a list of ManagerDeployment CRD objects",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-google-api/apis/deployment/v1alpha1.ManagerDeployment"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-google-api/apis/deployment/v1alpha1.ManagerDeployment"},
	}
}

func schema_provider_google_api_apis_deployment_v1alpha1_ManagerDeploymentSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"createPolicy": {
						SchemaProps: spec.SchemaProps{
							Description: "Set the policy to use for creating new resources. Only used on create and update. Valid values are 'CREATE_OR_ACQUIRE' (default) or 'ACQUIRE'. If set to 'ACQUIRE' and resources do not already exist, the deployment will fail. Note that updating this field does not actually affect the deployment, just how it is updated. Default value: \"CREATE_OR_ACQUIRE\" Possible values: [\"ACQUIRE\", \"CREATE_OR_ACQUIRE\"]",
							Type:        []string{"string"},
							Format:      "",
						},
					},
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-google-api/apis/deployment/v1alpha1.ManagerDeploymentSpecLabels"),
									},
								},
							},
						},
					...
					"preview": {
						SchemaProps: spec.SchemaProps{
							Description: "If set to true, a deployment is created with \"shell\" resources that are not actually instantiated. This allows you to preview a deployment. It can be updated to false to actually deploy with real resources.\n ~>**NOTE:** Deployment Manager does not allow update\nof a deployment in preview (unless updating to preview=false). Thus, Terraform will force-recreate deployments if either preview is updated to true or if other fields are updated while preview is true.",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
					...
					"target": {
						SchemaProps: spec.SchemaProps{
							Description: "Parameters that define your deployment, including the deployment configuration and relevant templates.",
							Ref:         ref("kubeform.dev/provider-google-api/apis/deployment/v1alpha1.ManagerDeploymentSpecTarget"),
						},
					},
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-google-api/apis/deployment/v1alpha1.ManagerDeploymentSpec2"),
						},
					},
				},
		...
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/apimachinery/api/v1alpha1.ResourceTimeout", "kubeform.dev/provider-google-api/apis/deployment/v1alpha1.ManagerDeploymentSpec2", "kubeform.dev/provider-google-api/apis/deployment/v1alpha1.ManagerDeploymentSpecLabels", "kubeform.dev/provider-google-api/apis/deployment/v1alpha1.ManagerDeploymentSpecTarget"},
	}
}

func schema_provider_google_api_apis_deployment_v1alpha1_ManagerDeploymentSpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
		...
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/apimachinery/api/v1alpha1.ResourceTimeout", "kubeform.dev/provider-google-api/apis/deployment/v1alpha1.ManagerDeploymentSpecLabels", "kubeform.dev/provider-google-api/apis/deployment/v1alpha1.ManagerDeploymentSpecTarget"},
	}
}

func schema_provider_google_api_apis_deployment_v1alpha1_ManagerDeploymentSpecLabels(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_google_api_apis_deployment_v1alpha1_ManagerDeploymentSpecTarget(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					"config": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("kubeform.dev/provider-google-api/apis/deployment/v1alpha1.ManagerDeploymentSpecTargetConfig"),
						},
					},
					"imports": {
						SchemaProps: spec.SchemaProps{
							Description: "Specifies import files for this configuration. This can be used to import templates or other files. For example, you might import a text file in order to use the file in a template.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-google-api/apis/deployment/v1alpha1.ManagerDeploymentSpecTargetImports"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"kubeform.dev/provider-google-api/apis/deployment/v1alpha1.ManagerDeploymentSpecTargetConfig", "kubeform.dev/provider-google-api/apis/deployment/v1alpha1.ManagerDeploymentSpecTargetImports"},
	}
}

func schema_provider_google_api_apis_deployment_v1alpha1_ManagerDeploymentSpecTargetCodec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_google_api_apis_deployment_v1alpha1_ManagerDeploymentSpecTargetConfig(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_google_api_apis_deployment_v1alpha1_ManagerDeploymentSpecTargetConfigCodec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_google_api_apis_deployment_v1alpha1_ManagerDeploymentSpecTargetImports(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"name": {
						SchemaProps: spec.SchemaProps{
							Description: "The name of the template to import, as declared in the YAML configuration.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
...
func schema_provider_google_api_apis_deployment_v1alpha1_ManagerDeploymentStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
