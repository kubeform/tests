...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-google-api/apis/billingsubaccount/v1alpha1.BillingSubaccount":       schema_provider_google_api_apis_billingsubaccount_v1alpha1_BillingSubaccount(ref),
		"kubeform.dev/provider-google-api/apis/billingsubaccount/v1alpha1.BillingSubaccountList":   schema_provider_google_api_apis_billingsubaccount_v1alpha1_BillingSubaccountList(ref),
		"kubeform.dev/provider-google-api/apis/billingsubaccount/v1alpha1.BillingSubaccountSpec":   schema_provider_google_api_apis_billingsubaccount_v1alpha1_BillingSubaccountSpec(ref),
		"kubeform.dev/provider-google-api/apis/billingsubaccount/v1alpha1.BillingSubaccountSpec2":  schema_provider_google_api_apis_billingsubaccount_v1alpha1_BillingSubaccountSpec2(ref),
		"kubeform.dev/provider-google-api/apis/billingsubaccount/v1alpha1.BillingSubaccountStatus": schema_provider_google_api_apis_billingsubaccount_v1alpha1_BillingSubaccountStatus(ref),
	}
}
...
func schema_provider_google_api_apis_billingsubaccount_v1alpha1_BillingSubaccount(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-google-api/apis/billingsubaccount/v1alpha1.BillingSubaccountSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-google-api/apis/billingsubaccount/v1alpha1.BillingSubaccountStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-google-api/apis/billingsubaccount/v1alpha1.BillingSubaccountSpec", "kubeform.dev/provider-google-api/apis/billingsubaccount/v1alpha1.BillingSubaccountStatus"},
	}
}

func schema_provider_google_api_apis_billingsubaccount_v1alpha1_BillingSubaccountList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "BillingSubaccountList is a list of BillingSubaccounts",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							Description: "Items is a list of BillingSubaccount CRD objects",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-google-api/apis/billingsubaccount/v1alpha1.BillingSubaccount"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-google-api/apis/billingsubaccount/v1alpha1.BillingSubaccount"},
	}
}

func schema_provider_google_api_apis_billingsubaccount_v1alpha1_BillingSubaccountSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-google-api/apis/billingsubaccount/v1alpha1.BillingSubaccountSpec2"),
						},
					},
				},
				Required: []string{"providerRef", "displayName", "masterBillingAccount"},
			},
		},
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/provider-google-api/apis/billingsubaccount/v1alpha1.BillingSubaccountSpec2"},
	}
}

func schema_provider_google_api_apis_billingsubaccount_v1alpha1_BillingSubaccountSpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_google_api_apis_billingsubaccount_v1alpha1_BillingSubaccountStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
