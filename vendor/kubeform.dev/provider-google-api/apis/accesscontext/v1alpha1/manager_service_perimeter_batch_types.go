...
type ManagerServicePerimeterBatchSpec struct {
	ManagerServicePerimeterBatchSpec2 `json:",inline"`
	// +optional
	KubeformOutput ManagerServicePerimeterBatchSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type ManagerServicePerimeterBatchSpec2 struct {
