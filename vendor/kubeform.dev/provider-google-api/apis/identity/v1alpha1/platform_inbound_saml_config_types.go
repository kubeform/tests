...
type PlatformInboundSamlConfigSpec struct {
	PlatformInboundSamlConfigSpec2 `json:",inline"`
	// +optional
	KubeformOutput PlatformInboundSamlConfigSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type PlatformInboundSamlConfigSpec2 struct {
