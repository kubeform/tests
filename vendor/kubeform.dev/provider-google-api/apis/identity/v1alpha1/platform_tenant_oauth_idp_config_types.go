...
type PlatformTenantOauthIdpConfigSpec struct {
	PlatformTenantOauthIdpConfigSpec2 `json:",inline"`
	// +optional
	KubeformOutput PlatformTenantOauthIdpConfigSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type PlatformTenantOauthIdpConfigSpec2 struct {
