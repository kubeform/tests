...
type SubscriptionIamBindingSpec struct {
	SubscriptionIamBindingSpec2 `json:",inline"`
	// +optional
	KubeformOutput SubscriptionIamBindingSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type SubscriptionIamBindingSpec2 struct {
