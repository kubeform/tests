...
type SubscriptionIamMemberSpec struct {
	SubscriptionIamMemberSpec2 `json:",inline"`
	// +optional
	KubeformOutput SubscriptionIamMemberSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type SubscriptionIamMemberSpec2 struct {
