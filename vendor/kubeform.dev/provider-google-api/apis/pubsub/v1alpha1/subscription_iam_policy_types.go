...
type SubscriptionIamPolicySpec struct {
	SubscriptionIamPolicySpec2 `json:",inline"`
	// +optional
	KubeformOutput SubscriptionIamPolicySpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type SubscriptionIamPolicySpec2 struct {
