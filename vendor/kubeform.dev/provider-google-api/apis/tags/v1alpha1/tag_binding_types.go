...
type TagBindingSpec struct {
	TagBindingSpec2 `json:",inline"`
	// +optional
	KubeformOutput TagBindingSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type TagBindingSpec2 struct {
...
type TagBindingList struct {
	...
	// Items is a list of TagBinding CRD objects
	Items []TagBinding `json:"items,omitempty"`
}
