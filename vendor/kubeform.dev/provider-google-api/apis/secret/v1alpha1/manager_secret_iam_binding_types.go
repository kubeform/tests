...
type ManagerSecretIamBindingSpec struct {
	ManagerSecretIamBindingSpec2 `json:",inline"`
	// +optional
	KubeformOutput ManagerSecretIamBindingSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type ManagerSecretIamBindingSpec2 struct {
