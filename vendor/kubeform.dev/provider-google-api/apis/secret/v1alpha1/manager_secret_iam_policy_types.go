...
type ManagerSecretIamPolicySpec struct {
	ManagerSecretIamPolicySpec2 `json:",inline"`
	// +optional
	KubeformOutput ManagerSecretIamPolicySpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type ManagerSecretIamPolicySpec2 struct {
