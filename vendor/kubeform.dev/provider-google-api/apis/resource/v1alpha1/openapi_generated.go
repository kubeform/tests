...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-google-api/apis/resource/v1alpha1.ManagerLien":       schema_provider_google_api_apis_resource_v1alpha1_ManagerLien(ref),
		"kubeform.dev/provider-google-api/apis/resource/v1alpha1.ManagerLienList":   schema_provider_google_api_apis_resource_v1alpha1_ManagerLienList(ref),
		"kubeform.dev/provider-google-api/apis/resource/v1alpha1.ManagerLienSpec":   schema_provider_google_api_apis_resource_v1alpha1_ManagerLienSpec(ref),
		"kubeform.dev/provider-google-api/apis/resource/v1alpha1.ManagerLienSpec2":  schema_provider_google_api_apis_resource_v1alpha1_ManagerLienSpec2(ref),
		"kubeform.dev/provider-google-api/apis/resource/v1alpha1.ManagerLienStatus": schema_provider_google_api_apis_resource_v1alpha1_ManagerLienStatus(ref),
	}
}
...
func schema_provider_google_api_apis_resource_v1alpha1_ManagerLien(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-google-api/apis/resource/v1alpha1.ManagerLienSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-google-api/apis/resource/v1alpha1.ManagerLienStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-google-api/apis/resource/v1alpha1.ManagerLienSpec", "kubeform.dev/provider-google-api/apis/resource/v1alpha1.ManagerLienStatus"},
	}
}

func schema_provider_google_api_apis_resource_v1alpha1_ManagerLienList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ManagerLienList is a list of ManagerLiens",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							Description: "Items is a list of ManagerLien CRD objects",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-google-api/apis/resource/v1alpha1.ManagerLien"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-google-api/apis/resource/v1alpha1.ManagerLien"},
	}
}

func schema_provider_google_api_apis_resource_v1alpha1_ManagerLienSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"parent": {
						SchemaProps: spec.SchemaProps{
							Description: "A reference to the resource this Lien is attached to. The server will validate the parent against those for which Liens are supported. Since a variety of objects can have Liens against them, you must provide the type prefix (e.g. \"projects/my-project-name\").",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					...
					"restrictions": {
						SchemaProps: spec.SchemaProps{
							Description: "The types of operations which should be blocked as a result of this Lien. Each value should correspond to an IAM permission. The server will validate the permissions against those for which Liens are supported.  An empty list is meaningless and will be rejected. e.g. ['resourcemanager.projects.delete']",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-google-api/apis/resource/v1alpha1.ManagerLienSpec2"),
						},
					},
				},
		...
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/apimachinery/api/v1alpha1.ResourceTimeout", "kubeform.dev/provider-google-api/apis/resource/v1alpha1.ManagerLienSpec2"},
	}
}

func schema_provider_google_api_apis_resource_v1alpha1_ManagerLienSpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_google_api_apis_resource_v1alpha1_ManagerLienStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
