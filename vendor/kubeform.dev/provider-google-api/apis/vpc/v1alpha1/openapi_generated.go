...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-google-api/apis/vpc/v1alpha1.AccessConnector":       schema_provider_google_api_apis_vpc_v1alpha1_AccessConnector(ref),
		"kubeform.dev/provider-google-api/apis/vpc/v1alpha1.AccessConnectorList":   schema_provider_google_api_apis_vpc_v1alpha1_AccessConnectorList(ref),
		"kubeform.dev/provider-google-api/apis/vpc/v1alpha1.AccessConnectorSpec":   schema_provider_google_api_apis_vpc_v1alpha1_AccessConnectorSpec(ref),
		"kubeform.dev/provider-google-api/apis/vpc/v1alpha1.AccessConnectorSpec2":  schema_provider_google_api_apis_vpc_v1alpha1_AccessConnectorSpec2(ref),
		"kubeform.dev/provider-google-api/apis/vpc/v1alpha1.AccessConnectorStatus": schema_provider_google_api_apis_vpc_v1alpha1_AccessConnectorStatus(ref),
	}
}
...
func schema_provider_google_api_apis_vpc_v1alpha1_AccessConnector(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-google-api/apis/vpc/v1alpha1.AccessConnectorSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-google-api/apis/vpc/v1alpha1.AccessConnectorStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-google-api/apis/vpc/v1alpha1.AccessConnectorSpec", "kubeform.dev/provider-google-api/apis/vpc/v1alpha1.AccessConnectorStatus"},
	}
}

func schema_provider_google_api_apis_vpc_v1alpha1_AccessConnectorList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "AccessConnectorList is a list of AccessConnectors",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							Description: "Items is a list of AccessConnector CRD objects",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-google-api/apis/vpc/v1alpha1.AccessConnector"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-google-api/apis/vpc/v1alpha1.AccessConnector"},
	}
}

func schema_provider_google_api_apis_vpc_v1alpha1_AccessConnectorSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-google-api/apis/vpc/v1alpha1.AccessConnectorSpec2"),
						},
					},
				},
		...
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/apimachinery/api/v1alpha1.ResourceTimeout", "kubeform.dev/provider-google-api/apis/vpc/v1alpha1.AccessConnectorSpec2"},
	}
}

func schema_provider_google_api_apis_vpc_v1alpha1_AccessConnectorSpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_google_api_apis_vpc_v1alpha1_AccessConnectorStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
