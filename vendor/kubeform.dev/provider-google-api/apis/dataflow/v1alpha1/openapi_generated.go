...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-google-api/apis/dataflow/v1alpha1.Job":       schema_provider_google_api_apis_dataflow_v1alpha1_Job(ref),
		"kubeform.dev/provider-google-api/apis/dataflow/v1alpha1.JobList":   schema_provider_google_api_apis_dataflow_v1alpha1_JobList(ref),
		"kubeform.dev/provider-google-api/apis/dataflow/v1alpha1.JobSpec":   schema_provider_google_api_apis_dataflow_v1alpha1_JobSpec(ref),
		"kubeform.dev/provider-google-api/apis/dataflow/v1alpha1.JobSpec2":  schema_provider_google_api_apis_dataflow_v1alpha1_JobSpec2(ref),
		"kubeform.dev/provider-google-api/apis/dataflow/v1alpha1.JobStatus": schema_provider_google_api_apis_dataflow_v1alpha1_JobStatus(ref),
	}
}
...
func schema_provider_google_api_apis_dataflow_v1alpha1_Job(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-google-api/apis/dataflow/v1alpha1.JobSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-google-api/apis/dataflow/v1alpha1.JobStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-google-api/apis/dataflow/v1alpha1.JobSpec", "kubeform.dev/provider-google-api/apis/dataflow/v1alpha1.JobStatus"},
	}
}

func schema_provider_google_api_apis_dataflow_v1alpha1_JobList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-google-api/apis/dataflow/v1alpha1.Job"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-google-api/apis/dataflow/v1alpha1.Job"},
	}
}

func schema_provider_google_api_apis_dataflow_v1alpha1_JobSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-google-api/apis/dataflow/v1alpha1.JobSpec2"),
						},
					},
				},
		...
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/apimachinery/api/v1alpha1.ResourceTimeout", "kubeform.dev/provider-google-api/apis/dataflow/v1alpha1.JobSpec2"},
	}
}

func schema_provider_google_api_apis_dataflow_v1alpha1_JobSpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_google_api_apis_dataflow_v1alpha1_JobStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
