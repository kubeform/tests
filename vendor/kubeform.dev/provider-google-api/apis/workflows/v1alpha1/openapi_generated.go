...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-google-api/apis/workflows/v1alpha1.Workflow":       schema_provider_google_api_apis_workflows_v1alpha1_Workflow(ref),
		"kubeform.dev/provider-google-api/apis/workflows/v1alpha1.WorkflowList":   schema_provider_google_api_apis_workflows_v1alpha1_WorkflowList(ref),
		"kubeform.dev/provider-google-api/apis/workflows/v1alpha1.WorkflowSpec":   schema_provider_google_api_apis_workflows_v1alpha1_WorkflowSpec(ref),
		"kubeform.dev/provider-google-api/apis/workflows/v1alpha1.WorkflowSpec2":  schema_provider_google_api_apis_workflows_v1alpha1_WorkflowSpec2(ref),
		"kubeform.dev/provider-google-api/apis/workflows/v1alpha1.WorkflowStatus": schema_provider_google_api_apis_workflows_v1alpha1_WorkflowStatus(ref),
	}
}
...
func schema_provider_google_api_apis_workflows_v1alpha1_Workflow(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-google-api/apis/workflows/v1alpha1.WorkflowSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-google-api/apis/workflows/v1alpha1.WorkflowStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-google-api/apis/workflows/v1alpha1.WorkflowSpec", "kubeform.dev/provider-google-api/apis/workflows/v1alpha1.WorkflowStatus"},
	}
}

func schema_provider_google_api_apis_workflows_v1alpha1_WorkflowList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-google-api/apis/workflows/v1alpha1.Workflow"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-google-api/apis/workflows/v1alpha1.Workflow"},
	}
}

func schema_provider_google_api_apis_workflows_v1alpha1_WorkflowSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"serviceAccount": {
						SchemaProps: spec.SchemaProps{
							Description: "Name of the service account associated with the latest workflow version. This service account represents the identity of the workflow and determines what permissions the workflow has.\n\nFormat: projects/{project}/serviceAccounts/{account}.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-google-api/apis/workflows/v1alpha1.WorkflowSpec2"),
						},
					},
				},
		...
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/apimachinery/api/v1alpha1.ResourceTimeout", "kubeform.dev/provider-google-api/apis/workflows/v1alpha1.WorkflowSpec2"},
	}
}

func schema_provider_google_api_apis_workflows_v1alpha1_WorkflowSpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_google_api_apis_workflows_v1alpha1_WorkflowStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
