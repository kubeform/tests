...
type AssetOrganizationFeedSpec struct {
	AssetOrganizationFeedSpec2 `json:",inline"`
	// +optional
	KubeformOutput AssetOrganizationFeedSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type AssetOrganizationFeedSpec2 struct {
