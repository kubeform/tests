...
type CatalogEntryGroupIamBindingSpec struct {
	CatalogEntryGroupIamBindingSpec2 `json:",inline"`
	// +optional
	KubeformOutput CatalogEntryGroupIamBindingSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type CatalogEntryGroupIamBindingSpec2 struct {
