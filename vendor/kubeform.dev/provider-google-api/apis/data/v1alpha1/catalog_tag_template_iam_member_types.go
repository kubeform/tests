...
type CatalogTagTemplateIamMemberSpec struct {
	CatalogTagTemplateIamMemberSpec2 `json:",inline"`
	// +optional
	KubeformOutput CatalogTagTemplateIamMemberSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type CatalogTagTemplateIamMemberSpec2 struct {
