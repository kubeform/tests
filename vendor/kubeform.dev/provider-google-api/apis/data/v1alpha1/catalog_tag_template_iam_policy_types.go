...
type CatalogTagTemplateIamPolicySpec struct {
	CatalogTagTemplateIamPolicySpec2 `json:",inline"`
	// +optional
	KubeformOutput CatalogTagTemplateIamPolicySpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type CatalogTagTemplateIamPolicySpec2 struct {
