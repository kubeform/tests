...
type CatalogEntryGroupIamMemberSpec struct {
	CatalogEntryGroupIamMemberSpec2 `json:",inline"`
	// +optional
	KubeformOutput CatalogEntryGroupIamMemberSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type CatalogEntryGroupIamMemberSpec2 struct {
