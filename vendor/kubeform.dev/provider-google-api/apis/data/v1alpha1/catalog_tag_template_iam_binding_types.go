...
type CatalogTagTemplateIamBindingSpec struct {
	CatalogTagTemplateIamBindingSpec2 `json:",inline"`
	// +optional
	KubeformOutput CatalogTagTemplateIamBindingSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type CatalogTagTemplateIamBindingSpec2 struct {
