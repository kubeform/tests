...
type CatalogEntryGroupIamPolicySpec struct {
	CatalogEntryGroupIamPolicySpec2 `json:",inline"`
	// +optional
	KubeformOutput CatalogEntryGroupIamPolicySpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type CatalogEntryGroupIamPolicySpec2 struct {
