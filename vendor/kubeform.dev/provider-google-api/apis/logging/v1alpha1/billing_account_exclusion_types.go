...
type BillingAccountExclusionSpec struct {
	BillingAccountExclusionSpec2 `json:",inline"`
	// +optional
	KubeformOutput BillingAccountExclusionSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type BillingAccountExclusionSpec2 struct {
