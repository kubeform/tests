...
type OrganizationBucketConfigSpec struct {
	OrganizationBucketConfigSpec2 `json:",inline"`
	// +optional
	KubeformOutput OrganizationBucketConfigSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type OrganizationBucketConfigSpec2 struct {
