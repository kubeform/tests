...
type OrganizationExclusionSpec struct {
	OrganizationExclusionSpec2 `json:",inline"`
	// +optional
	KubeformOutput OrganizationExclusionSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type OrganizationExclusionSpec2 struct {
