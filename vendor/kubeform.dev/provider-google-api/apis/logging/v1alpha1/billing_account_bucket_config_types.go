...
type BillingAccountBucketConfigSpec struct {
	BillingAccountBucketConfigSpec2 `json:",inline"`
	// +optional
	KubeformOutput BillingAccountBucketConfigSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type BillingAccountBucketConfigSpec2 struct {
