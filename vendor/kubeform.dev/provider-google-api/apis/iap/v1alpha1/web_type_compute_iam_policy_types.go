...
type WebTypeComputeIamPolicySpec struct {
	WebTypeComputeIamPolicySpec2 `json:",inline"`
	// +optional
	KubeformOutput WebTypeComputeIamPolicySpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type WebTypeComputeIamPolicySpec2 struct {
