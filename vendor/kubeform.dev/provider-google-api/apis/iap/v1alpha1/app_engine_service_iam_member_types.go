...
type AppEngineServiceIamMemberSpec struct {
	AppEngineServiceIamMemberSpec2 `json:",inline"`
	// +optional
	KubeformOutput AppEngineServiceIamMemberSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type AppEngineServiceIamMemberSpec2 struct {
