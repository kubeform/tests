...
type WebBackendServiceIamBindingSpec struct {
	WebBackendServiceIamBindingSpec2 `json:",inline"`
	// +optional
	KubeformOutput WebBackendServiceIamBindingSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type WebBackendServiceIamBindingSpec2 struct {
