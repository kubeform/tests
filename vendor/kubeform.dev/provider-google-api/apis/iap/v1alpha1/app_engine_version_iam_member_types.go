...
type AppEngineVersionIamMemberSpec struct {
	AppEngineVersionIamMemberSpec2 `json:",inline"`
	// +optional
	KubeformOutput AppEngineVersionIamMemberSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type AppEngineVersionIamMemberSpec2 struct {
