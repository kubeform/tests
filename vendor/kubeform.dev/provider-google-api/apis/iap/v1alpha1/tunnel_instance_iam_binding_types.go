...
type TunnelInstanceIamBindingSpec struct {
	TunnelInstanceIamBindingSpec2 `json:",inline"`
	// +optional
	KubeformOutput TunnelInstanceIamBindingSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type TunnelInstanceIamBindingSpec2 struct {
