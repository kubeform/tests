...
type AppEngineServiceIamBindingSpec struct {
	AppEngineServiceIamBindingSpec2 `json:",inline"`
	// +optional
	KubeformOutput AppEngineServiceIamBindingSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type AppEngineServiceIamBindingSpec2 struct {
