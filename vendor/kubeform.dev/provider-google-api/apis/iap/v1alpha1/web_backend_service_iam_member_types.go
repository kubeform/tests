...
type WebBackendServiceIamMemberSpec struct {
	WebBackendServiceIamMemberSpec2 `json:",inline"`
	// +optional
	KubeformOutput WebBackendServiceIamMemberSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type WebBackendServiceIamMemberSpec2 struct {
