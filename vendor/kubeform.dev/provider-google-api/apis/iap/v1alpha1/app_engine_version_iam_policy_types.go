...
type AppEngineVersionIamPolicySpec struct {
	AppEngineVersionIamPolicySpec2 `json:",inline"`
	// +optional
	KubeformOutput AppEngineVersionIamPolicySpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type AppEngineVersionIamPolicySpec2 struct {
