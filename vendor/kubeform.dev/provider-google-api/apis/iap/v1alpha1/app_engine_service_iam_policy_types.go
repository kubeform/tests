...
type AppEngineServiceIamPolicySpec struct {
	AppEngineServiceIamPolicySpec2 `json:",inline"`
	// +optional
	KubeformOutput AppEngineServiceIamPolicySpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type AppEngineServiceIamPolicySpec2 struct {
