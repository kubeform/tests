...
type WebTypeAppEngineIamPolicySpec struct {
	WebTypeAppEngineIamPolicySpec2 `json:",inline"`
	// +optional
	KubeformOutput WebTypeAppEngineIamPolicySpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type WebTypeAppEngineIamPolicySpec2 struct {
