...
type WebTypeComputeIamMemberSpec struct {
	WebTypeComputeIamMemberSpec2 `json:",inline"`
	// +optional
	KubeformOutput WebTypeComputeIamMemberSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type WebTypeComputeIamMemberSpec2 struct {
