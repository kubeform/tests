...
type WebTypeAppEngineIamMemberSpec struct {
	WebTypeAppEngineIamMemberSpec2 `json:",inline"`
	// +optional
	KubeformOutput WebTypeAppEngineIamMemberSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type WebTypeAppEngineIamMemberSpec2 struct {
