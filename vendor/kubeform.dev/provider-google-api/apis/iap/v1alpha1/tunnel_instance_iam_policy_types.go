...
type TunnelInstanceIamPolicySpec struct {
	TunnelInstanceIamPolicySpec2 `json:",inline"`
	// +optional
	KubeformOutput TunnelInstanceIamPolicySpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type TunnelInstanceIamPolicySpec2 struct {
