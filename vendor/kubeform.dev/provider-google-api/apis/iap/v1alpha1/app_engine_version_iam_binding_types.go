...
type AppEngineVersionIamBindingSpec struct {
	AppEngineVersionIamBindingSpec2 `json:",inline"`
	// +optional
	KubeformOutput AppEngineVersionIamBindingSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type AppEngineVersionIamBindingSpec2 struct {
