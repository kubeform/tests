...
type WebTypeComputeIamBindingSpec struct {
	WebTypeComputeIamBindingSpec2 `json:",inline"`
	// +optional
	KubeformOutput WebTypeComputeIamBindingSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type WebTypeComputeIamBindingSpec2 struct {
