...
type TunnelInstanceIamMemberSpec struct {
	TunnelInstanceIamMemberSpec2 `json:",inline"`
	// +optional
	KubeformOutput TunnelInstanceIamMemberSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type TunnelInstanceIamMemberSpec2 struct {
