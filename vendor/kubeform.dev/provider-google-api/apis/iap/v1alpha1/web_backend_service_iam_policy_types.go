...
type WebBackendServiceIamPolicySpec struct {
	WebBackendServiceIamPolicySpec2 `json:",inline"`
	// +optional
	KubeformOutput WebBackendServiceIamPolicySpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type WebBackendServiceIamPolicySpec2 struct {
