...
type ConsentStoreIamPolicySpec struct {
	ConsentStoreIamPolicySpec2 `json:",inline"`
	// +optional
	KubeformOutput ConsentStoreIamPolicySpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type ConsentStoreIamPolicySpec2 struct {
