...
type ConsentStoreIamMemberSpec struct {
	ConsentStoreIamMemberSpec2 `json:",inline"`
	// +optional
	KubeformOutput ConsentStoreIamMemberSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type ConsentStoreIamMemberSpec2 struct {
