...
type ConsentStoreIamBindingSpec struct {
	ConsentStoreIamBindingSpec2 `json:",inline"`
	// +optional
	KubeformOutput ConsentStoreIamBindingSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type ConsentStoreIamBindingSpec2 struct {
