...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-google-api/apis/redis/v1alpha1.Instance":       schema_provider_google_api_apis_redis_v1alpha1_Instance(ref),
		"kubeform.dev/provider-google-api/apis/redis/v1alpha1.InstanceList":   schema_provider_google_api_apis_redis_v1alpha1_InstanceList(ref),
		"kubeform.dev/provider-google-api/apis/redis/v1alpha1.InstanceSpec":   schema_provider_google_api_apis_redis_v1alpha1_InstanceSpec(ref),
		"kubeform.dev/provider-google-api/apis/redis/v1alpha1.InstanceSpec2":  schema_provider_google_api_apis_redis_v1alpha1_InstanceSpec2(ref),
		"kubeform.dev/provider-google-api/apis/redis/v1alpha1.InstanceStatus": schema_provider_google_api_apis_redis_v1alpha1_InstanceStatus(ref),
	}
}
...
func schema_provider_google_api_apis_redis_v1alpha1_Instance(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-google-api/apis/redis/v1alpha1.InstanceSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-google-api/apis/redis/v1alpha1.InstanceStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-google-api/apis/redis/v1alpha1.InstanceSpec", "kubeform.dev/provider-google-api/apis/redis/v1alpha1.InstanceStatus"},
	}
}

func schema_provider_google_api_apis_redis_v1alpha1_InstanceList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-google-api/apis/redis/v1alpha1.Instance"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-google-api/apis/redis/v1alpha1.Instance"},
	}
}

func schema_provider_google_api_apis_redis_v1alpha1_InstanceSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"redisVersion": {
						SchemaProps: spec.SchemaProps{
							Description: "The version of Redis software. If not provided, latest supported version will be used. Currently, the supported values are:\n\n- REDIS_5_0 for Redis 5.0 compatibility - REDIS_4_0 for Redis 4.0 compatibility - REDIS_3_2 for Redis 3.2 compatibility",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					...
					"tier": {
						SchemaProps: spec.SchemaProps{
							Description: "The service tier of the instance. Must be one of these values:\n\n- BASIC: standalone instance - STANDARD_HA: highly available primary/replica instances Default value: \"BASIC\" Possible values: [\"BASIC\", \"STANDARD_HA\"]",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-google-api/apis/redis/v1alpha1.InstanceSpec2"),
						},
					},
				},
		...
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/apimachinery/api/v1alpha1.ResourceTimeout", "kubeform.dev/provider-google-api/apis/redis/v1alpha1.InstanceSpec2"},
	}
}

func schema_provider_google_api_apis_redis_v1alpha1_InstanceSpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_google_api_apis_redis_v1alpha1_InstanceStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
