...
type GlobalNetworkEndpointGroupSpec struct {
	GlobalNetworkEndpointGroupSpec2 `json:",inline"`
	// +optional
	KubeformOutput GlobalNetworkEndpointGroupSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type GlobalNetworkEndpointGroupSpec2 struct {
