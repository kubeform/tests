...
type ProjectDefaultNetworkTierSpec struct {
	ProjectDefaultNetworkTierSpec2 `json:",inline"`
	// +optional
	KubeformOutput ProjectDefaultNetworkTierSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type ProjectDefaultNetworkTierSpec2 struct {
