...
type BackendBucketSignedURLKeySpec struct {
	BackendBucketSignedURLKeySpec2 `json:",inline"`
	// +optional
	KubeformOutput BackendBucketSignedURLKeySpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type BackendBucketSignedURLKeySpec2 struct {
