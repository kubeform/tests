...
type BackendServiceSignedURLKeySpec struct {
	BackendServiceSignedURLKeySpec2 `json:",inline"`
	// +optional
	KubeformOutput BackendServiceSignedURLKeySpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type BackendServiceSignedURLKeySpec2 struct {
