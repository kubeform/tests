...
type RegionPerInstanceConfigSpec struct {
	RegionPerInstanceConfigSpec2 `json:",inline"`
	// +optional
	KubeformOutput RegionPerInstanceConfigSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type RegionPerInstanceConfigSpec2 struct {
