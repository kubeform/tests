...
type DiskResourcePolicyAttachmentSpec struct {
	DiskResourcePolicyAttachmentSpec2 `json:",inline"`
	// +optional
	KubeformOutput DiskResourcePolicyAttachmentSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type DiskResourcePolicyAttachmentSpec2 struct {
