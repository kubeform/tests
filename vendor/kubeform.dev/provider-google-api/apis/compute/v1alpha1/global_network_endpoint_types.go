...
type GlobalNetworkEndpointSpec struct {
	GlobalNetworkEndpointSpec2 `json:",inline"`
	// +optional
	KubeformOutput GlobalNetworkEndpointSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type GlobalNetworkEndpointSpec2 struct {
