...
type RegionTargetHTTPProxySpec struct {
	RegionTargetHTTPProxySpec2 `json:",inline"`
	// +optional
	KubeformOutput RegionTargetHTTPProxySpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type RegionTargetHTTPProxySpec2 struct {
