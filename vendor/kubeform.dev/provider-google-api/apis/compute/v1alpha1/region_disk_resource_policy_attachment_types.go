...
type RegionDiskResourcePolicyAttachmentSpec struct {
	RegionDiskResourcePolicyAttachmentSpec2 `json:",inline"`
	// +optional
	KubeformOutput RegionDiskResourcePolicyAttachmentSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type RegionDiskResourcePolicyAttachmentSpec2 struct {
