...
type SharedVpcServiceProjectSpec struct {
	SharedVpcServiceProjectSpec2 `json:",inline"`
	// +optional
	KubeformOutput SharedVpcServiceProjectSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type SharedVpcServiceProjectSpec2 struct {
