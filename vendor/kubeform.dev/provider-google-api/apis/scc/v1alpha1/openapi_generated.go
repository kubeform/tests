...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-google-api/apis/scc/v1alpha1.Source":       schema_provider_google_api_apis_scc_v1alpha1_Source(ref),
		"kubeform.dev/provider-google-api/apis/scc/v1alpha1.SourceList":   schema_provider_google_api_apis_scc_v1alpha1_SourceList(ref),
		"kubeform.dev/provider-google-api/apis/scc/v1alpha1.SourceSpec":   schema_provider_google_api_apis_scc_v1alpha1_SourceSpec(ref),
		"kubeform.dev/provider-google-api/apis/scc/v1alpha1.SourceSpec2":  schema_provider_google_api_apis_scc_v1alpha1_SourceSpec2(ref),
		"kubeform.dev/provider-google-api/apis/scc/v1alpha1.SourceStatus": schema_provider_google_api_apis_scc_v1alpha1_SourceStatus(ref),
	}
}
...
func schema_provider_google_api_apis_scc_v1alpha1_Source(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-google-api/apis/scc/v1alpha1.SourceSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-google-api/apis/scc/v1alpha1.SourceStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-google-api/apis/scc/v1alpha1.SourceSpec", "kubeform.dev/provider-google-api/apis/scc/v1alpha1.SourceStatus"},
	}
}

func schema_provider_google_api_apis_scc_v1alpha1_SourceList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SourceList is a list of Sources",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							Description: "Items is a list of Source CRD objects",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-google-api/apis/scc/v1alpha1.Source"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-google-api/apis/scc/v1alpha1.Source"},
	}
}

func schema_provider_google_api_apis_scc_v1alpha1_SourceSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"name": {
						SchemaProps: spec.SchemaProps{
							Description: "The resource name of this source, in the format 'organizations/{{organization}}/sources/{{source}}'.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-google-api/apis/scc/v1alpha1.SourceSpec2"),
						},
					},
				},
				Required: []string{"providerRef", "displayName", "organization"},
			},
		},
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/apimachinery/api/v1alpha1.ResourceTimeout", "kubeform.dev/provider-google-api/apis/scc/v1alpha1.SourceSpec2"},
	}
}

func schema_provider_google_api_apis_scc_v1alpha1_SourceSpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_google_api_apis_scc_v1alpha1_SourceStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
