...
type DistributionConfigurationSpec struct {
	DistributionConfigurationSpec2 `json:",inline"`
	// +optional
	KubeformOutput DistributionConfigurationSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type DistributionConfigurationSpec2 struct {
