...
type LakeformationResourceSpec struct {
	LakeformationResourceSpec2 `json:",inline"`
	// +optional
	KubeformOutput LakeformationResourceSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type LakeformationResourceSpec2 struct {
