...
type TransitGatewayRouteTableAssociationSpec struct {
	TransitGatewayRouteTableAssociationSpec2 `json:",inline"`
	// +optional
	KubeformOutput TransitGatewayRouteTableAssociationSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type TransitGatewayRouteTableAssociationSpec2 struct {
