...
type TransitGatewayRouteTablePropagationSpec struct {
	TransitGatewayRouteTablePropagationSpec2 `json:",inline"`
	// +optional
	KubeformOutput TransitGatewayRouteTablePropagationSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type TransitGatewayRouteTablePropagationSpec2 struct {
