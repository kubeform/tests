...
type TrafficMirrorFilterRuleSpec struct {
	TrafficMirrorFilterRuleSpec2 `json:",inline"`
	// +optional
	KubeformOutput TrafficMirrorFilterRuleSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type TrafficMirrorFilterRuleSpec2 struct {
