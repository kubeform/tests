...
type TransitGatewayRouteTableSpec struct {
	TransitGatewayRouteTableSpec2 `json:",inline"`
	// +optional
	KubeformOutput TransitGatewayRouteTableSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type TransitGatewayRouteTableSpec2 struct {
