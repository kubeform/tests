...
type TransitGatewayPrefixListReferenceSpec struct {
	TransitGatewayPrefixListReferenceSpec2 `json:",inline"`
	// +optional
	KubeformOutput TransitGatewayPrefixListReferenceSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type TransitGatewayPrefixListReferenceSpec2 struct {
