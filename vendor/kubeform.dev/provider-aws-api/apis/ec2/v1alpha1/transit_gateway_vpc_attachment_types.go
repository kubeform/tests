...
type TransitGatewayVpcAttachmentSpec struct {
	TransitGatewayVpcAttachmentSpec2 `json:",inline"`
	// +optional
	KubeformOutput TransitGatewayVpcAttachmentSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type TransitGatewayVpcAttachmentSpec2 struct {
