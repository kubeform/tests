...
type TransitGatewayVpcAttachmentAccepterSpec struct {
	TransitGatewayVpcAttachmentAccepterSpec2 `json:",inline"`
	// +optional
	KubeformOutput TransitGatewayVpcAttachmentAccepterSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type TransitGatewayVpcAttachmentAccepterSpec2 struct {
