...
type LocalGatewayRouteTableVpcAssociationSpec struct {
	LocalGatewayRouteTableVpcAssociationSpec2 `json:",inline"`
	// +optional
	KubeformOutput LocalGatewayRouteTableVpcAssociationSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type LocalGatewayRouteTableVpcAssociationSpec2 struct {
