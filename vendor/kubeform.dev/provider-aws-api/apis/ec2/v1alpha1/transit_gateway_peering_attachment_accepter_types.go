...
type TransitGatewayPeeringAttachmentAccepterSpec struct {
	TransitGatewayPeeringAttachmentAccepterSpec2 `json:",inline"`
	// +optional
	KubeformOutput TransitGatewayPeeringAttachmentAccepterSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type TransitGatewayPeeringAttachmentAccepterSpec2 struct {
