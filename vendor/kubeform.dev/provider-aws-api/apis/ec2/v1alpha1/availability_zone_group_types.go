...
type AvailabilityZoneGroupSpec struct {
	AvailabilityZoneGroupSpec2 `json:",inline"`
	// +optional
	KubeformOutput AvailabilityZoneGroupSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type AvailabilityZoneGroupSpec2 struct {
