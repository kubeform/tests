...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-aws-api/apis/flow/v1alpha1.Log":           schema_provider_aws_api_apis_flow_v1alpha1_Log(ref),
		"kubeform.dev/provider-aws-api/apis/flow/v1alpha1.LogList":       schema_provider_aws_api_apis_flow_v1alpha1_LogList(ref),
		"kubeform.dev/provider-aws-api/apis/flow/v1alpha1.LogSpec":       schema_provider_aws_api_apis_flow_v1alpha1_LogSpec(ref),
		"kubeform.dev/provider-aws-api/apis/flow/v1alpha1.LogSpec2":      schema_provider_aws_api_apis_flow_v1alpha1_LogSpec2(ref),
		"kubeform.dev/provider-aws-api/apis/flow/v1alpha1.LogStatus":     schema_provider_aws_api_apis_flow_v1alpha1_LogStatus(ref),
	}
}
...
func schema_provider_aws_api_apis_flow_v1alpha1_Log(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-aws-api/apis/flow/v1alpha1.LogSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-aws-api/apis/flow/v1alpha1.LogStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-aws-api/apis/flow/v1alpha1.LogSpec", "kubeform.dev/provider-aws-api/apis/flow/v1alpha1.LogStatus"},
	}
}

func schema_provider_aws_api_apis_flow_v1alpha1_LogList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "LogList is a list of Logs",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							Description: "Items is a list of Log CRD objects",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-aws-api/apis/flow/v1alpha1.Log"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-aws-api/apis/flow/v1alpha1.Log"},
	}
}

func schema_provider_aws_api_apis_flow_v1alpha1_LogSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-aws-api/apis/flow/v1alpha1.LogSpec2"),
						},
					},
				},
				Required: []string{"providerRef", "trafficType"},
			},
		},
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/provider-aws-api/apis/flow/v1alpha1.LogSpec2"},
	}
}

func schema_provider_aws_api_apis_flow_v1alpha1_LogSpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_aws_api_apis_flow_v1alpha1_LogStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
