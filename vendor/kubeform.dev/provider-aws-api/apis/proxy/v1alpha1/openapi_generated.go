...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-aws-api/apis/proxy/v1alpha1.ProtocolPolicy":       schema_provider_aws_api_apis_proxy_v1alpha1_ProtocolPolicy(ref),
		"kubeform.dev/provider-aws-api/apis/proxy/v1alpha1.ProtocolPolicyList":   schema_provider_aws_api_apis_proxy_v1alpha1_ProtocolPolicyList(ref),
		"kubeform.dev/provider-aws-api/apis/proxy/v1alpha1.ProtocolPolicySpec":   schema_provider_aws_api_apis_proxy_v1alpha1_ProtocolPolicySpec(ref),
		"kubeform.dev/provider-aws-api/apis/proxy/v1alpha1.ProtocolPolicySpec2":  schema_provider_aws_api_apis_proxy_v1alpha1_ProtocolPolicySpec2(ref),
		"kubeform.dev/provider-aws-api/apis/proxy/v1alpha1.ProtocolPolicyStatus": schema_provider_aws_api_apis_proxy_v1alpha1_ProtocolPolicyStatus(ref),
	}
}
...
func schema_provider_aws_api_apis_proxy_v1alpha1_ProtocolPolicy(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-aws-api/apis/proxy/v1alpha1.ProtocolPolicySpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-aws-api/apis/proxy/v1alpha1.ProtocolPolicyStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-aws-api/apis/proxy/v1alpha1.ProtocolPolicySpec", "kubeform.dev/provider-aws-api/apis/proxy/v1alpha1.ProtocolPolicyStatus"},
	}
}

func schema_provider_aws_api_apis_proxy_v1alpha1_ProtocolPolicyList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ProtocolPolicyList is a list of ProtocolPolicys",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							Description: "Items is a list of ProtocolPolicy CRD objects",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-aws-api/apis/proxy/v1alpha1.ProtocolPolicy"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-aws-api/apis/proxy/v1alpha1.ProtocolPolicy"},
	}
}

func schema_provider_aws_api_apis_proxy_v1alpha1_ProtocolPolicySpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-aws-api/apis/proxy/v1alpha1.ProtocolPolicySpec2"),
						},
					},
				},
				Required: []string{"providerRef", "instancePorts", "loadBalancer"},
			},
		},
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/provider-aws-api/apis/proxy/v1alpha1.ProtocolPolicySpec2"},
	}
}

func schema_provider_aws_api_apis_proxy_v1alpha1_ProtocolPolicySpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_aws_api_apis_proxy_v1alpha1_ProtocolPolicyStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
