...
type ParameterGroupSpec struct {
	ParameterGroupSpec2 `json:",inline"`
	// +optional
	KubeformOutput ParameterGroupSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type ParameterGroupSpecParameters struct {
	Name  *string `json:"name" tf:"name"`
	Value *string `json:"value" tf:"value"`
}

type ParameterGroupSpec2 struct {
	...
	Name        *string `json:"name" tf:"name"`
	// +optional
	Parameters []ParameterGroupSpecParameters `json:"parameters,omitempty" tf:"parameters"`
}
