...
type ThingPrincipalAttachmentSpec struct {
	ThingPrincipalAttachmentSpec2 `json:",inline"`
	// +optional
	KubeformOutput ThingPrincipalAttachmentSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type ThingPrincipalAttachmentSpec2 struct {
