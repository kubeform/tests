...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-apigateway-aws-kubeform-com-v1alpha1-deployment,mutating=false,failurePolicy=fail,groups=apigateway.aws.kubeform.com,resources=deployments,versions=v1alpha1,name=deployment.apigateway.aws.kubeform.io,sideEffects=None,admissionReviewVersions=v1
