...
type DocumentationVersionSpec struct {
	DocumentationVersionSpec2 `json:",inline"`
	// +optional
	KubeformOutput DocumentationVersionSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type DocumentationVersionSpec2 struct {
...
type DocumentationVersionList struct {
	...
	// Items is a list of DocumentationVersion CRD objects
