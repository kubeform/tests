...
type MemberAccountAssociationSpec struct {
	MemberAccountAssociationSpec2 `json:",inline"`
	// +optional
	KubeformOutput MemberAccountAssociationSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type MemberAccountAssociationSpec2 struct {
