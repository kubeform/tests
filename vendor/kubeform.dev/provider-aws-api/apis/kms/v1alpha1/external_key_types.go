...
type ExternalKey struct {
	...
	Spec              ExternalKeySpec   `json:"spec,omitempty"`
	Status            ExternalKeyStatus `json:"status,omitempty"`
}

type ExternalKeySpec struct {
	ExternalKeySpec2 `json:",inline"`
	// +optional
	KubeformOutput ExternalKeySpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type ExternalKeySpec2 struct {
	...
	// +optional
	ExpirationModel *string `json:"expirationModel,omitempty" tf:"expiration_model"`
	// +optional
	KeyMaterialBase64 *string `json:"-" sensitive:"true" tf:"key_material_base64"`
	// +optional
...
type ExternalKeyList struct {
	...
	// Items is a list of ExternalKey CRD objects
	Items []ExternalKey `json:"items,omitempty"`
}
