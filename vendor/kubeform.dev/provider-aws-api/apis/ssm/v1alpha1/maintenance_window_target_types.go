...
type MaintenanceWindowTargetSpec struct {
	MaintenanceWindowTargetSpec2 `json:",inline"`
	// +optional
	KubeformOutput MaintenanceWindowTargetSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type MaintenanceWindowTargetSpec2 struct {
