...
type StandardsSubscriptionSpec struct {
	StandardsSubscriptionSpec2 `json:",inline"`
	// +optional
	KubeformOutput StandardsSubscriptionSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type StandardsSubscriptionSpec2 struct {
