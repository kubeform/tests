...
type OrganizationAdminAccountSpec struct {
	OrganizationAdminAccountSpec2 `json:",inline"`
	// +optional
	KubeformOutput OrganizationAdminAccountSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type OrganizationAdminAccountSpec2 struct {
