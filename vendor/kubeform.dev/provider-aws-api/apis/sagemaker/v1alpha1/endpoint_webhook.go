...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-sagemaker-aws-kubeform-com-v1alpha1-endpoint,mutating=false,failurePolicy=fail,groups=sagemaker.aws.kubeform.com,resources=endpoints,versions=v1alpha1,name=endpoint.sagemaker.aws.kubeform.io,sideEffects=None,admissionReviewVersions=v1
