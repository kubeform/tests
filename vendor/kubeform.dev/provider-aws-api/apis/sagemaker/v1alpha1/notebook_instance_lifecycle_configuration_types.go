...
type NotebookInstanceLifecycleConfigurationSpec struct {
	NotebookInstanceLifecycleConfigurationSpec2 `json:",inline"`
	// +optional
	KubeformOutput NotebookInstanceLifecycleConfigurationSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type NotebookInstanceLifecycleConfigurationSpec2 struct {
