...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-sagemaker-aws-kubeform-com-v1alpha1-domain,mutating=false,failurePolicy=fail,groups=sagemaker.aws.kubeform.com,resources=domains,versions=v1alpha1,name=domain.sagemaker.aws.kubeform.io,sideEffects=None,admissionReviewVersions=v1
