...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-dms-aws-kubeform-com-v1alpha1-endpoint,mutating=false,failurePolicy=fail,groups=dms.aws.kubeform.com,resources=endpoints,versions=v1alpha1,name=endpoint.dms.aws.kubeform.io,sideEffects=None,admissionReviewVersions=v1
