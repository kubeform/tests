...
type ScramSecretAssociationSpec struct {
	ScramSecretAssociationSpec2 `json:",inline"`
	// +optional
	KubeformOutput ScramSecretAssociationSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type ScramSecretAssociationSpec2 struct {
