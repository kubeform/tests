...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-s3outposts-aws-kubeform-com-v1alpha1-endpoint,mutating=false,failurePolicy=fail,groups=s3outposts.aws.kubeform.com,resources=endpoints,versions=v1alpha1,name=endpoint.s3outposts.aws.kubeform.io,sideEffects=None,admissionReviewVersions=v1
