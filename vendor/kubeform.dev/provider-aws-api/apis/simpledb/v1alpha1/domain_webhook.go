...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-simpledb-aws-kubeform-com-v1alpha1-domain,mutating=false,failurePolicy=fail,groups=simpledb.aws.kubeform.com,resources=domains,versions=v1alpha1,name=domain.simpledb.aws.kubeform.io,sideEffects=None,admissionReviewVersions=v1
