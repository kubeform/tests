...
type ProvisionedConcurrencyConfigSpec struct {
	ProvisionedConcurrencyConfigSpec2 `json:",inline"`
	// +optional
	KubeformOutput ProvisionedConcurrencyConfigSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type ProvisionedConcurrencyConfigSpec2 struct {
