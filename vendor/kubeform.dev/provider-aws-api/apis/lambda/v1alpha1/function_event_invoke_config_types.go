...
type FunctionEventInvokeConfigSpec struct {
	FunctionEventInvokeConfigSpec2 `json:",inline"`
	// +optional
	KubeformOutput FunctionEventInvokeConfigSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type FunctionEventInvokeConfigSpec2 struct {
