...
type ReportDefinitionSpec struct {
	ReportDefinitionSpec2 `json:",inline"`
	// +optional
	KubeformOutput ReportDefinitionSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type ReportDefinitionSpec2 struct {
...
// ReportDefinitionList is a list of ReportDefinitions
type ReportDefinitionList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	// Items is a list of ReportDefinition CRD objects
	Items []ReportDefinition `json:"items,omitempty"`
}
