...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-aws-api/apis/serverlessapplicationrepository/v1alpha1.CloudformationStack": schema_provider_aws_api_apis_serverlessapplicationrepository_v1alpha1_CloudformationStack(ref),
		"kubeform.dev/provider-aws-api/apis/serverlessapplicationrepository/v1alpha1.CloudformationStackList":   schema_provider_aws_api_apis_serverlessapplicationrepository_v1alpha1_CloudformationStackList(ref),
		"kubeform.dev/provider-aws-api/apis/serverlessapplicationrepository/v1alpha1.CloudformationStackSpec":   schema_provider_aws_api_apis_serverlessapplicationrepository_v1alpha1_CloudformationStackSpec(ref),
		"kubeform.dev/provider-aws-api/apis/serverlessapplicationrepository/v1alpha1.CloudformationStackSpec2":  schema_provider_aws_api_apis_serverlessapplicationrepository_v1alpha1_CloudformationStackSpec2(ref),
		"kubeform.dev/provider-aws-api/apis/serverlessapplicationrepository/v1alpha1.CloudformationStackStatus": schema_provider_aws_api_apis_serverlessapplicationrepository_v1alpha1_CloudformationStackStatus(ref),
	}
}
...
func schema_provider_aws_api_apis_serverlessapplicationrepository_v1alpha1_CloudformationStack(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-aws-api/apis/serverlessapplicationrepository/v1alpha1.CloudformationStackSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-aws-api/apis/serverlessapplicationrepository/v1alpha1.CloudformationStackStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-aws-api/apis/serverlessapplicationrepository/v1alpha1.CloudformationStackSpec", "kubeform.dev/provider-aws-api/apis/serverlessapplicationrepository/v1alpha1.CloudformationStackStatus"},
	}
}

func schema_provider_aws_api_apis_serverlessapplicationrepository_v1alpha1_CloudformationStackList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-aws-api/apis/serverlessapplicationrepository/v1alpha1.CloudformationStack"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-aws-api/apis/serverlessapplicationrepository/v1alpha1.CloudformationStack"},
	}
}

func schema_provider_aws_api_apis_serverlessapplicationrepository_v1alpha1_CloudformationStackSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-aws-api/apis/serverlessapplicationrepository/v1alpha1.CloudformationStackSpec2"),
						},
					},
				},
				Required: []string{"providerRef", "applicationID", "capabilities", "name"},
			},
		},
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/apimachinery/api/v1alpha1.ResourceTimeout", "kubeform.dev/provider-aws-api/apis/serverlessapplicationrepository/v1alpha1.CloudformationStackSpec2"},
	}
}

func schema_provider_aws_api_apis_serverlessapplicationrepository_v1alpha1_CloudformationStackSpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_aws_api_apis_serverlessapplicationrepository_v1alpha1_CloudformationStackStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
