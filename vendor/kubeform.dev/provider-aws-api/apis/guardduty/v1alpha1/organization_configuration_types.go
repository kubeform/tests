...
type OrganizationConfigurationSpec struct {
	OrganizationConfigurationSpec2 `json:",inline"`
	// +optional
	KubeformOutput OrganizationConfigurationSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type OrganizationConfigurationSpec2 struct {
