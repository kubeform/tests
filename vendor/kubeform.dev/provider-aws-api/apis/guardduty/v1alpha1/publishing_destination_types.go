...
type PublishingDestinationSpec struct {
	PublishingDestinationSpec2 `json:",inline"`
	// +optional
	KubeformOutput PublishingDestinationSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type PublishingDestinationSpec2 struct {
