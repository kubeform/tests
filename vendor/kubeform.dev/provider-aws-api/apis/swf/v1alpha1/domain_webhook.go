...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-swf-aws-kubeform-com-v1alpha1-domain,mutating=false,failurePolicy=fail,groups=swf.aws.kubeform.com,resources=domains,versions=v1alpha1,name=domain.swf.aws.kubeform.io,sideEffects=None,admissionReviewVersions=v1
