...
type CertificateValidationSpec struct {
	CertificateValidationSpec2 `json:",inline"`
	// +optional
	KubeformOutput CertificateValidationSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type CertificateValidationSpec2 struct {
