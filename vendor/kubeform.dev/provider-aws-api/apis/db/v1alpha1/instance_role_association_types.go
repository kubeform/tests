...
type InstanceRoleAssociationSpec struct {
	InstanceRoleAssociationSpec2 `json:",inline"`
	// +optional
	KubeformOutput InstanceRoleAssociationSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type InstanceRoleAssociationSpec2 struct {
