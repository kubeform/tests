...
type ResolverQueryLogConfigSpec struct {
	ResolverQueryLogConfigSpec2 `json:",inline"`
	// +optional
	KubeformOutput ResolverQueryLogConfigSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type ResolverQueryLogConfigSpec2 struct {
