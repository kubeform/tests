...
type ResolverQueryLogConfigAssociationSpec struct {
	ResolverQueryLogConfigAssociationSpec2 `json:",inline"`
	// +optional
	KubeformOutput ResolverQueryLogConfigAssociationSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type ResolverQueryLogConfigAssociationSpec2 struct {
