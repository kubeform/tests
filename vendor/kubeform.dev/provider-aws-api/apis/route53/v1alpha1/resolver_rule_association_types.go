...
type ResolverRuleAssociationSpec struct {
	ResolverRuleAssociationSpec2 `json:",inline"`
	// +optional
	KubeformOutput ResolverRuleAssociationSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type ResolverRuleAssociationSpec2 struct {
