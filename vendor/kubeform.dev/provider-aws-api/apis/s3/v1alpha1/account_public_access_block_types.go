...
type AccountPublicAccessBlockSpec struct {
	AccountPublicAccessBlockSpec2 `json:",inline"`
	// +optional
	KubeformOutput AccountPublicAccessBlockSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type AccountPublicAccessBlockSpec2 struct {
