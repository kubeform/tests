...
type BucketOwnershipControlsSpec struct {
	BucketOwnershipControlsSpec2 `json:",inline"`
	// +optional
	KubeformOutput BucketOwnershipControlsSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type BucketOwnershipControlsSpec2 struct {
