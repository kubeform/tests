...
type BucketPublicAccessBlockSpec struct {
	BucketPublicAccessBlockSpec2 `json:",inline"`
	// +optional
	KubeformOutput BucketPublicAccessBlockSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type BucketPublicAccessBlockSpec2 struct {
