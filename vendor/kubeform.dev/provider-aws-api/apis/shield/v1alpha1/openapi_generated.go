...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-aws-api/apis/shield/v1alpha1.Protection":       schema_provider_aws_api_apis_shield_v1alpha1_Protection(ref),
		"kubeform.dev/provider-aws-api/apis/shield/v1alpha1.ProtectionList":   schema_provider_aws_api_apis_shield_v1alpha1_ProtectionList(ref),
		"kubeform.dev/provider-aws-api/apis/shield/v1alpha1.ProtectionSpec":   schema_provider_aws_api_apis_shield_v1alpha1_ProtectionSpec(ref),
		"kubeform.dev/provider-aws-api/apis/shield/v1alpha1.ProtectionSpec2":  schema_provider_aws_api_apis_shield_v1alpha1_ProtectionSpec2(ref),
		"kubeform.dev/provider-aws-api/apis/shield/v1alpha1.ProtectionStatus": schema_provider_aws_api_apis_shield_v1alpha1_ProtectionStatus(ref),
	}
}
...
func schema_provider_aws_api_apis_shield_v1alpha1_Protection(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-aws-api/apis/shield/v1alpha1.ProtectionSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-aws-api/apis/shield/v1alpha1.ProtectionStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-aws-api/apis/shield/v1alpha1.ProtectionSpec", "kubeform.dev/provider-aws-api/apis/shield/v1alpha1.ProtectionStatus"},
	}
}

func schema_provider_aws_api_apis_shield_v1alpha1_ProtectionList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ProtectionList is a list of Protections",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							Description: "Items is a list of Protection CRD objects",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-aws-api/apis/shield/v1alpha1.Protection"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-aws-api/apis/shield/v1alpha1.Protection"},
	}
}

func schema_provider_aws_api_apis_shield_v1alpha1_ProtectionSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-aws-api/apis/shield/v1alpha1.ProtectionSpec2"),
						},
					},
				},
				Required: []string{"providerRef", "name", "resourceArn"},
			},
		},
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/provider-aws-api/apis/shield/v1alpha1.ProtectionSpec2"},
	}
}

func schema_provider_aws_api_apis_shield_v1alpha1_ProtectionSpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_aws_api_apis_shield_v1alpha1_ProtectionStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
