...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-aws-api/apis/servicequotas/v1alpha1.ServiceQuota":       schema_provider_aws_api_apis_servicequotas_v1alpha1_ServiceQuota(ref),
		"kubeform.dev/provider-aws-api/apis/servicequotas/v1alpha1.ServiceQuotaList":   schema_provider_aws_api_apis_servicequotas_v1alpha1_ServiceQuotaList(ref),
		"kubeform.dev/provider-aws-api/apis/servicequotas/v1alpha1.ServiceQuotaSpec":   schema_provider_aws_api_apis_servicequotas_v1alpha1_ServiceQuotaSpec(ref),
		"kubeform.dev/provider-aws-api/apis/servicequotas/v1alpha1.ServiceQuotaSpec2":  schema_provider_aws_api_apis_servicequotas_v1alpha1_ServiceQuotaSpec2(ref),
		"kubeform.dev/provider-aws-api/apis/servicequotas/v1alpha1.ServiceQuotaStatus": schema_provider_aws_api_apis_servicequotas_v1alpha1_ServiceQuotaStatus(ref),
	}
}
...
func schema_provider_aws_api_apis_servicequotas_v1alpha1_ServiceQuota(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-aws-api/apis/servicequotas/v1alpha1.ServiceQuotaSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-aws-api/apis/servicequotas/v1alpha1.ServiceQuotaStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-aws-api/apis/servicequotas/v1alpha1.ServiceQuotaSpec", "kubeform.dev/provider-aws-api/apis/servicequotas/v1alpha1.ServiceQuotaStatus"},
	}
}

func schema_provider_aws_api_apis_servicequotas_v1alpha1_ServiceQuotaList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ServiceQuotaList is a list of ServiceQuotas",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							Description: "Items is a list of ServiceQuota CRD objects",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-aws-api/apis/servicequotas/v1alpha1.ServiceQuota"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-aws-api/apis/servicequotas/v1alpha1.ServiceQuota"},
	}
}

func schema_provider_aws_api_apis_servicequotas_v1alpha1_ServiceQuotaSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-aws-api/apis/servicequotas/v1alpha1.ServiceQuotaSpec2"),
						},
					},
				},
				Required: []string{"providerRef", "quotaCode", "serviceCode", "value"},
			},
		},
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/provider-aws-api/apis/servicequotas/v1alpha1.ServiceQuotaSpec2"},
	}
}

func schema_provider_aws_api_apis_servicequotas_v1alpha1_ServiceQuotaSpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_aws_api_apis_servicequotas_v1alpha1_ServiceQuotaStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
