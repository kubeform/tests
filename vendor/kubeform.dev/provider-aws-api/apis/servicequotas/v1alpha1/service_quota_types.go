...
type ServiceQuota struct {
	...
	Spec              ServiceQuotaSpec   `json:"spec,omitempty"`
	Status            ServiceQuotaStatus `json:"status,omitempty"`
}

type ServiceQuotaSpec struct {
	ServiceQuotaSpec2 `json:",inline"`
	// +optional
	KubeformOutput ServiceQuotaSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type ServiceQuotaSpec2 struct {
	...
	// +optional
	Adjustable *bool `json:"adjustable,omitempty" tf:"adjustable"`
	// +optional
	Arn *string `json:"arn,omitempty" tf:"arn"`
	// +optional
	DefaultValue *float64 `json:"defaultValue,omitempty" tf:"default_value"`
...
type ServiceQuotaList struct {
	...
	// Items is a list of ServiceQuota CRD objects
	Items []ServiceQuota `json:"items,omitempty"`
}
