...
type GatewayRoutePropagationSpec struct {
	GatewayRoutePropagationSpec2 `json:",inline"`
	// +optional
	KubeformOutput GatewayRoutePropagationSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type GatewayRoutePropagationSpec2 struct {
