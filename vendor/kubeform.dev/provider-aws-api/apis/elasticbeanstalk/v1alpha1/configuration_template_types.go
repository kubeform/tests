...
type ConfigurationTemplateSpec struct {
	ConfigurationTemplateSpec2 `json:",inline"`
	// +optional
	KubeformOutput ConfigurationTemplateSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type ConfigurationTemplateSpec2 struct {
