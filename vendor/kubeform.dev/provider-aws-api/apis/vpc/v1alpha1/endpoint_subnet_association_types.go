...
type EndpointSubnetAssociationSpec struct {
	EndpointSubnetAssociationSpec2 `json:",inline"`
	// +optional
	KubeformOutput EndpointSubnetAssociationSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type EndpointSubnetAssociationSpec2 struct {
