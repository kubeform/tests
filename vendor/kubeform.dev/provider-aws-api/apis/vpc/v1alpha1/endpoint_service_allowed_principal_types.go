...
type EndpointServiceAllowedPrincipalSpec struct {
	EndpointServiceAllowedPrincipalSpec2 `json:",inline"`
	// +optional
	KubeformOutput EndpointServiceAllowedPrincipalSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type EndpointServiceAllowedPrincipalSpec2 struct {
