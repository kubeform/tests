...
type EndpointRouteTableAssociationSpec struct {
	EndpointRouteTableAssociationSpec2 `json:",inline"`
	// +optional
	KubeformOutput EndpointRouteTableAssociationSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type EndpointRouteTableAssociationSpec2 struct {
