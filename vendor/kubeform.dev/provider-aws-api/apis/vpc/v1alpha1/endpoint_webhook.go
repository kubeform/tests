...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-vpc-aws-kubeform-com-v1alpha1-endpoint,mutating=false,failurePolicy=fail,groups=vpc.aws.kubeform.com,resources=endpoints,versions=v1alpha1,name=endpoint.vpc.aws.kubeform.io,sideEffects=None,admissionReviewVersions=v1
