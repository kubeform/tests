...
type Ipv4CIDRBlockAssociationSpec struct {
	Ipv4CIDRBlockAssociationSpec2 `json:",inline"`
	// +optional
	KubeformOutput Ipv4CIDRBlockAssociationSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type Ipv4CIDRBlockAssociationSpec2 struct {
