...
type DhcpOptionsAssociationSpec struct {
	DhcpOptionsAssociationSpec2 `json:",inline"`
	// +optional
	KubeformOutput DhcpOptionsAssociationSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type DhcpOptionsAssociationSpec2 struct {
