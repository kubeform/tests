...
type EndpointConnectionNotificationSpec struct {
	EndpointConnectionNotificationSpec2 `json:",inline"`
	// +optional
	KubeformOutput EndpointConnectionNotificationSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type EndpointConnectionNotificationSpec2 struct {
