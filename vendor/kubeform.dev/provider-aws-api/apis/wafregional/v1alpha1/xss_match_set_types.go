...
type XssMatchSetSpecXssMatchTuple struct {
	FieldToMatch       *XssMatchSetSpecXssMatchTupleFieldToMatch `json:"fieldToMatch" tf:"field_to_match"`
...
type XssMatchSetSpec2 struct {
	...
	// +optional
	XssMatchTuple []XssMatchSetSpecXssMatchTuple `json:"xssMatchTuple,omitempty" tf:"xss_match_tuple"`
}
