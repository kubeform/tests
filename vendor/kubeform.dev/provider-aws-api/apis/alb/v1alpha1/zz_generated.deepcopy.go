...
func (in *AlbSpec) DeepCopyInto(out *AlbSpec) {
	*out = *in
	in.AlbSpec2.DeepCopyInto(&out.AlbSpec2)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AlbSpec2) DeepCopyInto(out *AlbSpec2) {
	*out = *in
	if in.Timeouts != nil {
	...
	if in.SubnetMapping != nil {
		...
		*out = make([]AlbSpecSubnetMapping, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AlbSpec2.
func (in *AlbSpec2) DeepCopy() *AlbSpec2 {
	if in == nil {
		return nil
	}
	out := new(AlbSpec2)
