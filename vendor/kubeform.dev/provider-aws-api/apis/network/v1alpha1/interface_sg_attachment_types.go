...
type InterfaceSgAttachmentSpec struct {
	InterfaceSgAttachmentSpec2 `json:",inline"`
	// +optional
	KubeformOutput InterfaceSgAttachmentSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type InterfaceSgAttachmentSpec2 struct {
