...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-aws-api/apis/subnet/v1alpha1.Subnet":       schema_provider_aws_api_apis_subnet_v1alpha1_Subnet(ref),
		"kubeform.dev/provider-aws-api/apis/subnet/v1alpha1.SubnetList":   schema_provider_aws_api_apis_subnet_v1alpha1_SubnetList(ref),
		"kubeform.dev/provider-aws-api/apis/subnet/v1alpha1.SubnetSpec":   schema_provider_aws_api_apis_subnet_v1alpha1_SubnetSpec(ref),
		"kubeform.dev/provider-aws-api/apis/subnet/v1alpha1.SubnetSpec2":  schema_provider_aws_api_apis_subnet_v1alpha1_SubnetSpec2(ref),
		"kubeform.dev/provider-aws-api/apis/subnet/v1alpha1.SubnetStatus": schema_provider_aws_api_apis_subnet_v1alpha1_SubnetStatus(ref),
	}
}
...
func schema_provider_aws_api_apis_subnet_v1alpha1_Subnet(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-aws-api/apis/subnet/v1alpha1.SubnetSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-aws-api/apis/subnet/v1alpha1.SubnetStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-aws-api/apis/subnet/v1alpha1.SubnetSpec", "kubeform.dev/provider-aws-api/apis/subnet/v1alpha1.SubnetStatus"},
	}
}

func schema_provider_aws_api_apis_subnet_v1alpha1_SubnetList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-aws-api/apis/subnet/v1alpha1.Subnet"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-aws-api/apis/subnet/v1alpha1.Subnet"},
	}
}

func schema_provider_aws_api_apis_subnet_v1alpha1_SubnetSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-aws-api/apis/subnet/v1alpha1.SubnetSpec2"),
						},
					},
				},
		...
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/apimachinery/api/v1alpha1.ResourceTimeout", "kubeform.dev/provider-aws-api/apis/subnet/v1alpha1.SubnetSpec2"},
	}
}

func schema_provider_aws_api_apis_subnet_v1alpha1_SubnetSpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_aws_api_apis_subnet_v1alpha1_SubnetStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
