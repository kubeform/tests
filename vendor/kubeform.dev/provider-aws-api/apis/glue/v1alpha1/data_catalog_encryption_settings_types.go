...
type DataCatalogEncryptionSettingsSpec struct {
	DataCatalogEncryptionSettingsSpec2 `json:",inline"`
	// +optional
	KubeformOutput DataCatalogEncryptionSettingsSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type DataCatalogEncryptionSettingsSpec2 struct {
