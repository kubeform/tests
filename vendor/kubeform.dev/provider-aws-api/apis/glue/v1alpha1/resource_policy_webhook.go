...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-glue-aws-kubeform-com-v1alpha1-resourcepolicy,mutating=false,failurePolicy=fail,groups=glue.aws.kubeform.com,resources=resourcepolicies,versions=v1alpha1,name=resourcepolicy.glue.aws.kubeform.io,sideEffects=None,admissionReviewVersions=v1
