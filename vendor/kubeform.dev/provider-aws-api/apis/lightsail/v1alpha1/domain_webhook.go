...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-lightsail-aws-kubeform-com-v1alpha1-domain,mutating=false,failurePolicy=fail,groups=lightsail.aws.kubeform.com,resources=domains,versions=v1alpha1,name=domain.lightsail.aws.kubeform.io,sideEffects=None,admissionReviewVersions=v1
