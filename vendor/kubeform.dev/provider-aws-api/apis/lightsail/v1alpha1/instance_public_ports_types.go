...
type InstancePublicPorts struct {
	...
	Spec              InstancePublicPortsSpec   `json:"spec,omitempty"`
	Status            InstancePublicPortsStatus `json:"status,omitempty"`
}

type InstancePublicPortsSpec struct {
	InstancePublicPortsSpec2 `json:",inline"`
	// +optional
	KubeformOutput InstancePublicPortsSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type InstancePublicPortsSpecPortInfo struct {
	// +optional
...
type InstancePublicPortsSpec2 struct {
	...
	PortInfo []InstancePublicPortsSpecPortInfo `json:"portInfo" tf:"port_info"`
}
...
type InstancePublicPortsList struct {
	...
	// Items is a list of InstancePublicPorts CRD objects
	Items []InstancePublicPorts `json:"items,omitempty"`
}
