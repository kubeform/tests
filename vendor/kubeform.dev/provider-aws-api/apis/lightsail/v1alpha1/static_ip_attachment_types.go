...
type StaticIPAttachment struct {
	...
	Spec              StaticIPAttachmentSpec   `json:"spec,omitempty"`
	Status            StaticIPAttachmentStatus `json:"status,omitempty"`
}

type StaticIPAttachmentSpec struct {
	StaticIPAttachmentSpec2 `json:",inline"`
	// +optional
	KubeformOutput StaticIPAttachmentSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type StaticIPAttachmentSpec2 struct {
...
type StaticIPAttachmentList struct {
	...
	// Items is a list of StaticIPAttachment CRD objects
	Items []StaticIPAttachment `json:"items,omitempty"`
}
