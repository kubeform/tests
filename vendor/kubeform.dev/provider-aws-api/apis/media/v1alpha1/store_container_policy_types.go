...
type StoreContainerPolicy struct {
	...
	Spec              StoreContainerPolicySpec   `json:"spec,omitempty"`
	Status            StoreContainerPolicyStatus `json:"status,omitempty"`
}

type StoreContainerPolicySpec struct {
	StoreContainerPolicySpec2 `json:",inline"`
	// +optional
	KubeformOutput StoreContainerPolicySpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type StoreContainerPolicySpec2 struct {
...
type StoreContainerPolicyList struct {
	...
	// Items is a list of StoreContainerPolicy CRD objects
	Items []StoreContainerPolicy `json:"items,omitempty"`
}
