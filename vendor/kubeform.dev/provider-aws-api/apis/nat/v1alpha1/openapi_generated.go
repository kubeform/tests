...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-aws-api/apis/nat/v1alpha1.Gateway":        schema_provider_aws_api_apis_nat_v1alpha1_Gateway(ref),
		"kubeform.dev/provider-aws-api/apis/nat/v1alpha1.GatewayList":    schema_provider_aws_api_apis_nat_v1alpha1_GatewayList(ref),
		"kubeform.dev/provider-aws-api/apis/nat/v1alpha1.GatewaySpec":    schema_provider_aws_api_apis_nat_v1alpha1_GatewaySpec(ref),
		"kubeform.dev/provider-aws-api/apis/nat/v1alpha1.GatewaySpec2":   schema_provider_aws_api_apis_nat_v1alpha1_GatewaySpec2(ref),
		"kubeform.dev/provider-aws-api/apis/nat/v1alpha1.GatewayStatus":  schema_provider_aws_api_apis_nat_v1alpha1_GatewayStatus(ref),
	}
}
...
func schema_provider_aws_api_apis_nat_v1alpha1_Gateway(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-aws-api/apis/nat/v1alpha1.GatewaySpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-aws-api/apis/nat/v1alpha1.GatewayStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-aws-api/apis/nat/v1alpha1.GatewaySpec", "kubeform.dev/provider-aws-api/apis/nat/v1alpha1.GatewayStatus"},
	}
}

func schema_provider_aws_api_apis_nat_v1alpha1_GatewayList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-aws-api/apis/nat/v1alpha1.Gateway"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-aws-api/apis/nat/v1alpha1.Gateway"},
	}
}

func schema_provider_aws_api_apis_nat_v1alpha1_GatewaySpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-aws-api/apis/nat/v1alpha1.GatewaySpec2"),
						},
					},
				},
				Required: []string{"providerRef", "allocationID", "subnetID"},
			},
		},
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/provider-aws-api/apis/nat/v1alpha1.GatewaySpec2"},
	}
}

func schema_provider_aws_api_apis_nat_v1alpha1_GatewaySpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_aws_api_apis_nat_v1alpha1_GatewayStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
