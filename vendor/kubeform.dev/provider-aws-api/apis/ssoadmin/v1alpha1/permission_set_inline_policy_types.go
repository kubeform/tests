...
type PermissionSetInlinePolicySpec struct {
	PermissionSetInlinePolicySpec2 `json:",inline"`
	// +optional
	KubeformOutput PermissionSetInlinePolicySpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type PermissionSetInlinePolicySpec2 struct {
