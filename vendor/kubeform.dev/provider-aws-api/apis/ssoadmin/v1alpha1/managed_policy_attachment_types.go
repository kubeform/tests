...
type ManagedPolicyAttachmentSpec struct {
	ManagedPolicyAttachmentSpec2 `json:",inline"`
	// +optional
	KubeformOutput ManagedPolicyAttachmentSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type ManagedPolicyAttachmentSpec2 struct {
