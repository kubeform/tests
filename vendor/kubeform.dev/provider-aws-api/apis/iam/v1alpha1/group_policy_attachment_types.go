...
type GroupPolicyAttachmentSpec struct {
	GroupPolicyAttachmentSpec2 `json:",inline"`
	// +optional
	KubeformOutput GroupPolicyAttachmentSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type GroupPolicyAttachmentSpec2 struct {
