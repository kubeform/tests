...
type OpenidConnectProviderSpec struct {
	OpenidConnectProviderSpec2 `json:",inline"`
	// +optional
	KubeformOutput OpenidConnectProviderSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type OpenidConnectProviderSpec2 struct {
