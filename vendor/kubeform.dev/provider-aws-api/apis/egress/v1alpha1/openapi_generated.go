...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-aws-api/apis/egress/v1alpha1.OnlyInternetGateway":       schema_provider_aws_api_apis_egress_v1alpha1_OnlyInternetGateway(ref),
		"kubeform.dev/provider-aws-api/apis/egress/v1alpha1.OnlyInternetGatewayList":   schema_provider_aws_api_apis_egress_v1alpha1_OnlyInternetGatewayList(ref),
		"kubeform.dev/provider-aws-api/apis/egress/v1alpha1.OnlyInternetGatewaySpec":   schema_provider_aws_api_apis_egress_v1alpha1_OnlyInternetGatewaySpec(ref),
		"kubeform.dev/provider-aws-api/apis/egress/v1alpha1.OnlyInternetGatewaySpec2":  schema_provider_aws_api_apis_egress_v1alpha1_OnlyInternetGatewaySpec2(ref),
		"kubeform.dev/provider-aws-api/apis/egress/v1alpha1.OnlyInternetGatewayStatus": schema_provider_aws_api_apis_egress_v1alpha1_OnlyInternetGatewayStatus(ref),
	}
}
...
func schema_provider_aws_api_apis_egress_v1alpha1_OnlyInternetGateway(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-aws-api/apis/egress/v1alpha1.OnlyInternetGatewaySpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-aws-api/apis/egress/v1alpha1.OnlyInternetGatewayStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-aws-api/apis/egress/v1alpha1.OnlyInternetGatewaySpec", "kubeform.dev/provider-aws-api/apis/egress/v1alpha1.OnlyInternetGatewayStatus"},
	}
}

func schema_provider_aws_api_apis_egress_v1alpha1_OnlyInternetGatewayList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "OnlyInternetGatewayList is a list of OnlyInternetGateways",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							Description: "Items is a list of OnlyInternetGateway CRD objects",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-aws-api/apis/egress/v1alpha1.OnlyInternetGateway"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-aws-api/apis/egress/v1alpha1.OnlyInternetGateway"},
	}
}

func schema_provider_aws_api_apis_egress_v1alpha1_OnlyInternetGatewaySpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-aws-api/apis/egress/v1alpha1.OnlyInternetGatewaySpec2"),
						},
					},
				},
		...
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/provider-aws-api/apis/egress/v1alpha1.OnlyInternetGatewaySpec2"},
	}
}

func schema_provider_aws_api_apis_egress_v1alpha1_OnlyInternetGatewaySpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_aws_api_apis_egress_v1alpha1_OnlyInternetGatewayStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
