...
type UserPoolUiCustomizationSpec struct {
	UserPoolUiCustomizationSpec2 `json:",inline"`
	// +optional
	KubeformOutput UserPoolUiCustomizationSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type UserPoolUiCustomizationSpec2 struct {
