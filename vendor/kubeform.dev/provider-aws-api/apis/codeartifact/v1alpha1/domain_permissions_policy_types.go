...
type DomainPermissionsPolicySpec struct {
	DomainPermissionsPolicySpec2 `json:",inline"`
	// +optional
	KubeformOutput DomainPermissionsPolicySpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type DomainPermissionsPolicySpec2 struct {
