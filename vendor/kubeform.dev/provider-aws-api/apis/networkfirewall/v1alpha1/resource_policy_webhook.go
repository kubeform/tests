...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-networkfirewall-aws-kubeform-com-v1alpha1-resourcepolicy,mutating=false,failurePolicy=fail,groups=networkfirewall.aws.kubeform.com,resources=resourcepolicies,versions=v1alpha1,name=resourcepolicy.networkfirewall.aws.kubeform.io,sideEffects=None,admissionReviewVersions=v1
