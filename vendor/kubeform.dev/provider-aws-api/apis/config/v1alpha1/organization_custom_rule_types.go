...
type OrganizationCustomRuleSpec struct {
	OrganizationCustomRuleSpec2 `json:",inline"`
	// +optional
	KubeformOutput OrganizationCustomRuleSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type OrganizationCustomRuleSpec2 struct {
