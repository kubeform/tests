...
type ConfigurationRecorderSpec struct {
	ConfigurationRecorderSpec2 `json:",inline"`
	// +optional
	KubeformOutput ConfigurationRecorderSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}
...
type ConfigurationRecorderSpec2 struct {
