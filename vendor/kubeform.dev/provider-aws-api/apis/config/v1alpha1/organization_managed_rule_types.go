...
type OrganizationManagedRuleSpec struct {
	OrganizationManagedRuleSpec2 `json:",inline"`
	// +optional
	KubeformOutput OrganizationManagedRuleSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type OrganizationManagedRuleSpec2 struct {
