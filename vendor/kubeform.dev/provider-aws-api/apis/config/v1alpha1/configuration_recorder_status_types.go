...
type ConfigurationRecorderStatus_Spec struct {
	ConfigurationRecorderStatus_Spec2 `json:",inline"`
	// +optional
	KubeformOutput ConfigurationRecorderStatus_Spec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type ConfigurationRecorderStatus_Spec2 struct {
