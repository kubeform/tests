...
type AggregateAuthorizationSpec struct {
	AggregateAuthorizationSpec2 `json:",inline"`
	// +optional
	KubeformOutput AggregateAuthorizationSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type AggregateAuthorizationSpec2 struct {
