...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-apigatewayv2-aws-kubeform-com-v1alpha1-deployment,mutating=false,failurePolicy=fail,groups=apigatewayv2.aws.kubeform.com,resources=deployments,versions=v1alpha1,name=deployment.apigatewayv2.aws.kubeform.io,sideEffects=None,admissionReviewVersions=v1
