...
type EnvironmentEc2Spec struct {
	EnvironmentEc2Spec2 `json:",inline"`
	// +optional
	KubeformOutput EnvironmentEc2Spec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type EnvironmentEc2Spec2 struct {
...
type EnvironmentEc2List struct {
	...
	// Items is a list of EnvironmentEc2 CRD objects
	Items []EnvironmentEc2 `json:"items,omitempty"`
}
