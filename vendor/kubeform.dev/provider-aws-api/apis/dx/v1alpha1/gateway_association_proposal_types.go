...
type GatewayAssociationProposalSpec struct {
	GatewayAssociationProposalSpec2 `json:",inline"`
	// +optional
	KubeformOutput GatewayAssociationProposalSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type GatewayAssociationProposalSpec2 struct {
