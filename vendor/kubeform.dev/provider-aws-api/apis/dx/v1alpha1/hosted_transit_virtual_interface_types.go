...
type HostedTransitVirtualInterfaceSpec struct {
	HostedTransitVirtualInterfaceSpec2 `json:",inline"`
	// +optional
	KubeformOutput HostedTransitVirtualInterfaceSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type HostedTransitVirtualInterfaceSpec2 struct {
