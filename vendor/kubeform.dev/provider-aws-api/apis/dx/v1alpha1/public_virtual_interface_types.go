...
type PublicVirtualInterfaceSpec struct {
	PublicVirtualInterfaceSpec2 `json:",inline"`
	// +optional
	KubeformOutput PublicVirtualInterfaceSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type PublicVirtualInterfaceSpec2 struct {
