...
type HostedPrivateVirtualInterfaceAccepterSpec struct {
	HostedPrivateVirtualInterfaceAccepterSpec2 `json:",inline"`
	// +optional
	KubeformOutput HostedPrivateVirtualInterfaceAccepterSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type HostedPrivateVirtualInterfaceAccepterSpec2 struct {
