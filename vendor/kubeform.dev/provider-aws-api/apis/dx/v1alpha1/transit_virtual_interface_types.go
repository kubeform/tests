...
type TransitVirtualInterfaceSpec struct {
	TransitVirtualInterfaceSpec2 `json:",inline"`
	// +optional
	KubeformOutput TransitVirtualInterfaceSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type TransitVirtualInterfaceSpec2 struct {
