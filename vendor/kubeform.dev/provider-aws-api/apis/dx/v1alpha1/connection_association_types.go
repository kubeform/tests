...
type ConnectionAssociationSpec struct {
	ConnectionAssociationSpec2 `json:",inline"`
	// +optional
	KubeformOutput ConnectionAssociationSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type ConnectionAssociationSpec2 struct {
