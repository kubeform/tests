...
type HostedTransitVirtualInterfaceAccepterSpec struct {
	HostedTransitVirtualInterfaceAccepterSpec2 `json:",inline"`
	// +optional
	KubeformOutput HostedTransitVirtualInterfaceAccepterSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type HostedTransitVirtualInterfaceAccepterSpec2 struct {
