...
type HostedPublicVirtualInterfaceAccepterSpec struct {
	HostedPublicVirtualInterfaceAccepterSpec2 `json:",inline"`
	// +optional
	KubeformOutput HostedPublicVirtualInterfaceAccepterSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type HostedPublicVirtualInterfaceAccepterSpec2 struct {
