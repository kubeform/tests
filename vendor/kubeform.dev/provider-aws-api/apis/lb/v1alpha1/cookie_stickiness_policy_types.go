...
type CookieStickinessPolicySpec struct {
	CookieStickinessPolicySpec2 `json:",inline"`
	// +optional
	KubeformOutput CookieStickinessPolicySpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type CookieStickinessPolicySpec2 struct {
