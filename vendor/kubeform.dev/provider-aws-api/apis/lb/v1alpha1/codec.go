...
func GetEncoder() map[string]jsoniter.ValEncoder {
	return map[string]jsoniter.ValEncoder{
		jsoniter.MustGetKind(reflect2.TypeOf(LbSpecAccessLogs{}).Type1()):                             LbSpecAccessLogsCodec{},
...
func (LbSpecAccessLogsCodec) IsEmpty(ptr unsafe.Pointer) bool {
	return (*LbSpecAccessLogs)(ptr) == nil
}

func (LbSpecAccessLogsCodec) Encode(ptr unsafe.Pointer, stream *jsoniter.Stream) {
	obj := (*LbSpecAccessLogs)(ptr)
	var objs []LbSpecAccessLogs
	if obj != nil {
		objs = []LbSpecAccessLogs{*obj}
	}
	...
	jsonit := jsoniter.Config{
		...
		TagKey:                 "tf",
		TypeEncoders:           getEncodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(LbSpecAccessLogs{}).Type1())),
	}.Froze()
...
func (LbSpecAccessLogsCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	switch iter.WhatIsNext() {
	case jsoniter.NilValue:
		iter.Skip()
		*(*LbSpecAccessLogs)(ptr) = LbSpecAccessLogs{}
		return
	case jsoniter.ArrayValue:
		...
		if len(objsByte) > 0 {
			...
			jsonit := jsoniter.Config{
				...
				ValidateJsonRawMessage: true,
				TagKey:                 "tf",
				TypeDecoders:           getDecodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(LbSpecAccessLogs{}).Type1())),
			}.Froze()
			jsonit.Unmarshal(objsByte, &objs)

			if len(objs) > 0 {
				*(*LbSpecAccessLogs)(ptr) = objs[0]
			} else {
				*(*LbSpecAccessLogs)(ptr) = LbSpecAccessLogs{}
			}
		} else {
	...
	default:
		iter.ReportError("decode LbSpecAccessLogs", "unexpected JSON type")
	}
}
