...
type TargetGroupAttachmentSpec struct {
	TargetGroupAttachmentSpec2 `json:",inline"`
	// +optional
	KubeformOutput TargetGroupAttachmentSpec2 `json:"kubeformOutput,omitempty" tf:"-"`
}

type TargetGroupAttachmentSpec2 struct {
