...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-aws-api/apis/volume/v1alpha1.Attachment":       schema_provider_aws_api_apis_volume_v1alpha1_Attachment(ref),
		"kubeform.dev/provider-aws-api/apis/volume/v1alpha1.AttachmentList":   schema_provider_aws_api_apis_volume_v1alpha1_AttachmentList(ref),
		"kubeform.dev/provider-aws-api/apis/volume/v1alpha1.AttachmentSpec":   schema_provider_aws_api_apis_volume_v1alpha1_AttachmentSpec(ref),
		"kubeform.dev/provider-aws-api/apis/volume/v1alpha1.AttachmentSpec2":  schema_provider_aws_api_apis_volume_v1alpha1_AttachmentSpec2(ref),
		"kubeform.dev/provider-aws-api/apis/volume/v1alpha1.AttachmentStatus": schema_provider_aws_api_apis_volume_v1alpha1_AttachmentStatus(ref),
	}
}
...
func schema_provider_aws_api_apis_volume_v1alpha1_Attachment(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-aws-api/apis/volume/v1alpha1.AttachmentSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-aws-api/apis/volume/v1alpha1.AttachmentStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-aws-api/apis/volume/v1alpha1.AttachmentSpec", "kubeform.dev/provider-aws-api/apis/volume/v1alpha1.AttachmentStatus"},
	}
}

func schema_provider_aws_api_apis_volume_v1alpha1_AttachmentList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-aws-api/apis/volume/v1alpha1.Attachment"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-aws-api/apis/volume/v1alpha1.Attachment"},
	}
}

func schema_provider_aws_api_apis_volume_v1alpha1_AttachmentSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-aws-api/apis/volume/v1alpha1.AttachmentSpec2"),
						},
					},
				},
				Required: []string{"providerRef", "deviceName", "instanceID", "volumeID"},
			},
		},
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/provider-aws-api/apis/volume/v1alpha1.AttachmentSpec2"},
	}
}

func schema_provider_aws_api_apis_volume_v1alpha1_AttachmentSpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_aws_api_apis_volume_v1alpha1_AttachmentStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
