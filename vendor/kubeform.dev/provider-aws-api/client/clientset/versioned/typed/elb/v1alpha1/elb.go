...
func newElbs(c *ElbV1alpha1Client, namespace string) *elbs {
	return &elbs{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *elbs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Elb, err error) {
	result = &v1alpha1.Elb{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("elbs").
...
func (c *elbs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ElbList, err error) {
...
func (c *elbs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *elbs) Create(ctx context.Context, elb *v1alpha1.Elb, opts v1.CreateOptions) (result *v1alpha1.Elb, err error) {
	result = &v1alpha1.Elb{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("elbs").
...
func (c *elbs) Update(ctx context.Context, elb *v1alpha1.Elb, opts v1.UpdateOptions) (result *v1alpha1.Elb, err error) {
	result = &v1alpha1.Elb{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("elbs").
...
func (c *elbs) UpdateStatus(ctx context.Context, elb *v1alpha1.Elb, opts v1.UpdateOptions) (result *v1alpha1.Elb, err error) {
	result = &v1alpha1.Elb{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("elbs").
...
func (c *elbs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *elbs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *elbs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Elb, err error) {
	result = &v1alpha1.Elb{}
