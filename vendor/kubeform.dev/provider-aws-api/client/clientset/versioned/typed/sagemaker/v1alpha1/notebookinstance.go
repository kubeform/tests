...
func (c *notebookInstances) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.NotebookInstance, err error) {
...
func (c *notebookInstances) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.NotebookInstanceList, err error) {
...
func (c *notebookInstances) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *notebookInstances) Create(ctx context.Context, notebookInstance *v1alpha1.NotebookInstance, opts v1.CreateOptions) (result *v1alpha1.NotebookInstance, err error) {
	result = &v1alpha1.NotebookInstance{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("notebookinstances").
...
func (c *notebookInstances) Update(ctx context.Context, notebookInstance *v1alpha1.NotebookInstance, opts v1.UpdateOptions) (result *v1alpha1.NotebookInstance, err error) {
	result = &v1alpha1.NotebookInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("notebookinstances").
...
func (c *notebookInstances) UpdateStatus(ctx context.Context, notebookInstance *v1alpha1.NotebookInstance, opts v1.UpdateOptions) (result *v1alpha1.NotebookInstance, err error) {
	result = &v1alpha1.NotebookInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("notebookinstances").
...
func (c *notebookInstances) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *notebookInstances) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *notebookInstances) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.NotebookInstance, err error) {
	result = &v1alpha1.NotebookInstance{}
