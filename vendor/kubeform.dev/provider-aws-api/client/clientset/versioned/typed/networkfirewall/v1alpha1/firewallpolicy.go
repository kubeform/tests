...
func newFirewallPolicies(c *NetworkfirewallV1alpha1Client, namespace string) *firewallPolicies {
...
func (c *firewallPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.FirewallPolicy, err error) {
	result = &v1alpha1.FirewallPolicy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *firewallPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FirewallPolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.FirewallPolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("firewallpolicies").
...
func (c *firewallPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *firewallPolicies) Create(ctx context.Context, firewallPolicy *v1alpha1.FirewallPolicy, opts v1.CreateOptions) (result *v1alpha1.FirewallPolicy, err error) {
	result = &v1alpha1.FirewallPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("firewallpolicies").
...
func (c *firewallPolicies) Update(ctx context.Context, firewallPolicy *v1alpha1.FirewallPolicy, opts v1.UpdateOptions) (result *v1alpha1.FirewallPolicy, err error) {
	result = &v1alpha1.FirewallPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("firewallpolicies").
...
func (c *firewallPolicies) UpdateStatus(ctx context.Context, firewallPolicy *v1alpha1.FirewallPolicy, opts v1.UpdateOptions) (result *v1alpha1.FirewallPolicy, err error) {
	result = &v1alpha1.FirewallPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("firewallpolicies").
...
func (c *firewallPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *firewallPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *firewallPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.FirewallPolicy, err error) {
	result = &v1alpha1.FirewallPolicy{}
