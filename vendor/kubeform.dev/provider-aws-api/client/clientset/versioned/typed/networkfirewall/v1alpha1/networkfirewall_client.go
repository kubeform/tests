...
type NetworkfirewallV1alpha1Interface interface {
	RESTClient() rest.Interface
	FirewallsGetter
	FirewallPoliciesGetter
	LoggingConfigurationsGetter
...
func (c *NetworkfirewallV1alpha1Client) LoggingConfigurations(namespace string) LoggingConfigurationInterface {
	return newLoggingConfigurations(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*NetworkfirewallV1alpha1Client, error) {
	...
	return &NetworkfirewallV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new NetworkfirewallV1alpha1Client for the given config and
...
func New(c rest.Interface) *NetworkfirewallV1alpha1Client {
	return &NetworkfirewallV1alpha1Client{c}
}
...
func (c *NetworkfirewallV1alpha1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
