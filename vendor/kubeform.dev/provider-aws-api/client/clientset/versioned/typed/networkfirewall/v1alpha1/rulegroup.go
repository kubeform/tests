...
func newRuleGroups(c *NetworkfirewallV1alpha1Client, namespace string) *ruleGroups {
	return &ruleGroups{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *ruleGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.RuleGroup, err error) {
	result = &v1alpha1.RuleGroup{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("rulegroups").
		Name(name).
...
func (c *ruleGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RuleGroupList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.RuleGroupList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("rulegroups").
...
func (c *ruleGroups) Create(ctx context.Context, ruleGroup *v1alpha1.RuleGroup, opts v1.CreateOptions) (result *v1alpha1.RuleGroup, err error) {
	result = &v1alpha1.RuleGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("rulegroups").
...
func (c *ruleGroups) Update(ctx context.Context, ruleGroup *v1alpha1.RuleGroup, opts v1.UpdateOptions) (result *v1alpha1.RuleGroup, err error) {
	result = &v1alpha1.RuleGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("rulegroups").
...
func (c *ruleGroups) UpdateStatus(ctx context.Context, ruleGroup *v1alpha1.RuleGroup, opts v1.UpdateOptions) (result *v1alpha1.RuleGroup, err error) {
	result = &v1alpha1.RuleGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("rulegroups").
...
func (c *ruleGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.RuleGroup, err error) {
	result = &v1alpha1.RuleGroup{}
