...
func NewForConfig(c *rest.Config) (*NeptuneV1alpha1Client, error) {
	...
	return &NeptuneV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new NeptuneV1alpha1Client for the given config and
...
func New(c rest.Interface) *NeptuneV1alpha1Client {
	return &NeptuneV1alpha1Client{c}
}
