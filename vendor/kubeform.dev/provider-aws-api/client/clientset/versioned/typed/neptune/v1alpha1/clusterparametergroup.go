...
func newClusterParameterGroups(c *NeptuneV1alpha1Client, namespace string) *clusterParameterGroups {
...
func (c *clusterParameterGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ClusterParameterGroup, err error) {
...
func (c *clusterParameterGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ClusterParameterGroupList, err error) {
...
func (c *clusterParameterGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *clusterParameterGroups) Create(ctx context.Context, clusterParameterGroup *v1alpha1.ClusterParameterGroup, opts v1.CreateOptions) (result *v1alpha1.ClusterParameterGroup, err error) {
	result = &v1alpha1.ClusterParameterGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("clusterparametergroups").
...
func (c *clusterParameterGroups) Update(ctx context.Context, clusterParameterGroup *v1alpha1.ClusterParameterGroup, opts v1.UpdateOptions) (result *v1alpha1.ClusterParameterGroup, err error) {
	result = &v1alpha1.ClusterParameterGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("clusterparametergroups").
...
func (c *clusterParameterGroups) UpdateStatus(ctx context.Context, clusterParameterGroup *v1alpha1.ClusterParameterGroup, opts v1.UpdateOptions) (result *v1alpha1.ClusterParameterGroup, err error) {
	result = &v1alpha1.ClusterParameterGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("clusterparametergroups").
...
func (c *clusterParameterGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *clusterParameterGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *clusterParameterGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ClusterParameterGroup, err error) {
	result = &v1alpha1.ClusterParameterGroup{}
