...
func NewForConfig(c *rest.Config) (*CodepipelineV1alpha1Client, error) {
	...
	return &CodepipelineV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new CodepipelineV1alpha1Client for the given config and
...
func New(c rest.Interface) *CodepipelineV1alpha1Client {
	return &CodepipelineV1alpha1Client{c}
}
