...
// AppV1alpha1Client is used to interact with features provided by the app.aws.kubeform.com group.
type AppV1alpha1Client struct {
	restClient rest.Interface
}

func (c *AppV1alpha1Client) CookieStickinessPolicies(namespace string) CookieStickinessPolicyInterface {
