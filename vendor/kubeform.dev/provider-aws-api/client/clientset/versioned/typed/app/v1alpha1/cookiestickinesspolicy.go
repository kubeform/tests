...
// CookieStickinessPoliciesGetter has a method to return a CookieStickinessPolicyInterface.
...
// cookieStickinessPolicies implements CookieStickinessPolicyInterface
type cookieStickinessPolicies struct {
	client rest.Interface
	ns     string
}

// newCookieStickinessPolicies returns a CookieStickinessPolicies
func newCookieStickinessPolicies(c *AppV1alpha1Client, namespace string) *cookieStickinessPolicies {
	return &cookieStickinessPolicies{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *cookieStickinessPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CookieStickinessPolicy, err error) {
	result = &v1alpha1.CookieStickinessPolicy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *cookieStickinessPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CookieStickinessPolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.CookieStickinessPolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("cookiestickinesspolicies").
...
func (c *cookieStickinessPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cookieStickinessPolicies) Create(ctx context.Context, cookieStickinessPolicy *v1alpha1.CookieStickinessPolicy, opts v1.CreateOptions) (result *v1alpha1.CookieStickinessPolicy, err error) {
	result = &v1alpha1.CookieStickinessPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cookiestickinesspolicies").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(cookieStickinessPolicy).
		Do(ctx).
		Into(result)
	return
}
...
func (c *cookieStickinessPolicies) Update(ctx context.Context, cookieStickinessPolicy *v1alpha1.CookieStickinessPolicy, opts v1.UpdateOptions) (result *v1alpha1.CookieStickinessPolicy, err error) {
	result = &v1alpha1.CookieStickinessPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cookiestickinesspolicies").
		Name(cookieStickinessPolicy.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(cookieStickinessPolicy).
		Do(ctx).
		Into(result)
...
func (c *cookieStickinessPolicies) UpdateStatus(ctx context.Context, cookieStickinessPolicy *v1alpha1.CookieStickinessPolicy, opts v1.UpdateOptions) (result *v1alpha1.CookieStickinessPolicy, err error) {
	result = &v1alpha1.CookieStickinessPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cookiestickinesspolicies").
...
func (c *cookieStickinessPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *cookieStickinessPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *cookieStickinessPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CookieStickinessPolicy, err error) {
	result = &v1alpha1.CookieStickinessPolicy{}
