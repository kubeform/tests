...
type CodeartifactV1alpha1Interface interface {
	RESTClient() rest.Interface
	DomainsGetter
	DomainPermissionsPoliciesGetter
	RepositoriesGetter
	RepositoryPermissionsPoliciesGetter
}
...
func (c *CodeartifactV1alpha1Client) DomainPermissionsPolicies(namespace string) DomainPermissionsPolicyInterface {
	return newDomainPermissionsPolicies(c, namespace)
}
...
func (c *CodeartifactV1alpha1Client) RepositoryPermissionsPolicies(namespace string) RepositoryPermissionsPolicyInterface {
	return newRepositoryPermissionsPolicies(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*CodeartifactV1alpha1Client, error) {
	...
	return &CodeartifactV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new CodeartifactV1alpha1Client for the given config and
...
func New(c rest.Interface) *CodeartifactV1alpha1Client {
	return &CodeartifactV1alpha1Client{c}
}
