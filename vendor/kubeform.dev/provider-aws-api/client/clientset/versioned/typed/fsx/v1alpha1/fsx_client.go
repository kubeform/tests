...
func (c *FsxV1alpha1Client) WindowsFileSystems(namespace string) WindowsFileSystemInterface {
	return newWindowsFileSystems(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*FsxV1alpha1Client, error) {
	...
	return &FsxV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new FsxV1alpha1Client for the given config and
...
func New(c rest.Interface) *FsxV1alpha1Client {
	return &FsxV1alpha1Client{c}
}
