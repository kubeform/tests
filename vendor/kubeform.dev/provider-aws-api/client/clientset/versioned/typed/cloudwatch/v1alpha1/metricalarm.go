...
// MetricAlarmsGetter has a method to return a MetricAlarmInterface.
...
// metricAlarms implements MetricAlarmInterface
type metricAlarms struct {
	client rest.Interface
	ns     string
}

// newMetricAlarms returns a MetricAlarms
func newMetricAlarms(c *CloudwatchV1alpha1Client, namespace string) *metricAlarms {
	return &metricAlarms{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *metricAlarms) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MetricAlarm, err error) {
	result = &v1alpha1.MetricAlarm{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *metricAlarms) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MetricAlarmList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.MetricAlarmList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("metricalarms").
...
func (c *metricAlarms) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *metricAlarms) Create(ctx context.Context, metricAlarm *v1alpha1.MetricAlarm, opts v1.CreateOptions) (result *v1alpha1.MetricAlarm, err error) {
	result = &v1alpha1.MetricAlarm{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("metricalarms").
...
func (c *metricAlarms) Update(ctx context.Context, metricAlarm *v1alpha1.MetricAlarm, opts v1.UpdateOptions) (result *v1alpha1.MetricAlarm, err error) {
	result = &v1alpha1.MetricAlarm{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("metricalarms").
...
func (c *metricAlarms) UpdateStatus(ctx context.Context, metricAlarm *v1alpha1.MetricAlarm, opts v1.UpdateOptions) (result *v1alpha1.MetricAlarm, err error) {
	result = &v1alpha1.MetricAlarm{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("metricalarms").
...
func (c *metricAlarms) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *metricAlarms) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *metricAlarms) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MetricAlarm, err error) {
	result = &v1alpha1.MetricAlarm{}
