...
func newLogStreams(c *CloudwatchV1alpha1Client, namespace string) *logStreams {
	return &logStreams{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *logStreams) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LogStream, err error) {
...
func (c *logStreams) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LogStreamList, err error) {
...
func (c *logStreams) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *logStreams) Create(ctx context.Context, logStream *v1alpha1.LogStream, opts v1.CreateOptions) (result *v1alpha1.LogStream, err error) {
	result = &v1alpha1.LogStream{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("logstreams").
...
func (c *logStreams) Update(ctx context.Context, logStream *v1alpha1.LogStream, opts v1.UpdateOptions) (result *v1alpha1.LogStream, err error) {
	result = &v1alpha1.LogStream{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("logstreams").
...
func (c *logStreams) UpdateStatus(ctx context.Context, logStream *v1alpha1.LogStream, opts v1.UpdateOptions) (result *v1alpha1.LogStream, err error) {
	result = &v1alpha1.LogStream{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("logstreams").
...
func (c *logStreams) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *logStreams) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *logStreams) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LogStream, err error) {
	result = &v1alpha1.LogStream{}
