...
// LogDestinationsGetter has a method to return a LogDestinationInterface.
...
// logDestinations implements LogDestinationInterface
type logDestinations struct {
	client rest.Interface
	ns     string
}

// newLogDestinations returns a LogDestinations
func newLogDestinations(c *CloudwatchV1alpha1Client, namespace string) *logDestinations {
...
func (c *logDestinations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LogDestination, err error) {
	result = &v1alpha1.LogDestination{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *logDestinations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LogDestinationList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.LogDestinationList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("logdestinations").
...
func (c *logDestinations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *logDestinations) Create(ctx context.Context, logDestination *v1alpha1.LogDestination, opts v1.CreateOptions) (result *v1alpha1.LogDestination, err error) {
	result = &v1alpha1.LogDestination{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("logdestinations").
...
func (c *logDestinations) Update(ctx context.Context, logDestination *v1alpha1.LogDestination, opts v1.UpdateOptions) (result *v1alpha1.LogDestination, err error) {
	result = &v1alpha1.LogDestination{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("logdestinations").
...
func (c *logDestinations) UpdateStatus(ctx context.Context, logDestination *v1alpha1.LogDestination, opts v1.UpdateOptions) (result *v1alpha1.LogDestination, err error) {
	result = &v1alpha1.LogDestination{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("logdestinations").
...
func (c *logDestinations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *logDestinations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *logDestinations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LogDestination, err error) {
	result = &v1alpha1.LogDestination{}
