...
// QueryDefinitionsGetter has a method to return a QueryDefinitionInterface.
...
// queryDefinitions implements QueryDefinitionInterface
type queryDefinitions struct {
	client rest.Interface
	ns     string
}

// newQueryDefinitions returns a QueryDefinitions
func newQueryDefinitions(c *CloudwatchV1alpha1Client, namespace string) *queryDefinitions {
...
func (c *queryDefinitions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.QueryDefinition, err error) {
	result = &v1alpha1.QueryDefinition{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *queryDefinitions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.QueryDefinitionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.QueryDefinitionList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("querydefinitions").
...
func (c *queryDefinitions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *queryDefinitions) Create(ctx context.Context, queryDefinition *v1alpha1.QueryDefinition, opts v1.CreateOptions) (result *v1alpha1.QueryDefinition, err error) {
	result = &v1alpha1.QueryDefinition{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("querydefinitions").
...
func (c *queryDefinitions) Update(ctx context.Context, queryDefinition *v1alpha1.QueryDefinition, opts v1.UpdateOptions) (result *v1alpha1.QueryDefinition, err error) {
	result = &v1alpha1.QueryDefinition{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("querydefinitions").
...
func (c *queryDefinitions) UpdateStatus(ctx context.Context, queryDefinition *v1alpha1.QueryDefinition, opts v1.UpdateOptions) (result *v1alpha1.QueryDefinition, err error) {
	result = &v1alpha1.QueryDefinition{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("querydefinitions").
...
func (c *queryDefinitions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *queryDefinitions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *queryDefinitions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.QueryDefinition, err error) {
	result = &v1alpha1.QueryDefinition{}
