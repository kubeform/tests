...
type SecurityhubV1alpha1Interface interface {
...
func (c *SecurityhubV1alpha1Client) StandardsSubscriptions(namespace string) StandardsSubscriptionInterface {
	return newStandardsSubscriptions(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*SecurityhubV1alpha1Client, error) {
	...
	return &SecurityhubV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new SecurityhubV1alpha1Client for the given config and
...
func New(c rest.Interface) *SecurityhubV1alpha1Client {
	return &SecurityhubV1alpha1Client{c}
}
