...
// InsightsGetter has a method to return a InsightInterface.
...
// newInsights returns a Insights
func newInsights(c *SecurityhubV1alpha1Client, namespace string) *insights {
	return &insights{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *insights) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Insight, err error) {
	result = &v1alpha1.Insight{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("insights").
		Name(name).
...
func (c *insights) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.InsightList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.InsightList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("insights").
...
func (c *insights) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *insights) Create(ctx context.Context, insight *v1alpha1.Insight, opts v1.CreateOptions) (result *v1alpha1.Insight, err error) {
	result = &v1alpha1.Insight{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("insights").
...
func (c *insights) Update(ctx context.Context, insight *v1alpha1.Insight, opts v1.UpdateOptions) (result *v1alpha1.Insight, err error) {
	result = &v1alpha1.Insight{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("insights").
...
func (c *insights) UpdateStatus(ctx context.Context, insight *v1alpha1.Insight, opts v1.UpdateOptions) (result *v1alpha1.Insight, err error) {
	result = &v1alpha1.Insight{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("insights").
...
func (c *insights) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *insights) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *insights) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Insight, err error) {
	result = &v1alpha1.Insight{}
