...
func newNetworkACLs(c *DefaultV1alpha1Client, namespace string) *networkACLs {
	return &networkACLs{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *networkACLs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.NetworkACL, err error) {
...
func (c *networkACLs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.NetworkACLList, err error) {
...
func (c *networkACLs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *networkACLs) Create(ctx context.Context, networkACL *v1alpha1.NetworkACL, opts v1.CreateOptions) (result *v1alpha1.NetworkACL, err error) {
	result = &v1alpha1.NetworkACL{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("networkacls").
...
func (c *networkACLs) Update(ctx context.Context, networkACL *v1alpha1.NetworkACL, opts v1.UpdateOptions) (result *v1alpha1.NetworkACL, err error) {
	result = &v1alpha1.NetworkACL{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("networkacls").
...
func (c *networkACLs) UpdateStatus(ctx context.Context, networkACL *v1alpha1.NetworkACL, opts v1.UpdateOptions) (result *v1alpha1.NetworkACL, err error) {
	result = &v1alpha1.NetworkACL{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("networkacls").
...
func (c *networkACLs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *networkACLs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *networkACLs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.NetworkACL, err error) {
	result = &v1alpha1.NetworkACL{}
