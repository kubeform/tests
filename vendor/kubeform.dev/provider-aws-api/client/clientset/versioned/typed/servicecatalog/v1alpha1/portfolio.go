...
func (c *portfolios) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Portfolio, err error) {
...
func (c *portfolios) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PortfolioList, err error) {
...
func (c *portfolios) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *portfolios) Create(ctx context.Context, portfolio *v1alpha1.Portfolio, opts v1.CreateOptions) (result *v1alpha1.Portfolio, err error) {
	result = &v1alpha1.Portfolio{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("portfolios").
...
func (c *portfolios) Update(ctx context.Context, portfolio *v1alpha1.Portfolio, opts v1.UpdateOptions) (result *v1alpha1.Portfolio, err error) {
	result = &v1alpha1.Portfolio{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("portfolios").
...
func (c *portfolios) UpdateStatus(ctx context.Context, portfolio *v1alpha1.Portfolio, opts v1.UpdateOptions) (result *v1alpha1.Portfolio, err error) {
	result = &v1alpha1.Portfolio{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("portfolios").
...
func (c *portfolios) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *portfolios) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *portfolios) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Portfolio, err error) {
	result = &v1alpha1.Portfolio{}
