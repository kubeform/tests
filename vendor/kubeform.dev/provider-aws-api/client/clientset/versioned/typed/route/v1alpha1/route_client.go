...
type RouteV1alpha1Interface interface {
	...
	RoutesGetter
	TablesGetter
	TableAssociationsGetter
}

// RouteV1alpha1Client is used to interact with features provided by the route.aws.kubeform.com group.
...
func (c *RouteV1alpha1Client) TableAssociations(namespace string) TableAssociationInterface {
	return newTableAssociations(c, namespace)
}
