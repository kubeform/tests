...
func (c *detectors) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Detector, err error) {
...
func (c *detectors) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DetectorList, err error) {
...
func (c *detectors) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *detectors) Create(ctx context.Context, detector *v1alpha1.Detector, opts v1.CreateOptions) (result *v1alpha1.Detector, err error) {
	result = &v1alpha1.Detector{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("detectors").
...
func (c *detectors) Update(ctx context.Context, detector *v1alpha1.Detector, opts v1.UpdateOptions) (result *v1alpha1.Detector, err error) {
	result = &v1alpha1.Detector{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("detectors").
...
func (c *detectors) UpdateStatus(ctx context.Context, detector *v1alpha1.Detector, opts v1.UpdateOptions) (result *v1alpha1.Detector, err error) {
	result = &v1alpha1.Detector{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("detectors").
...
func (c *detectors) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *detectors) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *detectors) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Detector, err error) {
	result = &v1alpha1.Detector{}
