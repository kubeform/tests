...
func (c *threatintelsets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Threatintelset, err error) {
...
func (c *threatintelsets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ThreatintelsetList, err error) {
...
func (c *threatintelsets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *threatintelsets) Create(ctx context.Context, threatintelset *v1alpha1.Threatintelset, opts v1.CreateOptions) (result *v1alpha1.Threatintelset, err error) {
	result = &v1alpha1.Threatintelset{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("threatintelsets").
...
func (c *threatintelsets) Update(ctx context.Context, threatintelset *v1alpha1.Threatintelset, opts v1.UpdateOptions) (result *v1alpha1.Threatintelset, err error) {
	result = &v1alpha1.Threatintelset{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("threatintelsets").
...
func (c *threatintelsets) UpdateStatus(ctx context.Context, threatintelset *v1alpha1.Threatintelset, opts v1.UpdateOptions) (result *v1alpha1.Threatintelset, err error) {
	result = &v1alpha1.Threatintelset{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("threatintelsets").
...
func (c *threatintelsets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *threatintelsets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *threatintelsets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Threatintelset, err error) {
	result = &v1alpha1.Threatintelset{}
