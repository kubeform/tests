...
// NodejsAppLayersGetter has a method to return a NodejsAppLayerInterface.
...
// nodejsAppLayers implements NodejsAppLayerInterface
type nodejsAppLayers struct {
	client rest.Interface
	ns     string
}

// newNodejsAppLayers returns a NodejsAppLayers
func newNodejsAppLayers(c *OpsworksV1alpha1Client, namespace string) *nodejsAppLayers {
	return &nodejsAppLayers{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *nodejsAppLayers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.NodejsAppLayer, err error) {
	result = &v1alpha1.NodejsAppLayer{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *nodejsAppLayers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.NodejsAppLayerList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.NodejsAppLayerList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("nodejsapplayers").
...
func (c *nodejsAppLayers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *nodejsAppLayers) Create(ctx context.Context, nodejsAppLayer *v1alpha1.NodejsAppLayer, opts v1.CreateOptions) (result *v1alpha1.NodejsAppLayer, err error) {
	result = &v1alpha1.NodejsAppLayer{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("nodejsapplayers").
...
func (c *nodejsAppLayers) Update(ctx context.Context, nodejsAppLayer *v1alpha1.NodejsAppLayer, opts v1.UpdateOptions) (result *v1alpha1.NodejsAppLayer, err error) {
	result = &v1alpha1.NodejsAppLayer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("nodejsapplayers").
		Name(nodejsAppLayer.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(nodejsAppLayer).
		Do(ctx).
		Into(result)
...
func (c *nodejsAppLayers) UpdateStatus(ctx context.Context, nodejsAppLayer *v1alpha1.NodejsAppLayer, opts v1.UpdateOptions) (result *v1alpha1.NodejsAppLayer, err error) {
	result = &v1alpha1.NodejsAppLayer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("nodejsapplayers").
...
func (c *nodejsAppLayers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *nodejsAppLayers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *nodejsAppLayers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.NodejsAppLayer, err error) {
	result = &v1alpha1.NodejsAppLayer{}
