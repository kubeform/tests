...
// JavaAppLayersGetter has a method to return a JavaAppLayerInterface.
...
// javaAppLayers implements JavaAppLayerInterface
type javaAppLayers struct {
	client rest.Interface
	ns     string
}

// newJavaAppLayers returns a JavaAppLayers
func newJavaAppLayers(c *OpsworksV1alpha1Client, namespace string) *javaAppLayers {
	return &javaAppLayers{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *javaAppLayers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.JavaAppLayer, err error) {
	result = &v1alpha1.JavaAppLayer{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *javaAppLayers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.JavaAppLayerList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.JavaAppLayerList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("javaapplayers").
...
func (c *javaAppLayers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *javaAppLayers) Create(ctx context.Context, javaAppLayer *v1alpha1.JavaAppLayer, opts v1.CreateOptions) (result *v1alpha1.JavaAppLayer, err error) {
	result = &v1alpha1.JavaAppLayer{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("javaapplayers").
...
func (c *javaAppLayers) Update(ctx context.Context, javaAppLayer *v1alpha1.JavaAppLayer, opts v1.UpdateOptions) (result *v1alpha1.JavaAppLayer, err error) {
	result = &v1alpha1.JavaAppLayer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("javaapplayers").
		Name(javaAppLayer.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(javaAppLayer).
		Do(ctx).
		Into(result)
...
func (c *javaAppLayers) UpdateStatus(ctx context.Context, javaAppLayer *v1alpha1.JavaAppLayer, opts v1.UpdateOptions) (result *v1alpha1.JavaAppLayer, err error) {
	result = &v1alpha1.JavaAppLayer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("javaapplayers").
...
func (c *javaAppLayers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *javaAppLayers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *javaAppLayers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.JavaAppLayer, err error) {
	result = &v1alpha1.JavaAppLayer{}
