...
// MysqlLayersGetter has a method to return a MysqlLayerInterface.
...
// mysqlLayers implements MysqlLayerInterface
type mysqlLayers struct {
	client rest.Interface
	ns     string
}

// newMysqlLayers returns a MysqlLayers
func newMysqlLayers(c *OpsworksV1alpha1Client, namespace string) *mysqlLayers {
	return &mysqlLayers{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *mysqlLayers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MysqlLayer, err error) {
...
func (c *mysqlLayers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MysqlLayerList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.MysqlLayerList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("mysqllayers").
...
func (c *mysqlLayers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *mysqlLayers) Create(ctx context.Context, mysqlLayer *v1alpha1.MysqlLayer, opts v1.CreateOptions) (result *v1alpha1.MysqlLayer, err error) {
	result = &v1alpha1.MysqlLayer{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("mysqllayers").
...
func (c *mysqlLayers) Update(ctx context.Context, mysqlLayer *v1alpha1.MysqlLayer, opts v1.UpdateOptions) (result *v1alpha1.MysqlLayer, err error) {
	result = &v1alpha1.MysqlLayer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mysqllayers").
		Name(mysqlLayer.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(mysqlLayer).
		Do(ctx).
		Into(result)
...
func (c *mysqlLayers) UpdateStatus(ctx context.Context, mysqlLayer *v1alpha1.MysqlLayer, opts v1.UpdateOptions) (result *v1alpha1.MysqlLayer, err error) {
	result = &v1alpha1.MysqlLayer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mysqllayers").
...
func (c *mysqlLayers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *mysqlLayers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *mysqlLayers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MysqlLayer, err error) {
	result = &v1alpha1.MysqlLayer{}
