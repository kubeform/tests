...
func newPermissions(c *OpsworksV1alpha1Client, namespace string) *permissions {
	return &permissions{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *permissions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Permission, err error) {
...
func (c *permissions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PermissionList, err error) {
...
func (c *permissions) Create(ctx context.Context, permission *v1alpha1.Permission, opts v1.CreateOptions) (result *v1alpha1.Permission, err error) {
	result = &v1alpha1.Permission{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("permissions").
...
func (c *permissions) Update(ctx context.Context, permission *v1alpha1.Permission, opts v1.UpdateOptions) (result *v1alpha1.Permission, err error) {
	result = &v1alpha1.Permission{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("permissions").
...
func (c *permissions) UpdateStatus(ctx context.Context, permission *v1alpha1.Permission, opts v1.UpdateOptions) (result *v1alpha1.Permission, err error) {
	result = &v1alpha1.Permission{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("permissions").
...
func (c *permissions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Permission, err error) {
	result = &v1alpha1.Permission{}
