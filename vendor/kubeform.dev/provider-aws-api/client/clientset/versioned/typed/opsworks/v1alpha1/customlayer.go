...
// CustomLayersGetter has a method to return a CustomLayerInterface.
...
// customLayers implements CustomLayerInterface
type customLayers struct {
	client rest.Interface
	ns     string
}

// newCustomLayers returns a CustomLayers
func newCustomLayers(c *OpsworksV1alpha1Client, namespace string) *customLayers {
	return &customLayers{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *customLayers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CustomLayer, err error) {
	result = &v1alpha1.CustomLayer{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *customLayers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CustomLayerList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.CustomLayerList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("customlayers").
...
func (c *customLayers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *customLayers) Create(ctx context.Context, customLayer *v1alpha1.CustomLayer, opts v1.CreateOptions) (result *v1alpha1.CustomLayer, err error) {
	result = &v1alpha1.CustomLayer{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("customlayers").
...
func (c *customLayers) Update(ctx context.Context, customLayer *v1alpha1.CustomLayer, opts v1.UpdateOptions) (result *v1alpha1.CustomLayer, err error) {
	result = &v1alpha1.CustomLayer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("customlayers").
...
func (c *customLayers) UpdateStatus(ctx context.Context, customLayer *v1alpha1.CustomLayer, opts v1.UpdateOptions) (result *v1alpha1.CustomLayer, err error) {
	result = &v1alpha1.CustomLayer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("customlayers").
...
func (c *customLayers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *customLayers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *customLayers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CustomLayer, err error) {
	result = &v1alpha1.CustomLayer{}
