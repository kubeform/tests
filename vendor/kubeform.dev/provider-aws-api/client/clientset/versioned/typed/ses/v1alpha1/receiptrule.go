...
func (c *receiptRules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ReceiptRule, err error) {
...
func (c *receiptRules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ReceiptRuleList, err error) {
...
func (c *receiptRules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *receiptRules) Create(ctx context.Context, receiptRule *v1alpha1.ReceiptRule, opts v1.CreateOptions) (result *v1alpha1.ReceiptRule, err error) {
	result = &v1alpha1.ReceiptRule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("receiptrules").
...
func (c *receiptRules) Update(ctx context.Context, receiptRule *v1alpha1.ReceiptRule, opts v1.UpdateOptions) (result *v1alpha1.ReceiptRule, err error) {
	result = &v1alpha1.ReceiptRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("receiptrules").
...
func (c *receiptRules) UpdateStatus(ctx context.Context, receiptRule *v1alpha1.ReceiptRule, opts v1.UpdateOptions) (result *v1alpha1.ReceiptRule, err error) {
	result = &v1alpha1.ReceiptRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("receiptrules").
...
func (c *receiptRules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *receiptRules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *receiptRules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ReceiptRule, err error) {
	result = &v1alpha1.ReceiptRule{}
