...
func (c *receiptFilters) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ReceiptFilter, err error) {
...
func (c *receiptFilters) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ReceiptFilterList, err error) {
...
func (c *receiptFilters) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *receiptFilters) Create(ctx context.Context, receiptFilter *v1alpha1.ReceiptFilter, opts v1.CreateOptions) (result *v1alpha1.ReceiptFilter, err error) {
	result = &v1alpha1.ReceiptFilter{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("receiptfilters").
...
func (c *receiptFilters) Update(ctx context.Context, receiptFilter *v1alpha1.ReceiptFilter, opts v1.UpdateOptions) (result *v1alpha1.ReceiptFilter, err error) {
	result = &v1alpha1.ReceiptFilter{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("receiptfilters").
...
func (c *receiptFilters) UpdateStatus(ctx context.Context, receiptFilter *v1alpha1.ReceiptFilter, opts v1.UpdateOptions) (result *v1alpha1.ReceiptFilter, err error) {
	result = &v1alpha1.ReceiptFilter{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("receiptfilters").
...
func (c *receiptFilters) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *receiptFilters) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *receiptFilters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ReceiptFilter, err error) {
	result = &v1alpha1.ReceiptFilter{}
