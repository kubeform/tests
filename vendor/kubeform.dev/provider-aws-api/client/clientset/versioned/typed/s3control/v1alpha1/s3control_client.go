...
func NewForConfig(c *rest.Config) (*S3controlV1alpha1Client, error) {
	...
	return &S3controlV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new S3controlV1alpha1Client for the given config and
...
func New(c rest.Interface) *S3controlV1alpha1Client {
	return &S3controlV1alpha1Client{c}
}
