...
type VpnV1alpha1Interface interface {
	...
	ConnectionsGetter
	ConnectionRoutesGetter
	GatewaysGetter
	GatewayAttachmentsGetter
	GatewayRoutePropagationsGetter
}

// VpnV1alpha1Client is used to interact with features provided by the vpn.aws.kubeform.com group.
...
func (c *VpnV1alpha1Client) ConnectionRoutes(namespace string) ConnectionRouteInterface {
	return newConnectionRoutes(c, namespace)
}
...
func (c *VpnV1alpha1Client) GatewayAttachments(namespace string) GatewayAttachmentInterface {
	return newGatewayAttachments(c, namespace)
}

func (c *VpnV1alpha1Client) GatewayRoutePropagations(namespace string) GatewayRoutePropagationInterface {
	return newGatewayRoutePropagations(c, namespace)
}
