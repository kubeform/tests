...
type CodebuildV1alpha1Interface interface {
...
func (c *CodebuildV1alpha1Client) SourceCredentials(namespace string) SourceCredentialInterface {
	return newSourceCredentials(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*CodebuildV1alpha1Client, error) {
	...
	return &CodebuildV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new CodebuildV1alpha1Client for the given config and
...
func New(c rest.Interface) *CodebuildV1alpha1Client {
	return &CodebuildV1alpha1Client{c}
}
