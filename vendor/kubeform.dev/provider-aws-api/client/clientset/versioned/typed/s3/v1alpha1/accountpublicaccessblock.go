...
// AccountPublicAccessBlocksGetter has a method to return a AccountPublicAccessBlockInterface.
...
// accountPublicAccessBlocks implements AccountPublicAccessBlockInterface
type accountPublicAccessBlocks struct {
	client rest.Interface
	ns     string
}

// newAccountPublicAccessBlocks returns a AccountPublicAccessBlocks
func newAccountPublicAccessBlocks(c *S3V1alpha1Client, namespace string) *accountPublicAccessBlocks {
	return &accountPublicAccessBlocks{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *accountPublicAccessBlocks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AccountPublicAccessBlock, err error) {
	result = &v1alpha1.AccountPublicAccessBlock{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *accountPublicAccessBlocks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AccountPublicAccessBlockList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.AccountPublicAccessBlockList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("accountpublicaccessblocks").
...
func (c *accountPublicAccessBlocks) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *accountPublicAccessBlocks) Create(ctx context.Context, accountPublicAccessBlock *v1alpha1.AccountPublicAccessBlock, opts v1.CreateOptions) (result *v1alpha1.AccountPublicAccessBlock, err error) {
	result = &v1alpha1.AccountPublicAccessBlock{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("accountpublicaccessblocks").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(accountPublicAccessBlock).
		Do(ctx).
		Into(result)
	return
}
...
func (c *accountPublicAccessBlocks) Update(ctx context.Context, accountPublicAccessBlock *v1alpha1.AccountPublicAccessBlock, opts v1.UpdateOptions) (result *v1alpha1.AccountPublicAccessBlock, err error) {
	result = &v1alpha1.AccountPublicAccessBlock{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("accountpublicaccessblocks").
		Name(accountPublicAccessBlock.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(accountPublicAccessBlock).
		Do(ctx).
		Into(result)
...
func (c *accountPublicAccessBlocks) UpdateStatus(ctx context.Context, accountPublicAccessBlock *v1alpha1.AccountPublicAccessBlock, opts v1.UpdateOptions) (result *v1alpha1.AccountPublicAccessBlock, err error) {
	result = &v1alpha1.AccountPublicAccessBlock{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("accountpublicaccessblocks").
...
func (c *accountPublicAccessBlocks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *accountPublicAccessBlocks) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *accountPublicAccessBlocks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AccountPublicAccessBlock, err error) {
	result = &v1alpha1.AccountPublicAccessBlock{}
