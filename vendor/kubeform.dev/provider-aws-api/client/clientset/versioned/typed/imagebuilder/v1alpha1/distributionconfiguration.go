...
// DistributionConfigurationsGetter has a method to return a DistributionConfigurationInterface.
...
// distributionConfigurations implements DistributionConfigurationInterface
type distributionConfigurations struct {
	client rest.Interface
	ns     string
}

// newDistributionConfigurations returns a DistributionConfigurations
func newDistributionConfigurations(c *ImagebuilderV1alpha1Client, namespace string) *distributionConfigurations {
...
func (c *distributionConfigurations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DistributionConfiguration, err error) {
	result = &v1alpha1.DistributionConfiguration{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *distributionConfigurations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DistributionConfigurationList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.DistributionConfigurationList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("distributionconfigurations").
...
func (c *distributionConfigurations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *distributionConfigurations) Create(ctx context.Context, distributionConfiguration *v1alpha1.DistributionConfiguration, opts v1.CreateOptions) (result *v1alpha1.DistributionConfiguration, err error) {
	result = &v1alpha1.DistributionConfiguration{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("distributionconfigurations").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(distributionConfiguration).
		Do(ctx).
		Into(result)
	return
}
...
func (c *distributionConfigurations) Update(ctx context.Context, distributionConfiguration *v1alpha1.DistributionConfiguration, opts v1.UpdateOptions) (result *v1alpha1.DistributionConfiguration, err error) {
	result = &v1alpha1.DistributionConfiguration{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("distributionconfigurations").
		Name(distributionConfiguration.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(distributionConfiguration).
		Do(ctx).
		Into(result)
...
func (c *distributionConfigurations) UpdateStatus(ctx context.Context, distributionConfiguration *v1alpha1.DistributionConfiguration, opts v1.UpdateOptions) (result *v1alpha1.DistributionConfiguration, err error) {
	result = &v1alpha1.DistributionConfiguration{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("distributionconfigurations").
...
func (c *distributionConfigurations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *distributionConfigurations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *distributionConfigurations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DistributionConfiguration, err error) {
	result = &v1alpha1.DistributionConfiguration{}
