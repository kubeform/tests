...
type ImagebuilderV1alpha1Interface interface {
	...
	ImageRecipesGetter
	InfrastructureConfigurationsGetter
}
...
func (c *ImagebuilderV1alpha1Client) DistributionConfigurations(namespace string) DistributionConfigurationInterface {
	return newDistributionConfigurations(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*ImagebuilderV1alpha1Client, error) {
	...
	return &ImagebuilderV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new ImagebuilderV1alpha1Client for the given config and
...
func New(c rest.Interface) *ImagebuilderV1alpha1Client {
	return &ImagebuilderV1alpha1Client{c}
}
