...
// ScheduledActionsGetter has a method to return a ScheduledActionInterface.
...
// scheduledActions implements ScheduledActionInterface
type scheduledActions struct {
	client rest.Interface
	ns     string
}

// newScheduledActions returns a ScheduledActions
func newScheduledActions(c *AppautoscalingV1alpha1Client, namespace string) *scheduledActions {
...
func (c *scheduledActions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ScheduledAction, err error) {
	result = &v1alpha1.ScheduledAction{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *scheduledActions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ScheduledActionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ScheduledActionList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("scheduledactions").
...
func (c *scheduledActions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *scheduledActions) Create(ctx context.Context, scheduledAction *v1alpha1.ScheduledAction, opts v1.CreateOptions) (result *v1alpha1.ScheduledAction, err error) {
	result = &v1alpha1.ScheduledAction{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("scheduledactions").
...
func (c *scheduledActions) Update(ctx context.Context, scheduledAction *v1alpha1.ScheduledAction, opts v1.UpdateOptions) (result *v1alpha1.ScheduledAction, err error) {
	result = &v1alpha1.ScheduledAction{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("scheduledactions").
...
func (c *scheduledActions) UpdateStatus(ctx context.Context, scheduledAction *v1alpha1.ScheduledAction, opts v1.UpdateOptions) (result *v1alpha1.ScheduledAction, err error) {
	result = &v1alpha1.ScheduledAction{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("scheduledactions").
...
func (c *scheduledActions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *scheduledActions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *scheduledActions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ScheduledAction, err error) {
	result = &v1alpha1.ScheduledAction{}
