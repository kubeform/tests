...
func newByteMatchSets(c *WafV1alpha1Client, namespace string) *byteMatchSets {
...
func (c *byteMatchSets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ByteMatchSet, err error) {
...
func (c *byteMatchSets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ByteMatchSetList, err error) {
...
func (c *byteMatchSets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *byteMatchSets) Create(ctx context.Context, byteMatchSet *v1alpha1.ByteMatchSet, opts v1.CreateOptions) (result *v1alpha1.ByteMatchSet, err error) {
	result = &v1alpha1.ByteMatchSet{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("bytematchsets").
...
func (c *byteMatchSets) Update(ctx context.Context, byteMatchSet *v1alpha1.ByteMatchSet, opts v1.UpdateOptions) (result *v1alpha1.ByteMatchSet, err error) {
	result = &v1alpha1.ByteMatchSet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("bytematchsets").
...
func (c *byteMatchSets) UpdateStatus(ctx context.Context, byteMatchSet *v1alpha1.ByteMatchSet, opts v1.UpdateOptions) (result *v1alpha1.ByteMatchSet, err error) {
	result = &v1alpha1.ByteMatchSet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("bytematchsets").
...
func (c *byteMatchSets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *byteMatchSets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *byteMatchSets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ByteMatchSet, err error) {
	result = &v1alpha1.ByteMatchSet{}
