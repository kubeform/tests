...
// VpcAssociationAuthorizationsGetter has a method to return a VpcAssociationAuthorizationInterface.
...
// vpcAssociationAuthorizations implements VpcAssociationAuthorizationInterface
type vpcAssociationAuthorizations struct {
	client rest.Interface
	ns     string
}

// newVpcAssociationAuthorizations returns a VpcAssociationAuthorizations
func newVpcAssociationAuthorizations(c *Route53V1alpha1Client, namespace string) *vpcAssociationAuthorizations {
	return &vpcAssociationAuthorizations{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *vpcAssociationAuthorizations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.VpcAssociationAuthorization, err error) {
	result = &v1alpha1.VpcAssociationAuthorization{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *vpcAssociationAuthorizations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.VpcAssociationAuthorizationList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.VpcAssociationAuthorizationList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("vpcassociationauthorizations").
...
func (c *vpcAssociationAuthorizations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *vpcAssociationAuthorizations) Create(ctx context.Context, vpcAssociationAuthorization *v1alpha1.VpcAssociationAuthorization, opts v1.CreateOptions) (result *v1alpha1.VpcAssociationAuthorization, err error) {
	result = &v1alpha1.VpcAssociationAuthorization{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("vpcassociationauthorizations").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(vpcAssociationAuthorization).
		Do(ctx).
		Into(result)
	return
}
...
func (c *vpcAssociationAuthorizations) Update(ctx context.Context, vpcAssociationAuthorization *v1alpha1.VpcAssociationAuthorization, opts v1.UpdateOptions) (result *v1alpha1.VpcAssociationAuthorization, err error) {
	result = &v1alpha1.VpcAssociationAuthorization{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vpcassociationauthorizations").
		Name(vpcAssociationAuthorization.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(vpcAssociationAuthorization).
		Do(ctx).
		Into(result)
...
func (c *vpcAssociationAuthorizations) UpdateStatus(ctx context.Context, vpcAssociationAuthorization *v1alpha1.VpcAssociationAuthorization, opts v1.UpdateOptions) (result *v1alpha1.VpcAssociationAuthorization, err error) {
	result = &v1alpha1.VpcAssociationAuthorization{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vpcassociationauthorizations").
...
func (c *vpcAssociationAuthorizations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *vpcAssociationAuthorizations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *vpcAssociationAuthorizations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.VpcAssociationAuthorization, err error) {
	result = &v1alpha1.VpcAssociationAuthorization{}
