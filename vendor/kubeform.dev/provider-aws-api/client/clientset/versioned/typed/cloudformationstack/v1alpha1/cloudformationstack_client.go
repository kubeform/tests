...
type CloudformationstackV1alpha1Interface interface {
...
func (c *CloudformationstackV1alpha1Client) SetInstances(namespace string) SetInstanceInterface {
	return newSetInstances(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*CloudformationstackV1alpha1Client, error) {
	...
	return &CloudformationstackV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new CloudformationstackV1alpha1Client for the given config and
...
func New(c rest.Interface) *CloudformationstackV1alpha1Client {
	return &CloudformationstackV1alpha1Client{c}
}
