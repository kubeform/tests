...
// LagsGetter has a method to return a LagInterface.
...
// lags implements LagInterface
type lags struct {
	client rest.Interface
	ns     string
}

// newLags returns a Lags
func newLags(c *DxV1alpha1Client, namespace string) *lags {
	return &lags{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *lags) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Lag, err error) {
	result = &v1alpha1.Lag{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("lags").
...
func (c *lags) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LagList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.LagList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("lags").
...
func (c *lags) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *lags) Create(ctx context.Context, lag *v1alpha1.Lag, opts v1.CreateOptions) (result *v1alpha1.Lag, err error) {
	result = &v1alpha1.Lag{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("lags").
...
func (c *lags) Update(ctx context.Context, lag *v1alpha1.Lag, opts v1.UpdateOptions) (result *v1alpha1.Lag, err error) {
	result = &v1alpha1.Lag{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("lags").
...
func (c *lags) UpdateStatus(ctx context.Context, lag *v1alpha1.Lag, opts v1.UpdateOptions) (result *v1alpha1.Lag, err error) {
	result = &v1alpha1.Lag{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("lags").
...
func (c *lags) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *lags) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *lags) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Lag, err error) {
	result = &v1alpha1.Lag{}
