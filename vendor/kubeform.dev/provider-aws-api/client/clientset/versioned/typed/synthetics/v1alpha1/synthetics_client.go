...
// SyntheticsV1alpha1Client is used to interact with features provided by the synthetics.aws.kubeform.com group.
type SyntheticsV1alpha1Client struct {
	restClient rest.Interface
}

func (c *SyntheticsV1alpha1Client) Canaries(namespace string) CanaryInterface {
