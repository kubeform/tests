...
type EfsV1alpha1Interface interface {
	RESTClient() rest.Interface
	AccessPointsGetter
	FileSystemsGetter
	FileSystemPoliciesGetter
	MountTargetsGetter
}
...
func (c *EfsV1alpha1Client) FileSystemPolicies(namespace string) FileSystemPolicyInterface {
	return newFileSystemPolicies(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*EfsV1alpha1Client, error) {
	...
	return &EfsV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new EfsV1alpha1Client for the given config and
...
func New(c rest.Interface) *EfsV1alpha1Client {
	return &EfsV1alpha1Client{c}
}
