...
func (c *virtualServices) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.VirtualService, err error) {
...
func (c *virtualServices) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.VirtualServiceList, err error) {
...
func (c *virtualServices) Create(ctx context.Context, virtualService *v1alpha1.VirtualService, opts v1.CreateOptions) (result *v1alpha1.VirtualService, err error) {
	result = &v1alpha1.VirtualService{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("virtualservices").
...
func (c *virtualServices) Update(ctx context.Context, virtualService *v1alpha1.VirtualService, opts v1.UpdateOptions) (result *v1alpha1.VirtualService, err error) {
	result = &v1alpha1.VirtualService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("virtualservices").
...
func (c *virtualServices) UpdateStatus(ctx context.Context, virtualService *v1alpha1.VirtualService, opts v1.UpdateOptions) (result *v1alpha1.VirtualService, err error) {
	result = &v1alpha1.VirtualService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("virtualservices").
...
func (c *virtualServices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.VirtualService, err error) {
	result = &v1alpha1.VirtualService{}
