...
func newGatewayRoutes(c *AppmeshV1alpha1Client, namespace string) *gatewayRoutes {
...
func (c *gatewayRoutes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.GatewayRoute, err error) {
	result = &v1alpha1.GatewayRoute{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *gatewayRoutes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.GatewayRouteList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.GatewayRouteList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("gatewayroutes").
...
func (c *gatewayRoutes) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *gatewayRoutes) Create(ctx context.Context, gatewayRoute *v1alpha1.GatewayRoute, opts v1.CreateOptions) (result *v1alpha1.GatewayRoute, err error) {
	result = &v1alpha1.GatewayRoute{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("gatewayroutes").
...
func (c *gatewayRoutes) Update(ctx context.Context, gatewayRoute *v1alpha1.GatewayRoute, opts v1.UpdateOptions) (result *v1alpha1.GatewayRoute, err error) {
	result = &v1alpha1.GatewayRoute{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("gatewayroutes").
...
func (c *gatewayRoutes) UpdateStatus(ctx context.Context, gatewayRoute *v1alpha1.GatewayRoute, opts v1.UpdateOptions) (result *v1alpha1.GatewayRoute, err error) {
	result = &v1alpha1.GatewayRoute{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("gatewayroutes").
...
func (c *gatewayRoutes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *gatewayRoutes) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *gatewayRoutes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.GatewayRoute, err error) {
	result = &v1alpha1.GatewayRoute{}
