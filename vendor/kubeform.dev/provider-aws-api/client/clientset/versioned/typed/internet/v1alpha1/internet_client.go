...
func NewForConfig(c *rest.Config) (*InternetV1alpha1Client, error) {
	...
	return &InternetV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new InternetV1alpha1Client for the given config and
...
func New(c rest.Interface) *InternetV1alpha1Client {
	return &InternetV1alpha1Client{c}
}
