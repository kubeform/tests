...
func (c *configurationAggregators) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ConfigurationAggregator, err error) {
...
func (c *configurationAggregators) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ConfigurationAggregatorList, err error) {
...
func (c *configurationAggregators) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *configurationAggregators) Create(ctx context.Context, configurationAggregator *v1alpha1.ConfigurationAggregator, opts v1.CreateOptions) (result *v1alpha1.ConfigurationAggregator, err error) {
	result = &v1alpha1.ConfigurationAggregator{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("configurationaggregators").
...
func (c *configurationAggregators) Update(ctx context.Context, configurationAggregator *v1alpha1.ConfigurationAggregator, opts v1.UpdateOptions) (result *v1alpha1.ConfigurationAggregator, err error) {
	result = &v1alpha1.ConfigurationAggregator{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("configurationaggregators").
...
func (c *configurationAggregators) UpdateStatus(ctx context.Context, configurationAggregator *v1alpha1.ConfigurationAggregator, opts v1.UpdateOptions) (result *v1alpha1.ConfigurationAggregator, err error) {
	result = &v1alpha1.ConfigurationAggregator{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("configurationaggregators").
...
func (c *configurationAggregators) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *configurationAggregators) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *configurationAggregators) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ConfigurationAggregator, err error) {
	result = &v1alpha1.ConfigurationAggregator{}
