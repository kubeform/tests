...
// OrganizationManagedRulesGetter has a method to return a OrganizationManagedRuleInterface.
...
// organizationManagedRules implements OrganizationManagedRuleInterface
type organizationManagedRules struct {
	client rest.Interface
	ns     string
}

// newOrganizationManagedRules returns a OrganizationManagedRules
func newOrganizationManagedRules(c *ConfigV1alpha1Client, namespace string) *organizationManagedRules {
	return &organizationManagedRules{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *organizationManagedRules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.OrganizationManagedRule, err error) {
	result = &v1alpha1.OrganizationManagedRule{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *organizationManagedRules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.OrganizationManagedRuleList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.OrganizationManagedRuleList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("organizationmanagedrules").
...
func (c *organizationManagedRules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *organizationManagedRules) Create(ctx context.Context, organizationManagedRule *v1alpha1.OrganizationManagedRule, opts v1.CreateOptions) (result *v1alpha1.OrganizationManagedRule, err error) {
	result = &v1alpha1.OrganizationManagedRule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("organizationmanagedrules").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(organizationManagedRule).
		Do(ctx).
		Into(result)
	return
}
...
func (c *organizationManagedRules) Update(ctx context.Context, organizationManagedRule *v1alpha1.OrganizationManagedRule, opts v1.UpdateOptions) (result *v1alpha1.OrganizationManagedRule, err error) {
	result = &v1alpha1.OrganizationManagedRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("organizationmanagedrules").
		Name(organizationManagedRule.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(organizationManagedRule).
		Do(ctx).
		Into(result)
...
func (c *organizationManagedRules) UpdateStatus(ctx context.Context, organizationManagedRule *v1alpha1.OrganizationManagedRule, opts v1.UpdateOptions) (result *v1alpha1.OrganizationManagedRule, err error) {
	result = &v1alpha1.OrganizationManagedRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("organizationmanagedrules").
...
func (c *organizationManagedRules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *organizationManagedRules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *organizationManagedRules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.OrganizationManagedRule, err error) {
	result = &v1alpha1.OrganizationManagedRule{}
