...
type FmsV1alpha1Interface interface {
...
func (c *FmsV1alpha1Client) AdminAccounts(namespace string) AdminAccountInterface {
	return newAdminAccounts(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*FmsV1alpha1Client, error) {
	...
	return &FmsV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new FmsV1alpha1Client for the given config and
