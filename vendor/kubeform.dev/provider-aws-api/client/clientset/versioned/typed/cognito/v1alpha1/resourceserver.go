...
// ResourceServersGetter has a method to return a ResourceServerInterface.
...
// resourceServers implements ResourceServerInterface
type resourceServers struct {
	client rest.Interface
	ns     string
}

// newResourceServers returns a ResourceServers
func newResourceServers(c *CognitoV1alpha1Client, namespace string) *resourceServers {
...
func (c *resourceServers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ResourceServer, err error) {
	result = &v1alpha1.ResourceServer{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *resourceServers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ResourceServerList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ResourceServerList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("resourceservers").
...
func (c *resourceServers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *resourceServers) Create(ctx context.Context, resourceServer *v1alpha1.ResourceServer, opts v1.CreateOptions) (result *v1alpha1.ResourceServer, err error) {
	result = &v1alpha1.ResourceServer{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("resourceservers").
...
func (c *resourceServers) Update(ctx context.Context, resourceServer *v1alpha1.ResourceServer, opts v1.UpdateOptions) (result *v1alpha1.ResourceServer, err error) {
	result = &v1alpha1.ResourceServer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("resourceservers").
...
func (c *resourceServers) UpdateStatus(ctx context.Context, resourceServer *v1alpha1.ResourceServer, opts v1.UpdateOptions) (result *v1alpha1.ResourceServer, err error) {
	result = &v1alpha1.ResourceServer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("resourceservers").
...
func (c *resourceServers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *resourceServers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *resourceServers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ResourceServer, err error) {
	result = &v1alpha1.ResourceServer{}
