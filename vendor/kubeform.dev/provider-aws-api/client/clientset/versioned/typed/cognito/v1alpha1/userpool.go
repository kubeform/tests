...
func (c *userPools) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.UserPool, err error) {
...
func (c *userPools) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.UserPoolList, err error) {
...
func (c *userPools) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *userPools) Create(ctx context.Context, userPool *v1alpha1.UserPool, opts v1.CreateOptions) (result *v1alpha1.UserPool, err error) {
	result = &v1alpha1.UserPool{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("userpools").
...
func (c *userPools) Update(ctx context.Context, userPool *v1alpha1.UserPool, opts v1.UpdateOptions) (result *v1alpha1.UserPool, err error) {
	result = &v1alpha1.UserPool{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("userpools").
...
func (c *userPools) UpdateStatus(ctx context.Context, userPool *v1alpha1.UserPool, opts v1.UpdateOptions) (result *v1alpha1.UserPool, err error) {
	result = &v1alpha1.UserPool{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("userpools").
...
func (c *userPools) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *userPools) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *userPools) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.UserPool, err error) {
	result = &v1alpha1.UserPool{}
