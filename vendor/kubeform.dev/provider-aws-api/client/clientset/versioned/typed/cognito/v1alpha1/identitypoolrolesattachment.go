...
// IdentityPoolRolesAttachmentsGetter has a method to return a IdentityPoolRolesAttachmentInterface.
...
// identityPoolRolesAttachments implements IdentityPoolRolesAttachmentInterface
type identityPoolRolesAttachments struct {
	client rest.Interface
	ns     string
}

// newIdentityPoolRolesAttachments returns a IdentityPoolRolesAttachments
func newIdentityPoolRolesAttachments(c *CognitoV1alpha1Client, namespace string) *identityPoolRolesAttachments {
	return &identityPoolRolesAttachments{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *identityPoolRolesAttachments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IdentityPoolRolesAttachment, err error) {
	result = &v1alpha1.IdentityPoolRolesAttachment{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *identityPoolRolesAttachments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IdentityPoolRolesAttachmentList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.IdentityPoolRolesAttachmentList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("identitypoolrolesattachments").
...
func (c *identityPoolRolesAttachments) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *identityPoolRolesAttachments) Create(ctx context.Context, identityPoolRolesAttachment *v1alpha1.IdentityPoolRolesAttachment, opts v1.CreateOptions) (result *v1alpha1.IdentityPoolRolesAttachment, err error) {
	result = &v1alpha1.IdentityPoolRolesAttachment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("identitypoolrolesattachments").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(identityPoolRolesAttachment).
		Do(ctx).
		Into(result)
	return
}
...
func (c *identityPoolRolesAttachments) Update(ctx context.Context, identityPoolRolesAttachment *v1alpha1.IdentityPoolRolesAttachment, opts v1.UpdateOptions) (result *v1alpha1.IdentityPoolRolesAttachment, err error) {
	result = &v1alpha1.IdentityPoolRolesAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("identitypoolrolesattachments").
		Name(identityPoolRolesAttachment.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(identityPoolRolesAttachment).
		Do(ctx).
		Into(result)
...
func (c *identityPoolRolesAttachments) UpdateStatus(ctx context.Context, identityPoolRolesAttachment *v1alpha1.IdentityPoolRolesAttachment, opts v1.UpdateOptions) (result *v1alpha1.IdentityPoolRolesAttachment, err error) {
	result = &v1alpha1.IdentityPoolRolesAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("identitypoolrolesattachments").
...
func (c *identityPoolRolesAttachments) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *identityPoolRolesAttachments) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *identityPoolRolesAttachments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IdentityPoolRolesAttachment, err error) {
	result = &v1alpha1.IdentityPoolRolesAttachment{}
