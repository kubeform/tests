...
// UserPoolUiCustomizationsGetter has a method to return a UserPoolUiCustomizationInterface.
...
// userPoolUiCustomizations implements UserPoolUiCustomizationInterface
type userPoolUiCustomizations struct {
	client rest.Interface
	ns     string
}

// newUserPoolUiCustomizations returns a UserPoolUiCustomizations
func newUserPoolUiCustomizations(c *CognitoV1alpha1Client, namespace string) *userPoolUiCustomizations {
	return &userPoolUiCustomizations{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *userPoolUiCustomizations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.UserPoolUiCustomization, err error) {
	result = &v1alpha1.UserPoolUiCustomization{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *userPoolUiCustomizations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.UserPoolUiCustomizationList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.UserPoolUiCustomizationList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("userpooluicustomizations").
...
func (c *userPoolUiCustomizations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *userPoolUiCustomizations) Create(ctx context.Context, userPoolUiCustomization *v1alpha1.UserPoolUiCustomization, opts v1.CreateOptions) (result *v1alpha1.UserPoolUiCustomization, err error) {
	result = &v1alpha1.UserPoolUiCustomization{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("userpooluicustomizations").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(userPoolUiCustomization).
		Do(ctx).
		Into(result)
	return
}
...
func (c *userPoolUiCustomizations) Update(ctx context.Context, userPoolUiCustomization *v1alpha1.UserPoolUiCustomization, opts v1.UpdateOptions) (result *v1alpha1.UserPoolUiCustomization, err error) {
	result = &v1alpha1.UserPoolUiCustomization{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("userpooluicustomizations").
		Name(userPoolUiCustomization.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(userPoolUiCustomization).
		Do(ctx).
		Into(result)
...
func (c *userPoolUiCustomizations) UpdateStatus(ctx context.Context, userPoolUiCustomization *v1alpha1.UserPoolUiCustomization, opts v1.UpdateOptions) (result *v1alpha1.UserPoolUiCustomization, err error) {
	result = &v1alpha1.UserPoolUiCustomization{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("userpooluicustomizations").
...
func (c *userPoolUiCustomizations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *userPoolUiCustomizations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *userPoolUiCustomizations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.UserPoolUiCustomization, err error) {
	result = &v1alpha1.UserPoolUiCustomization{}
