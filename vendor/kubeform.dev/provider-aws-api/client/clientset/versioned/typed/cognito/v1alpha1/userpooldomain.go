...
// UserPoolDomainsGetter has a method to return a UserPoolDomainInterface.
...
// userPoolDomains implements UserPoolDomainInterface
type userPoolDomains struct {
	client rest.Interface
	ns     string
}

// newUserPoolDomains returns a UserPoolDomains
func newUserPoolDomains(c *CognitoV1alpha1Client, namespace string) *userPoolDomains {
	return &userPoolDomains{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *userPoolDomains) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.UserPoolDomain, err error) {
	result = &v1alpha1.UserPoolDomain{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *userPoolDomains) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.UserPoolDomainList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.UserPoolDomainList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("userpooldomains").
...
func (c *userPoolDomains) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *userPoolDomains) Create(ctx context.Context, userPoolDomain *v1alpha1.UserPoolDomain, opts v1.CreateOptions) (result *v1alpha1.UserPoolDomain, err error) {
	result = &v1alpha1.UserPoolDomain{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("userpooldomains").
...
func (c *userPoolDomains) Update(ctx context.Context, userPoolDomain *v1alpha1.UserPoolDomain, opts v1.UpdateOptions) (result *v1alpha1.UserPoolDomain, err error) {
	result = &v1alpha1.UserPoolDomain{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("userpooldomains").
...
func (c *userPoolDomains) UpdateStatus(ctx context.Context, userPoolDomain *v1alpha1.UserPoolDomain, opts v1.UpdateOptions) (result *v1alpha1.UserPoolDomain, err error) {
	result = &v1alpha1.UserPoolDomain{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("userpooldomains").
...
func (c *userPoolDomains) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *userPoolDomains) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *userPoolDomains) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.UserPoolDomain, err error) {
	result = &v1alpha1.UserPoolDomain{}
