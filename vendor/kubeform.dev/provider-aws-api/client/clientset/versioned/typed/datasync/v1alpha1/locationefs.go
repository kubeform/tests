...
// LocationEfsesGetter has a method to return a LocationEfsInterface.
...
// locationEfses implements LocationEfsInterface
type locationEfses struct {
	client rest.Interface
	ns     string
}

// newLocationEfses returns a LocationEfses
func newLocationEfses(c *DatasyncV1alpha1Client, namespace string) *locationEfses {
	return &locationEfses{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *locationEfses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LocationEfs, err error) {
	result = &v1alpha1.LocationEfs{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("locationefses").
		Name(name).
...
func (c *locationEfses) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LocationEfsList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.LocationEfsList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("locationefses").
...
func (c *locationEfses) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *locationEfses) Create(ctx context.Context, locationEfs *v1alpha1.LocationEfs, opts v1.CreateOptions) (result *v1alpha1.LocationEfs, err error) {
	result = &v1alpha1.LocationEfs{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("locationefses").
...
func (c *locationEfses) Update(ctx context.Context, locationEfs *v1alpha1.LocationEfs, opts v1.UpdateOptions) (result *v1alpha1.LocationEfs, err error) {
	result = &v1alpha1.LocationEfs{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("locationefses").
		Name(locationEfs.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(locationEfs).
		Do(ctx).
		Into(result)
...
func (c *locationEfses) UpdateStatus(ctx context.Context, locationEfs *v1alpha1.LocationEfs, opts v1.UpdateOptions) (result *v1alpha1.LocationEfs, err error) {
	result = &v1alpha1.LocationEfs{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("locationefses").
...
func (c *locationEfses) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *locationEfses) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *locationEfses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LocationEfs, err error) {
	result = &v1alpha1.LocationEfs{}
