...
type DatasyncV1alpha1Interface interface {
...
func NewForConfig(c *rest.Config) (*DatasyncV1alpha1Client, error) {
	...
	return &DatasyncV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new DatasyncV1alpha1Client for the given config and
...
func New(c rest.Interface) *DatasyncV1alpha1Client {
	return &DatasyncV1alpha1Client{c}
}
