...
func newDomainNames(c *ApigatewayV1alpha1Client, namespace string) *domainNames {
	return &domainNames{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *domainNames) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DomainName, err error) {
...
func (c *domainNames) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DomainNameList, err error) {
...
func (c *domainNames) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *domainNames) Create(ctx context.Context, domainName *v1alpha1.DomainName, opts v1.CreateOptions) (result *v1alpha1.DomainName, err error) {
	result = &v1alpha1.DomainName{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("domainnames").
...
func (c *domainNames) Update(ctx context.Context, domainName *v1alpha1.DomainName, opts v1.UpdateOptions) (result *v1alpha1.DomainName, err error) {
	result = &v1alpha1.DomainName{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("domainnames").
...
func (c *domainNames) UpdateStatus(ctx context.Context, domainName *v1alpha1.DomainName, opts v1.UpdateOptions) (result *v1alpha1.DomainName, err error) {
	result = &v1alpha1.DomainName{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("domainnames").
...
func (c *domainNames) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *domainNames) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *domainNames) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DomainName, err error) {
	result = &v1alpha1.DomainName{}
