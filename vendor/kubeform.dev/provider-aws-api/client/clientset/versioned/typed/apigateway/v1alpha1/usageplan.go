...
func (c *usagePlans) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.UsagePlan, err error) {
...
func (c *usagePlans) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.UsagePlanList, err error) {
...
func (c *usagePlans) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *usagePlans) Create(ctx context.Context, usagePlan *v1alpha1.UsagePlan, opts v1.CreateOptions) (result *v1alpha1.UsagePlan, err error) {
	result = &v1alpha1.UsagePlan{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("usageplans").
...
func (c *usagePlans) Update(ctx context.Context, usagePlan *v1alpha1.UsagePlan, opts v1.UpdateOptions) (result *v1alpha1.UsagePlan, err error) {
	result = &v1alpha1.UsagePlan{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("usageplans").
...
func (c *usagePlans) UpdateStatus(ctx context.Context, usagePlan *v1alpha1.UsagePlan, opts v1.UpdateOptions) (result *v1alpha1.UsagePlan, err error) {
	result = &v1alpha1.UsagePlan{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("usageplans").
...
func (c *usagePlans) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *usagePlans) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *usagePlans) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.UsagePlan, err error) {
	result = &v1alpha1.UsagePlan{}
