...
func (c *apigatewayResources) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ApigatewayResource, err error) {
...
func (c *apigatewayResources) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ApigatewayResourceList, err error) {
...
func (c *apigatewayResources) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *apigatewayResources) Create(ctx context.Context, apigatewayResource *v1alpha1.ApigatewayResource, opts v1.CreateOptions) (result *v1alpha1.ApigatewayResource, err error) {
	result = &v1alpha1.ApigatewayResource{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("apigatewayresources").
...
func (c *apigatewayResources) Update(ctx context.Context, apigatewayResource *v1alpha1.ApigatewayResource, opts v1.UpdateOptions) (result *v1alpha1.ApigatewayResource, err error) {
	result = &v1alpha1.ApigatewayResource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apigatewayresources").
...
func (c *apigatewayResources) UpdateStatus(ctx context.Context, apigatewayResource *v1alpha1.ApigatewayResource, opts v1.UpdateOptions) (result *v1alpha1.ApigatewayResource, err error) {
	result = &v1alpha1.ApigatewayResource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apigatewayresources").
...
func (c *apigatewayResources) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *apigatewayResources) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *apigatewayResources) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ApigatewayResource, err error) {
	result = &v1alpha1.ApigatewayResource{}
