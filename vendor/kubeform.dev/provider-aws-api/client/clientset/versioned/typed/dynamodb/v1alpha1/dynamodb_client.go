...
type DynamodbV1alpha1Interface interface {
...
func (c *DynamodbV1alpha1Client) GlobalTables(namespace string) GlobalTableInterface {
	return newGlobalTables(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*DynamodbV1alpha1Client, error) {
	...
	return &DynamodbV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new DynamodbV1alpha1Client for the given config and
...
func New(c rest.Interface) *DynamodbV1alpha1Client {
	return &DynamodbV1alpha1Client{c}
}
