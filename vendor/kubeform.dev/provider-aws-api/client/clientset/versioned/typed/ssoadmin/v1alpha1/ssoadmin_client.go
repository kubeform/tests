...
type SsoadminV1alpha1Interface interface {
	RESTClient() rest.Interface
	AccountAssignmentsGetter
	ManagedPolicyAttachmentsGetter
	PermissionSetsGetter
	PermissionSetInlinePoliciesGetter
}
...
func NewForConfig(c *rest.Config) (*SsoadminV1alpha1Client, error) {
	...
	return &SsoadminV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new SsoadminV1alpha1Client for the given config and
...
func New(c rest.Interface) *SsoadminV1alpha1Client {
	return &SsoadminV1alpha1Client{c}
}
