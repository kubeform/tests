...
func NewForConfig(c *rest.Config) (*AthenaV1alpha1Client, error) {
	...
	return &AthenaV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new AthenaV1alpha1Client for the given config and
...
func New(c rest.Interface) *AthenaV1alpha1Client {
	return &AthenaV1alpha1Client{c}
}
