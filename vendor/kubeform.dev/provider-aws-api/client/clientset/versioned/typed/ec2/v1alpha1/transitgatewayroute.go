...
func (c *transitGatewayRoutes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TransitGatewayRoute, err error) {
...
func (c *transitGatewayRoutes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TransitGatewayRouteList, err error) {
...
func (c *transitGatewayRoutes) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *transitGatewayRoutes) Create(ctx context.Context, transitGatewayRoute *v1alpha1.TransitGatewayRoute, opts v1.CreateOptions) (result *v1alpha1.TransitGatewayRoute, err error) {
	result = &v1alpha1.TransitGatewayRoute{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("transitgatewayroutes").
...
func (c *transitGatewayRoutes) Update(ctx context.Context, transitGatewayRoute *v1alpha1.TransitGatewayRoute, opts v1.UpdateOptions) (result *v1alpha1.TransitGatewayRoute, err error) {
	result = &v1alpha1.TransitGatewayRoute{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("transitgatewayroutes").
...
func (c *transitGatewayRoutes) UpdateStatus(ctx context.Context, transitGatewayRoute *v1alpha1.TransitGatewayRoute, opts v1.UpdateOptions) (result *v1alpha1.TransitGatewayRoute, err error) {
	result = &v1alpha1.TransitGatewayRoute{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("transitgatewayroutes").
...
func (c *transitGatewayRoutes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *transitGatewayRoutes) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *transitGatewayRoutes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TransitGatewayRoute, err error) {
	result = &v1alpha1.TransitGatewayRoute{}
