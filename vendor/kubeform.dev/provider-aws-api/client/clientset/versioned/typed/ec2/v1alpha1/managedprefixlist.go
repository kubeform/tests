...
// ManagedPrefixListsGetter has a method to return a ManagedPrefixListInterface.
...
// managedPrefixLists implements ManagedPrefixListInterface
type managedPrefixLists struct {
	client rest.Interface
	ns     string
}

// newManagedPrefixLists returns a ManagedPrefixLists
func newManagedPrefixLists(c *Ec2V1alpha1Client, namespace string) *managedPrefixLists {
...
func (c *managedPrefixLists) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ManagedPrefixList, err error) {
	result = &v1alpha1.ManagedPrefixList{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *managedPrefixLists) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ManagedPrefixListList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ManagedPrefixListList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("managedprefixlists").
...
func (c *managedPrefixLists) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *managedPrefixLists) Create(ctx context.Context, managedPrefixList *v1alpha1.ManagedPrefixList, opts v1.CreateOptions) (result *v1alpha1.ManagedPrefixList, err error) {
	result = &v1alpha1.ManagedPrefixList{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("managedprefixlists").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(managedPrefixList).
		Do(ctx).
		Into(result)
	return
}
...
func (c *managedPrefixLists) Update(ctx context.Context, managedPrefixList *v1alpha1.ManagedPrefixList, opts v1.UpdateOptions) (result *v1alpha1.ManagedPrefixList, err error) {
	result = &v1alpha1.ManagedPrefixList{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("managedprefixlists").
		Name(managedPrefixList.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(managedPrefixList).
		Do(ctx).
		Into(result)
...
func (c *managedPrefixLists) UpdateStatus(ctx context.Context, managedPrefixList *v1alpha1.ManagedPrefixList, opts v1.UpdateOptions) (result *v1alpha1.ManagedPrefixList, err error) {
	result = &v1alpha1.ManagedPrefixList{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("managedprefixlists").
...
func (c *managedPrefixLists) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *managedPrefixLists) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *managedPrefixLists) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ManagedPrefixList, err error) {
	result = &v1alpha1.ManagedPrefixList{}
