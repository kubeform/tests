...
func (c *transitGateways) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TransitGateway, err error) {
...
func (c *transitGateways) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TransitGatewayList, err error) {
...
func (c *transitGateways) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *transitGateways) Create(ctx context.Context, transitGateway *v1alpha1.TransitGateway, opts v1.CreateOptions) (result *v1alpha1.TransitGateway, err error) {
	result = &v1alpha1.TransitGateway{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("transitgateways").
...
func (c *transitGateways) Update(ctx context.Context, transitGateway *v1alpha1.TransitGateway, opts v1.UpdateOptions) (result *v1alpha1.TransitGateway, err error) {
	result = &v1alpha1.TransitGateway{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("transitgateways").
...
func (c *transitGateways) UpdateStatus(ctx context.Context, transitGateway *v1alpha1.TransitGateway, opts v1.UpdateOptions) (result *v1alpha1.TransitGateway, err error) {
	result = &v1alpha1.TransitGateway{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("transitgateways").
...
func (c *transitGateways) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *transitGateways) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *transitGateways) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TransitGateway, err error) {
	result = &v1alpha1.TransitGateway{}
