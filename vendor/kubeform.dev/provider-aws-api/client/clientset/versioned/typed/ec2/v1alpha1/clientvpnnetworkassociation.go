...
// ClientVPNNetworkAssociationsGetter has a method to return a ClientVPNNetworkAssociationInterface.
...
// clientVPNNetworkAssociations implements ClientVPNNetworkAssociationInterface
type clientVPNNetworkAssociations struct {
	client rest.Interface
	ns     string
}

// newClientVPNNetworkAssociations returns a ClientVPNNetworkAssociations
func newClientVPNNetworkAssociations(c *Ec2V1alpha1Client, namespace string) *clientVPNNetworkAssociations {
	return &clientVPNNetworkAssociations{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *clientVPNNetworkAssociations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ClientVPNNetworkAssociation, err error) {
	result = &v1alpha1.ClientVPNNetworkAssociation{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *clientVPNNetworkAssociations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ClientVPNNetworkAssociationList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ClientVPNNetworkAssociationList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("clientvpnnetworkassociations").
...
func (c *clientVPNNetworkAssociations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *clientVPNNetworkAssociations) Create(ctx context.Context, clientVPNNetworkAssociation *v1alpha1.ClientVPNNetworkAssociation, opts v1.CreateOptions) (result *v1alpha1.ClientVPNNetworkAssociation, err error) {
	result = &v1alpha1.ClientVPNNetworkAssociation{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("clientvpnnetworkassociations").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(clientVPNNetworkAssociation).
		Do(ctx).
		Into(result)
	return
}
...
func (c *clientVPNNetworkAssociations) Update(ctx context.Context, clientVPNNetworkAssociation *v1alpha1.ClientVPNNetworkAssociation, opts v1.UpdateOptions) (result *v1alpha1.ClientVPNNetworkAssociation, err error) {
	result = &v1alpha1.ClientVPNNetworkAssociation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("clientvpnnetworkassociations").
		Name(clientVPNNetworkAssociation.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(clientVPNNetworkAssociation).
		Do(ctx).
		Into(result)
...
func (c *clientVPNNetworkAssociations) UpdateStatus(ctx context.Context, clientVPNNetworkAssociation *v1alpha1.ClientVPNNetworkAssociation, opts v1.UpdateOptions) (result *v1alpha1.ClientVPNNetworkAssociation, err error) {
	result = &v1alpha1.ClientVPNNetworkAssociation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("clientvpnnetworkassociations").
...
func (c *clientVPNNetworkAssociations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *clientVPNNetworkAssociations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *clientVPNNetworkAssociations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ClientVPNNetworkAssociation, err error) {
	result = &v1alpha1.ClientVPNNetworkAssociation{}
