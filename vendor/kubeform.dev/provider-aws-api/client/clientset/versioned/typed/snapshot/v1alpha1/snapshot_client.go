...
type SnapshotV1alpha1Interface interface {
	...
	CreateVolumePermissionsGetter
}

// SnapshotV1alpha1Client is used to interact with features provided by the snapshot.aws.kubeform.com group.
type SnapshotV1alpha1Client struct {
	restClient rest.Interface
}

func (c *SnapshotV1alpha1Client) CreateVolumePermissions(namespace string) CreateVolumePermissionInterface {
	return newCreateVolumePermissions(c, namespace)
}
