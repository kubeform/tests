...
type DocdbV1alpha1Interface interface {
...
func NewForConfig(c *rest.Config) (*DocdbV1alpha1Client, error) {
	...
	return &DocdbV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new DocdbV1alpha1Client for the given config and
...
func New(c rest.Interface) *DocdbV1alpha1Client {
	return &DocdbV1alpha1Client{c}
}
