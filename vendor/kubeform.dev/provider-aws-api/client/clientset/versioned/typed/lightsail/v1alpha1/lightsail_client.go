...
type LightsailV1alpha1Interface interface {
	RESTClient() rest.Interface
	DomainsGetter
	InstancesGetter
	InstancePublicPortsesGetter
	KeyPairsGetter
	StaticIPsGetter
	StaticIPAttachmentsGetter
}
...
func (c *LightsailV1alpha1Client) InstancePublicPortses(namespace string) InstancePublicPortsInterface {
	return newInstancePublicPortses(c, namespace)
}
...
func (c *LightsailV1alpha1Client) StaticIPAttachments(namespace string) StaticIPAttachmentInterface {
	return newStaticIPAttachments(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*LightsailV1alpha1Client, error) {
	...
	return &LightsailV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new LightsailV1alpha1Client for the given config and
...
func New(c rest.Interface) *LightsailV1alpha1Client {
	return &LightsailV1alpha1Client{c}
}
