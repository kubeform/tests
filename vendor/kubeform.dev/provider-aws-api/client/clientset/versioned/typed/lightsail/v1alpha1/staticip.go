...
func newStaticIPs(c *LightsailV1alpha1Client, namespace string) *staticIPs {
	return &staticIPs{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *staticIPs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.StaticIP, err error) {
	result = &v1alpha1.StaticIP{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("staticips").
		Name(name).
...
func (c *staticIPs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.StaticIPList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.StaticIPList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("staticips").
...
func (c *staticIPs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *staticIPs) Create(ctx context.Context, staticIP *v1alpha1.StaticIP, opts v1.CreateOptions) (result *v1alpha1.StaticIP, err error) {
	result = &v1alpha1.StaticIP{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("staticips").
...
func (c *staticIPs) Update(ctx context.Context, staticIP *v1alpha1.StaticIP, opts v1.UpdateOptions) (result *v1alpha1.StaticIP, err error) {
	result = &v1alpha1.StaticIP{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("staticips").
...
func (c *staticIPs) UpdateStatus(ctx context.Context, staticIP *v1alpha1.StaticIP, opts v1.UpdateOptions) (result *v1alpha1.StaticIP, err error) {
	result = &v1alpha1.StaticIP{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("staticips").
...
func (c *staticIPs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *staticIPs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *staticIPs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.StaticIP, err error) {
	result = &v1alpha1.StaticIP{}
