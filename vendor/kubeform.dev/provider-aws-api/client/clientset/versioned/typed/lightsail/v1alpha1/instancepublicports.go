...
// InstancePublicPortsesGetter has a method to return a InstancePublicPortsInterface.
...
// instancePublicPortses implements InstancePublicPortsInterface
type instancePublicPortses struct {
	client rest.Interface
	ns     string
}

// newInstancePublicPortses returns a InstancePublicPortses
func newInstancePublicPortses(c *LightsailV1alpha1Client, namespace string) *instancePublicPortses {
	return &instancePublicPortses{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *instancePublicPortses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.InstancePublicPorts, err error) {
	result = &v1alpha1.InstancePublicPorts{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("instancepublicportses").
		Name(name).
...
func (c *instancePublicPortses) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.InstancePublicPortsList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.InstancePublicPortsList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("instancepublicportses").
...
func (c *instancePublicPortses) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *instancePublicPortses) Create(ctx context.Context, instancePublicPorts *v1alpha1.InstancePublicPorts, opts v1.CreateOptions) (result *v1alpha1.InstancePublicPorts, err error) {
	result = &v1alpha1.InstancePublicPorts{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("instancepublicportses").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(instancePublicPorts).
		Do(ctx).
		Into(result)
	return
}
...
func (c *instancePublicPortses) Update(ctx context.Context, instancePublicPorts *v1alpha1.InstancePublicPorts, opts v1.UpdateOptions) (result *v1alpha1.InstancePublicPorts, err error) {
	result = &v1alpha1.InstancePublicPorts{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("instancepublicportses").
		Name(instancePublicPorts.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(instancePublicPorts).
		Do(ctx).
		Into(result)
...
func (c *instancePublicPortses) UpdateStatus(ctx context.Context, instancePublicPorts *v1alpha1.InstancePublicPorts, opts v1.UpdateOptions) (result *v1alpha1.InstancePublicPorts, err error) {
	result = &v1alpha1.InstancePublicPorts{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("instancepublicportses").
...
func (c *instancePublicPortses) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *instancePublicPortses) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *instancePublicPortses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.InstancePublicPorts, err error) {
	result = &v1alpha1.InstancePublicPorts{}
