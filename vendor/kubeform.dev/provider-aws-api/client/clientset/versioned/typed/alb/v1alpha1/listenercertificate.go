...
func newListenerCertificates(c *AlbV1alpha1Client, namespace string) *listenerCertificates {
...
func (c *listenerCertificates) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ListenerCertificate, err error) {
...
func (c *listenerCertificates) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ListenerCertificateList, err error) {
...
func (c *listenerCertificates) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *listenerCertificates) Create(ctx context.Context, listenerCertificate *v1alpha1.ListenerCertificate, opts v1.CreateOptions) (result *v1alpha1.ListenerCertificate, err error) {
	result = &v1alpha1.ListenerCertificate{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("listenercertificates").
...
func (c *listenerCertificates) Update(ctx context.Context, listenerCertificate *v1alpha1.ListenerCertificate, opts v1.UpdateOptions) (result *v1alpha1.ListenerCertificate, err error) {
	result = &v1alpha1.ListenerCertificate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("listenercertificates").
...
func (c *listenerCertificates) UpdateStatus(ctx context.Context, listenerCertificate *v1alpha1.ListenerCertificate, opts v1.UpdateOptions) (result *v1alpha1.ListenerCertificate, err error) {
	result = &v1alpha1.ListenerCertificate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("listenercertificates").
...
func (c *listenerCertificates) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *listenerCertificates) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *listenerCertificates) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ListenerCertificate, err error) {
	result = &v1alpha1.ListenerCertificate{}
