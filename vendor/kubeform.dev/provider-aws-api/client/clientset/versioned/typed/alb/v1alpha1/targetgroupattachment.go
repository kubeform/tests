...
// TargetGroupAttachmentsGetter has a method to return a TargetGroupAttachmentInterface.
...
// targetGroupAttachments implements TargetGroupAttachmentInterface
type targetGroupAttachments struct {
	client rest.Interface
	ns     string
}

// newTargetGroupAttachments returns a TargetGroupAttachments
func newTargetGroupAttachments(c *AlbV1alpha1Client, namespace string) *targetGroupAttachments {
	return &targetGroupAttachments{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *targetGroupAttachments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TargetGroupAttachment, err error) {
	result = &v1alpha1.TargetGroupAttachment{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *targetGroupAttachments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TargetGroupAttachmentList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.TargetGroupAttachmentList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("targetgroupattachments").
...
func (c *targetGroupAttachments) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *targetGroupAttachments) Create(ctx context.Context, targetGroupAttachment *v1alpha1.TargetGroupAttachment, opts v1.CreateOptions) (result *v1alpha1.TargetGroupAttachment, err error) {
	result = &v1alpha1.TargetGroupAttachment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("targetgroupattachments").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(targetGroupAttachment).
		Do(ctx).
		Into(result)
	return
}
...
func (c *targetGroupAttachments) Update(ctx context.Context, targetGroupAttachment *v1alpha1.TargetGroupAttachment, opts v1.UpdateOptions) (result *v1alpha1.TargetGroupAttachment, err error) {
	result = &v1alpha1.TargetGroupAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("targetgroupattachments").
		Name(targetGroupAttachment.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(targetGroupAttachment).
		Do(ctx).
		Into(result)
...
func (c *targetGroupAttachments) UpdateStatus(ctx context.Context, targetGroupAttachment *v1alpha1.TargetGroupAttachment, opts v1.UpdateOptions) (result *v1alpha1.TargetGroupAttachment, err error) {
	result = &v1alpha1.TargetGroupAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("targetgroupattachments").
...
func (c *targetGroupAttachments) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *targetGroupAttachments) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *targetGroupAttachments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TargetGroupAttachment, err error) {
	result = &v1alpha1.TargetGroupAttachment{}
