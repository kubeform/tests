...
func newListenerRules(c *AlbV1alpha1Client, namespace string) *listenerRules {
...
func (c *listenerRules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ListenerRule, err error) {
...
func (c *listenerRules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ListenerRuleList, err error) {
...
func (c *listenerRules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *listenerRules) Create(ctx context.Context, listenerRule *v1alpha1.ListenerRule, opts v1.CreateOptions) (result *v1alpha1.ListenerRule, err error) {
	result = &v1alpha1.ListenerRule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("listenerrules").
...
func (c *listenerRules) Update(ctx context.Context, listenerRule *v1alpha1.ListenerRule, opts v1.UpdateOptions) (result *v1alpha1.ListenerRule, err error) {
	result = &v1alpha1.ListenerRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("listenerrules").
...
func (c *listenerRules) UpdateStatus(ctx context.Context, listenerRule *v1alpha1.ListenerRule, opts v1.UpdateOptions) (result *v1alpha1.ListenerRule, err error) {
	result = &v1alpha1.ListenerRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("listenerrules").
...
func (c *listenerRules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *listenerRules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *listenerRules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ListenerRule, err error) {
	result = &v1alpha1.ListenerRule{}
