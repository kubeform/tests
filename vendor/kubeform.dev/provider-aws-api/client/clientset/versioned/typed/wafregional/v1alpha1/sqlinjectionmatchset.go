...
func newSqlInjectionMatchSets(c *WafregionalV1alpha1Client, namespace string) *sqlInjectionMatchSets {
...
func (c *sqlInjectionMatchSets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SqlInjectionMatchSet, err error) {
...
func (c *sqlInjectionMatchSets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SqlInjectionMatchSetList, err error) {
...
func (c *sqlInjectionMatchSets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *sqlInjectionMatchSets) Create(ctx context.Context, sqlInjectionMatchSet *v1alpha1.SqlInjectionMatchSet, opts v1.CreateOptions) (result *v1alpha1.SqlInjectionMatchSet, err error) {
	result = &v1alpha1.SqlInjectionMatchSet{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("sqlinjectionmatchsets").
...
func (c *sqlInjectionMatchSets) Update(ctx context.Context, sqlInjectionMatchSet *v1alpha1.SqlInjectionMatchSet, opts v1.UpdateOptions) (result *v1alpha1.SqlInjectionMatchSet, err error) {
	result = &v1alpha1.SqlInjectionMatchSet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sqlinjectionmatchsets").
...
func (c *sqlInjectionMatchSets) UpdateStatus(ctx context.Context, sqlInjectionMatchSet *v1alpha1.SqlInjectionMatchSet, opts v1.UpdateOptions) (result *v1alpha1.SqlInjectionMatchSet, err error) {
	result = &v1alpha1.SqlInjectionMatchSet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sqlinjectionmatchsets").
...
func (c *sqlInjectionMatchSets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *sqlInjectionMatchSets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *sqlInjectionMatchSets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SqlInjectionMatchSet, err error) {
	result = &v1alpha1.SqlInjectionMatchSet{}
