...
// RegexMatchSetsGetter has a method to return a RegexMatchSetInterface.
...
// regexMatchSets implements RegexMatchSetInterface
type regexMatchSets struct {
	client rest.Interface
	ns     string
}

// newRegexMatchSets returns a RegexMatchSets
func newRegexMatchSets(c *WafregionalV1alpha1Client, namespace string) *regexMatchSets {
...
func (c *regexMatchSets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.RegexMatchSet, err error) {
	result = &v1alpha1.RegexMatchSet{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *regexMatchSets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RegexMatchSetList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.RegexMatchSetList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("regexmatchsets").
...
func (c *regexMatchSets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *regexMatchSets) Create(ctx context.Context, regexMatchSet *v1alpha1.RegexMatchSet, opts v1.CreateOptions) (result *v1alpha1.RegexMatchSet, err error) {
	result = &v1alpha1.RegexMatchSet{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("regexmatchsets").
...
func (c *regexMatchSets) Update(ctx context.Context, regexMatchSet *v1alpha1.RegexMatchSet, opts v1.UpdateOptions) (result *v1alpha1.RegexMatchSet, err error) {
	result = &v1alpha1.RegexMatchSet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("regexmatchsets").
...
func (c *regexMatchSets) UpdateStatus(ctx context.Context, regexMatchSet *v1alpha1.RegexMatchSet, opts v1.UpdateOptions) (result *v1alpha1.RegexMatchSet, err error) {
	result = &v1alpha1.RegexMatchSet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("regexmatchsets").
...
func (c *regexMatchSets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *regexMatchSets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *regexMatchSets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.RegexMatchSet, err error) {
	result = &v1alpha1.RegexMatchSet{}
