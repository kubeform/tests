...
func (c *LicensemanagerV1alpha1Client) LicenseConfigurations(namespace string) LicenseConfigurationInterface {
	return newLicenseConfigurations(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*LicensemanagerV1alpha1Client, error) {
	...
	return &LicensemanagerV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new LicensemanagerV1alpha1Client for the given config and
...
func New(c rest.Interface) *LicensemanagerV1alpha1Client {
	return &LicensemanagerV1alpha1Client{c}
}
...
func (c *LicensemanagerV1alpha1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
