...
func (c *replicationSubnetGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ReplicationSubnetGroup, err error) {
...
func (c *replicationSubnetGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ReplicationSubnetGroupList, err error) {
...
func (c *replicationSubnetGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *replicationSubnetGroups) Create(ctx context.Context, replicationSubnetGroup *v1alpha1.ReplicationSubnetGroup, opts v1.CreateOptions) (result *v1alpha1.ReplicationSubnetGroup, err error) {
	result = &v1alpha1.ReplicationSubnetGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("replicationsubnetgroups").
...
func (c *replicationSubnetGroups) Update(ctx context.Context, replicationSubnetGroup *v1alpha1.ReplicationSubnetGroup, opts v1.UpdateOptions) (result *v1alpha1.ReplicationSubnetGroup, err error) {
	result = &v1alpha1.ReplicationSubnetGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("replicationsubnetgroups").
...
func (c *replicationSubnetGroups) UpdateStatus(ctx context.Context, replicationSubnetGroup *v1alpha1.ReplicationSubnetGroup, opts v1.UpdateOptions) (result *v1alpha1.ReplicationSubnetGroup, err error) {
	result = &v1alpha1.ReplicationSubnetGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("replicationsubnetgroups").
...
func (c *replicationSubnetGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *replicationSubnetGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *replicationSubnetGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ReplicationSubnetGroup, err error) {
	result = &v1alpha1.ReplicationSubnetGroup{}
