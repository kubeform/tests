...
func NewForConfig(c *rest.Config) (*DevicefarmV1alpha1Client, error) {
	...
	return &DevicefarmV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new DevicefarmV1alpha1Client for the given config and
...
func New(c rest.Interface) *DevicefarmV1alpha1Client {
	return &DevicefarmV1alpha1Client{c}
}
