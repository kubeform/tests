...
// FargateProfilesGetter has a method to return a FargateProfileInterface.
...
// fargateProfiles implements FargateProfileInterface
type fargateProfiles struct {
	client rest.Interface
	ns     string
}

// newFargateProfiles returns a FargateProfiles
func newFargateProfiles(c *EksV1alpha1Client, namespace string) *fargateProfiles {
...
func (c *fargateProfiles) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.FargateProfile, err error) {
...
func (c *fargateProfiles) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FargateProfileList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.FargateProfileList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("fargateprofiles").
...
func (c *fargateProfiles) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *fargateProfiles) Create(ctx context.Context, fargateProfile *v1alpha1.FargateProfile, opts v1.CreateOptions) (result *v1alpha1.FargateProfile, err error) {
	result = &v1alpha1.FargateProfile{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("fargateprofiles").
...
func (c *fargateProfiles) Update(ctx context.Context, fargateProfile *v1alpha1.FargateProfile, opts v1.UpdateOptions) (result *v1alpha1.FargateProfile, err error) {
	result = &v1alpha1.FargateProfile{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("fargateprofiles").
		Name(fargateProfile.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(fargateProfile).
		Do(ctx).
		Into(result)
...
func (c *fargateProfiles) UpdateStatus(ctx context.Context, fargateProfile *v1alpha1.FargateProfile, opts v1.UpdateOptions) (result *v1alpha1.FargateProfile, err error) {
	result = &v1alpha1.FargateProfile{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("fargateprofiles").
...
func (c *fargateProfiles) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *fargateProfiles) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *fargateProfiles) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.FargateProfile, err error) {
	result = &v1alpha1.FargateProfile{}
