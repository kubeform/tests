...
func (c *apiMappings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ApiMapping, err error) {
...
func (c *apiMappings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ApiMappingList, err error) {
...
func (c *apiMappings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *apiMappings) Create(ctx context.Context, apiMapping *v1alpha1.ApiMapping, opts v1.CreateOptions) (result *v1alpha1.ApiMapping, err error) {
	result = &v1alpha1.ApiMapping{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("apimappings").
...
func (c *apiMappings) Update(ctx context.Context, apiMapping *v1alpha1.ApiMapping, opts v1.UpdateOptions) (result *v1alpha1.ApiMapping, err error) {
	result = &v1alpha1.ApiMapping{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apimappings").
...
func (c *apiMappings) UpdateStatus(ctx context.Context, apiMapping *v1alpha1.ApiMapping, opts v1.UpdateOptions) (result *v1alpha1.ApiMapping, err error) {
	result = &v1alpha1.ApiMapping{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apimappings").
...
func (c *apiMappings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *apiMappings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *apiMappings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ApiMapping, err error) {
	result = &v1alpha1.ApiMapping{}
