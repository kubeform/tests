...
// VpcLinksGetter has a method to return a VpcLinkInterface.
...
// vpcLinks implements VpcLinkInterface
type vpcLinks struct {
	client rest.Interface
	ns     string
}

// newVpcLinks returns a VpcLinks
func newVpcLinks(c *Apigatewayv2V1alpha1Client, namespace string) *vpcLinks {
	return &vpcLinks{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *vpcLinks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.VpcLink, err error) {
	result = &v1alpha1.VpcLink{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("vpclinks").
		Name(name).
...
func (c *vpcLinks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.VpcLinkList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.VpcLinkList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("vpclinks").
...
func (c *vpcLinks) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *vpcLinks) Create(ctx context.Context, vpcLink *v1alpha1.VpcLink, opts v1.CreateOptions) (result *v1alpha1.VpcLink, err error) {
	result = &v1alpha1.VpcLink{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("vpclinks").
...
func (c *vpcLinks) Update(ctx context.Context, vpcLink *v1alpha1.VpcLink, opts v1.UpdateOptions) (result *v1alpha1.VpcLink, err error) {
	result = &v1alpha1.VpcLink{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vpclinks").
...
func (c *vpcLinks) UpdateStatus(ctx context.Context, vpcLink *v1alpha1.VpcLink, opts v1.UpdateOptions) (result *v1alpha1.VpcLink, err error) {
	result = &v1alpha1.VpcLink{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vpclinks").
...
func (c *vpcLinks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *vpcLinks) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *vpcLinks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.VpcLink, err error) {
	result = &v1alpha1.VpcLink{}
