...
type KinesisV1alpha1Interface interface {
	RESTClient() rest.Interface
	AnalyticsApplicationsGetter
	FirehoseDeliveryStreamsGetter
	StreamsGetter
	StreamConsumersGetter
	VideoStreamsGetter
}
...
func NewForConfig(c *rest.Config) (*KinesisV1alpha1Client, error) {
	...
	return &KinesisV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new KinesisV1alpha1Client for the given config and
...
func New(c rest.Interface) *KinesisV1alpha1Client {
	return &KinesisV1alpha1Client{c}
}
