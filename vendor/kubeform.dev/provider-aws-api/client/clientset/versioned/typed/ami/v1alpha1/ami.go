...
func newAmis(c *AmiV1alpha1Client, namespace string) *amis {
	return &amis{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *amis) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Ami, err error) {
	result = &v1alpha1.Ami{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("amis").
...
func (c *amis) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AmiList, err error) {
...
func (c *amis) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *amis) Create(ctx context.Context, ami *v1alpha1.Ami, opts v1.CreateOptions) (result *v1alpha1.Ami, err error) {
	result = &v1alpha1.Ami{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("amis").
...
func (c *amis) Update(ctx context.Context, ami *v1alpha1.Ami, opts v1.UpdateOptions) (result *v1alpha1.Ami, err error) {
	result = &v1alpha1.Ami{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("amis").
...
func (c *amis) UpdateStatus(ctx context.Context, ami *v1alpha1.Ami, opts v1.UpdateOptions) (result *v1alpha1.Ami, err error) {
	result = &v1alpha1.Ami{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("amis").
...
func (c *amis) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *amis) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *amis) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Ami, err error) {
	result = &v1alpha1.Ami{}
