...
// TapePoolsGetter has a method to return a TapePoolInterface.
...
// tapePools implements TapePoolInterface
type tapePools struct {
	client rest.Interface
	ns     string
}

// newTapePools returns a TapePools
func newTapePools(c *StoragegatewayV1alpha1Client, namespace string) *tapePools {
	return &tapePools{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *tapePools) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TapePool, err error) {
	result = &v1alpha1.TapePool{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("tapepools").
		Name(name).
...
func (c *tapePools) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TapePoolList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.TapePoolList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("tapepools").
...
func (c *tapePools) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *tapePools) Create(ctx context.Context, tapePool *v1alpha1.TapePool, opts v1.CreateOptions) (result *v1alpha1.TapePool, err error) {
	result = &v1alpha1.TapePool{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("tapepools").
...
func (c *tapePools) Update(ctx context.Context, tapePool *v1alpha1.TapePool, opts v1.UpdateOptions) (result *v1alpha1.TapePool, err error) {
	result = &v1alpha1.TapePool{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tapepools").
...
func (c *tapePools) UpdateStatus(ctx context.Context, tapePool *v1alpha1.TapePool, opts v1.UpdateOptions) (result *v1alpha1.TapePool, err error) {
	result = &v1alpha1.TapePool{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tapepools").
...
func (c *tapePools) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *tapePools) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *tapePools) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TapePool, err error) {
	result = &v1alpha1.TapePool{}
