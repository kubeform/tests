...
type PinpointV1alpha1Interface interface {
	RESTClient() rest.Interface
	AdmChannelsGetter
	ApnsChannelsGetter
	ApnsSandboxChannelsGetter
	ApnsVoipChannelsGetter
	ApnsVoipSandboxChannelsGetter
	AppsGetter
	BaiduChannelsGetter
	EmailChannelsGetter
	EventStreamsGetter
...
func NewForConfig(c *rest.Config) (*PinpointV1alpha1Client, error) {
	...
	return &PinpointV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new PinpointV1alpha1Client for the given config and
...
func New(c rest.Interface) *PinpointV1alpha1Client {
	return &PinpointV1alpha1Client{c}
}
