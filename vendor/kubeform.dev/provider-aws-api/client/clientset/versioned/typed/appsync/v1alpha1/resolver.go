...
func (c *resolvers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Resolver, err error) {
...
func (c *resolvers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ResolverList, err error) {
...
func (c *resolvers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *resolvers) Create(ctx context.Context, resolver *v1alpha1.Resolver, opts v1.CreateOptions) (result *v1alpha1.Resolver, err error) {
	result = &v1alpha1.Resolver{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("resolvers").
...
func (c *resolvers) Update(ctx context.Context, resolver *v1alpha1.Resolver, opts v1.UpdateOptions) (result *v1alpha1.Resolver, err error) {
	result = &v1alpha1.Resolver{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("resolvers").
...
func (c *resolvers) UpdateStatus(ctx context.Context, resolver *v1alpha1.Resolver, opts v1.UpdateOptions) (result *v1alpha1.Resolver, err error) {
	result = &v1alpha1.Resolver{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("resolvers").
...
func (c *resolvers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *resolvers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *resolvers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Resolver, err error) {
	result = &v1alpha1.Resolver{}
