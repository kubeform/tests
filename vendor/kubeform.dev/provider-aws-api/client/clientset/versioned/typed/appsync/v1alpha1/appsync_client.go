...
func NewForConfig(c *rest.Config) (*AppsyncV1alpha1Client, error) {
	...
	return &AppsyncV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new AppsyncV1alpha1Client for the given config and
...
func New(c rest.Interface) *AppsyncV1alpha1Client {
	return &AppsyncV1alpha1Client{c}
}
