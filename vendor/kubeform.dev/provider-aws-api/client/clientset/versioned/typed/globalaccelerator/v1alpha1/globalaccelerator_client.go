...
type GlobalacceleratorV1alpha1Interface interface {
...
func NewForConfig(c *rest.Config) (*GlobalacceleratorV1alpha1Client, error) {
	...
	return &GlobalacceleratorV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new GlobalacceleratorV1alpha1Client for the given config and
...
func New(c rest.Interface) *GlobalacceleratorV1alpha1Client {
	return &GlobalacceleratorV1alpha1Client{c}
}
