...
func newCloudtrails(c *CloudtrailV1alpha1Client, namespace string) *cloudtrails {
	return &cloudtrails{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *cloudtrails) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Cloudtrail, err error) {
...
func (c *cloudtrails) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CloudtrailList, err error) {
...
func (c *cloudtrails) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cloudtrails) Create(ctx context.Context, cloudtrail *v1alpha1.Cloudtrail, opts v1.CreateOptions) (result *v1alpha1.Cloudtrail, err error) {
	result = &v1alpha1.Cloudtrail{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cloudtrails").
...
func (c *cloudtrails) Update(ctx context.Context, cloudtrail *v1alpha1.Cloudtrail, opts v1.UpdateOptions) (result *v1alpha1.Cloudtrail, err error) {
	result = &v1alpha1.Cloudtrail{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cloudtrails").
...
func (c *cloudtrails) UpdateStatus(ctx context.Context, cloudtrail *v1alpha1.Cloudtrail, opts v1.UpdateOptions) (result *v1alpha1.Cloudtrail, err error) {
	result = &v1alpha1.Cloudtrail{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cloudtrails").
...
func (c *cloudtrails) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *cloudtrails) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *cloudtrails) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Cloudtrail, err error) {
	result = &v1alpha1.Cloudtrail{}
