...
func NewForConfig(c *rest.Config) (*CloudtrailV1alpha1Client, error) {
	...
	return &CloudtrailV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new CloudtrailV1alpha1Client for the given config and
...
func New(c rest.Interface) *CloudtrailV1alpha1Client {
	return &CloudtrailV1alpha1Client{c}
}
