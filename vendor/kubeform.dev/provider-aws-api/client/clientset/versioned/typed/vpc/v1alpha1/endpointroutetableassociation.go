...
// EndpointRouteTableAssociationsGetter has a method to return a EndpointRouteTableAssociationInterface.
...
// endpointRouteTableAssociations implements EndpointRouteTableAssociationInterface
type endpointRouteTableAssociations struct {
	client rest.Interface
	ns     string
}

// newEndpointRouteTableAssociations returns a EndpointRouteTableAssociations
func newEndpointRouteTableAssociations(c *VpcV1alpha1Client, namespace string) *endpointRouteTableAssociations {
	return &endpointRouteTableAssociations{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *endpointRouteTableAssociations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.EndpointRouteTableAssociation, err error) {
	result = &v1alpha1.EndpointRouteTableAssociation{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *endpointRouteTableAssociations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EndpointRouteTableAssociationList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.EndpointRouteTableAssociationList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("endpointroutetableassociations").
...
func (c *endpointRouteTableAssociations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *endpointRouteTableAssociations) Create(ctx context.Context, endpointRouteTableAssociation *v1alpha1.EndpointRouteTableAssociation, opts v1.CreateOptions) (result *v1alpha1.EndpointRouteTableAssociation, err error) {
	result = &v1alpha1.EndpointRouteTableAssociation{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("endpointroutetableassociations").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(endpointRouteTableAssociation).
		Do(ctx).
		Into(result)
	return
}
...
func (c *endpointRouteTableAssociations) Update(ctx context.Context, endpointRouteTableAssociation *v1alpha1.EndpointRouteTableAssociation, opts v1.UpdateOptions) (result *v1alpha1.EndpointRouteTableAssociation, err error) {
	result = &v1alpha1.EndpointRouteTableAssociation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("endpointroutetableassociations").
		Name(endpointRouteTableAssociation.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(endpointRouteTableAssociation).
		Do(ctx).
		Into(result)
...
func (c *endpointRouteTableAssociations) UpdateStatus(ctx context.Context, endpointRouteTableAssociation *v1alpha1.EndpointRouteTableAssociation, opts v1.UpdateOptions) (result *v1alpha1.EndpointRouteTableAssociation, err error) {
	result = &v1alpha1.EndpointRouteTableAssociation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("endpointroutetableassociations").
...
func (c *endpointRouteTableAssociations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *endpointRouteTableAssociations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *endpointRouteTableAssociations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.EndpointRouteTableAssociation, err error) {
	result = &v1alpha1.EndpointRouteTableAssociation{}
