...
// PeeringConnectionAcceptersGetter has a method to return a PeeringConnectionAccepterInterface.
...
// peeringConnectionAccepters implements PeeringConnectionAccepterInterface
type peeringConnectionAccepters struct {
	client rest.Interface
	ns     string
}

// newPeeringConnectionAccepters returns a PeeringConnectionAccepters
func newPeeringConnectionAccepters(c *VpcV1alpha1Client, namespace string) *peeringConnectionAccepters {
	return &peeringConnectionAccepters{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *peeringConnectionAccepters) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.PeeringConnectionAccepter, err error) {
	result = &v1alpha1.PeeringConnectionAccepter{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *peeringConnectionAccepters) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PeeringConnectionAccepterList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.PeeringConnectionAccepterList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("peeringconnectionaccepters").
...
func (c *peeringConnectionAccepters) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *peeringConnectionAccepters) Create(ctx context.Context, peeringConnectionAccepter *v1alpha1.PeeringConnectionAccepter, opts v1.CreateOptions) (result *v1alpha1.PeeringConnectionAccepter, err error) {
	result = &v1alpha1.PeeringConnectionAccepter{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("peeringconnectionaccepters").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(peeringConnectionAccepter).
		Do(ctx).
		Into(result)
	return
}
...
func (c *peeringConnectionAccepters) Update(ctx context.Context, peeringConnectionAccepter *v1alpha1.PeeringConnectionAccepter, opts v1.UpdateOptions) (result *v1alpha1.PeeringConnectionAccepter, err error) {
	result = &v1alpha1.PeeringConnectionAccepter{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("peeringconnectionaccepters").
		Name(peeringConnectionAccepter.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(peeringConnectionAccepter).
		Do(ctx).
		Into(result)
...
func (c *peeringConnectionAccepters) UpdateStatus(ctx context.Context, peeringConnectionAccepter *v1alpha1.PeeringConnectionAccepter, opts v1.UpdateOptions) (result *v1alpha1.PeeringConnectionAccepter, err error) {
	result = &v1alpha1.PeeringConnectionAccepter{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("peeringconnectionaccepters").
...
func (c *peeringConnectionAccepters) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *peeringConnectionAccepters) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *peeringConnectionAccepters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.PeeringConnectionAccepter, err error) {
	result = &v1alpha1.PeeringConnectionAccepter{}
