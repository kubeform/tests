...
// EndpointServicesGetter has a method to return a EndpointServiceInterface.
...
// endpointServices implements EndpointServiceInterface
type endpointServices struct {
	client rest.Interface
	ns     string
}

// newEndpointServices returns a EndpointServices
func newEndpointServices(c *VpcV1alpha1Client, namespace string) *endpointServices {
...
func (c *endpointServices) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.EndpointService, err error) {
	result = &v1alpha1.EndpointService{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *endpointServices) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EndpointServiceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.EndpointServiceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("endpointservices").
...
func (c *endpointServices) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *endpointServices) Create(ctx context.Context, endpointService *v1alpha1.EndpointService, opts v1.CreateOptions) (result *v1alpha1.EndpointService, err error) {
	result = &v1alpha1.EndpointService{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("endpointservices").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(endpointService).
		Do(ctx).
		Into(result)
	return
}
...
func (c *endpointServices) Update(ctx context.Context, endpointService *v1alpha1.EndpointService, opts v1.UpdateOptions) (result *v1alpha1.EndpointService, err error) {
	result = &v1alpha1.EndpointService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("endpointservices").
...
func (c *endpointServices) UpdateStatus(ctx context.Context, endpointService *v1alpha1.EndpointService, opts v1.UpdateOptions) (result *v1alpha1.EndpointService, err error) {
	result = &v1alpha1.EndpointService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("endpointservices").
...
func (c *endpointServices) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *endpointServices) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *endpointServices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.EndpointService, err error) {
	result = &v1alpha1.EndpointService{}
