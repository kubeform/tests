...
func newDhcpOptionses(c *VpcV1alpha1Client, namespace string) *dhcpOptionses {
...
func (c *dhcpOptionses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DhcpOptions, err error) {
...
func (c *dhcpOptionses) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DhcpOptionsList, err error) {
...
func (c *dhcpOptionses) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dhcpOptionses) Create(ctx context.Context, dhcpOptions *v1alpha1.DhcpOptions, opts v1.CreateOptions) (result *v1alpha1.DhcpOptions, err error) {
	result = &v1alpha1.DhcpOptions{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("dhcpoptionses").
...
func (c *dhcpOptionses) Update(ctx context.Context, dhcpOptions *v1alpha1.DhcpOptions, opts v1.UpdateOptions) (result *v1alpha1.DhcpOptions, err error) {
	result = &v1alpha1.DhcpOptions{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dhcpoptionses").
...
func (c *dhcpOptionses) UpdateStatus(ctx context.Context, dhcpOptions *v1alpha1.DhcpOptions, opts v1.UpdateOptions) (result *v1alpha1.DhcpOptions, err error) {
	result = &v1alpha1.DhcpOptions{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dhcpoptionses").
...
func (c *dhcpOptionses) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *dhcpOptionses) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *dhcpOptionses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DhcpOptions, err error) {
	result = &v1alpha1.DhcpOptions{}
