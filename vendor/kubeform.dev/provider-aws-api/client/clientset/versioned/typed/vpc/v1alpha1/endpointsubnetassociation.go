...
// EndpointSubnetAssociationsGetter has a method to return a EndpointSubnetAssociationInterface.
...
// endpointSubnetAssociations implements EndpointSubnetAssociationInterface
type endpointSubnetAssociations struct {
	client rest.Interface
	ns     string
}

// newEndpointSubnetAssociations returns a EndpointSubnetAssociations
func newEndpointSubnetAssociations(c *VpcV1alpha1Client, namespace string) *endpointSubnetAssociations {
	return &endpointSubnetAssociations{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *endpointSubnetAssociations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.EndpointSubnetAssociation, err error) {
	result = &v1alpha1.EndpointSubnetAssociation{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *endpointSubnetAssociations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EndpointSubnetAssociationList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.EndpointSubnetAssociationList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("endpointsubnetassociations").
...
func (c *endpointSubnetAssociations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *endpointSubnetAssociations) Create(ctx context.Context, endpointSubnetAssociation *v1alpha1.EndpointSubnetAssociation, opts v1.CreateOptions) (result *v1alpha1.EndpointSubnetAssociation, err error) {
	result = &v1alpha1.EndpointSubnetAssociation{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("endpointsubnetassociations").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(endpointSubnetAssociation).
		Do(ctx).
		Into(result)
	return
}
...
func (c *endpointSubnetAssociations) Update(ctx context.Context, endpointSubnetAssociation *v1alpha1.EndpointSubnetAssociation, opts v1.UpdateOptions) (result *v1alpha1.EndpointSubnetAssociation, err error) {
	result = &v1alpha1.EndpointSubnetAssociation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("endpointsubnetassociations").
		Name(endpointSubnetAssociation.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(endpointSubnetAssociation).
		Do(ctx).
		Into(result)
...
func (c *endpointSubnetAssociations) UpdateStatus(ctx context.Context, endpointSubnetAssociation *v1alpha1.EndpointSubnetAssociation, opts v1.UpdateOptions) (result *v1alpha1.EndpointSubnetAssociation, err error) {
	result = &v1alpha1.EndpointSubnetAssociation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("endpointsubnetassociations").
...
func (c *endpointSubnetAssociations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *endpointSubnetAssociations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *endpointSubnetAssociations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.EndpointSubnetAssociation, err error) {
	result = &v1alpha1.EndpointSubnetAssociation{}
