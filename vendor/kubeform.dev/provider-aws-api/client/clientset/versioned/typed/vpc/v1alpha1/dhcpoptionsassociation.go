...
// DhcpOptionsAssociationsGetter has a method to return a DhcpOptionsAssociationInterface.
...
// dhcpOptionsAssociations implements DhcpOptionsAssociationInterface
type dhcpOptionsAssociations struct {
	client rest.Interface
	ns     string
}

// newDhcpOptionsAssociations returns a DhcpOptionsAssociations
func newDhcpOptionsAssociations(c *VpcV1alpha1Client, namespace string) *dhcpOptionsAssociations {
	return &dhcpOptionsAssociations{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *dhcpOptionsAssociations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DhcpOptionsAssociation, err error) {
	result = &v1alpha1.DhcpOptionsAssociation{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *dhcpOptionsAssociations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DhcpOptionsAssociationList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.DhcpOptionsAssociationList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("dhcpoptionsassociations").
...
func (c *dhcpOptionsAssociations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dhcpOptionsAssociations) Create(ctx context.Context, dhcpOptionsAssociation *v1alpha1.DhcpOptionsAssociation, opts v1.CreateOptions) (result *v1alpha1.DhcpOptionsAssociation, err error) {
	result = &v1alpha1.DhcpOptionsAssociation{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("dhcpoptionsassociations").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(dhcpOptionsAssociation).
		Do(ctx).
		Into(result)
	return
}
...
func (c *dhcpOptionsAssociations) Update(ctx context.Context, dhcpOptionsAssociation *v1alpha1.DhcpOptionsAssociation, opts v1.UpdateOptions) (result *v1alpha1.DhcpOptionsAssociation, err error) {
	result = &v1alpha1.DhcpOptionsAssociation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dhcpoptionsassociations").
		Name(dhcpOptionsAssociation.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(dhcpOptionsAssociation).
		Do(ctx).
		Into(result)
...
func (c *dhcpOptionsAssociations) UpdateStatus(ctx context.Context, dhcpOptionsAssociation *v1alpha1.DhcpOptionsAssociation, opts v1.UpdateOptions) (result *v1alpha1.DhcpOptionsAssociation, err error) {
	result = &v1alpha1.DhcpOptionsAssociation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dhcpoptionsassociations").
...
func (c *dhcpOptionsAssociations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *dhcpOptionsAssociations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *dhcpOptionsAssociations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DhcpOptionsAssociation, err error) {
	result = &v1alpha1.DhcpOptionsAssociation{}
