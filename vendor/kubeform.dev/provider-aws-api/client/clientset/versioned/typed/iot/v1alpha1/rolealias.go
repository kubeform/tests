...
// RoleAliasesGetter has a method to return a RoleAliasInterface.
...
// roleAliases implements RoleAliasInterface
type roleAliases struct {
	client rest.Interface
	ns     string
}

// newRoleAliases returns a RoleAliases
func newRoleAliases(c *IotV1alpha1Client, namespace string) *roleAliases {
	return &roleAliases{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *roleAliases) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.RoleAlias, err error) {
	result = &v1alpha1.RoleAlias{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("rolealiases").
		Name(name).
...
func (c *roleAliases) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RoleAliasList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.RoleAliasList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("rolealiases").
...
func (c *roleAliases) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *roleAliases) Create(ctx context.Context, roleAlias *v1alpha1.RoleAlias, opts v1.CreateOptions) (result *v1alpha1.RoleAlias, err error) {
	result = &v1alpha1.RoleAlias{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("rolealiases").
...
func (c *roleAliases) Update(ctx context.Context, roleAlias *v1alpha1.RoleAlias, opts v1.UpdateOptions) (result *v1alpha1.RoleAlias, err error) {
	result = &v1alpha1.RoleAlias{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("rolealiases").
...
func (c *roleAliases) UpdateStatus(ctx context.Context, roleAlias *v1alpha1.RoleAlias, opts v1.UpdateOptions) (result *v1alpha1.RoleAlias, err error) {
	result = &v1alpha1.RoleAlias{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("rolealiases").
...
func (c *roleAliases) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *roleAliases) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *roleAliases) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.RoleAlias, err error) {
	result = &v1alpha1.RoleAlias{}
