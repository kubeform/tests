...
func (c *eventSourceMappings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.EventSourceMapping, err error) {
...
func (c *eventSourceMappings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EventSourceMappingList, err error) {
...
func (c *eventSourceMappings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *eventSourceMappings) Create(ctx context.Context, eventSourceMapping *v1alpha1.EventSourceMapping, opts v1.CreateOptions) (result *v1alpha1.EventSourceMapping, err error) {
	result = &v1alpha1.EventSourceMapping{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("eventsourcemappings").
...
func (c *eventSourceMappings) Update(ctx context.Context, eventSourceMapping *v1alpha1.EventSourceMapping, opts v1.UpdateOptions) (result *v1alpha1.EventSourceMapping, err error) {
	result = &v1alpha1.EventSourceMapping{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("eventsourcemappings").
...
func (c *eventSourceMappings) UpdateStatus(ctx context.Context, eventSourceMapping *v1alpha1.EventSourceMapping, opts v1.UpdateOptions) (result *v1alpha1.EventSourceMapping, err error) {
	result = &v1alpha1.EventSourceMapping{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("eventsourcemappings").
...
func (c *eventSourceMappings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *eventSourceMappings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *eventSourceMappings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.EventSourceMapping, err error) {
	result = &v1alpha1.EventSourceMapping{}
