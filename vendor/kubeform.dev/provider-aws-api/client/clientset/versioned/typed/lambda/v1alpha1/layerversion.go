...
func (c *layerVersions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LayerVersion, err error) {
...
func (c *layerVersions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LayerVersionList, err error) {
...
func (c *layerVersions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *layerVersions) Create(ctx context.Context, layerVersion *v1alpha1.LayerVersion, opts v1.CreateOptions) (result *v1alpha1.LayerVersion, err error) {
	result = &v1alpha1.LayerVersion{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("layerversions").
...
func (c *layerVersions) Update(ctx context.Context, layerVersion *v1alpha1.LayerVersion, opts v1.UpdateOptions) (result *v1alpha1.LayerVersion, err error) {
	result = &v1alpha1.LayerVersion{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("layerversions").
...
func (c *layerVersions) UpdateStatus(ctx context.Context, layerVersion *v1alpha1.LayerVersion, opts v1.UpdateOptions) (result *v1alpha1.LayerVersion, err error) {
	result = &v1alpha1.LayerVersion{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("layerversions").
...
func (c *layerVersions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *layerVersions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *layerVersions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LayerVersion, err error) {
	result = &v1alpha1.LayerVersion{}
