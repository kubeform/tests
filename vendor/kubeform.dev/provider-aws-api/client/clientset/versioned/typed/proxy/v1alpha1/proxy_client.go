...
type ProxyV1alpha1Interface interface {
	...
	ProtocolPoliciesGetter
}

// ProxyV1alpha1Client is used to interact with features provided by the proxy.aws.kubeform.com group.
type ProxyV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ProxyV1alpha1Client) ProtocolPolicies(namespace string) ProtocolPolicyInterface {
	return newProtocolPolicies(c, namespace)
}
