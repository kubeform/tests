...
// ClassifiersGetter has a method to return a ClassifierInterface.
...
// classifiers implements ClassifierInterface
type classifiers struct {
	client rest.Interface
	ns     string
}

// newClassifiers returns a Classifiers
func newClassifiers(c *GlueV1alpha1Client, namespace string) *classifiers {
	return &classifiers{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *classifiers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Classifier, err error) {
	result = &v1alpha1.Classifier{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *classifiers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ClassifierList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ClassifierList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("classifiers").
...
func (c *classifiers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *classifiers) Create(ctx context.Context, classifier *v1alpha1.Classifier, opts v1.CreateOptions) (result *v1alpha1.Classifier, err error) {
	result = &v1alpha1.Classifier{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("classifiers").
...
func (c *classifiers) Update(ctx context.Context, classifier *v1alpha1.Classifier, opts v1.UpdateOptions) (result *v1alpha1.Classifier, err error) {
	result = &v1alpha1.Classifier{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("classifiers").
...
func (c *classifiers) UpdateStatus(ctx context.Context, classifier *v1alpha1.Classifier, opts v1.UpdateOptions) (result *v1alpha1.Classifier, err error) {
	result = &v1alpha1.Classifier{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("classifiers").
...
func (c *classifiers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *classifiers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *classifiers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Classifier, err error) {
	result = &v1alpha1.Classifier{}
