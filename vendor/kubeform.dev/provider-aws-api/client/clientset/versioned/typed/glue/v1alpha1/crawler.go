...
func (c *crawlers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Crawler, err error) {
...
func (c *crawlers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CrawlerList, err error) {
...
func (c *crawlers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *crawlers) Create(ctx context.Context, crawler *v1alpha1.Crawler, opts v1.CreateOptions) (result *v1alpha1.Crawler, err error) {
	result = &v1alpha1.Crawler{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("crawlers").
...
func (c *crawlers) Update(ctx context.Context, crawler *v1alpha1.Crawler, opts v1.UpdateOptions) (result *v1alpha1.Crawler, err error) {
	result = &v1alpha1.Crawler{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("crawlers").
...
func (c *crawlers) UpdateStatus(ctx context.Context, crawler *v1alpha1.Crawler, opts v1.UpdateOptions) (result *v1alpha1.Crawler, err error) {
	result = &v1alpha1.Crawler{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("crawlers").
...
func (c *crawlers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *crawlers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *crawlers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Crawler, err error) {
	result = &v1alpha1.Crawler{}
