...
func newUserSSHKeys(c *IamV1alpha1Client, namespace string) *userSSHKeys {
	return &userSSHKeys{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *userSSHKeys) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.UserSSHKey, err error) {
	result = &v1alpha1.UserSSHKey{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *userSSHKeys) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.UserSSHKeyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.UserSSHKeyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("usersshkeys").
...
func (c *userSSHKeys) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *userSSHKeys) Create(ctx context.Context, userSSHKey *v1alpha1.UserSSHKey, opts v1.CreateOptions) (result *v1alpha1.UserSSHKey, err error) {
	result = &v1alpha1.UserSSHKey{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("usersshkeys").
...
func (c *userSSHKeys) Update(ctx context.Context, userSSHKey *v1alpha1.UserSSHKey, opts v1.UpdateOptions) (result *v1alpha1.UserSSHKey, err error) {
	result = &v1alpha1.UserSSHKey{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("usersshkeys").
...
func (c *userSSHKeys) UpdateStatus(ctx context.Context, userSSHKey *v1alpha1.UserSSHKey, opts v1.UpdateOptions) (result *v1alpha1.UserSSHKey, err error) {
	result = &v1alpha1.UserSSHKey{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("usersshkeys").
...
func (c *userSSHKeys) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *userSSHKeys) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *userSSHKeys) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.UserSSHKey, err error) {
	result = &v1alpha1.UserSSHKey{}
