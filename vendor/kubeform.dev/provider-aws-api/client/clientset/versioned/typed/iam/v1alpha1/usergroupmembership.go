...
// UserGroupMembershipsGetter has a method to return a UserGroupMembershipInterface.
...
// userGroupMemberships implements UserGroupMembershipInterface
type userGroupMemberships struct {
	client rest.Interface
	ns     string
}

// newUserGroupMemberships returns a UserGroupMemberships
func newUserGroupMemberships(c *IamV1alpha1Client, namespace string) *userGroupMemberships {
...
func (c *userGroupMemberships) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.UserGroupMembership, err error) {
	result = &v1alpha1.UserGroupMembership{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *userGroupMemberships) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.UserGroupMembershipList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.UserGroupMembershipList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("usergroupmemberships").
...
func (c *userGroupMemberships) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *userGroupMemberships) Create(ctx context.Context, userGroupMembership *v1alpha1.UserGroupMembership, opts v1.CreateOptions) (result *v1alpha1.UserGroupMembership, err error) {
	result = &v1alpha1.UserGroupMembership{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("usergroupmemberships").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(userGroupMembership).
		Do(ctx).
		Into(result)
	return
}
...
func (c *userGroupMemberships) Update(ctx context.Context, userGroupMembership *v1alpha1.UserGroupMembership, opts v1.UpdateOptions) (result *v1alpha1.UserGroupMembership, err error) {
	result = &v1alpha1.UserGroupMembership{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("usergroupmemberships").
...
func (c *userGroupMemberships) UpdateStatus(ctx context.Context, userGroupMembership *v1alpha1.UserGroupMembership, opts v1.UpdateOptions) (result *v1alpha1.UserGroupMembership, err error) {
	result = &v1alpha1.UserGroupMembership{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("usergroupmemberships").
...
func (c *userGroupMemberships) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *userGroupMemberships) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *userGroupMemberships) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.UserGroupMembership, err error) {
	result = &v1alpha1.UserGroupMembership{}
