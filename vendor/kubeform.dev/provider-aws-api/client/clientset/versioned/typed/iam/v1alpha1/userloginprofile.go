...
// UserLoginProfilesGetter has a method to return a UserLoginProfileInterface.
...
// userLoginProfiles implements UserLoginProfileInterface
type userLoginProfiles struct {
	client rest.Interface
	ns     string
}

// newUserLoginProfiles returns a UserLoginProfiles
func newUserLoginProfiles(c *IamV1alpha1Client, namespace string) *userLoginProfiles {
...
func (c *userLoginProfiles) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.UserLoginProfile, err error) {
	result = &v1alpha1.UserLoginProfile{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *userLoginProfiles) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.UserLoginProfileList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.UserLoginProfileList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("userloginprofiles").
...
func (c *userLoginProfiles) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *userLoginProfiles) Create(ctx context.Context, userLoginProfile *v1alpha1.UserLoginProfile, opts v1.CreateOptions) (result *v1alpha1.UserLoginProfile, err error) {
	result = &v1alpha1.UserLoginProfile{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("userloginprofiles").
...
func (c *userLoginProfiles) Update(ctx context.Context, userLoginProfile *v1alpha1.UserLoginProfile, opts v1.UpdateOptions) (result *v1alpha1.UserLoginProfile, err error) {
	result = &v1alpha1.UserLoginProfile{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("userloginprofiles").
...
func (c *userLoginProfiles) UpdateStatus(ctx context.Context, userLoginProfile *v1alpha1.UserLoginProfile, opts v1.UpdateOptions) (result *v1alpha1.UserLoginProfile, err error) {
	result = &v1alpha1.UserLoginProfile{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("userloginprofiles").
...
func (c *userLoginProfiles) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *userLoginProfiles) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *userLoginProfiles) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.UserLoginProfile, err error) {
	result = &v1alpha1.UserLoginProfile{}
