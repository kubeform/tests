...
func newRegexPatternSets(c *Wafv2V1alpha1Client, namespace string) *regexPatternSets {
...
func (c *regexPatternSets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.RegexPatternSet, err error) {
...
func (c *regexPatternSets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RegexPatternSetList, err error) {
...
func (c *regexPatternSets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *regexPatternSets) Create(ctx context.Context, regexPatternSet *v1alpha1.RegexPatternSet, opts v1.CreateOptions) (result *v1alpha1.RegexPatternSet, err error) {
	result = &v1alpha1.RegexPatternSet{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("regexpatternsets").
...
func (c *regexPatternSets) Update(ctx context.Context, regexPatternSet *v1alpha1.RegexPatternSet, opts v1.UpdateOptions) (result *v1alpha1.RegexPatternSet, err error) {
	result = &v1alpha1.RegexPatternSet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("regexpatternsets").
...
func (c *regexPatternSets) UpdateStatus(ctx context.Context, regexPatternSet *v1alpha1.RegexPatternSet, opts v1.UpdateOptions) (result *v1alpha1.RegexPatternSet, err error) {
	result = &v1alpha1.RegexPatternSet{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("regexpatternsets").
...
func (c *regexPatternSets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *regexPatternSets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *regexPatternSets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.RegexPatternSet, err error) {
	result = &v1alpha1.RegexPatternSet{}
