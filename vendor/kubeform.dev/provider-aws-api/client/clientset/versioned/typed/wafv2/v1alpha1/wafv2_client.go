...
type Wafv2V1alpha1Interface interface {
	...
	WebACLLoggingConfigurationsGetter
}
...
func (c *Wafv2V1alpha1Client) WebACLLoggingConfigurations(namespace string) WebACLLoggingConfigurationInterface {
	return newWebACLLoggingConfigurations(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*Wafv2V1alpha1Client, error) {
	...
	return &Wafv2V1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new Wafv2V1alpha1Client for the given config and
...
func New(c rest.Interface) *Wafv2V1alpha1Client {
	return &Wafv2V1alpha1Client{c}
}
