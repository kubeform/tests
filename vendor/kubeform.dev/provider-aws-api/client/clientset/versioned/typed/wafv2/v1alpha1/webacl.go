...
func newWebACLs(c *Wafv2V1alpha1Client, namespace string) *webACLs {
	return &webACLs{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *webACLs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.WebACL, err error) {
...
func (c *webACLs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.WebACLList, err error) {
...
func (c *webACLs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *webACLs) Create(ctx context.Context, webACL *v1alpha1.WebACL, opts v1.CreateOptions) (result *v1alpha1.WebACL, err error) {
	result = &v1alpha1.WebACL{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("webacls").
...
func (c *webACLs) Update(ctx context.Context, webACL *v1alpha1.WebACL, opts v1.UpdateOptions) (result *v1alpha1.WebACL, err error) {
	result = &v1alpha1.WebACL{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("webacls").
...
func (c *webACLs) UpdateStatus(ctx context.Context, webACL *v1alpha1.WebACL, opts v1.UpdateOptions) (result *v1alpha1.WebACL, err error) {
	result = &v1alpha1.WebACL{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("webacls").
...
func (c *webACLs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *webACLs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *webACLs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.WebACL, err error) {
	result = &v1alpha1.WebACL{}
