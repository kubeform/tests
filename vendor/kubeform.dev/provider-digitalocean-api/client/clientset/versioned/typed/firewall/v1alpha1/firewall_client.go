...
import (
	v1alpha1 "kubeform.dev/provider-digitalocean-api/apis/firewall/v1alpha1"
...
// FirewallV1alpha1Client is used to interact with features provided by the firewall.digitalocean.kubeform.com group.
