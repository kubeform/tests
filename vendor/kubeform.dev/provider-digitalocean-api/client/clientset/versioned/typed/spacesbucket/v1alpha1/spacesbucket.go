...
func newSpacesBuckets(c *SpacesbucketV1alpha1Client, namespace string) *spacesBuckets {
...
func (c *spacesBuckets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SpacesBucket, err error) {
...
func (c *spacesBuckets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SpacesBucketList, err error) {
...
func (c *spacesBuckets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *spacesBuckets) Create(ctx context.Context, spacesBucket *v1alpha1.SpacesBucket, opts v1.CreateOptions) (result *v1alpha1.SpacesBucket, err error) {
	result = &v1alpha1.SpacesBucket{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("spacesbuckets").
...
func (c *spacesBuckets) Update(ctx context.Context, spacesBucket *v1alpha1.SpacesBucket, opts v1.UpdateOptions) (result *v1alpha1.SpacesBucket, err error) {
	result = &v1alpha1.SpacesBucket{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("spacesbuckets").
...
func (c *spacesBuckets) UpdateStatus(ctx context.Context, spacesBucket *v1alpha1.SpacesBucket, opts v1.UpdateOptions) (result *v1alpha1.SpacesBucket, err error) {
	result = &v1alpha1.SpacesBucket{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("spacesbuckets").
...
func (c *spacesBuckets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *spacesBuckets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *spacesBuckets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SpacesBucket, err error) {
	result = &v1alpha1.SpacesBucket{}
