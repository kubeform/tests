...
import (
	v1alpha1 "kubeform.dev/provider-digitalocean-api/apis/custom/v1alpha1"
...
// CustomV1alpha1Client is used to interact with features provided by the custom.digitalocean.kubeform.com group.
type CustomV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CustomV1alpha1Client) Images(namespace string) ImageInterface {
