...
// CdnV1alpha1Client is used to interact with features provided by the cdn.digitalocean.kubeform.com group.
type CdnV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CdnV1alpha1Client) Cdns(namespace string) CdnInterface {
