...
func newCdns(c *CdnV1alpha1Client, namespace string) *cdns {
	return &cdns{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *cdns) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Cdn, err error) {
	result = &v1alpha1.Cdn{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("cdns").
...
func (c *cdns) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CdnList, err error) {
...
func (c *cdns) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cdns) Create(ctx context.Context, cdn *v1alpha1.Cdn, opts v1.CreateOptions) (result *v1alpha1.Cdn, err error) {
	result = &v1alpha1.Cdn{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cdns").
...
func (c *cdns) Update(ctx context.Context, cdn *v1alpha1.Cdn, opts v1.UpdateOptions) (result *v1alpha1.Cdn, err error) {
	result = &v1alpha1.Cdn{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cdns").
...
func (c *cdns) UpdateStatus(ctx context.Context, cdn *v1alpha1.Cdn, opts v1.UpdateOptions) (result *v1alpha1.Cdn, err error) {
	result = &v1alpha1.Cdn{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cdns").
...
func (c *cdns) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *cdns) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *cdns) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Cdn, err error) {
	result = &v1alpha1.Cdn{}
