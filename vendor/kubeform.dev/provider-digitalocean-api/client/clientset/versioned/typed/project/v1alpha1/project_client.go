...
// ProjectV1alpha1Client is used to interact with features provided by the project.digitalocean.kubeform.com group.
...
func (c *ProjectV1alpha1Client) Resourceses(namespace string) ResourcesInterface {
	return newResourceses(c, namespace)
}
