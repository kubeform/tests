...
import (
	v1alpha1 "kubeform.dev/provider-digitalocean-api/apis/vpc/v1alpha1"
...
// VpcV1alpha1Client is used to interact with features provided by the vpc.digitalocean.kubeform.com group.
