...
type ContainerregistryV1alpha1Interface interface {
	RESTClient() rest.Interface
	ContainerRegistriesGetter
	DockerCredentialsesGetter
}
...
func (c *ContainerregistryV1alpha1Client) DockerCredentialses(namespace string) DockerCredentialsInterface {
	return newDockerCredentialses(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*ContainerregistryV1alpha1Client, error) {
	...
	return &ContainerregistryV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new ContainerregistryV1alpha1Client for the given config and
...
func New(c rest.Interface) *ContainerregistryV1alpha1Client {
	return &ContainerregistryV1alpha1Client{c}
}
