...
func newReplicas(c *DatabaseV1alpha1Client, namespace string) *replicas {
	return &replicas{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *replicas) UpdateStatus(ctx context.Context, replica *v1alpha1.Replica, opts v1.UpdateOptions) (result *v1alpha1.Replica, err error) {
	result = &v1alpha1.Replica{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("replicas").
