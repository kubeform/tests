...
func newDbs(c *DatabaseV1alpha1Client, namespace string) *dbs {
	return &dbs{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *dbs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Db, err error) {
	result = &v1alpha1.Db{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("dbs").
...
func (c *dbs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DbList, err error) {
...
func (c *dbs) Create(ctx context.Context, db *v1alpha1.Db, opts v1.CreateOptions) (result *v1alpha1.Db, err error) {
	result = &v1alpha1.Db{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("dbs").
...
func (c *dbs) Update(ctx context.Context, db *v1alpha1.Db, opts v1.UpdateOptions) (result *v1alpha1.Db, err error) {
	result = &v1alpha1.Db{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dbs").
...
func (c *dbs) UpdateStatus(ctx context.Context, db *v1alpha1.Db, opts v1.UpdateOptions) (result *v1alpha1.Db, err error) {
	result = &v1alpha1.Db{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dbs").
...
func (c *dbs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Db, err error) {
	result = &v1alpha1.Db{}
