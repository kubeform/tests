...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-digitalocean-api/apis/cdn/v1alpha1.Cdn":       schema_provider_digitalocean_api_apis_cdn_v1alpha1_Cdn(ref),
		"kubeform.dev/provider-digitalocean-api/apis/cdn/v1alpha1.CdnList":   schema_provider_digitalocean_api_apis_cdn_v1alpha1_CdnList(ref),
		"kubeform.dev/provider-digitalocean-api/apis/cdn/v1alpha1.CdnSpec":   schema_provider_digitalocean_api_apis_cdn_v1alpha1_CdnSpec(ref),
		"kubeform.dev/provider-digitalocean-api/apis/cdn/v1alpha1.CdnSpec2":  schema_provider_digitalocean_api_apis_cdn_v1alpha1_CdnSpec2(ref),
		"kubeform.dev/provider-digitalocean-api/apis/cdn/v1alpha1.CdnStatus": schema_provider_digitalocean_api_apis_cdn_v1alpha1_CdnStatus(ref),
	}
}
...
func schema_provider_digitalocean_api_apis_cdn_v1alpha1_Cdn(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-digitalocean-api/apis/cdn/v1alpha1.CdnSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-digitalocean-api/apis/cdn/v1alpha1.CdnStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-digitalocean-api/apis/cdn/v1alpha1.CdnSpec", "kubeform.dev/provider-digitalocean-api/apis/cdn/v1alpha1.CdnStatus"},
	}
}

func schema_provider_digitalocean_api_apis_cdn_v1alpha1_CdnList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-digitalocean-api/apis/cdn/v1alpha1.Cdn"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-digitalocean-api/apis/cdn/v1alpha1.Cdn"},
	}
}

func schema_provider_digitalocean_api_apis_cdn_v1alpha1_CdnSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"certificateID": {
						SchemaProps: spec.SchemaProps{
							Description: "ID of a DigitalOcean managed TLS certificate for use with custom domains Deprecated",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("kubeform.dev/provider-digitalocean-api/apis/cdn/v1alpha1.CdnSpec2"),
						},
					},
				},
		...
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/provider-digitalocean-api/apis/cdn/v1alpha1.CdnSpec2"},
	}
}

func schema_provider_digitalocean_api_apis_cdn_v1alpha1_CdnSpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_digitalocean_api_apis_cdn_v1alpha1_CdnStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
