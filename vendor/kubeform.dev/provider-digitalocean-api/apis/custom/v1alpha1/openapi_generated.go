...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-digitalocean-api/apis/custom/v1alpha1.Image":       schema_provider_digitalocean_api_apis_custom_v1alpha1_Image(ref),
		"kubeform.dev/provider-digitalocean-api/apis/custom/v1alpha1.ImageList":   schema_provider_digitalocean_api_apis_custom_v1alpha1_ImageList(ref),
		"kubeform.dev/provider-digitalocean-api/apis/custom/v1alpha1.ImageSpec":   schema_provider_digitalocean_api_apis_custom_v1alpha1_ImageSpec(ref),
		"kubeform.dev/provider-digitalocean-api/apis/custom/v1alpha1.ImageSpec2":  schema_provider_digitalocean_api_apis_custom_v1alpha1_ImageSpec2(ref),
		"kubeform.dev/provider-digitalocean-api/apis/custom/v1alpha1.ImageStatus": schema_provider_digitalocean_api_apis_custom_v1alpha1_ImageStatus(ref),
	}
}
...
func schema_provider_digitalocean_api_apis_custom_v1alpha1_Image(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-digitalocean-api/apis/custom/v1alpha1.ImageSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-digitalocean-api/apis/custom/v1alpha1.ImageStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-digitalocean-api/apis/custom/v1alpha1.ImageSpec", "kubeform.dev/provider-digitalocean-api/apis/custom/v1alpha1.ImageStatus"},
	}
}

func schema_provider_digitalocean_api_apis_custom_v1alpha1_ImageList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-digitalocean-api/apis/custom/v1alpha1.Image"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-digitalocean-api/apis/custom/v1alpha1.Image"},
	}
}

func schema_provider_digitalocean_api_apis_custom_v1alpha1_ImageSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("kubeform.dev/provider-digitalocean-api/apis/custom/v1alpha1.ImageSpec2"),
						},
					},
				},
				Required: []string{"providerRef", "name", "regions", "url"},
			},
		},
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/provider-digitalocean-api/apis/custom/v1alpha1.ImageSpec2"},
	}
}

func schema_provider_digitalocean_api_apis_custom_v1alpha1_ImageSpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_digitalocean_api_apis_custom_v1alpha1_ImageStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
