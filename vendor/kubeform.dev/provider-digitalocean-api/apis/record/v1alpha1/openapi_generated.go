...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-digitalocean-api/apis/record/v1alpha1.Record":       schema_provider_digitalocean_api_apis_record_v1alpha1_Record(ref),
		"kubeform.dev/provider-digitalocean-api/apis/record/v1alpha1.RecordList":   schema_provider_digitalocean_api_apis_record_v1alpha1_RecordList(ref),
		"kubeform.dev/provider-digitalocean-api/apis/record/v1alpha1.RecordSpec":   schema_provider_digitalocean_api_apis_record_v1alpha1_RecordSpec(ref),
		"kubeform.dev/provider-digitalocean-api/apis/record/v1alpha1.RecordSpec2":  schema_provider_digitalocean_api_apis_record_v1alpha1_RecordSpec2(ref),
		"kubeform.dev/provider-digitalocean-api/apis/record/v1alpha1.RecordStatus": schema_provider_digitalocean_api_apis_record_v1alpha1_RecordStatus(ref),
	}
}
...
func schema_provider_digitalocean_api_apis_record_v1alpha1_Record(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-digitalocean-api/apis/record/v1alpha1.RecordSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-digitalocean-api/apis/record/v1alpha1.RecordStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-digitalocean-api/apis/record/v1alpha1.RecordSpec", "kubeform.dev/provider-digitalocean-api/apis/record/v1alpha1.RecordStatus"},
	}
}

func schema_provider_digitalocean_api_apis_record_v1alpha1_RecordList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-digitalocean-api/apis/record/v1alpha1.Record"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-digitalocean-api/apis/record/v1alpha1.Record"},
	}
}

func schema_provider_digitalocean_api_apis_record_v1alpha1_RecordSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("kubeform.dev/provider-digitalocean-api/apis/record/v1alpha1.RecordSpec2"),
						},
					},
				},
		...
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/provider-digitalocean-api/apis/record/v1alpha1.RecordSpec2"},
	}
}

func schema_provider_digitalocean_api_apis_record_v1alpha1_RecordSpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_digitalocean_api_apis_record_v1alpha1_RecordStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
