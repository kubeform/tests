...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-digitalocean-api/apis/vpc/v1alpha1.Vpc":       schema_provider_digitalocean_api_apis_vpc_v1alpha1_Vpc(ref),
		"kubeform.dev/provider-digitalocean-api/apis/vpc/v1alpha1.VpcList":   schema_provider_digitalocean_api_apis_vpc_v1alpha1_VpcList(ref),
		"kubeform.dev/provider-digitalocean-api/apis/vpc/v1alpha1.VpcSpec":   schema_provider_digitalocean_api_apis_vpc_v1alpha1_VpcSpec(ref),
		"kubeform.dev/provider-digitalocean-api/apis/vpc/v1alpha1.VpcSpec2":  schema_provider_digitalocean_api_apis_vpc_v1alpha1_VpcSpec2(ref),
		"kubeform.dev/provider-digitalocean-api/apis/vpc/v1alpha1.VpcStatus": schema_provider_digitalocean_api_apis_vpc_v1alpha1_VpcStatus(ref),
	}
}
...
func schema_provider_digitalocean_api_apis_vpc_v1alpha1_Vpc(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-digitalocean-api/apis/vpc/v1alpha1.VpcSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-digitalocean-api/apis/vpc/v1alpha1.VpcStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-digitalocean-api/apis/vpc/v1alpha1.VpcSpec", "kubeform.dev/provider-digitalocean-api/apis/vpc/v1alpha1.VpcStatus"},
	}
}

func schema_provider_digitalocean_api_apis_vpc_v1alpha1_VpcList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-digitalocean-api/apis/vpc/v1alpha1.Vpc"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-digitalocean-api/apis/vpc/v1alpha1.Vpc"},
	}
}

func schema_provider_digitalocean_api_apis_vpc_v1alpha1_VpcSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("kubeform.dev/provider-digitalocean-api/apis/vpc/v1alpha1.VpcSpec2"),
						},
					},
				},
		...
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/apimachinery/api/v1alpha1.ResourceTimeout", "kubeform.dev/provider-digitalocean-api/apis/vpc/v1alpha1.VpcSpec2"},
	}
}

func schema_provider_digitalocean_api_apis_vpc_v1alpha1_VpcSpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_digitalocean_api_apis_vpc_v1alpha1_VpcStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
