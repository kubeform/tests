...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-digitalocean-api/apis/domain/v1alpha1.Domain":       schema_provider_digitalocean_api_apis_domain_v1alpha1_Domain(ref),
		"kubeform.dev/provider-digitalocean-api/apis/domain/v1alpha1.DomainList":   schema_provider_digitalocean_api_apis_domain_v1alpha1_DomainList(ref),
		"kubeform.dev/provider-digitalocean-api/apis/domain/v1alpha1.DomainSpec":   schema_provider_digitalocean_api_apis_domain_v1alpha1_DomainSpec(ref),
		"kubeform.dev/provider-digitalocean-api/apis/domain/v1alpha1.DomainSpec2":  schema_provider_digitalocean_api_apis_domain_v1alpha1_DomainSpec2(ref),
		"kubeform.dev/provider-digitalocean-api/apis/domain/v1alpha1.DomainStatus": schema_provider_digitalocean_api_apis_domain_v1alpha1_DomainStatus(ref),
	}
}
...
func schema_provider_digitalocean_api_apis_domain_v1alpha1_Domain(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-digitalocean-api/apis/domain/v1alpha1.DomainSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-digitalocean-api/apis/domain/v1alpha1.DomainStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-digitalocean-api/apis/domain/v1alpha1.DomainSpec", "kubeform.dev/provider-digitalocean-api/apis/domain/v1alpha1.DomainStatus"},
	}
}

func schema_provider_digitalocean_api_apis_domain_v1alpha1_DomainList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-digitalocean-api/apis/domain/v1alpha1.Domain"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-digitalocean-api/apis/domain/v1alpha1.Domain"},
	}
}

func schema_provider_digitalocean_api_apis_domain_v1alpha1_DomainSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("kubeform.dev/provider-digitalocean-api/apis/domain/v1alpha1.DomainSpec2"),
						},
					},
				},
		...
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/provider-digitalocean-api/apis/domain/v1alpha1.DomainSpec2"},
	}
}

func schema_provider_digitalocean_api_apis_domain_v1alpha1_DomainSpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_digitalocean_api_apis_domain_v1alpha1_DomainStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
