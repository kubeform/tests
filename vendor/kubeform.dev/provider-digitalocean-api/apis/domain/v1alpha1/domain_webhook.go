...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-domain-digitalocean-kubeform-com-v1alpha1-domain,mutating=false,failurePolicy=fail,groups=domain.digitalocean.kubeform.com,resources=domains,versions=v1alpha1,name=domain.domain.digitalocean.kubeform.io,sideEffects=None,admissionReviewVersions=v1
