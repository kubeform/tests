...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubeform.dev/provider-digitalocean-api/apis/ssh/v1alpha1.Key":       schema_provider_digitalocean_api_apis_ssh_v1alpha1_Key(ref),
		"kubeform.dev/provider-digitalocean-api/apis/ssh/v1alpha1.KeyList":   schema_provider_digitalocean_api_apis_ssh_v1alpha1_KeyList(ref),
		"kubeform.dev/provider-digitalocean-api/apis/ssh/v1alpha1.KeySpec":   schema_provider_digitalocean_api_apis_ssh_v1alpha1_KeySpec(ref),
		"kubeform.dev/provider-digitalocean-api/apis/ssh/v1alpha1.KeySpec2":  schema_provider_digitalocean_api_apis_ssh_v1alpha1_KeySpec2(ref),
		"kubeform.dev/provider-digitalocean-api/apis/ssh/v1alpha1.KeyStatus": schema_provider_digitalocean_api_apis_ssh_v1alpha1_KeyStatus(ref),
	}
}
...
func schema_provider_digitalocean_api_apis_ssh_v1alpha1_Key(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-digitalocean-api/apis/ssh/v1alpha1.KeySpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("kubeform.dev/provider-digitalocean-api/apis/ssh/v1alpha1.KeyStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "kubeform.dev/provider-digitalocean-api/apis/ssh/v1alpha1.KeySpec", "kubeform.dev/provider-digitalocean-api/apis/ssh/v1alpha1.KeyStatus"},
	}
}

func schema_provider_digitalocean_api_apis_ssh_v1alpha1_KeyList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubeform.dev/provider-digitalocean-api/apis/ssh/v1alpha1.Key"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubeform.dev/provider-digitalocean-api/apis/ssh/v1alpha1.Key"},
	}
}

func schema_provider_digitalocean_api_apis_ssh_v1alpha1_KeySpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"kubeformOutput": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("kubeform.dev/provider-digitalocean-api/apis/ssh/v1alpha1.KeySpec2"),
						},
					},
				},
		...
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "kubeform.dev/provider-digitalocean-api/apis/ssh/v1alpha1.KeySpec2"},
	}
}

func schema_provider_digitalocean_api_apis_ssh_v1alpha1_KeySpec2(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_provider_digitalocean_api_apis_ssh_v1alpha1_KeyStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
